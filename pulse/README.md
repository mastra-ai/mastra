...
See `current-model.md` for the current consolidated candidate model after `fit_exploration_04/`, `fit_exploration_05/`, `fit_exploration_06/`, `fit_exploration_07/`, `fit_exploration_08/`, and `fit_exploration_09/`.

See `pulse-export-spec.md` for the initial draft spec.
...
See `fit_exploration_01/`, `fit_exploration_02/`, `fit_exploration_03/`, `fit_exploration_04/`, `fit_exploration_05/`, `fit_exploration_06/`, `fit_exploration_07/`, `fit_exploration_08/`, and `fit_exploration_09/` for historical and in-progress shape-fit passes.

See `code_audit/README.md` for source and candidate emission audits, including the Harness/config provenance addendum and the current branch refresh.
