...
- **Number**: 12021
- **Title**: feat: add NestJS server adapter with Express and Fastify support
- **Author**: eduartua
- **Created**: 2026-01-16T18:26:44Z
- **Updated**: 2026-01-19T19:33:09Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 3814, **Deletions**: 1347, **Changed Files**: 28
- **Branch**: feature/nestjs-adapter -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/12021

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 12021 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 12021
   gh pr diff 12021 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/12021.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/12021.json`. Be concise but thorough in `summary` and `maintainerNotes`.
