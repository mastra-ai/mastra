...
- **Number**: 12454
- **Title**: fix: recover tool call args when split across messages (#12405)
- **Author**: Rish-it
- **Created**: 2026-01-29T05:57:14Z
- **Updated**: 2026-03-03T12:39:54Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 235, **Deletions**: 3, **Changed Files**: 3
- **Branch**: fix/issue-12405-split-tool-call-args -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/12454

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 12454 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 12454
   gh pr diff 12454 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/12454.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/12454.json`. Be concise but thorough in `summary` and `maintainerNotes`.
