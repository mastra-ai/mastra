...
- **Number**: 12963
- **Title**:  fix(deployer): skip analyzeBundle in dev mode to prevent hang in large monorepos
- **Author**: intojhanurag
- **Created**: 2026-02-11T18:05:48Z
- **Updated**: 2026-03-09T14:02:05Z
- **Draft**: False
- **Review Decision**: APPROVED
- **Additions**: 91, **Deletions**: 8, **Changed Files**: 4
- **Branch**: fix/12843-dev-hangs-large-monorepos -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/12963

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 12963 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 12963
   gh pr diff 12963 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/12963.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/12963.json`. Be concise but thorough in `summary` and `maintainerNotes`.
