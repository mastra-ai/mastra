...
- **Number**: 13681
- **Title**: feat(voice-hume)
- **Author**: ivaaan
- **Created**: 2026-03-02T16:33:05Z
- **Updated**: 2026-03-09T18:37:40Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 1096, **Deletions**: 0, **Changed Files**: 18
- **Branch**: add-hume -> main
- **Labels**: Documentation
- **URL**: https://github.com/mastra-ai/mastra/pull/13681

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13681 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13681
   gh pr diff 13681 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13681.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13681.json`. Be concise but thorough in `summary` and `maintainerNotes`.
