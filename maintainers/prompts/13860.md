...
- **Number**: 13860
- **Title**: fix(core): persist provider-executed tool calls in stream order
- **Author**: TheIsrael1
- **Created**: 2026-03-05T15:58:31Z
- **Updated**: 2026-03-10T09:15:49Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 124, **Deletions**: 6, **Changed Files**: 3
- **Branch**: addition -> main
- **Labels**: Documentation
- **URL**: https://github.com/mastra-ai/mastra/pull/13860

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13860 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13860
   gh pr diff 13860 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13860.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13860.json`. Be concise but thorough in `summary` and `maintainerNotes`.
