...
- **Number**: 9256
- **Title**: Fix and feat: add metadata filtering support to semantic recall (Issue #8610)
- **Author**: blind05
- **Created**: 2025-10-24T17:50:14Z
- **Updated**: 2026-03-03T12:42:33Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 606, **Deletions**: 9, **Changed Files**: 6
- **Branch**: fix/memory-8610-hunterhagedorn-semantic-filter -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/9256

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 9256 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 9256
   gh pr diff 9256 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/9256.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/9256.json`. Be concise but thorough in `summary` and `maintainerNotes`.
