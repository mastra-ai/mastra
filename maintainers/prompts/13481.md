...
- **Number**: 13481
- **Title**: fix: fallback to original schema when compat layer breaks optional fields (#13480)
- **Author**: echoVic
- **Created**: 2026-02-25T08:25:25Z
- **Updated**: 2026-03-03T12:35:10Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 236, **Deletions**: 2, **Changed Files**: 4
- **Branch**: fix/original-schema-fallback-validation -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13481

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13481 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13481
   gh pr diff 13481 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13481.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13481.json`. Be concise but thorough in `summary` and `maintainerNotes`.
