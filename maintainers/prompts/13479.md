...
- **Number**: 13479
- **Title**: fix(tools): schema-aware null stripping preserves .nullable() fields (#13419)
- **Author**: echoVic
- **Created**: 2026-02-25T07:34:50Z
- **Updated**: 2026-03-03T12:35:12Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 93, **Deletions**: 31, **Changed Files**: 6
- **Branch**: fix/schema-aware-null-stripping -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13479

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13479 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13479
   gh pr diff 13479 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13479.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13479.json`. Be concise but thorough in `summary` and `maintainerNotes`.
