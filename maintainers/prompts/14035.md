...
- **Number**: 14035
- **Title**: fix(server): allow thread ownership transfer in trusted server contexts
- **Author**: DanielSLew
- **Created**: 2026-03-09T20:36:09Z
- **Updated**: 2026-03-09T22:29:50Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 588, **Deletions**: 5, **Changed Files**: 7
- **Branch**: fix/issue-13327 -> main
- **Labels**: Documentation
- **URL**: https://github.com/mastra-ai/mastra/pull/14035

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 14035 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 14035
   gh pr diff 14035 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/14035.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/14035.json`. Be concise but thorough in `summary` and `maintainerNotes`.
