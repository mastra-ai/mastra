...
- **Number**: 13989
- **Title**: fix(server): fallback to agent toolsResolver in EXECUTE_TOOL_ROUTE
- **Author**: Aayush-engineer
- **Created**: 2026-03-09T03:51:22Z
- **Updated**: 2026-03-09T16:34:47Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 14, **Deletions**: 0, **Changed Files**: 1
- **Branch**: fix/tool-execute-dynamic-resolver -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13989

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13989 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13989
   gh pr diff 13989 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13989.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13989.json`. Be concise but thorough in `summary` and `maintainerNotes`.
