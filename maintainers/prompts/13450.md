...
- **Number**: 13450
- **Title**: feat(workspaces): add @mastra/agentfs workspace filesystem provider
- **Author**: penberg
- **Created**: 2026-02-24T12:44:50Z
- **Updated**: 2026-03-05T11:42:10Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 2249, **Deletions**: 1, **Changed Files**: 29
- **Branch**: agentfs -> main
- **Labels**: Documentation
- **URL**: https://github.com/mastra-ai/mastra/pull/13450

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13450 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13450
   gh pr diff 13450 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13450.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13450.json`. Be concise but thorough in `summary` and `maintainerNotes`.
