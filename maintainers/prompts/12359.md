...
- **Number**: 12359
- **Title**: feat:metadata filtering support
- **Author**: intojhanurag
- **Created**: 2026-01-27T14:05:45Z
- **Updated**: 2026-03-03T12:40:19Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 287, **Deletions**: 2, **Changed Files**: 9
- **Branch**: feat/metadata-filtering-support -> main
- **Labels**: Documentation
- **URL**: https://github.com/mastra-ai/mastra/pull/12359

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 12359 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 12359
   gh pr diff 12359 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/12359.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/12359.json`. Be concise but thorough in `summary` and `maintainerNotes`.
