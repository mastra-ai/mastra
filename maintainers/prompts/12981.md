...
- **Created**: 2026-02-12T00:53:13Z
- **Updated**: 2026-03-03T12:37:38Z
- **Draft**: True
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 157, **Deletions**: 6, **Changed Files**: 3
- **Branch**: suhas/network-tracing-context-regression -> main
- **Labels**: none
...
1. Run these commands to gather full PR details:
   ```
   gh pr view 12981 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 12981
   gh pr diff 12981 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/12981.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/12981.json`. Be concise but thorough in `summary` and `maintainerNotes`.
