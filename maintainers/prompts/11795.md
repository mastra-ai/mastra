...
- **Number**: 11795
- **Title**: feat(storage): redis package
- **Author**: mauroerta
- **Created**: 2026-01-11T16:01:11Z
- **Updated**: 2026-03-03T12:41:14Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 5471, **Deletions**: 4, **Changed Files**: 33
- **Branch**: main -> main
- **Labels**: Documentation
- **URL**: https://github.com/mastra-ai/mastra/pull/11795

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 11795 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 11795
   gh pr diff 11795 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/11795.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/11795.json`. Be concise but thorough in `summary` and `maintainerNotes`.
