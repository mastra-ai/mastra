...
- **Number**: 13858
- **Title**: fix(deployer): use export * for workspace packages to fix missing transitive exports
- **Author**: gourine
- **Created**: 2026-03-05T15:23:21Z
- **Updated**: 2026-03-06T11:56:57Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 29, **Deletions**: 18, **Changed Files**: 2
- **Branch**: fix/deployer-workspace-export-star -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13858

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13858 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13858
   gh pr diff 13858 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13858.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13858.json`. Be concise but thorough in `summary` and `maintainerNotes`.
