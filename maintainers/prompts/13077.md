...
- **Number**: 13077
- **Title**: feat(observability): update JsonExporter to support all signals (T/M/…
- **Author**: epinzur
- **Created**: 2026-02-14T12:30:22Z
- **Updated**: 2026-02-26T05:22:40Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 3416, **Deletions**: 1215, **Changed Files**: 69
- **Branch**: claude/add-notion-folder-oVXPw -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13077

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13077 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13077
   gh pr diff 13077 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13077.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13077.json`. Be concise but thorough in `summary` and `maintainerNotes`.
