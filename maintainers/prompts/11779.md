...
- **Number**: 11779
- **Title**: fix/feat(deployer): add dynamicPackages bundler config for runtime-loaded packages and auto detect pino
- **Author**: graysonhicks
- **Created**: 2026-01-09T18:47:47Z
- **Updated**: 2026-03-10T15:37:24Z
- **Draft**: False
- **Review Decision**: APPROVED
- **Additions**: 927, **Deletions**: 15, **Changed Files**: 15
- **Branch**: fix/10893--odd-imports -> main
- **Labels**: Documentation
- **URL**: https://github.com/mastra-ai/mastra/pull/11779

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 11779 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 11779
   gh pr diff 11779 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/11779.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/11779.json`. Be concise but thorough in `summary` and `maintainerNotes`.
