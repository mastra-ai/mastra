...
- **Number**: 12573
- **Title**: fix(core): use toJSON for requestContext serialization in all workflow paths
- **Author**: owk-owk130
- **Created**: 2026-02-02T05:03:18Z
- **Updated**: 2026-03-10T12:05:52Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 157, **Deletions**: 22, **Changed Files**: 7
- **Branch**: fix/serialize-request-context-non-serializable -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/12573

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 12573 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 12573
   gh pr diff 12573 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/12573.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/12573.json`. Be concise but thorough in `summary` and `maintainerNotes`.
