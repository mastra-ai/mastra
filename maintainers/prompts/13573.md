...
- **Number**: 13573
- **Title**: feat: prompt for API keys in mastracode TUI
- **Author**: smthomas
- **Created**: 2026-02-27T07:27:36Z
- **Updated**: 2026-03-08T02:24:51Z
- **Draft**: False
- **Review Decision**: APPROVED
- **Additions**: 224, **Deletions**: 4, **Changed Files**: 11
- **Branch**: mastra-code-key-input -> main
- **Labels**: Documentation
- **URL**: https://github.com/mastra-ai/mastra/pull/13573

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13573 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13573
   gh pr diff 13573 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13573.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13573.json`. Be concise but thorough in `summary` and `maintainerNotes`.
