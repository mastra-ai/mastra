...
- **Number**: 14040
- **Title**: feat(core): add metadata filtering for message queries
- **Author**: DanielSLew
- **Created**: 2026-03-09T21:22:04Z
- **Updated**: 2026-03-09T21:59:59Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 1070, **Deletions**: 46, **Changed Files**: 32
- **Branch**: fix/issue-12260 -> main
- **Labels**: Documentation
- **URL**: https://github.com/mastra-ai/mastra/pull/14040

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 14040 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 14040
   gh pr diff 14040 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/14040.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/14040.json`. Be concise but thorough in `summary` and `maintainerNotes`.
