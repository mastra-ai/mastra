...
- **Number**: 13925
- **Title**: feat(template): add Slack coding agent template
- **Author**: DanielSLew
- **Created**: 2026-03-06T16:39:29Z
- **Updated**: 2026-03-06T16:49:01Z
- **Draft**: False
- **Review Decision**: APPROVED
- **Additions**: 3074, **Deletions**: 0, **Changed Files**: 23
- **Branch**: feat/mastracode/slack -> main
- **Labels**: none
...
1. Run these commands to gather full PR details:
   ```
   gh pr view 13925 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13925
   gh pr diff 13925 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13925.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13925.json`. Be concise but thorough in `summary` and `maintainerNotes`.
