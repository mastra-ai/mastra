...
- **Number**: 12920
- **Title**: chore(deps): update ai sdk
- **Author**: daneatmastra
- **Created**: 2026-02-11T00:48:39Z
- **Updated**: 2026-03-06T18:19:45Z
- **Draft**: False
- **Review Decision**: APPROVED
- **Additions**: 273, **Deletions**: 350, **Changed Files**: 21
- **Branch**: renovate/ai-sdk -> main
- **Labels**: automation
- **URL**: https://github.com/mastra-ai/mastra/pull/12920

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 12920 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 12920
   gh pr diff 12920 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/12920.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/12920.json`. Be concise but thorough in `summary` and `maintainerNotes`.
