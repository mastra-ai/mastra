...
- **Number**: 13755
- **Title**: fix: propagate OTEL context into step.execute() for correct span nesting
- **Author**: Sanrigas
- **Created**: 2026-03-04T07:13:27Z
- **Updated**: 2026-03-04T07:21:54Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 7, **Deletions**: 1, **Changed Files**: 2
- **Branch**: fix/workflow-step-otel-context-propagation -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13755

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13755 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13755
   gh pr diff 13755 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13755.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13755.json`. Be concise but thorough in `summary` and `maintainerNotes`.
