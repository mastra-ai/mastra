...
- **Number**: 13591
- **Title**: feat(core): support string PIDs in ProcessHandle [COR-741]
- **Author**: NikAiyer
- **Created**: 2026-02-27T17:49:15Z
- **Updated**: 2026-02-27T21:03:17Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 145, **Deletions**: 74, **Changed Files**: 14
- **Branch**: feat-process-handle-pid -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13591

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13591 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13591
   gh pr diff 13591 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13591.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13591.json`. Be concise but thorough in `summary` and `maintainerNotes`.
