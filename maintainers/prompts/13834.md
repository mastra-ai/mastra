...
- **Number**: 13834
- **Title**: feat(filesystem): add prefix scoping and STS session token support for S3/GCS mounts
- **Author**: okxiaoliang4
- **Created**: 2026-03-05T06:07:35Z
- **Updated**: 2026-03-05T06:14:59Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 198, **Deletions**: 13, **Changed Files**: 7
- **Branch**: feature/filesystem-sts -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13834

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13834 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13834
   gh pr diff 13834 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13834.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13834.json`. Be concise but thorough in `summary` and `maintainerNotes`.
