...
- **Number**: 11684
- **Title**: chore(deps): bump @modelcontextprotocol/sdk from 1.20.1 to 1.25.2
- **Author**: app/dependabot
- **Created**: 2026-01-07T16:50:28Z
- **Updated**: 2026-02-10T21:02:57Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 575, **Deletions**: 250, **Changed Files**: 5
- **Branch**: dependabot/npm_and_yarn/modelcontextprotocol/sdk-1.25.2 -> main
- **Labels**: dependencies, javascript
- **URL**: https://github.com/mastra-ai/mastra/pull/11684

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 11684 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 11684
   gh pr diff 11684 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/11684.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/11684.json`. Be concise but thorough in `summary` and `maintainerNotes`.
