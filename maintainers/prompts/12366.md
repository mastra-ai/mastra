...
- **Number**: 12366
- **Title**: feat: adds cloudflare durable objects based storage adapter
- **Author**: clearlysid
- **Created**: 2026-01-27T15:58:48Z
- **Updated**: 2026-02-06T20:09:25Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 3032, **Deletions**: 33, **Changed Files**: 23
- **Branch**: sid/cloudflare-do-storage -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/12366

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 12366 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 12366
   gh pr diff 12366 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/12366.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/12366.json`. Be concise but thorough in `summary` and `maintainerNotes`.
