...
- **Number**: 13941
- **Title**: fix(playground): split vendor deps into parallel-loadable chunks
- **Author**: rphansen91
- **Created**: 2026-03-06T20:43:21Z
- **Updated**: 2026-03-06T20:53:36Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 127, **Deletions**: 51, **Changed Files**: 4
- **Branch**: fix/vendor-chunk-splitting -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13941

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13941 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13941
   gh pr diff 13941 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13941.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13941.json`. Be concise but thorough in `summary` and `maintainerNotes`.
