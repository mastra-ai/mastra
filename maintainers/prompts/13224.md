...
- **Number**: 13224
- **Title**: [Feature] Adds data retention and cleanup capabilities for Tracing & Workflows
- **Author**: epinzur
- **Created**: 2026-02-18T21:34:10Z
- **Updated**: 2026-03-03T12:35:50Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 1378, **Deletions**: 1, **Changed Files**: 21
- **Branch**: claude/database-cleanup-traces-nZFse -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13224

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13224 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13224
   gh pr diff 13224 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13224.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13224.json`. Be concise but thorough in `summary` and `maintainerNotes`.
