...
- **Number**: 13908
- **Title**: chore(deps): update dependency @modelcontextprotocol/sdk to v1.25.2 [security]
- **Author**: daneatmastra
- **Created**: 2026-03-06T12:20:06Z
- **Updated**: 2026-03-10T00:33:44Z
- **Draft**: False
- **Review Decision**: APPROVED
- **Additions**: 464, **Deletions**: 393, **Changed Files**: 1
- **Branch**: renovate/npm-modelcontextprotocol-sdk-vulnerability -> main
- **Labels**: automation
- **URL**: https://github.com/mastra-ai/mastra/pull/13908

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13908 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13908
   gh pr diff 13908 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13908.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13908.json`. Be concise but thorough in `summary` and `maintainerNotes`.
