...
- **Number**: 10678
- **Title**: Make tool ip/op/suspend data validation async to allow for zod refine…
- **Author**: ak681443
- **Created**: 2025-12-01T01:09:33Z
- **Updated**: 2025-12-28T05:13:16Z
- **Draft**: False
- **Review Decision**: APPROVED
- **Additions**: 74, **Deletions**: 21, **Changed Files**: 7
- **Branch**: asugumar/fix-async-tool-validation -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/10678

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 10678 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 10678
   gh pr diff 10678 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/10678.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/10678.json`. Be concise but thorough in `summary` and `maintainerNotes`.
