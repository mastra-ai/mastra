...
- **Number**: 11959
- **Title**: fix(observability): llm span metadata inheritance
- **Author**: kosukeoya
- **Created**: 2026-01-15T07:08:22Z
- **Updated**: 2026-01-22T13:53:50Z
- **Draft**: False
- **Review Decision**: CHANGES_REQUESTED
- **Additions**: 138, **Deletions**: 3, **Changed Files**: 4
- **Branch**: feature/llm-span-metadata-inheritance -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/11959

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 11959 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 11959
   gh pr diff 11959 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/11959.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/11959.json`. Be concise but thorough in `summary` and `maintainerNotes`.
