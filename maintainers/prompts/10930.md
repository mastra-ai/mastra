...
- **Number**: 10930
- **Title**: add @mastra/dsql - Amazon Aurora DSQL storage provider
- **Author**: vvatanabe
- **Created**: 2025-12-05T07:52:53Z
- **Updated**: 2026-01-17T07:34:02Z
- **Draft**: False
- **Review Decision**: APPROVED
- **Additions**: 9538, **Deletions**: 174, **Changed Files**: 33
- **Branch**: dsql-storage-provider -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/10930

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 10930 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 10930
   gh pr diff 10930 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/10930.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/10930.json`. Be concise but thorough in `summary` and `maintainerNotes`.
