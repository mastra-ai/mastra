...
- **Number**: 12236
- **Title**: feat: add temperature array support for LLM-based scorers
- **Author**: smthomas
- **Created**: 2026-01-23T08:55:19Z
- **Updated**: 2026-01-29T04:05:07Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 1038, **Deletions**: 325, **Changed Files**: 22
- **Branch**: smthomas/scorer-temp-array -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/12236

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 12236 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 12236
   gh pr diff 12236 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/12236.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/12236.json`. Be concise but thorough in `summary` and `maintainerNotes`.
