...
- **Number**: 12174
- **Title**: chore(deps-dev): bump wrangler from 4.58.0 to 4.59.1
- **Author**: app/dependabot
- **Created**: 2026-01-21T23:26:31Z
- **Updated**: 2026-02-23T00:50:49Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 750, **Deletions**: 334, **Changed Files**: 2
- **Branch**: dependabot/npm_and_yarn/wrangler-4.59.1 -> main
- **Labels**: dependencies, javascript
- **URL**: https://github.com/mastra-ai/mastra/pull/12174

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 12174 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 12174
   gh pr diff 12174 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/12174.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/12174.json`. Be concise but thorough in `summary` and `maintainerNotes`.
