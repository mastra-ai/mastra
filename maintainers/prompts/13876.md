...
- **Number**: 13876
- **Title**: fix: add permission denied handling for dataset pages
- **Author**: YujohnNattrass
- **Created**: 2026-03-05T21:32:53Z
- **Updated**: 2026-03-10T16:23:51Z
- **Draft**: False
- **Review Decision**: APPROVED
- **Additions**: 165, **Deletions**: 9, **Changed Files**: 11
- **Branch**: yj/gate-datasets-behind-ee-auth -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13876

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13876 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13876
   gh pr diff 13876 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13876.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13876.json`. Be concise but thorough in `summary` and `maintainerNotes`.
