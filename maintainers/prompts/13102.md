...
- **Number**: 13102
- **Title**: fix: forward requestContext to tools in createToolCallStep
- **Author**: naaa760
- **Created**: 2026-02-16T13:30:21Z
- **Updated**: 2026-03-03T12:36:34Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 8, **Deletions**: 1, **Changed Files**: 3
- **Branch**: fix/req-cont-tool-call -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13102

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13102 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13102
   gh pr diff 13102 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13102.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13102.json`. Be concise but thorough in `summary` and `maintainerNotes`.
