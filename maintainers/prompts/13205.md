...
- **Number**: 13205
- **Title**: fix(core): preserve reasoning items across multi-step tool calls for Azure OpenAI
- **Author**: roaminro
- **Created**: 2026-02-18T16:39:26Z
- **Updated**: 2026-03-03T12:35:56Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 384, **Deletions**: 24, **Changed Files**: 6
- **Branch**: roamin/issue-12775 -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13205

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13205 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13205
   gh pr diff 13205 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13205.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13205.json`. Be concise but thorough in `summary` and `maintainerNotes`.
