...
- **Number**: 13945
- **Title**: fix(deployer,cli): enable gzip compression for studio static assets
- **Author**: rphansen91
- **Created**: 2026-03-06T21:45:45Z
- **Updated**: 2026-03-10T00:15:20Z
- **Draft**: False
- **Review Decision**: APPROVED
- **Additions**: 48, **Deletions**: 1, **Changed Files**: 3
- **Branch**: fix/enable-gzip-compression -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13945

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13945 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13945
   gh pr diff 13945 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13945.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13945.json`. Be concise but thorough in `summary` and `maintainerNotes`.
