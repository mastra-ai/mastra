...
- **Number**: 13513
- **Title**: feat(datasets): add requestContext and defaultRequestContext support backend support
- **Author**: YujohnNattrass
- **Created**: 2026-02-25T23:23:42Z
- **Updated**: 2026-02-25T23:32:30Z
- **Draft**: True
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 360, **Deletions**: 30, **Changed Files**: 17
- **Branch**: yj/dataset-backend -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13513

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13513 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13513
   gh pr diff 13513 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13513.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13513.json`. Be concise but thorough in `summary` and `maintainerNotes`.
