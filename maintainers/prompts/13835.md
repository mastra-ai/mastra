...
- **Number**: 13835
- **Title**: fix(core): forward threadId and resourceId to runScorers from executeOnFinish
- **Author**: intojhanurag
- **Created**: 2026-03-05T06:13:00Z
- **Updated**: 2026-03-07T13:53:24Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 57, **Deletions**: 1, **Changed Files**: 5
- **Branch**: fix/scorer-threadid-resourceid-forwarding -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13835

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13835 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13835
   gh pr diff 13835 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13835.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13835.json`. Be concise but thorough in `summary` and `maintainerNotes`.
