...
- **Number**: 13150
- **Title**:  feat(core): support dynamic filesystem resolution via requestContext in Workspace
- **Author**: intojhanurag
- **Created**: 2026-02-17T18:05:52Z
- **Updated**: 2026-03-07T16:49:31Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 629, **Deletions**: 21, **Changed Files**: 9
- **Branch**: feat/dynamic-filesystem-resolver -> main
- **Labels**: Documentation
- **URL**: https://github.com/mastra-ai/mastra/pull/13150

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13150 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13150
   gh pr diff 13150 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13150.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13150.json`. Be concise but thorough in `summary` and `maintainerNotes`.
