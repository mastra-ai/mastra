...
- **Number**: 6609
- **Title**: fix: Delete embeddings when deleting messages and threads
- **Author**: gpanakkal
- **Created**: 2025-08-06T01:03:34Z
- **Updated**: 2026-03-03T12:43:14Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 612, **Deletions**: 85, **Changed Files**: 9
- **Branch**: delete-message-embeddings -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/6609

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 6609 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 6609
   gh pr diff 6609 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/6609.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/6609.json`. Be concise but thorough in `summary` and `maintainerNotes`.
