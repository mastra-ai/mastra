...
- **Number**: 11149
- **Title**: feat(core): add support for passing custom `assistantMessageId`
- **Author**: RostiMelk
- **Created**: 2025-12-13T15:10:24Z
- **Updated**: 2025-12-19T16:14:24Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 75, **Deletions**: 2, **Changed Files**: 9
- **Branch**: feat/core/allow-for-custom-assistant-message-id -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/11149

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 11149 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 11149
   gh pr diff 11149 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/11149.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/11149.json`. Be concise but thorough in `summary` and `maintainerNotes`.
