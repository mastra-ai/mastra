...
- **Number**: 12602
- **Title**: chore(deps-dev): bump fastify from 5.6.2 to 5.7.3
- **Author**: app/dependabot
- **Created**: 2026-02-03T00:13:44Z
- **Updated**: 2026-03-05T19:51:24Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 357, **Deletions**: 239, **Changed Files**: 3
- **Branch**: dependabot/npm_and_yarn/fastify-5.7.3 -> main
- **Labels**: dependencies, javascript
- **URL**: https://github.com/mastra-ai/mastra/pull/12602

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 12602 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 12602
   gh pr diff 12602 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/12602.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/12602.json`. Be concise but thorough in `summary` and `maintainerNotes`.
