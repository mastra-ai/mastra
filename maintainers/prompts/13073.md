...
- **Number**: 13073
- **Title**: fix(deployer): watch workspace package source files during mastra dev
- **Author**: intojhanurag
- **Created**: 2026-02-14T06:38:34Z
- **Updated**: 2026-03-03T12:37:00Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 238, **Deletions**: 1, **Changed Files**: 3
- **Branch**: fix/mastra-dev-watch-workspace-packages -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13073

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13073 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13073
   gh pr diff 13073 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13073.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13073.json`. Be concise but thorough in `summary` and `maintainerNotes`.
