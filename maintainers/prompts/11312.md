...
- **Number**: 11312
- **Title**: fix(deployer): Fix bundling for packages without exports field (#11310)
- **Author**: app/dane-ai-mastra
- **Created**: 2025-12-20T00:23:46Z
- **Updated**: 2026-01-10T17:07:03Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 144, **Deletions**: 197, **Changed Files**: 4
- **Branch**: backport/fix-node-resolver-11310 -> 0.x
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/11312

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 11312 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 11312
   gh pr diff 11312 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/11312.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/11312.json`. Be concise but thorough in `summary` and `maintainerNotes`.
