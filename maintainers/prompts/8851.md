...
- **Number**: 8851
- **Title**: Strict workflow output types
- **Author**: rase-
- **Created**: 2025-10-15T06:40:26Z
- **Updated**: 2025-10-16T06:37:11Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 457, **Deletions**: 444, **Changed Files**: 9
- **Branch**: fix/strict-workflow-output-types -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/8851

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 8851 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 8851
   gh pr diff 8851 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/8851.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/8851.json`. Be concise but thorough in `summary` and `maintainerNotes`.
