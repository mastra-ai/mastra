...
- **Number**: 13894
- **Title**: fix(playground-ui): fix Enter key not reliably submitting messages in chat input
- **Author**: graysonhicks
- **Created**: 2026-03-06T02:29:52Z
- **Updated**: 2026-03-06T16:29:48Z
- **Draft**: True
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 17, **Deletions**: 0, **Changed Files**: 2
- **Branch**: fix/13878--enter -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13894

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13894 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13894
   gh pr diff 13894 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13894.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13894.json`. Be concise but thorough in `summary` and `maintainerNotes`.
