...
- **Number**: 10146
- **Title**: feat: add @mastra/aisearch - Azure AI Search vector store
- **Author**: valdepeace
- **Created**: 2025-11-16T19:37:01Z
- **Updated**: 2026-02-08T16:35:52Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 4390, **Deletions**: 0, **Changed Files**: 19
- **Branch**: main -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/10146

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 10146 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 10146
   gh pr diff 10146 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/10146.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/10146.json`. Be concise but thorough in `summary` and `maintainerNotes`.
