...
- **Number**: 13797
- **Title**: chore(deps): update dependency @uiw/codemirror-theme-github to ^4.25.7
- **Author**: daneatmastra
- **Created**: 2026-03-04T18:32:36Z
- **Updated**: 2026-03-10T12:24:03Z
- **Draft**: False
- **Review Decision**: APPROVED
- **Additions**: 22, **Deletions**: 17, **Changed Files**: 3
- **Branch**: renovate/uiw-codemirror-theme-github-4.x -> main
- **Labels**: automation
- **URL**: https://github.com/mastra-ai/mastra/pull/13797

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13797 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13797
   gh pr diff 13797 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13797.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13797.json`. Be concise but thorough in `summary` and `maintainerNotes`.
