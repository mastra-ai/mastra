...
- **Number**: 13654
- **Title**: feat(cli): add dev session duration, package manager, and component tracking
- **Author**: calcsam
- **Created**: 2026-03-02T02:28:57Z
- **Updated**: 2026-03-02T02:33:59Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 48, **Deletions**: 5, **Changed Files**: 3
- **Branch**: feat/cli-analytics-improvements -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13654

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13654 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13654
   gh pr diff 13654 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13654.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13654.json`. Be concise but thorough in `summary` and `maintainerNotes`.
