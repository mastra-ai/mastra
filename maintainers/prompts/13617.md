...
- **Number**: 13617
- **Title**: fix: handle absent optional fields in OpenAI processed schemas
- **Author**: intojhanurag
- **Created**: 2026-02-28T10:54:57Z
- **Updated**: 2026-03-03T12:34:55Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 202, **Deletions**: 5, **Changed Files**: 3
- **Branch**: fix/validate-absent-nullable-fields -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13617

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13617 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13617
   gh pr diff 13617 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13617.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13617.json`. Be concise but thorough in `summary` and `maintainerNotes`.
