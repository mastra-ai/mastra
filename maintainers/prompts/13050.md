...
- **Number**: 13050
- **Title**: feat(core): add video media type detection for prompt support
- **Author**: intojhanurag
- **Created**: 2026-02-13T17:56:53Z
- **Updated**: 2026-03-06T22:31:30Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 428, **Deletions**: 3, **Changed Files**: 6
- **Branch**: feat/video-prompt-support -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13050

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13050 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13050
   gh pr diff 13050 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13050.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13050.json`. Be concise but thorough in `summary` and `maintainerNotes`.
