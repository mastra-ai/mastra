...
- **Number**: 13673
- **Title**: fix(client-js): serialize Zod inputSchema for ClientTools with execute functions
- **Author**: TheIsrael1
- **Created**: 2026-03-02T14:03:30Z
- **Updated**: 2026-03-03T12:34:31Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 112, **Deletions**: 19, **Changed Files**: 3
- **Branch**: witness -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13673

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13673 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13673
   gh pr diff 13673 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13673.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13673.json`. Be concise but thorough in `summary` and `maintainerNotes`.
