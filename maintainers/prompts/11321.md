...
- **Title**: Upgrade glob
- **Author**: alliehowe29
- **Created**: 2025-12-21T05:28:10Z
- **Updated**: 2025-12-23T01:04:53Z
- **Draft**: False
- **Review Decision**: APPROVED
- **Additions**: 167, **Deletions**: 159, **Changed Files**: 2
- **Branch**: allie/upgrade-glob -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/11321

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 11321 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 11321
   gh pr diff 11321 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/11321.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/11321.json`. Be concise but thorough in `summary` and `maintainerNotes`.
