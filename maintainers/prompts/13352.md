...
- **Number**: 13352
- **Title**: feat(core,server,playground-ui): add agent version pinning for experiments
- **Author**: YujohnNattrass
- **Created**: 2026-02-20T23:01:23Z
- **Updated**: 2026-02-25T23:39:24Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 351, **Deletions**: 10, **Changed Files**: 12
- **Branch**: yj/experiment-version-pinning -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13352

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13352 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13352
   gh pr diff 13352 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13352.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13352.json`. Be concise but thorough in `summary` and `maintainerNotes`.
