...
- **Number**: 13942
- **Title**: fix(playground-ui): split barrel export into domain sub-path entries
- **Author**: rphansen91
- **Created**: 2026-03-06T21:24:43Z
- **Updated**: 2026-03-09T23:28:34Z
- **Draft**: False
- **Review Decision**: APPROVED
- **Additions**: 333, **Deletions**: 204, **Changed Files**: 75
- **Branch**: fix/barrel-split -> fix/route-level-code-splitting
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13942

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13942 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13942
   gh pr diff 13942 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13942.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13942.json`. Be concise but thorough in `summary` and `maintainerNotes`.
