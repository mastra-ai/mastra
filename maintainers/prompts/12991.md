...
- **Number**: 12991
- **Title**: feat(pg, rag): add full-text and hybrid search support to RAG vector query tool
- **Author**: intojhanurag
- **Created**: 2026-02-12T07:32:43Z
- **Updated**: 2026-03-07T17:07:14Z
- **Draft**: False
- **Review Decision**: CHANGES_REQUESTED
- **Additions**: 1116, **Deletions**: 71, **Changed Files**: 10
- **Branch**: feat/fulltext-hybrid-search-rag -> main
- **Labels**: Documentation
- **URL**: https://github.com/mastra-ai/mastra/pull/12991

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 12991 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 12991
   gh pr diff 12991 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/12991.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/12991.json`. Be concise but thorough in `summary` and `maintainerNotes`.
