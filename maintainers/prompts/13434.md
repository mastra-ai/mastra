...
- **Number**: 13434
- **Title**: chore(deps): update assistant ui
- **Author**: daneatmastra
- **Created**: 2026-02-24T00:37:32Z
- **Updated**: 2026-02-24T06:30:14Z
- **Draft**: False
- **Review Decision**: APPROVED
- **Additions**: 214, **Deletions**: 303, **Changed Files**: 4
- **Branch**: renovate/assistant-ui -> main
- **Labels**: automation
- **URL**: https://github.com/mastra-ai/mastra/pull/13434

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13434 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13434
   gh pr diff 13434 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13434.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13434.json`. Be concise but thorough in `summary` and `maintainerNotes`.
