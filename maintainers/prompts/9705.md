...
- **Number**: 9705
- **Title**: fix: remove deprecated content and toolInvocations from MastraMessageContentV2
- **Author**: DanielSLew
- **Created**: 2025-11-04T21:05:31Z
- **Updated**: 2025-11-18T16:32:30Z
- **Draft**: False
- **Review Decision**: CHANGES_REQUESTED
- **Additions**: 1961, **Deletions**: 1529, **Changed Files**: 59
- **Branch**: break/remove-deprecated-MastraDBMessage-content -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/9705

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 9705 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 9705
   gh pr diff 9705 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/9705.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/9705.json`. Be concise but thorough in `summary` and `maintainerNotes`.
