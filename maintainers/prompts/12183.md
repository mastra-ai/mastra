...
- **Number**: 12183
- **Title**: [feat] Add new filters to traces list
- **Author**: greglobinski
- **Created**: 2026-01-22T08:50:36Z
- **Updated**: 2026-02-05T15:26:15Z
- **Draft**: True
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 464, **Deletions**: 198, **Changed Files**: 21
- **Branch**: traces-filters -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/12183

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 12183 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 12183
   gh pr diff 12183 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/12183.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/12183.json`. Be concise but thorough in `summary` and `maintainerNotes`.
