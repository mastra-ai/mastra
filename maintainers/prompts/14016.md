...
- **Number**: 14016
- **Title**: fix(core): add AI gateway tool support
- **Author**: TheIsrael1
- **Created**: 2026-03-09T14:50:35Z
- **Updated**: 2026-03-10T15:41:27Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 537, **Deletions**: 81, **Changed Files**: 11
- **Branch**: pr-13192-review -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/14016

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 14016 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 14016
   gh pr diff 14016 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/14016.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/14016.json`. Be concise but thorough in `summary` and `maintainerNotes`.
