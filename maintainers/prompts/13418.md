...
- **Number**: 13418
- **Title**: fix(core): strip OpenAI reasoning parts from LLM input to prevent item pairing errors
- **Author**: graysonhicks
- **Created**: 2026-02-23T20:18:52Z
- **Updated**: 2026-03-10T15:06:04Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 222, **Deletions**: 0, **Changed Files**: 3
- **Branch**: fix/12980--reasoning-parts -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13418

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13418 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13418
   gh pr diff 13418 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13418.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13418.json`. Be concise but thorough in `summary` and `maintainerNotes`.
