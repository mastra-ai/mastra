...
- **Number**: 12684
- **Title**: chore(deps): bump @modelcontextprotocol/sdk from 1.20.1 to 1.26.0
- **Author**: app/dependabot
- **Created**: 2026-02-04T20:33:27Z
- **Updated**: 2026-03-09T15:07:57Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 665, **Deletions**: 157, **Changed Files**: 5
- **Branch**: dependabot/npm_and_yarn/modelcontextprotocol/sdk-1.26.0 -> main
- **Labels**: dependencies, javascript
- **URL**: https://github.com/mastra-ai/mastra/pull/12684

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 12684 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 12684
   gh pr diff 12684 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/12684.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/12684.json`. Be concise but thorough in `summary` and `maintainerNotes`.
