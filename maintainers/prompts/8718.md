...
- **Number**: 8718
- **Title**: resolve WritableStream locked error in agent streaming (#8302)
- **Author**: willydouhard
- **Created**: 2025-10-10T13:44:28Z
- **Updated**: 2026-03-03T12:42:43Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 28, **Deletions**: 8, **Changed Files**: 1
- **Branch**: twill/mastra-ENG-5 -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/8718

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 8718 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 8718
   gh pr diff 8718 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/8718.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/8718.json`. Be concise but thorough in `summary` and `maintainerNotes`.
