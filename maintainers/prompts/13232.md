...
- **Number**: 13232
- **Title**: feat(sonic): add support for nova sonic
- **Author**: krokoko
- **Created**: 2026-02-18T23:51:24Z
- **Updated**: 2026-03-06T22:04:06Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 8791, **Deletions**: 423, **Changed Files**: 44
- **Branch**: feature/aws-nova-sonic -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13232

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13232 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13232
   gh pr diff 13232 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13232.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13232.json`. Be concise but thorough in `summary` and `maintainerNotes`.
