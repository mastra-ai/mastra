...
- **Number**: 13976
- **Title**: feat(mastracode): add codebase_search tool via Morph WarpGrep API
- **Author**: DhruvBhatia0
- **Created**: 2026-03-08T02:18:46Z
- **Updated**: 2026-03-08T02:19:11Z
- **Draft**: True
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 422, **Deletions**: 3, **Changed Files**: 7
- **Branch**: feat/mastracode-codebase-search -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13976

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13976 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13976
   gh pr diff 13976 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13976.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13976.json`. Be concise but thorough in `summary` and `maintainerNotes`.
