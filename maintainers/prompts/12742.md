...
- **Number**: 12742
- **Title**: fix(cli): wait for server process to exit before restarting
- **Author**: gartz
- **Created**: 2026-02-05T21:42:27Z
- **Updated**: 2026-02-05T21:51:13Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 16, **Deletions**: 0, **Changed Files**: 1
- **Branch**: fix/wait-for-server-exit-on-restart -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/12742

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 12742 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 12742
   gh pr diff 12742 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/12742.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/12742.json`. Be concise but thorough in `summary` and `maintainerNotes`.
