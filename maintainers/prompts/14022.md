...
- **Number**: 14022
- **Title**: fix: optimize semantic recall latency across all storage adapters
- **Author**: NikAiyer
- **Created**: 2026-03-09T17:41:08Z
- **Updated**: 2026-03-10T15:54:15Z
- **Draft**: False
- **Review Decision**: APPROVED
- **Additions**: 1190, **Deletions**: 599, **Changed Files**: 17
- **Branch**: fix-semantic-recall-latency -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/14022

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 14022 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 14022
   gh pr diff 14022 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/14022.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/14022.json`. Be concise but thorough in `summary` and `maintainerNotes`.
