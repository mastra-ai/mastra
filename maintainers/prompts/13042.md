...
- **Number**: 13042
- **Title**: Add Elysia server adapter
- **Author**: joel611
- **Created**: 2026-02-13T11:40:30Z
- **Updated**: 2026-03-03T12:37:17Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 1728, **Deletions**: 23, **Changed Files**: 15
- **Branch**: feat/server-adapter-elysia -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13042

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13042 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13042
   gh pr diff 13042 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13042.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13042.json`. Be concise but thorough in `summary` and `maintainerNotes`.
