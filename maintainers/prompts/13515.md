...
- **Number**: 13515
- **Title**: chore(deps): bump rollup from 4.55.1 to 4.59.0 in /observability/_examples/otel-bridge/agent-hub
- **Author**: app/dependabot
- **Created**: 2026-02-25T23:47:32Z
- **Updated**: 2026-03-06T11:07:34Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 13, **Deletions**: 0, **Changed Files**: 1
- **Branch**: dependabot/npm_and_yarn/observability/_examples/otel-bridge/agent-hub/rollup-4.59.0 -> main
- **Labels**: dependencies, javascript
- **URL**: https://github.com/mastra-ai/mastra/pull/13515

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13515 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13515
   gh pr diff 13515 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13515.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13515.json`. Be concise but thorough in `summary` and `maintainerNotes`.
