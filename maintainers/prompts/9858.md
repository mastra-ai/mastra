...
- **Number**: 9858
- **Title**: feat: allow configuring API root path
- **Author**: naaa760
- **Created**: 2025-11-07T06:52:00Z
- **Updated**: 2025-12-05T10:49:40Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 63, **Deletions**: 29, **Changed Files**: 4
- **Branch**: feat/config-api-path -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/9858

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 9858 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 9858
   gh pr diff 9858 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/9858.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/9858.json`. Be concise but thorough in `summary` and `maintainerNotes`.
