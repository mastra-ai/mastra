...
- **Number**: 13213
- **Title**: feat(core): pass through experimental_toToolResultContent for multi-m…
- **Author**: williamwang0
- **Created**: 2026-02-18T19:18:26Z
- **Updated**: 2026-03-05T00:41:32Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 42, **Deletions**: 0, **Changed Files**: 3
- **Branch**: feat/experimental-to-tool-result-content -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13213

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13213 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13213
   gh pr diff 13213 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13213.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13213.json`. Be concise but thorough in `summary` and `maintainerNotes`.
