...
- **Number**: 13954
- **Title**: feat(server): add mapUserToResourceId callback to auth config for automatic resource ID scoping
- **Author**: intojhanurag
- **Created**: 2026-03-07T07:37:47Z
- **Updated**: 2026-03-07T09:29:38Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 402, **Deletions**: 22, **Changed Files**: 11
- **Branch**: feat/auth-map-user-to-resource-id -> main
- **Labels**: Documentation
- **URL**: https://github.com/mastra-ai/mastra/pull/13954

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13954 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13954
   gh pr diff 13954 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13954.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13954.json`. Be concise but thorough in `summary` and `maintainerNotes`.
