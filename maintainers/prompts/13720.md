...
- **Number**: 13720
- **Title**: Fix LangSmith exporter flush to drain pending trace batches
- **Author**: epinzur
- **Created**: 2026-03-03T15:21:44Z
- **Updated**: 2026-03-03T15:27:50Z
- **Draft**: False
- **Review Decision**: APPROVED
- **Additions**: 17, **Deletions**: 0, **Changed Files**: 2
- **Branch**: claude/cherry-pick-langfuse-changes-3EaZt -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13720

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13720 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13720
   gh pr diff 13720 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13720.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13720.json`. Be concise but thorough in `summary` and `maintainerNotes`.
