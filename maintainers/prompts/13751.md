...
- **Number**: 13751
- **Title**: feat(mastracode): allow custom config directory via configDir option
- **Author**: tulga-bytes
- **Created**: 2026-03-04T03:35:16Z
- **Updated**: 2026-03-05T10:39:46Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 160, **Deletions**: 92, **Changed Files**: 14
- **Branch**: feat/mastracode-custom-config-dir -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13751

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13751 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13751
   gh pr diff 13751 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13751.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13751.json`. Be concise but thorough in `summary` and `maintainerNotes`.
