...
- **Number**: 13920
- **Title**: fix(server): serialize plain JSON Schema tool schemas
- **Author**: TheIsrael1
- **Created**: 2026-03-06T15:58:12Z
- **Updated**: 2026-03-10T14:06:08Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 81, **Deletions**: 45, **Changed Files**: 6
- **Branch**: fix/13909-json-schema-tool-serialization -> main
- **Labels**: Documentation
- **URL**: https://github.com/mastra-ai/mastra/pull/13920

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13920 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13920
   gh pr diff 13920 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13920.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13920.json`. Be concise but thorough in `summary` and `maintainerNotes`.
