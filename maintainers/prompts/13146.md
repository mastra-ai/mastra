...
- **Number**: 13146
- **Title**: fix(agent): preserve thread metadata when MASTRA_THREAD_ID_KEY is set
- **Author**: kosukeoya
- **Created**: 2026-02-17T16:36:15Z
- **Updated**: 2026-02-24T15:21:15Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 100, **Deletions**: 16, **Changed Files**: 5
- **Branch**: fix/preserve-thread-metadata-with-context-key -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13146

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13146 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13146
   gh pr diff 13146 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13146.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13146.json`. Be concise but thorough in `summary` and `maintainerNotes`.
