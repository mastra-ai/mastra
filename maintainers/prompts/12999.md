...
- **Number**: 12999
- **Title**: chore(deps): update ai sdk (major)
- **Author**: daneatmastra
- **Created**: 2026-02-12T12:30:47Z
- **Updated**: 2026-02-12T18:29:47Z
- **Draft**: False
- **Review Decision**: APPROVED
- **Additions**: 372, **Deletions**: 402, **Changed Files**: 25
- **Branch**: renovate/major-ai-sdk -> main
- **Labels**: automation
- **URL**: https://github.com/mastra-ai/mastra/pull/12999

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 12999 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 12999
   gh pr diff 12999 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/12999.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/12999.json`. Be concise but thorough in `summary` and `maintainerNotes`.
