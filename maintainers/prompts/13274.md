...
- **Number**: 13274
- **Title**: feat: mcp tool tracing
- **Author**: intojhanurag
- **Created**: 2026-02-19T13:18:46Z
- **Updated**: 2026-03-10T13:23:00Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 320, **Deletions**: 16, **Changed Files**: 9
- **Branch**: feat/mcp-tool-tracing -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13274

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13274 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13274
   gh pr diff 13274 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13274.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13274.json`. Be concise but thorough in `summary` and `maintainerNotes`.
