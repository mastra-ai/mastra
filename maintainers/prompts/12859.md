...
- **Number**: 12859
- **Title**: feature: add more metadata in agent message
- **Author**: intojhanurag
- **Created**: 2026-02-10T06:22:30Z
- **Updated**: 2026-03-07T13:28:19Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 357, **Deletions**: 8, **Changed Files**: 3
- **Branch**: feat/add-more-metadata -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/12859

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 12859 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 12859
   gh pr diff 12859 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/12859.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/12859.json`. Be concise but thorough in `summary` and `maintainerNotes`.
