...
- **Number**: 12557
- **Title**: feat(core,inngest): durable agent architecture with resumable streams
- **Author**: rase-
- **Created**: 2026-01-31T18:02:06Z
- **Updated**: 2026-02-26T09:22:58Z
- **Draft**: False
- **Review Decision**: APPROVED
- **Additions**: 34005, **Deletions**: 287, **Changed Files**: 169
- **Branch**: durable-agent-poc -> main
- **Labels**: Documentation
- **URL**: https://github.com/mastra-ai/mastra/pull/12557

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 12557 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 12557
   gh pr diff 12557 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/12557.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/12557.json`. Be concise but thorough in `summary` and `maintainerNotes`.
