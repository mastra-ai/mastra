...
- **Number**: 12403
- **Title**: Feat/studio cli auth headers
- **Author**: Rish-it
- **Created**: 2026-01-28T06:46:32Z
- **Updated**: 2026-03-03T12:40:02Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 228, **Deletions**: 7, **Changed Files**: 8
- **Branch**: feat/studio-cli-auth-headers -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/12403

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 12403 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 12403
   gh pr diff 12403 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/12403.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/12403.json`. Be concise but thorough in `summary` and `maintainerNotes`.
