...
- **Number**: 13116
- **Title**: fix(braintrust): use resolved model ID for accurate cost estimation
- **Author**: tomaswitek
- **Created**: 2026-02-16T18:46:39Z
- **Updated**: 2026-02-16T18:50:10Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 13, **Deletions**: 1, **Changed Files**: 1
- **Branch**: fix/braintrust-model-name-cost-estimation -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13116

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13116 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13116
   gh pr diff 13116 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13116.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13116.json`. Be concise but thorough in `summary` and `maintainerNotes`.
