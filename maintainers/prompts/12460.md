...
- **Number**: 12460
- **Title**: Feature/memory enabled flag
- **Author**: Rish-it
- **Created**: 2026-01-29T10:42:23Z
- **Updated**: 2026-03-03T12:39:47Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 474, **Deletions**: 25, **Changed Files**: 7
- **Branch**: feature/memory-enabled-flag -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/12460

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 12460 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 12460
   gh pr diff 12460 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/12460.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/12460.json`. Be concise but thorough in `summary` and `maintainerNotes`.
