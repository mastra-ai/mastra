...
- **Number**: 12438
- **Title**: chore(deps): bump next from 15.5.9 to 16.1.5 in /examples/ai-elements
- **Author**: app/dependabot
- **Created**: 2026-01-28T19:22:58Z
- **Updated**: 2026-03-02T14:08:14Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 1, **Deletions**: 1, **Changed Files**: 1
- **Branch**: dependabot/npm_and_yarn/examples/ai-elements/next-16.1.5 -> main
- **Labels**: dependencies, javascript
- **URL**: https://github.com/mastra-ai/mastra/pull/12438

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 12438 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 12438
   gh pr diff 12438 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/12438.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/12438.json`. Be concise but thorough in `summary` and `maintainerNotes`.
