...
- **Number**: 12692
- **Title**: fix(workflows): surface agent tool calls in streams
- **Author**: skylarkoo7
- **Created**: 2026-02-04T22:03:16Z
- **Updated**: 2026-02-04T22:10:41Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 42, **Deletions**: 4, **Changed Files**: 5
- **Branch**: fix-12660-workflow-tool-calls -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/12692

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 12692 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 12692
   gh pr diff 12692 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/12692.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/12692.json`. Be concise but thorough in `summary` and `maintainerNotes`.
