...
- **Number**: 12802
- **Title**: feat: support using client param in constructor elasticsearchvector
- **Author**: Shaik-Sirajuddin
- **Created**: 2026-02-07T06:18:26Z
- **Updated**: 2026-03-03T12:38:44Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 51, **Deletions**: 1, **Changed Files**: 2
- **Branch**: elastic_search_constructor -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/12802

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 12802 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 12802
   gh pr diff 12802 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/12802.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/12802.json`. Be concise but thorough in `summary` and `maintainerNotes`.
