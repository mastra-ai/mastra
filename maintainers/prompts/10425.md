...
- **Number**: 10425
- **Title**:    feat(tools): add dynamic tool description support
- **Author**: ashikshafi08
- **Created**: 2025-11-24T00:55:47Z
- **Updated**: 2026-03-03T12:42:12Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 520, **Deletions**: 36, **Changed Files**: 13
- **Branch**: feat/runtime-context-tool-description -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/10425

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 10425 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 10425
   gh pr diff 10425 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/10425.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/10425.json`. Be concise but thorough in `summary` and `maintainerNotes`.
