...
- **Number**: 11378
- **Title**: fix(core): emit tool-error chunk in fullStream when tool throws
- **Author**: DanielSLew
- **Created**: 2025-12-23T16:46:52Z
- **Updated**: 2026-03-03T16:33:35Z
- **Draft**: False
- **Review Decision**: APPROVED
- **Additions**: 215, **Deletions**: 111, **Changed Files**: 9
- **Branch**: fix/core/tool-error-chunk -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/11378

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 11378 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 11378
   gh pr diff 11378 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/11378.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/11378.json`. Be concise but thorough in `summary` and `maintainerNotes`.
