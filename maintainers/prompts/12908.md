...
- **Number**: 12908
- **Title**: chore(deps): bump langsmith from 0.3.81 to 0.4.6
- **Author**: app/dependabot
- **Created**: 2026-02-10T23:03:51Z
- **Updated**: 2026-03-10T12:21:18Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 61, **Deletions**: 87, **Changed Files**: 2
- **Branch**: dependabot/npm_and_yarn/langsmith-0.4.6 -> main
- **Labels**: dependencies, javascript
- **URL**: https://github.com/mastra-ai/mastra/pull/12908

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 12908 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 12908
   gh pr diff 12908 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/12908.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/12908.json`. Be concise but thorough in `summary` and `maintainerNotes`.
