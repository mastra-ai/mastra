...
- **Number**: 13867
- **Title**: feat: show accurate tiktoken output count in shell tool footers
- **Author**: CalebBarnes
- **Created**: 2026-03-05T19:37:03Z
- **Updated**: 2026-03-05T19:54:26Z
- **Draft**: True
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 281, **Deletions**: 131, **Changed Files**: 19
- **Branch**: feat/accurate-output-token-count -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13867

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13867 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13867
   gh pr diff 13867 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13867.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13867.json`. Be concise but thorough in `summary` and `maintainerNotes`.
