...
- **Number**: 13895
- **Title**: fix(core): remap provider tool types when routing to V3 models via gateway
- **Author**: roaminro
- **Created**: 2026-03-06T03:14:38Z
- **Updated**: 2026-03-09T18:59:00Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 285, **Deletions**: 2, **Changed Files**: 3
- **Branch**: low-street -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13895

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13895 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13895
   gh pr diff 13895 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13895.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13895.json`. Be concise but thorough in `summary` and `maintainerNotes`.
