...
- **Number**: 13934
- **Title**: fix(playground-ui): lazy-load prettier to reduce main bundle size
- **Author**: rphansen91
- **Created**: 2026-03-06T18:34:17Z
- **Updated**: 2026-03-10T14:07:29Z
- **Draft**: False
- **Review Decision**: APPROVED
- **Additions**: 26, **Deletions**: 3, **Changed Files**: 2
- **Branch**: fix/lazy-load-prettier -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13934

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13934 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13934
   gh pr diff 13934 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13934.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13934.json`. Be concise but thorough in `summary` and `maintainerNotes`.
