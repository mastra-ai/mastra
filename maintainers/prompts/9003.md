...
- **Number**: 9003
- **Title**: fix: pass writable stream through workflow resume path
- **Author**: gorpacrate
- **Created**: 2025-10-19T08:39:55Z
- **Updated**: 2025-10-20T02:16:14Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 7, **Deletions**: 0, **Changed Files**: 2
- **Branch**: fix/workflows-resume-streaming -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/9003

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 9003 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 9003
   gh pr diff 9003 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/9003.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/9003.json`. Be concise but thorough in `summary` and `maintainerNotes`.
