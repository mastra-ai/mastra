...
- **Number**: 14090
- **Title**: fix(qdrant): convert `ids` to integers inside the `upsert` method
- **Author**: danielynx
- **Created**: 2026-03-10T15:52:45Z
- **Updated**: 2026-03-10T16:17:31Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 43, **Deletions**: 2, **Changed Files**: 3
- **Branch**: bug/qdrant-upsert-with-numeric-ids -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/14090

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 14090 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 14090
   gh pr diff 14090 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/14090.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/14090.json`. Be concise but thorough in `summary` and `maintainerNotes`.
