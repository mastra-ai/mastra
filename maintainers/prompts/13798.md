...
- **Number**: 13798
- **Title**: fix: suppress tool result JSON leak in text-delta stream during multi-step execution
- **Author**: NikAiyer
- **Created**: 2026-03-04T18:33:00Z
- **Updated**: 2026-03-10T15:04:27Z
- **Draft**: True
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 1097, **Deletions**: 1, **Changed Files**: 5
- **Branch**: fix-tool-result-leak -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13798

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13798 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13798
   gh pr diff 13798 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13798.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13798.json`. Be concise but thorough in `summary` and `maintainerNotes`.
