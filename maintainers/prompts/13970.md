...
- **Number**: 13970
- **Title**: fix(core): move llm-based output processors off stream chunks
- **Author**: Wert1go
- **Created**: 2026-03-07T23:10:16Z
- **Updated**: 2026-03-09T08:40:49Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 108, **Deletions**: 385, **Changed Files**: 8
- **Branch**: fix/13644-output-processors -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13970

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13970 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13970
   gh pr diff 13970 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13970.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13970.json`. Be concise but thorough in `summary` and `maintainerNotes`.
