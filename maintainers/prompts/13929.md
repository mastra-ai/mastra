...
- **Number**: 13929
- **Title**: fix: prevent exponential token growth in multi-step agent workflows
- **Author**: NikAiyer
- **Created**: 2026-03-06T17:22:59Z
- **Updated**: 2026-03-10T16:12:25Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 514, **Deletions**: 419, **Changed Files**: 6
- **Branch**: fix-exponential-token-growth -> main
- **Labels**: Documentation
- **URL**: https://github.com/mastra-ai/mastra/pull/13929

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13929 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13929
   gh pr diff 13929 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13929.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13929.json`. Be concise but thorough in `summary` and `maintainerNotes`.
