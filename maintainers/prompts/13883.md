...
- **Created**: 2026-03-05T23:06:40Z
- **Updated**: 2026-03-10T15:48:39Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 1182, **Deletions**: 50, **Changed Files**: 97
- **Branch**: changeset-release/main -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13883

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13883 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13883
   gh pr diff 13883 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13883.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13883.json`. Be concise but thorough in `summary` and `maintainerNotes`.
