...
- **Number**: 12625
- **Title**: fix(voice-google-gemini-live): add new models and mark deprecated
- **Author**: t-aburasoba
- **Created**: 2026-02-03T13:38:28Z
- **Updated**: 2026-02-03T14:26:43Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 29, **Deletions**: 0, **Changed Files**: 2
- **Branch**: fix/add-gemini-live-ga-model -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/12625

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 12625 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 12625
   gh pr diff 12625 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/12625.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/12625.json`. Be concise but thorough in `summary` and `maintainerNotes`.
