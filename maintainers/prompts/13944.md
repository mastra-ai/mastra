...
- **Author**: rphansen91
- **Created**: 2026-03-06T21:29:38Z
- **Updated**: 2026-03-10T13:56:05Z
- **Draft**: False
- **Review Decision**: APPROVED
- **Additions**: 25, **Deletions**: 0, **Changed Files**: 2
- **Branch**: fix/vendor-chunks-clean -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13944

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13944 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13944
   gh pr diff 13944 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13944.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13944.json`. Be concise but thorough in `summary` and `maintainerNotes`.
