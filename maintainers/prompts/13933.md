...
- **Number**: 13933
- **Title**: chore(deps): update build tools
- **Author**: daneatmastra
- **Created**: 2026-03-06T18:20:48Z
- **Updated**: 2026-03-10T12:20:03Z
- **Draft**: False
- **Review Decision**: APPROVED
- **Additions**: 1336, **Deletions**: 1712, **Changed Files**: 104
- **Branch**: renovate/build-tools -> main
- **Labels**: automation
- **URL**: https://github.com/mastra-ai/mastra/pull/13933

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13933 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13933
   gh pr diff 13933 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13933.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13933.json`. Be concise but thorough in `summary` and `maintainerNotes`.
