...
- **Number**: 12706
- **Title**: feat(voice): add Camb AI TTS integration
- **Author**: neilruaro-camb
- **Created**: 2026-02-05T10:32:04Z
- **Updated**: 2026-02-09T05:44:58Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 558, **Deletions**: 0, **Changed Files**: 11
- **Branch**: add-camb-voice -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/12706

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 12706 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 12706
   gh pr diff 12706 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/12706.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/12706.json`. Be concise but thorough in `summary` and `maintainerNotes`.
