...
- **Number**: 13904
- **Title**: fix(deployer): patch fetch-to-node ReadableStream controller crash on client disconnect
- **Author**: intojhanurag
- **Created**: 2026-03-06T10:07:06Z
- **Updated**: 2026-03-06T10:51:13Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 48, **Deletions**: 3, **Changed Files**: 3
- **Branch**: fix/patch-fetch-to-node-stream-controller-crash -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13904

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13904 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13904
   gh pr diff 13904 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13904.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13904.json`. Be concise but thorough in `summary` and `maintainerNotes`.
