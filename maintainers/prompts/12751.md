...
- **Number**: 12751
- **Title**: feat(server): add NestJS server adapter
- **Author**: saguirre
- **Created**: 2026-02-06T03:38:00Z
- **Updated**: 2026-03-03T12:39:09Z
- **Draft**: False
- **Review Decision**: CHANGES_REQUESTED
- **Additions**: 6194, **Deletions**: 3, **Changed Files**: 63
- **Branch**: feat/nestjs-server-adapter -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/12751

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 12751 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 12751
   gh pr diff 12751 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/12751.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/12751.json`. Be concise but thorough in `summary` and `maintainerNotes`.
