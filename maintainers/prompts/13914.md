...
- **Number**: 13914
- **Title**: fix: Anthropic cache tokens missing from Langfuse traces in streaming mode
- **Author**: nancysangani
- **Created**: 2026-03-06T13:52:38Z
- **Updated**: 2026-03-06T14:13:11Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 2, **Deletions**: 1, **Changed Files**: 2
- **Branch**: fix/anthropic-cache-metrics-streaming -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13914

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13914 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13914
   gh pr diff 13914 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13914.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13914.json`. Be concise but thorough in `summary` and `maintainerNotes`.
