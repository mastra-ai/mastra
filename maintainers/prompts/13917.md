...
- **Number**: 13917
- **Title**: fix(harness): use type 'image' and mimeType for image parts in convertToHarnessMessage
- **Author**: nancysangani
- **Created**: 2026-03-06T14:41:03Z
- **Updated**: 2026-03-06T17:20:18Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 7, **Deletions**: 2, **Changed Files**: 2
- **Branch**: fix/harness-image-part-type-v2 -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13917

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13917 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13917
   gh pr diff 13917 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13917.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13917.json`. Be concise but thorough in `summary` and `maintainerNotes`.
