...
- **Number**: 11272
- **Title**: chore(deps-dev): bump storybook from 9.1.13 to 9.1.17
- **Author**: app/dependabot
- **Created**: 2025-12-18T19:00:59Z
- **Updated**: 2026-02-26T18:42:53Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 1226, **Deletions**: 548, **Changed Files**: 3
- **Branch**: dependabot/npm_and_yarn/storybook-9.1.17 -> main
- **Labels**: dependencies, javascript
- **URL**: https://github.com/mastra-ai/mastra/pull/11272

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 11272 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 11272
   gh pr diff 11272 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/11272.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/11272.json`. Be concise but thorough in `summary` and `maintainerNotes`.
