...
- **Author**: daneatmastra
- **Created**: 2026-01-05T12:31:18Z
- **Updated**: 2026-03-10T14:50:22Z
- **Draft**: False
- **Review Decision**: APPROVED
- **Additions**: 64, **Deletions**: 64, **Changed Files**: 6
- **Branch**: renovate/react -> main
- **Labels**: automation
- **URL**: https://github.com/mastra-ai/mastra/pull/11590

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 11590 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 11590
   gh pr diff 11590 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/11590.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/11590.json`. Be concise but thorough in `summary` and `maintainerNotes`.
