...
- **Number**: 13804
- **Title**: refactor: remove virtual-root path convention from LocalFilesystem
- **Author**: CalebBarnes
- **Created**: 2026-03-04T19:08:35Z
- **Updated**: 2026-03-09T21:12:15Z
- **Draft**: True
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 780, **Deletions**: 678, **Changed Files**: 30
- **Branch**: refactor/no-virtual-root -> main
- **Labels**: Documentation
- **URL**: https://github.com/mastra-ai/mastra/pull/13804

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13804 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13804
   gh pr diff 13804 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13804.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13804.json`. Be concise but thorough in `summary` and `maintainerNotes`.
