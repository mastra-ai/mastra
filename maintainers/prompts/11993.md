...
- **Number**: 11993
- **Title**: Fix/11913  usechat message history by thread and resolve network messages
- **Author**: graysonhicks
- **Created**: 2026-01-15T21:40:59Z
- **Updated**: 2026-03-09T15:30:20Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 498, **Deletions**: 1, **Changed Files**: 4
- **Branch**: fix/11913--usechat-message-history-by-thread-id -> main
- **Labels**: Documentation
- **URL**: https://github.com/mastra-ai/mastra/pull/11993

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 11993 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 11993
   gh pr diff 11993 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/11993.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/11993.json`. Be concise but thorough in `summary` and `maintainerNotes`.
