...
- **Number**: 13638
- **Title**: feat(stores): add MySQL storage adapter
- **Author**: luzhuang
- **Created**: 2026-03-01T14:29:26Z
- **Updated**: 2026-03-03T14:49:52Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 9136, **Deletions**: 1, **Changed Files**: 33
- **Branch**: feat/mysql-store -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13638

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13638 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13638
   gh pr diff 13638 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13638.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13638.json`. Be concise but thorough in `summary` and `maintainerNotes`.
