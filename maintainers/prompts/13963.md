...
- **Number**: 13963
- **Title**: fix(server): support Zod v4 in query parameter type detection
- **Author**: intojhanurag
- **Created**: 2026-03-07T18:05:49Z
- **Updated**: 2026-03-09T17:13:47Z
- **Draft**: False
- **Review Decision**: APPROVED
- **Additions**: 12, **Deletions**: 32, **Changed Files**: 2
- **Branch**: fix/zod4-query-param-type-detection -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13963

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13963 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13963
   gh pr diff 13963 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13963.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13963.json`. Be concise but thorough in `summary` and `maintainerNotes`.
