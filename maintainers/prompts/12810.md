...
- **Number**: 12810
- **Title**: feat(playground): propagate resourceId through component tree
- **Author**: oritwoen
- **Created**: 2026-02-07T20:49:53Z
- **Updated**: 2026-02-09T12:44:49Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 433, **Deletions**: 43, **Changed Files**: 14
- **Branch**: feat/resourceid-selection -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/12810

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 12810 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 12810
   gh pr diff 12810 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/12810.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/12810.json`. Be concise but thorough in `summary` and `maintainerNotes`.
