...
- **Number**: 10547
- **Title**: fix(langfuse): Support cross-process span linking for distributed workflows
- **Author**: suhasdeshpande
- **Created**: 2025-11-26T18:35:44Z
- **Updated**: 2025-11-28T19:39:40Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 41, **Deletions**: 5, **Changed Files**: 1
- **Branch**: patch-2 -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/10547

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 10547 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 10547
   gh pr diff 10547 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/10547.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/10547.json`. Be concise but thorough in `summary` and `maintainerNotes`.
