...
- **Number**: 11561
- **Title**: fix(core): respect sub-agent defaultOptions.memory when called as tool
- **Author**: dev-vishnu
- **Created**: 2026-01-04T18:01:56Z
- **Updated**: 2026-01-24T11:59:08Z
- **Draft**: False
- **Review Decision**: APPROVED
- **Additions**: 121, **Deletions**: 2, **Changed Files**: 3
- **Branch**: fix/sub-agent-memory-override -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/11561

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 11561 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 11561
   gh pr diff 11561 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/11561.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/11561.json`. Be concise but thorough in `summary` and `maintainerNotes`.
