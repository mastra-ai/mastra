...
- **Number**: 11544
- **Title**: fix(core): use findParent for input step processor span parenting
- **Author**: suhasdeshpande
- **Created**: 2026-01-02T18:52:51Z
- **Updated**: 2026-01-03T19:07:23Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 200, **Deletions**: 2, **Changed Files**: 2
- **Branch**: fix/langfuse-trace -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/11544

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 11544 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 11544
   gh pr diff 11544 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/11544.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/11544.json`. Be concise but thorough in `summary` and `maintainerNotes`.
