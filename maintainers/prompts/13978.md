...
- **Number**: 13978
- **Title**: fix(core): widen TrailingAssistantGuard to block all trailing assistant messages for Claude 4.6
- **Author**: intojhanurag
- **Created**: 2026-03-08T06:44:37Z
- **Updated**: 2026-03-08T07:04:33Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 204, **Deletions**: 10, **Changed Files**: 3
- **Branch**: fix/trailing-assistant-guard-all-messages -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13978

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13978 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13978
   gh pr diff 13978 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13978.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13978.json`. Be concise but thorough in `summary` and `maintainerNotes`.
