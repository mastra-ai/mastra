...
- **Number**: 13368
- **Title**: chore(deps-dev): bump ajv from 8.17.1 to 8.18.0
- **Author**: app/dependabot
- **Created**: 2026-02-21T03:45:40Z
- **Updated**: 2026-02-24T18:11:46Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 644, **Deletions**: 229, **Changed Files**: 2
- **Branch**: dependabot/npm_and_yarn/ajv-8.18.0 -> main
- **Labels**: dependencies, javascript
- **URL**: https://github.com/mastra-ai/mastra/pull/13368

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13368 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13368
   gh pr diff 13368 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13368.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13368.json`. Be concise but thorough in `summary` and `maintainerNotes`.
