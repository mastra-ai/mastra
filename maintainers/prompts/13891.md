...
- **Number**: 13891
- **Title**: feat(mastracode): allow overriding memory instance via config
- **Author**: tulga-bytes
- **Created**: 2026-03-06T00:50:06Z
- **Updated**: 2026-03-06T00:54:44Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 11, **Deletions**: 1, **Changed Files**: 1
- **Branch**: feat/mastracode-custom-memory-override -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13891

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13891 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13891
   gh pr diff 13891 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13891.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13891.json`. Be concise but thorough in `summary` and `maintainerNotes`.
