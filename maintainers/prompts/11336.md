...
- **Number**: 11336
- **Title**: fix(client-js): fix listMemoryThreads orderBy serialization and type
- **Author**: hanjeahwan
- **Created**: 2025-12-22T11:43:53Z
- **Updated**: 2025-12-22T12:42:36Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 34, **Deletions**: 4, **Changed Files**: 3
- **Branch**: fix/listMemoryThreads-orderBy-serialization -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/11336

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 11336 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 11336
   gh pr diff 11336 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/11336.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/11336.json`. Be concise but thorough in `summary` and `maintainerNotes`.
