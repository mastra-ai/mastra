...
- **Number**: 13446
- **Title**: feat(playground-ui): add Preprocessors CMS page for agent create/edit
- **Author**: mfrachet
- **Created**: 2026-02-24T08:58:22Z
- **Updated**: 2026-02-24T12:21:11Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 847, **Deletions**: 3, **Changed Files**: 19
- **Branch**: processors -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13446

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13446 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13446
   gh pr diff 13446 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13446.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13446.json`. Be concise but thorough in `summary` and `maintainerNotes`.
