...
- **Number**: 8141
- **Title**: fix: correct workflow chunk unwrapping and writer stream locking in network execution
- **Author**: AVVS
- **Created**: 2025-09-24T01:07:18Z
- **Updated**: 2025-09-25T20:12:47Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 283, **Deletions**: 23, **Changed Files**: 7
- **Branch**: fix/custom-parallel-network-workflow -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/8141

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 8141 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 8141
   gh pr diff 8141 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/8141.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/8141.json`. Be concise but thorough in `summary` and `maintainerNotes`.
