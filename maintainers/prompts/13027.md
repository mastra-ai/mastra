...
- **Number**: 13027
- **Title**: fix(core): prevent workflow hangs and memory leaks in evented workflows
- **Author**: roaminro
- **Created**: 2026-02-12T23:47:22Z
- **Updated**: 2026-02-20T18:49:08Z
- **Draft**: True
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 616, **Deletions**: 71, **Changed Files**: 3
- **Branch**: roamin/workflow-timeout-issue -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13027

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13027 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13027
   gh pr diff 13027 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13027.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13027.json`. Be concise but thorough in `summary` and `maintainerNotes`.
