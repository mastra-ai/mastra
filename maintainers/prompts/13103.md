...
- **Number**: 13103
- **Title**:  feat(deployer-netlify): add Netlify Edge Functions support
- **Author**: intojhanurag
- **Created**: 2026-02-16T13:55:13Z
- **Updated**: 2026-03-03T12:36:29Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 185, **Deletions**: 31, **Changed Files**: 4
- **Branch**: feat/netlify-edge-functions-support -> main
- **Labels**: Documentation
- **URL**: https://github.com/mastra-ai/mastra/pull/13103

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13103 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13103
   gh pr diff 13103 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13103.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13103.json`. Be concise but thorough in `summary` and `maintainerNotes`.
