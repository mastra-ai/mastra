...
- **Number**: 13903
- **Title**: fix: correlate provider-executed tool results back to tool calls
- **Author**: jnMetaCode
- **Created**: 2026-03-06T09:54:11Z
- **Updated**: 2026-03-07T21:05:36Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 20, **Deletions**: 0, **Changed Files**: 2
- **Branch**: fix/provider-tool-results-correlation -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13903

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13903 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13903
   gh pr diff 13903 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13903.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13903.json`. Be concise but thorough in `summary` and `maintainerNotes`.
