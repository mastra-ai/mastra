...
- **Number**: 10351
- **Title**: Fix: normalize undefined input for all optional object schemas in validation (#10031)
- **Author**: owaismohammed79
- **Created**: 2025-11-20T12:16:57Z
- **Updated**: 2025-11-21T09:33:18Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 42, **Deletions**: 0, **Changed Files**: 3
- **Branch**: bugfix/normalize-undefined-input -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/10351

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 10351 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 10351
   gh pr diff 10351 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/10351.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/10351.json`. Be concise but thorough in `summary` and `maintainerNotes`.
