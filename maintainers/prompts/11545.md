...
- **Number**: 11545
- **Title**: fix(server): remove explicit Transfer-Encoding header to fix streamin…
- **Author**: roaminro
- **Created**: 2026-01-02T19:26:24Z
- **Updated**: 2026-03-04T16:45:00Z
- **Draft**: False
- **Review Decision**: APPROVED
- **Additions**: 262, **Deletions**: 12, **Changed Files**: 7
- **Branch**: roamin/remove-transfer-encoding-header -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/11545

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 11545 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 11545
   gh pr diff 11545 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/11545.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/11545.json`. Be concise but thorough in `summary` and `maintainerNotes`.
