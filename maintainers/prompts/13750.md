...
- **Number**: 13750
- **Title**: feat(mastracode): allow passing MCP server configs to createMastraCode
- **Author**: tulga-bytes
- **Created**: 2026-03-04T03:14:55Z
- **Updated**: 2026-03-05T15:06:54Z
- **Draft**: False
- **Review Decision**: APPROVED
- **Additions**: 100, **Deletions**: 4, **Changed Files**: 4
- **Branch**: feat/mastracode-mcp-servers-config -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13750

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13750 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13750
   gh pr diff 13750 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13750.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13750.json`. Be concise but thorough in `summary` and `maintainerNotes`.
