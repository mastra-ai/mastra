...
- **Number**: 13967
- **Title**: fix(network): forward memory context in validation stream calls
- **Author**: Wert1go
- **Created**: 2026-03-07T22:53:57Z
- **Updated**: 2026-03-08T09:32:31Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 137, **Deletions**: 0, **Changed Files**: 3
- **Branch**: fix/network-validation-memory-context -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13967

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13967 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13967
   gh pr diff 13967 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13967.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13967.json`. Be concise but thorough in `summary` and `maintainerNotes`.
