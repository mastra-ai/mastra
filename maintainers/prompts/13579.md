...
- **Number**: 13579
- **Title**: fix(core): restore stdout pipe inheritance for Windows LocalSandbox
- **Author**: wumingaizhou
- **Created**: 2026-02-27T09:59:58Z
- **Updated**: 2026-03-10T15:35:44Z
- **Draft**: False
- **Review Decision**: APPROVED
- **Additions**: 53, **Deletions**: 5, **Changed Files**: 2
- **Branch**: fix/windows-sandbox-stdout-pipe-inheritance -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13579

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13579 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13579
   gh pr diff 13579 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13579.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13579.json`. Be concise but thorough in `summary` and `maintainerNotes`.
