...
- **Number**: 10798
- **Title**: fix: preserve system messages when prepareStep returns messages
- **Author**: zshannon
- **Created**: 2025-12-03T06:14:52Z
- **Updated**: 2025-12-05T02:40:11Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 174, **Deletions**: 3, **Changed Files**: 3
- **Branch**: fix/preserve-system-message-in-prepare-step -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/10798

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 10798 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 10798
   gh pr diff 10798 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/10798.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/10798.json`. Be concise but thorough in `summary` and `maintainerNotes`.
