...
- **Number**: 13580
- **Title**: fix(schema-compat): add ZodIntersection support for MCP tools using allOf
- **Author**: ChrisCindy
- **Created**: 2026-02-27T10:29:48Z
- **Updated**: 2026-03-02T09:52:58Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 543, **Deletions**: 11, **Changed Files**: 18
- **Branch**: fix/schema-compat-zod-intersection -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13580

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13580 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13580
   gh pr diff 13580 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13580.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13580.json`. Be concise but thorough in `summary` and `maintainerNotes`.
