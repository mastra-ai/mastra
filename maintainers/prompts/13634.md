...
- **Number**: 13634
- **Title**: feat(core): show first user message as thread title in chat history
- **Author**: gourine
- **Created**: 2026-03-01T09:56:51Z
- **Updated**: 2026-03-06T10:21:40Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 31, **Deletions**: 1, **Changed Files**: 4
- **Branch**: feat/thread-title-from-first-message -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13634

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13634 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13634
   gh pr diff 13634 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13634.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13634.json`. Be concise but thorough in `summary` and `maintainerNotes`.
