...
- **Number**: 12517
- **Title**: fix(workflows): propagate logger to executionEngine
- **Author**: rares04
- **Created**: 2026-01-30T11:14:49Z
- **Updated**: 2026-01-30T16:37:07Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 131, **Deletions**: 0, **Changed Files**: 3
- **Branch**: fix/workflow-logger-propagation -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/12517

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 12517 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 12517
   gh pr diff 12517 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/12517.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/12517.json`. Be concise but thorough in `summary` and `maintainerNotes`.
