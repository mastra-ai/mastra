...
- **Number**: 13881
- **Title**: fix(core): prevent supervisor messages from leaking into sub-agent thread
- **Author**: gourine
- **Created**: 2026-03-05T22:46:30Z
- **Updated**: 2026-03-08T11:26:05Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 10, **Deletions**: 4, **Changed Files**: 2
- **Branch**: fix/sub-agent-history-duplicates -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13881

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13881 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13881
   gh pr diff 13881 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13881.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13881.json`. Be concise but thorough in `summary` and `maintainerNotes`.
