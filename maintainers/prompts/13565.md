...
- **Number**: 13565
- **Title**: chore(deps-dev): bump koa from 3.1.1 to 3.1.2
- **Author**: app/dependabot
- **Created**: 2026-02-27T00:27:59Z
- **Updated**: 2026-03-03T23:08:36Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 665, **Deletions**: 230, **Changed Files**: 3
- **Branch**: dependabot/npm_and_yarn/koa-3.1.2 -> main
- **Labels**: dependencies, javascript
- **URL**: https://github.com/mastra-ai/mastra/pull/13565

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13565 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13565
   gh pr diff 13565 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13565.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13565.json`. Be concise but thorough in `summary` and `maintainerNotes`.
