...
- **Number**: 13977
- **Title**: fix(mcp): add SIGHUP handler to clean up stdio child processes on terminal disconnect
- **Author**: intojhanurag
- **Created**: 2026-03-08T05:18:40Z
- **Updated**: 2026-03-09T08:39:34Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 80, **Deletions**: 0, **Changed Files**: 3
- **Branch**: fix/mcp-sighup-child-process-leak -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13977

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13977 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13977
   gh pr diff 13977 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13977.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13977.json`. Be concise but thorough in `summary` and `maintainerNotes`.
