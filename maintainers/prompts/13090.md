...
- **Number**: 13090
- **Title**: feat(pi): add Observational Memory integration for Pi agent framework
- **Author**: abhiaiyer91
- **Created**: 2026-02-16T05:55:44Z
- **Updated**: 2026-02-22T02:16:15Z
- **Draft**: False
- **Review Decision**: APPROVED
- **Additions**: 7975, **Deletions**: 1214, **Changed Files**: 47
- **Branch**: pi-agent -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13090

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13090 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13090
   gh pr diff 13090 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13090.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13090.json`. Be concise but thorough in `summary` and `maintainerNotes`.
