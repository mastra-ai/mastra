...
- **Number**: 14038
- **Title**: fix(core): capture tripwire aborts in OpenTelemetry spans
- **Author**: DanielSLew
- **Created**: 2026-03-09T21:03:01Z
- **Updated**: 2026-03-10T12:28:25Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 369, **Deletions**: 185, **Changed Files**: 6
- **Branch**: fix/issue-12163 -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/14038

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 14038 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 14038
   gh pr diff 14038 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/14038.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/14038.json`. Be concise but thorough in `summary` and `maintainerNotes`.
