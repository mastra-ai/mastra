...
- **Number**: 13087
- **Title**: Add User-Agent header for Anthropic API calls
- **Author**: mikelambert
- **Created**: 2026-02-16T00:27:46Z
- **Updated**: 2026-03-10T15:32:23Z
- **Draft**: False
- **Review Decision**: APPROVED
- **Additions**: 81, **Deletions**: 37, **Changed Files**: 8
- **Branch**: mike/user-agent -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13087

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13087 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13087
   gh pr diff 13087 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13087.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13087.json`. Be concise but thorough in `summary` and `maintainerNotes`.
