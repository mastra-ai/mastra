...
- **Number**: 13081
- **Title**:  feat(e2e): add client-js e2e tests for agents, memory, workflows, tools, and vectors
- **Author**: intojhanurag
- **Created**: 2026-02-14T18:48:14Z
- **Updated**: 2026-03-06T22:33:17Z
- **Draft**: False
- **Review Decision**: CHANGES_REQUESTED
- **Additions**: 705, **Deletions**: 9, **Changed Files**: 19
- **Branch**: feat/client-js-e2e-tests-11342 -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13081

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13081 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13081
   gh pr diff 13081 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13081.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13081.json`. Be concise but thorough in `summary` and `maintainerNotes`.
