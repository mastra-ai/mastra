...
- **Number**: 13529
- **Title**: Add logs and metrics support to OtelExporter
- **Author**: epinzur
- **Created**: 2026-02-26T11:39:48Z
- **Updated**: 2026-02-26T12:06:05Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 2149, **Deletions**: 230, **Changed Files**: 13
- **Branch**: claude/add-notion-folder-X7c8S -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13529

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13529 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13529
   gh pr diff 13529 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13529.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13529.json`. Be concise but thorough in `summary` and `maintainerNotes`.
