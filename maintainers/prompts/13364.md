...
- **Number**: 13364
- **Title**: feat(processors): add onDetection callback to PromptInjectionDetector and PIIDetector
- **Author**: netbrah
- **Created**: 2026-02-21T02:03:01Z
- **Updated**: 2026-03-03T12:35:31Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 388, **Deletions**: 6, **Changed Files**: 8
- **Branch**: copilot/add-ondetection-callback -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13364

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13364 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13364
   gh pr diff 13364 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13364.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13364.json`. Be concise but thorough in `summary` and `maintainerNotes`.
