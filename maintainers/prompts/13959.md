...
- **Number**: 13959
- **Title**: fix(mcp): forward stderr and cwd options in connectStdio()
- **Author**: iulspop
- **Created**: 2026-03-07T14:12:03Z
- **Updated**: 2026-03-10T14:12:39Z
- **Draft**: False
- **Review Decision**: APPROVED
- **Additions**: 269, **Deletions**: 0, **Changed Files**: 6
- **Branch**: fix/mcp-stdio-stderr-cwd -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13959

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13959 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13959
   gh pr diff 13959 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13959.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13959.json`. Be concise but thorough in `summary` and `maintainerNotes`.
