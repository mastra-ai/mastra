...
- **Number**: 13805
- **Title**: fix(core): pass agent workspace into converted workspace tools
- **Author**: maxrochefortshugar
- **Created**: 2026-03-04T19:23:16Z
- **Updated**: 2026-03-04T19:46:06Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 42, **Deletions**: 0, **Changed Files**: 3
- **Branch**: fix/workspace-tools-missing-workspace -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13805

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13805 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13805
   gh pr diff 13805 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13805.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13805.json`. Be concise but thorough in `summary` and `maintainerNotes`.
