...
- **Number**: 13408
- **Title**: feat(editor): workflow-builder
- **Author**: DanielSLew
- **Created**: 2026-02-23T15:39:32Z
- **Updated**: 2026-02-23T15:40:43Z
- **Draft**: True
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 1839, **Deletions**: 247, **Changed Files**: 11
- **Branch**: feat/editor/workflow-builder -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13408

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13408 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13408
   gh pr diff 13408 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13408.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13408.json`. Be concise but thorough in `summary` and `maintainerNotes`.
