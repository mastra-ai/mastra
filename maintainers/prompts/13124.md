...
- **Number**: 13124
- **Title**: fix(deployer): bump esbuild from ^0.25.10 to ^0.27.3
- **Author**: croffasia
- **Created**: 2026-02-17T02:06:45Z
- **Updated**: 2026-02-17T02:09:41Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 6, **Deletions**: 1, **Changed Files**: 2
- **Branch**: fix/bump-esbuild -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13124

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13124 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13124
   gh pr diff 13124 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13124.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13124.json`. Be concise but thorough in `summary` and `maintainerNotes`.
