...
- **Number**: 12685
- **Title**: chore(deps): bump @modelcontextprotocol/sdk from 1.25.2 to 1.26.0 in /scripts/gh-issue-triage
- **Author**: app/dependabot
- **Created**: 2026-02-04T20:38:35Z
- **Updated**: 2026-03-09T15:07:59Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 27, **Deletions**: 14, **Changed Files**: 1
- **Branch**: dependabot/npm_and_yarn/scripts/gh-issue-triage/modelcontextprotocol/sdk-1.26.0 -> main
- **Labels**: dependencies, javascript
- **URL**: https://github.com/mastra-ai/mastra/pull/12685

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 12685 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 12685
   gh pr diff 12685 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/12685.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/12685.json`. Be concise but thorough in `summary` and `maintainerNotes`.
