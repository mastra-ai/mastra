...
- **Number**: 6447
- **Title**: Add runtime context features to Inngest workflows
- **Author**: aldebout
- **Created**: 2025-07-31T14:34:09Z
- **Updated**: 2026-03-03T12:43:24Z
- **Draft**: False
- **Review Decision**: APPROVED
- **Additions**: 315, **Deletions**: 15, **Changed Files**: 3
- **Branch**: feature/inngest-runtime-context -> main
- **Labels**: trio-tnt
- **URL**: https://github.com/mastra-ai/mastra/pull/6447

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 6447 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 6447
   gh pr diff 6447 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/6447.json` with this exact structure:
