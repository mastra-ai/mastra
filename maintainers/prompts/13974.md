...
- **Number**: 13974
- **Title**: fix(memory): ignore binary payload size in observational token counts
- **Author**: Wert1go
- **Created**: 2026-03-07T23:26:56Z
- **Updated**: 2026-03-09T08:40:42Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 155, **Deletions**: 0, **Changed Files**: 3
- **Branch**: fix/13301-om-image-token-count -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13974

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13974 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13974
   gh pr diff 13974 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13974.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13974.json`. Be concise but thorough in `summary` and `maintainerNotes`.
