...
- **Number**: 13313
- **Title**: refactor: extract shared BaseElasticFilterTranslator for Elasticsearch and OpenSearch stores
- **Author**: intojhanurag
- **Created**: 2026-02-20T10:19:03Z
- **Updated**: 2026-03-06T22:35:42Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 347, **Deletions**: 758, **Changed Files**: 6
- **Branch**: refactor/extract-shared-elastic-filter-translator -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/13313

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 13313 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 13313
   gh pr diff 13313 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/13313.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/13313.json`. Be concise but thorough in `summary` and `maintainerNotes`.
