...
- **Number**: 14092
- **Title**: docs(storage): fix composite storage domain documentation
- **Author**: brennanmceachran
- **Created**: 2026-03-10T16:25:28Z
- **Updated**: 2026-03-10T16:27:04Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 120, **Deletions**: 8, **Changed Files**: 4
- **Branch**: codex/storage-domain-docs -> main
- **Labels**: Documentation
- **URL**: https://github.com/mastra-ai/mastra/pull/14092

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 14092 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 14092
   gh pr diff 14092 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/14092.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/14092.json`. Be concise but thorough in `summary` and `maintainerNotes`.
