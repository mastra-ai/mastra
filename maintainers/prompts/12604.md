...
- **Number**: 12604
- **Title**: chore(deps): bump fastify from 5.6.0 to 5.7.3 in /observability/_examples/otel-bridge/agent-hub
- **Author**: app/dependabot
- **Created**: 2026-02-03T00:20:24Z
- **Updated**: 2026-03-09T23:34:58Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 58, **Deletions**: 15, **Changed Files**: 2
- **Branch**: dependabot/npm_and_yarn/observability/_examples/otel-bridge/agent-hub/fastify-5.7.3 -> main
- **Labels**: dependencies, javascript
- **URL**: https://github.com/mastra-ai/mastra/pull/12604

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 12604 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 12604
   gh pr diff 12604 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/12604.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/12604.json`. Be concise but thorough in `summary` and `maintainerNotes`.
