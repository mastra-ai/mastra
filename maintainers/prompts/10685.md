...
- **Number**: 10685
- **Title**: Update for Couchbase 8.0 release
- **Author**: VirajAgarwal-couchbase
- **Created**: 2025-12-01T05:25:55Z
- **Updated**: 2025-12-08T06:02:21Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 6888, **Deletions**: 246, **Changed Files**: 29
- **Branch**: new-vector-indexes-introduction -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/10685

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 10685 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 10685
   gh pr diff 10685 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/10685.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/10685.json`. Be concise but thorough in `summary` and `maintainerNotes`.
