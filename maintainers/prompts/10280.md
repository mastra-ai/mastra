...
- **Number**: 10280
- **Title**: fix(pg): prevent duplicate database object warning
- **Author**: blind05
- **Created**: 2025-11-19T19:16:29Z
- **Updated**: 2026-03-03T12:42:23Z
- **Draft**: False
- **Review Decision**: REVIEW_REQUIRED
- **Additions**: 172, **Deletions**: 3, **Changed Files**: 3
- **Branch**: blind05/7534-duplicate-db-object-suspend-resume -> main
- **Labels**: none
- **URL**: https://github.com/mastra-ai/mastra/pull/10280

## Steps

1. Run these commands to gather full PR details:
   ```
   gh pr view 10280 --json body,comments,reviews,commits,statusCheckRollup,mergeable,reviewRequests
   gh pr checks 10280
   gh pr diff 10280 | head -500
   ```
...
5. Write the JSON file to `maintainers/prs/10280.json` with this exact structure:
...
**IMPORTANT**: The file MUST be valid JSON. Write it to `maintainers/prs/10280.json`. Be concise but thorough in `summary` and `maintainerNotes`.
