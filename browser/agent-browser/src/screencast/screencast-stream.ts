...
export class ScreencastStream extends (EventEmitter as new () => TypedEmitter<ScreencastEvents>) {
  ...
  private browserManager: BrowserManagerLike;
   ...
   */
  constructor(browserManager: BrowserManagerLike, options?: ScreencastOptions) {
    super();
  ...
  private async startInternal(): Promise<void> {
    await this.browserManager.startScreencast((frame: ScreencastFrame) => {
      ...
      // Note: BrowserManagerLike handles screencastFrameAck internally
    }, this.options);
  }
