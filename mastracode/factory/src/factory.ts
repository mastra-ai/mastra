 ...
 * defaults constructed here are Platform GitHub, GitLab, incident.io, Jira,
 * and Linear integrations when Platform credentials exist and the caller did
 * not provide those integrations.
 *
...
export interface MastraFactoryConfig {
   ...
   * implementations. A missing `jira` integration also defaults to Platform
   * Jira, which discovers visible `jira` connections at runtime.
   */
