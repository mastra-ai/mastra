...
/** Resolve the configured PAT and the identity it belongs to. Unlike
 * `getGithubPat`, storage errors are propagated so callers reconciling a live
 * sandbox can distinguish an outage from an intentionally cleared PAT. */
