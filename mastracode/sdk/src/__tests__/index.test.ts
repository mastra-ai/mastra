...
describe('createMastraCode', () => {
  ...
  it('passes an injected vector to dynamic memory', async () => {
    ...
    // Third arg is the optional Knowledge instance (only present when
    // MASTRACODE_EXPERIMENTAL_SUBCONSCIOUS=1); fourth arg is the settings
    // path threaded through for pack-driven observational-memory resolution;
    // no `settingsPath` was configured here.
