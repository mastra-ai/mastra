...
2. If the plan leaves anything for the user to decide (open questions, assumptions, "TBD"s), use \`ask_user\` to resolve them now and fold the answers into the file with \`string_replace_lsp\` — don't submit a plan with unanswered questions
