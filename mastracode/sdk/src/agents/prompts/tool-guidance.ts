...
- Always set \`description\` to a 5-10 word summary of what the command does; the user sees it instead of the raw command. Write each one as the next step in a running narrative that can lean on earlier commands (e.g. "Searching open PRs for failing CI", then "Drilling into the first of 15 failures").
