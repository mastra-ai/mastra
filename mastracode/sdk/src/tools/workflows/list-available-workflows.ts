...
export function createListAvailableWorkflowsTool(accessPolicy?: DynamicWorkflowAccessPolicy) {
  ...
  return createTool({
    ...
    execute: async (_input, { mastra, requestContext }) => {
      ...
      const all = await service.listAccessibleRegisteredWorkflows(mastra as Mastra, { requestContext });
      return {
...
export const listAvailableWorkflowsTool = createListAvailableWorkflowsTool();
