  ...
  return (
    <>
      <div className="flex flex-col gap-2 py-3 border-b border-border1/40">
        ...
        <ModelPicker models={models} loading={loading} currentModelId={currentModelId} onModelChange={onModelChange} />
      </div>
...
function ModelPicker({
  ...
  if (loading) {
    return (
      <Txt as="div" variant="ui-sm" className="text-icon3" role="status">
        Loading models…
      </Txt>
    );
  }
  ...
  return (
    <div className="relative" ref={rootRef}>
      ...
      {open && (
        <div className="absolute z-50 mt-1 w-full rounded-lg border border-border1/60 bg-surface3 shadow-dialog">
