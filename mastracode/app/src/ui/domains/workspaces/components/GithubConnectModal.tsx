...
import { FolderIcon, LogoMark, SearchIcon } from '../../../ui/icons';
...
export function GithubConnectModal({ status, onProjectCreated, onClose }: GithubConnectModalProps) {
  ...
  return (
    <Dialog open onOpenChange={open => !open && onClose()}>
      <DialogContent className="flex max-h-[min(720px,calc(100vh-2rem))] w-full max-w-xl flex-col p-5">
        <DialogHeader className="mb-4 p-0 pr-10">
          <DialogTitle className="flex items-center gap-2 text-ui-lg font-semibold text-icon6">
