...
import type { OnboardingInlineComponent } from '../onboarding/onboarding-inline';
...
import type { AskQuestionInlineComponent } from './components/ask-question-inline';
import type { AssistantMessageComponent } from './components/assistant-message';
import { CustomEditor } from './components/custom-editor';
import type { IdleCounterComponent } from './components/idle-counter';
import type { JudgeDisplayComponent } from './components/judge-display';
import type { GradientAnimator } from './components/obi-loader';
import type { OMMarkerComponent, OMMarkerData } from './components/om-marker';
import type { OMProgressComponent } from './components/om-progress';
import type { PlanApprovalInlineComponent } from './components/plan-approval-inline';
import type { ShellStreamComponent } from './components/shell-output';
import type { SlashCommandComponent } from './components/slash-command';
import type { SubagentExecutionComponent } from './components/subagent-execution';
import type { SystemReminderComponent } from './components/system-reminder';
import type { TaskProgressComponent } from './components/task-progress';
import type { TemporalGapComponent } from './components/temporal-gap';
import type { IToolExecutionComponent } from './components/tool-execution-interface';
import type { UserMessageComponent } from './components/user-message';

import { GoalManager } from './goal-manager';
import { getEditorTheme, mastra, TERM_WIDTH_BUFFER } from './theme';
