 ...
 *
 * The service layer (mastracode/src/workflows/service.ts) is the single
 * implementation; agent tools and this slash handler both call it.
 */
import { randomUUID } from 'node:crypto';
import { RequestContext } from '@mastra/core/request-context';
import { deleteWorkflow, getWorkflow, listWorkflows, runWorkflow } from '../../workflows/service.js';
import type { StoredWorkflowRow, WorkflowRunEvent } from '../../workflows/service.js';
