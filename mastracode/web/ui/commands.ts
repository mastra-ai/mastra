...
export const SLASH_COMMANDS: SlashCommand[] = [
  { name: 'mode', args: '<id>', description: 'Switch mode (e.g. plan, build)' },
  { name: 'model', args: '<id>', description: 'Switch model' },
  { name: 'new', args: '[title]', description: 'Create a new thread' },
  { name: 'rename', args: '<title>', description: 'Rename the current thread' },
  { name: 'delete', args: '<id>', description: 'Delete a thread' },
