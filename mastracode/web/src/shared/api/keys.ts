...
export const queryKeys = {
  ...
  githubIssues: (factoryProjectId: string | undefined, label?: string) =>
    ['github', 'issues', factoryProjectId ?? null, label ?? null] as const,
  githubPulls: (factoryProjectId: string | undefined) => ['github', 'prs', factoryProjectId ?? null] as const,
  githubRepositorySettings: (factoryProjectId: string | undefined) =>
    ['github', 'repository-settings', factoryProjectId ?? null] as const,
  ...
  factoryMetrics: (factoryProjectId: string | undefined, days: number) =>
    ['factory', 'metrics', factoryProjectId ?? null, days] as const,
  factoryHealthThresholds: (factoryProjectId: string | undefined) =>
    ['factory', 'health-thresholds', factoryProjectId ?? null] as const,
  factoryAudit: (factoryProjectId: string | undefined, group: string) =>
    ['factory', 'audit', factoryProjectId ?? null, group] as const,
