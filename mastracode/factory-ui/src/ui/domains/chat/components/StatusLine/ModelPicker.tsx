import { ModelPicker as ModelPickerView } from '@mastra/playground-ui/components/ModelPicker';
...
export function ModelPicker() {
  ...
  return (
    <ModelPickerView
      ...
      loading={!selectedModelId && (isLoading || status === 'connecting')}
      error={!selectedModelId ? error?.message : undefined}
      busy={busy}
      notConfigured={notConfigured}
      readOnly={!switchable || (!showPacks && !modelsQuery.data?.length)}
      ...
      packs={
        showPacks
          ? {
              ...
              selectedId: packModelDeviates ? undefined : selectedPackId,
              defaultId: defaultModelPackId,
              onSelect: pickPack,
              onReset: canReset && defaultModelPackId ? () => pickPack(defaultModelPackId) : undefined,
              onManage: factoryId
