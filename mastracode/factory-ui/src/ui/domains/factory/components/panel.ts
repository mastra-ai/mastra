...
export const PANEL_ROW_LINK = `hover:bg-fill focus-visible:outline-border-focus transition-colors focus-visible:outline-2 focus-visible:-outline-offset-2 ${PANEL_ROW}`;
