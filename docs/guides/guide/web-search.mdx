...
sidebar_position: 2
sidebar_label: "Building an Agent that can search the web"
...
You can test your agent inside Mastra's [Playground](/getting-started/studio) using the `mastra dev` command:
