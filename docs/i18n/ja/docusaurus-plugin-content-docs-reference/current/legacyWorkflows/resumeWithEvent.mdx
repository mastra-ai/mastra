---
title: "リファレンス: resumeWithEvent() | レガシー ワークフロー | Mastra ドキュメント"
...
<div id="monitoring-and-auto-resuming">
  ### 監視と自動復旧
</div>
...
- [一時停止と再開](/docs/v0/workflows-legacy/suspend-and-resume)
- [resume()](./resume)
- [watch()](./watch)