...
- [Answer Relevancy Scorer](/reference/v0/scorers/answer-relevancy) - クエリと回答の関連性を評価
- [Faithfulness Scorer](/reference/v0/scorers/faithfulness) - コンテキストへの忠実性を評価
- [Tool Call Accuracy Scorer](/reference/v0/scorers/tool-call-accuracy) - ツール選択の正確さを評価
