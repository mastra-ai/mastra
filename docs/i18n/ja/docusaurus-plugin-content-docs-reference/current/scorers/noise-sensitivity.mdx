...
- [CI での実行](/docs/v0/scorers/overview) - CI/CD パイプラインでのスコアラーの設定
- [Hallucination Scorer](/reference/v0/scorers/hallucination) - 生成された虚偽内容を評価
- [Answer Relevancy Scorer](/reference/v0/scorers/answer-relevancy) - 応答の関連性を測定
