...
- [Context Precision Scorer](/reference/v0/scorers/context-precision) - MAP を用いてコンテキストランキングを評価
- [Faithfulness Scorer](/reference/v0/scorers/faithfulness) - コンテキストに対する回答の根拠性を測定
- [Custom Scorers](/docs/v0/scorers/custom-scorers) - 独自の評価指標を作成