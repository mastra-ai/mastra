...
<div id="how-to-create-a-custom-scorer">
  ## カスタムスコアラーの作成方法
</div>
...
<div id="custom-types-with-generics">
  ### ジェネリクスを用いたカスタム型
</div>
...
<div id="trace-scoring-with-agent-types">
  ## エージェントタイプによるトレース採点
</div>
