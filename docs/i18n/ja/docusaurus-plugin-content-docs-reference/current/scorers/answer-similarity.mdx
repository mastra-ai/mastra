...
<div id="answer-similarity-scorer">
...
<div id="answersimilarityoptions">
...
<div id="usage-with-runexperiment">
...
<div id="perfect-similarity-example">
  ### 完全一致の例
</div>
...
<div id="perfect-similarity-output">
  #### 完全一致の出力
</div>
...
<div id="high-semantic-similarity-example">
  ### 高いセマンティック類似性の例
</div>
...
<div id="high-semantic-similarity-output">
  #### セマンティック類似度が高い出力
</div>
...
<div id="partial-similarity-example">
  ### 部分的な類似の例
</div>
...
<div id="partial-similarity-output">
  #### 部分的な類似度の出力
</div>
...
<div id="cicd-integration-example">
  ### CI/CD 連携の例
</div>
...
<div id="custom-configuration-example">
  ### カスタム設定の例
</div>
