...
- [Answer Relevancy Scorer](/reference/v0/scorers/answer-relevancy) - 回答が質問に適切に対応しているかを評価します
- [Faithfulness Scorer](/reference/v0/scorers/faithfulness) - 回答が文脈に基づいている度合いを測定します
- [Custom Scorers](/docs/v0/scorers/custom-scorers) - 独自の評価指標を作成する方法