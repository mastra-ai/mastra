...
カスタムのトレーシング用コンフィグセレクターを使用する際に渡されるオプション。
...
- [AI トレーシングの概要](/docs/v0/observability/ai-tracing/overview) - AI トレーシングの完全ガイド
- [子スパンの作成](/docs/v0/observability/ai-tracing/overview#creating-child-spans) - スパンの階層構造を扱う
- [カスタムメタデータの追加](/docs/v0/observability/ai-tracing/overview#adding-custom-metadata) - トレースの情報を充実させる

<div id="reference">
  ### 参考
</div>

- [Configuration](/reference/v0/observability/ai-tracing/configuration) - レジストリと構成
- [AITracing Classes](/reference/v0/observability/ai-tracing/) - コア実装
- [Span Reference](/reference/v0/observability/ai-tracing/span) - Span のライフサイクル メソッド

<div id="examples">
  ### 例
</div>

- [Basic AI Tracing](/examples/v0/observability/basic-ai-tracing) - 実装例