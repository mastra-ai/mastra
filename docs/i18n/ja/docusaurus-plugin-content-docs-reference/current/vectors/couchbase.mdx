---
title: "リファレンス: Couchbase Vector Store | Vectors | Mastra ドキュメント"
description: Mastra の CouchbaseVector クラスのドキュメント。Couchbase Vector Search を使ったベクトル検索を提供します。
---

<div id="couchbase-vector-store">
  # Couchbase ベクターストア
</div>
