...
<div id="agent-driven-metadata-filtering">
...
<div id="transform-chunks-into-metadata">
  ### チャンクをメタデータに変換する
</div>
...
> 注: ベクターストアごとに固有のプロンプトが用意されています。詳しくは [Vector Store Prompts](/docs/v0/rag/retrieval#vector-store-prompts) を参照してください。
...
<div id="metadata-based-querying">
  ## メタデータベースのクエリ
</div>
