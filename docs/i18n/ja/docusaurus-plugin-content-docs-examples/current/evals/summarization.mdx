...
<div id="summarization-evaluation">
  # 要約の評価
</div>
...
<div id="accurate-summary-example">
  ## 正確な要約の例
</div>
...
<div id="accurate-summary-output">
  ### 正確な要約の出力
</div>
...
<div id="partial-summary-example">
  ## 部分的な要約の例
</div>
...
<div id="inaccurate-summary-example">
  ## 不正確な要約の例
</div>
...
<div id="inaccurate-summary-output">
  ### 不正確な要約出力
</div>
...
> 設定オプションの全一覧は [SummarizationMetric](/reference/v0/evals/summarization) を参照してください。
