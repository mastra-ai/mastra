...
<div id="ai-debate-with-turn-taking">
  # ターン制のAIディベート
</div>
...
<div id="creating-agents-with-voice-capabilities">
  ## 音声機能を備えたエージェントの作成
</div>
...
<div id="registering-the-agents-with-mastra">
  ## Mastra でのエージェント登録
</div>
...
<div id="managing-turn-taking-in-the-debate">
  ## 討論における発言順の管理
</div>
...
<div id="running-the-debate-from-the-command-line">
  ## コマンドラインからディベートを実行する
</div>
...
<div id="creating-a-web-interface-for-the-debate">
