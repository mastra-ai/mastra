...
<div id="high-example-all-keywords-present">
  ## 高度な例（すべてのキーワードを含む）
</div>
...
<div id="partial-example-missing-keywords">
  ## 部分的な例（キーワードの欠落）
</div>
...
<div id="low-example-no-keywords-present">
  ## 低い例（キーワードなし）
</div>
