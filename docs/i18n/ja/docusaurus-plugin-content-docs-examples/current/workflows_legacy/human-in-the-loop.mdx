---
title: "例: 人間参加型ワークフロー（レガシー） | ワークフロー（レガシー） | Mastra ドキュメント"
description: 人の介入ポイントを設けたレガシーなワークフローを Mastra で作成する例。
---

import GithubLink from "@site/src/components/GithubLink";


<div id="human-in-the-loop-workflow-legacy">
...
<div id="interactive-terminal-example-using-inquirer">
...
<div id="advanced-example-with-multiple-user-inputs">
  ## 複数のユーザー入力を伴う高度な例
</div>
...
- [循環依存を含むワークフロー（レガシー）](/examples/v0/workflows_legacy/cyclical-dependencies)
