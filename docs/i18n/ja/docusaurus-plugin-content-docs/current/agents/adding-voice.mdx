...
| OpenAI Realtime | `@mastra/voice-openai-realtime` | リアルタイム音声対話       | [Documentation](/reference/v0/voice/openai-realtime) |
| ElevenLabs      | `@mastra/voice-elevenlabs`      | 高品質な TTS               | [Documentation](/reference/v0/voice/elevenlabs)      |
...
音声機能の詳細は、[Voice API リファレンス](/reference/v0/voice/mastra-voice)をご参照ください。