  ...
  <TabItem value="操作" label="操作">
    <Steps>
      ...
      <StepItem>
        ...
        > サーバーが起動すると、エージェントはローカルで利用可能になります。詳しくは、[ローカル開発環境](/docs/getting-started/studio)を参照してください。
      </StepItem>
  ...
  <TabItem value="サーバーエンドポイント" label="サーバー エンドポイント">
    <Steps>
      ...
      <StepItem>
        ...
        > 起動後、エージェントはローカルで利用可能になります。詳しくは [ローカル開発環境](/docs/getting-started/studio) をご覧ください。
      </StepItem>
