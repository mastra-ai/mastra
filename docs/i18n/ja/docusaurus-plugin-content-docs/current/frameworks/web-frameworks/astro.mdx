  ...
  <TabItem value="操作" label="操作">
    ...
    <Steps>
      ...
      <StepItem>
        ...
        > 起動後、エージェントはローカルで利用可能になります。詳しくは [ローカル開発環境](/docs/v0/getting-started/studio) を参照してください。
      </StepItem>
    ...
    * `astro.config.mjs` は `output: "server"` に設定されています
    ...
    <Steps>
      ...
      <StepItem>
        ...
        > 起動すると、エージェントはローカル環境で利用可能になります。詳しくは「[ローカル開発環境](/docs/v0/getting-started/studio)」をご覧ください。
      </StepItem>
...
- [デプロイ | Vercel での Astro](/docs/v0/deployment/web-framework#with-astro-on-vercel)
