...
| ------------------------------------------------ | -------------------- | ------------------------------------------- | ------------------------------------- |
| **[LibSQL](/reference/v0/storage/libsql)**          | batch-with-updates   | realtime, batch-with-updates, insert-only   | 既定のストレージ。開発に適しています |
| **[PostgreSQL](/reference/v0/storage/postgresql)**  | batch-with-updates   | batch-with-updates, insert-only             | 本番環境に推奨                        |
...
- [AI トレーシングの概要](/docs/v0/observability/ai-tracing/overview)
- [CloudExporter](/docs/v0/observability/ai-tracing/exporters/cloud)
- [ストレージの設定](/docs/v0/server-db/storage)