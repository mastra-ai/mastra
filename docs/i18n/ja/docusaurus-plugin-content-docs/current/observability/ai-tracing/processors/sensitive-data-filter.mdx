...
<div id="healthcare-applications">
  ### ヘルスケアアプリケーション
</div>
...
- [AI トレーシングの基本例](/examples/v0/observability/basic-ai-tracing)