...
また、Langfuse や Braintrust、Datadog、New Relic、SigNoz などの OpenTelemetry 互換プラットフォームを含む各種外部トレーシングプロバイダーにも対応しています。詳しくは [AI Tracing](/docs/v0/observability/ai-tracing/overview) のドキュメントをご覧ください。
...
- **[AI トレーシングを設定](/docs/v0/observability/ai-tracing/overview)**: アプリケーションのトレーシングを構成
- **[ロギングを設定](/docs/v0/observability/logging)**: 構造化ログを追加
- **[サンプルを見る](/examples/v0/observability/basic-ai-tracing)**: オブザーバビリティを実際に確認
- **[API リファレンス](/reference/v0/observability/ai-tracing/)**: 詳細な構成オプション