...
> 詳細は [Agent.stream()](/reference/v0/streaming/agents/stream) をご覧ください。


<div id="output-from-agentstream">
  ### `Agent.stream()` の出力
</div>
...
<div id="agent-stream-properties">
  ### エージェントストリームのプロパティ
</div>
...
<div id="ai-sdk-v5-compatibility">
  ### AI SDK v5 の互換性
</div>
...
> 詳細は [Agent.network()](/reference/v0/agents/network) をご覧ください。


<div id="network-stream-properties">
  #### ネットワークストリームのプロパティ
</div>
...
<div id="streaming-with-workflows">
  ## ワークフローでのストリーミング
</div>
...
<div id="workflow-stream-properties">
  ## ワークフローストリームのプロパティ
</div>
...
- [イベントのストリーミング](./events)
- [エージェントの使用](/docs/v0/agents/overview)
