...
> 利用可能なすべての設定オプションについては、[MastraAuthAuth0](/reference/v0/auth/auth0) の API リファレンスを参照してください。
...
> 設定の詳細については [Mastra Client SDK](/docs/v0/server-db/mastra-client) を参照してください。
