...
> 利用可能な設定オプションの一覧については、[MastraAuthWorkos](/reference/v0/auth/workos) の API リファレンスを参照してください。
...
> さらに詳しい設定オプションについては、[Mastra Client SDK](/docs/v0/server-db/mastra-client) を参照してください。
