...
> 利用可能なすべての設定オプションについては、[MastraAuthFirebase](/reference/v0/auth/firebase) の API リファレンスを参照してください。
...
> そのほかの設定オプションについては、[Mastra Client SDK](/docs/v0/server-db/mastra-client) を参照してください。
