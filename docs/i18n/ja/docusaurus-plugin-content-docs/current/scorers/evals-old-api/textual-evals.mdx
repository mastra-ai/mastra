...
:::info Scorers
このドキュメントは従来の evals API を参照しています。最新のスコアラー機能については [Scorers](/docs/scorers/overview) をご覧ください。
:::
...
Mastra はエージェントの出力を評価するための複数の評価指標を提供しています。Mastra はこれらの指標に限らず、[独自の評価を定義](/docs/scorers/evals-old-api/custom-eval)することも可能です。
