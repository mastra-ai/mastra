...
チャンク化の戦略については、[チャンクに関するドキュメント](/reference/v0/rag/chunk)でさらに詳しく解説しています。
...
- [チャンクのリファレンス](/reference/v0/rag/chunk)
- [埋め込みのリファレンス](/reference/v0/rag/embeddings)

ベクターデータベースと埋め込みの詳細については、次を参照してください：

- [ベクターデータベース](./vector-databases)
- [埋め込み API リファレンス](/reference/v0/rag/embeddings)