...
Mastra のワークフローは、ワークフロー実行内の各ステップの[入力と出力を自動的に記録](/docs/v0/observability/otel-tracing)し、これらのデータを任意のログ、テレメトリー、または可観測性ツールへ送信できます。
...
- [逐次ステップのワークフロー例](/examples/v0/workflows_legacy/sequential-steps)
- [並列ステップのワークフロー例](/examples/v0/workflows_legacy/parallel-steps)
- [分岐パスのワークフロー例](/examples/v0/workflows_legacy/branching-paths)
- [ワークフロー変数の例](/examples/v0/workflows_legacy/workflow-variables)
- [循環依存のワークフロー例](/examples/v0/workflows_legacy/cyclical-dependencies)
- [一時停止と再開のワークフロー例](/examples/v0/workflows_legacy/suspend-and-resume)