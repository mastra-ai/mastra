...
- [Mastra Workflows におけるスナップショットの理解](/reference/v0/legacyWorkflows/snapshots) - suspend/resume 機能を支えるスナップショット機構について学ぶ
- [ステップ設定ガイド](./steps) - ワークフロー内のステップ設定を詳しく解説
- [制御フローガイド](./control-flow) - 高度なワークフロー制御パターン
- [イベント駆動型ワークフロー](/reference/v0/legacyWorkflows/events) - イベントベースのワークフローに関する詳細リファレンス

<div id="related-resources">
  ## 関連リソース
</div>

- 完成した動作例は「[Suspend and Resume の例](/examples/v0/workflows_legacy/suspend-and-resume)」をご覧ください
- suspend/resume の API の詳細は「[Step Class リファレンス](/reference/v0/legacyWorkflows/step-class)」を参照してください
- サスペンドされたワークフローの監視については「[Workflow Observability](/docs/v0/observability/otel-tracing)」を参照してください