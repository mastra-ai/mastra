---
title: "入れ子ワークフロー（レガシー） | ワークフロー（レガシー） | Mastra Docs"
sidebar_position: 4
sidebar_label: "入れ子ワークフロー"
---

<div id="nested-workflows-legacy">
  # ネストされたワークフロー（レガシー）
</div>
...
<div id="control-flow-with-nested-workflows">
...
<div id="watching-nested-workflows">
  ## ネストされたワークフローの監視
</div>
...
<div id="suspending-and-resuming">
  ## 一時停止と再開
</div>
...
<div id="result-schemas-and-mapping">
  ## 結果スキーマとマッピング
</div>
