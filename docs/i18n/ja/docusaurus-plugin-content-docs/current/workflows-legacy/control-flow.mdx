...
詳細は、[Parallel Steps](/examples/v0/workflows_legacy/parallel-steps) の例をご覧ください。
...
詳細は、[Sequential Steps](/examples/v0/workflows_legacy/sequential-steps) のサンプルをご参照ください。
...
詳細は [Branching Paths](/examples/v0/workflows_legacy/branching-paths) の例をご覧ください。
