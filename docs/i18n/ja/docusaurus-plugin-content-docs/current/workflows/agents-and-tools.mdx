...
<div id="using-agents-in-workflows">
  ## ワークフローでのエージェントの利用
</div>
...
> さらに詳しい例は [Calling Agents](/examples/v0/agents/calling-agents) をご覧ください。


<div id="agents-as-steps">
  ### ステップとしてのエージェント
</div>
...
<div id="using-tools-in-workflows">
  ## ワークフローでのツールの使用
</div>
...
> さらに詳しくは、[Calling Tools](/examples/v0/workflows_legacy/using-a-tool-as-a-step) をご覧ください。


<div id="tools-as-steps">
  ### ステップとしてのツール
</div>
...
- [エージェントの使い方](/docs/v0/agents/overview)
