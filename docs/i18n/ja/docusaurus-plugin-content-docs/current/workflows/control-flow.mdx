...
> 詳しくは [Parallel Execution with Steps](/examples/v0/workflows_legacy/parallel-steps) をご参照ください。
...
> 詳細は [Workflow with Conditional Branching](/examples/v0/workflows_legacy/conditional-branching) を参照してください。
