...
- ローカル開発には [LibSQL Storage](/reference/v0/storage/libsql) をご確認ください
- 本番環境には [PostgreSQL Storage](/reference/v0/storage/postgresql) をご確認ください
- サーバーレスデプロイには [Upstash Storage](/reference/v0/storage/upstash) をご確認ください
- ドキュメント指向ストレージには [MongoDB Storage](/reference/v0/storage/mongodb) をご確認ください