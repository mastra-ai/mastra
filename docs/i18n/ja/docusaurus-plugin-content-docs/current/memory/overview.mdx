...
利用可能なオプションには、[LibSQL](/docs/v0/memory/storage/memory-with-libsql)、[MongoDB](/docs/v0/memory/storage/memory-with-mongodb)、[Postgres](/docs/v0/memory/storage/memory-with-pg)、[Upstash](/docs/v0/memory/storage/memory-with-upstash) があります。
...
また、利用可能なオプションについては [設定リファレンス](/reference/v0/memory/memory-class) を参照してください。