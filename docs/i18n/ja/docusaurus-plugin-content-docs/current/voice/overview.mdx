...
エージェントに音声機能を統合する方法は、[「エージェントに音声を追加する」](/docs/v0/agents/adding-voice)のドキュメントをご参照ください。本セクションでは、単一および複数の音声プロバイダーの活用方法に加え、リアルタイムでのインタラクションについても解説します。
...
<Tabs>
  <TabItem value="OpenAI" label="OpenAI">
    ...
    OpenAI の音声プロバイダーについて詳しくは、[OpenAI Voice Reference](/reference/v0/voice/openai)をご覧ください。
  </TabItem>
  ...
  <TabItem value="azure" label="Azure">
    ...
    Azure 音声プロバイダーの詳細は、[Azure Voice Reference](/reference/v0/voice/azure) をご覧ください。
  </TabItem>
  ...
  <TabItem value="ElevenLabs" label="ElevenLabs">
    ...
    ElevenLabs の音声プロバイダーの詳細は、[ElevenLabs Voice Reference](/reference/v0/voice/elevenlabs) をご覧ください。
  </TabItem>
  ...
  <TabItem value="PlayAI" label="PlayAI">
    ...
    PlayAI の音声プロバイダーについて詳しくは、[PlayAI Voice Reference](/reference/v0/voice/playai)をご覧ください。
  </TabItem>
  ...
  <TabItem value="Google" label="Google">
    ...
    Google の音声プロバイダーについて詳しくは、[Google Voice リファレンス](/reference/v0/voice/google)をご覧ください。
  </TabItem>
  ...
  <TabItem value="Cloudflare" label="Cloudflare">
    ...
    Cloudflare の音声プロバイダーについて詳しくは、[Cloudflare Voice Reference](/reference/v0/voice/cloudflare) をご覧ください。
  </TabItem>
  ...
  <TabItem value="Deepgram" label="Deepgram">
    ...
    Deepgram の音声プロバイダーの詳細については、[Deepgram Voice リファレンス](/reference/v0/voice/deepgram)を参照してください。
  </TabItem>
  ...
  <TabItem value="Speechify（スピーチファイ）" label="Speechify">
    ...
    Speechify の音声プロバイダーの詳細は、[Speechify Voice Reference](/reference/v0/voice/speechify) をご覧ください。
  </TabItem>
  ...
  <TabItem value="sarvam" label="Sarvam">
    ...
    Sarvam の音声プロバイダーについて詳しくは、[Sarvam Voice Reference](/reference/v0/voice/sarvam)をご覧ください。
  </TabItem>
  ...
  <TabItem value="murf" label="Murf">
    ...
    Murf の音声プロバイダーについて詳しくは、[Murf Voice Reference](/reference/v0/voice/murf) をご覧ください。
  </TabItem>
</Tabs>
...
<Tabs>
  <TabItem value="OpenAI" label="OpenAI">
    ...
    OpenAI の音声プロバイダーの詳細は、[OpenAI Voice Reference](/reference/v0/voice/openai)をご覧ください。
  </TabItem>
  ...
  <TabItem value="アジュール" label="Azure">
    ...
    Azure の音声プロバイダーの詳細は、[Azure Voice Reference](/reference/v0/voice/azure) をご覧ください。
  </TabItem>
  ...
  <TabItem value="ElevenLabs" label="ElevenLabs">
    ...
    ElevenLabs の音声プロバイダーについて詳しくは、[ElevenLabs Voice Reference](/reference/v0/voice/elevenlabs) をご覧ください。
  </TabItem>
  ...
  <TabItem value="Cloudflare" label="Cloudflare">
    ...
    Cloudflare の音声プロバイダーの詳細は、[Cloudflare Voice Reference](/reference/v0/voice/cloudflare) をご覧ください。
  </TabItem>
  ...
  <TabItem value="Deepgram" label="Deepgram">
    ...
    Deepgram の音声プロバイダーに関する詳細は、[Deepgram Voice Reference](/reference/v0/voice/deepgram) をご覧ください。
  </TabItem>
  ...
  <TabItem value="sarvam" label="Sarvam">
    ...
    Sarvam の音声プロバイダーについての詳細は、[Sarvam Voice Reference](/reference/v0/voice/sarvam) をご覧ください。
  </TabItem>
</Tabs>
...
OpenAI の音声プロバイダーに関する詳細は、[OpenAI Voice Reference](/reference/v0/voice/openai-realtime)をご覧ください。
...
Google Gemini Live の音声プロバイダーに関する詳細は、[Google Gemini Live Reference](/reference/v0/voice/google-gemini-live)をご覧ください。
...
<Tabs>
  <TabItem value="OpenAI" label="OpenAI">
    ...
    OpenAI の音声プロバイダーの詳細については、[OpenAI Voice Reference](/reference/v0/voice/openai) をご覧ください。
  </TabItem>
  ...
  <TabItem value="ElevenLabs" label="ElevenLabs">
    ...
    ElevenLabs の音声プロバイダーについての詳細は、[ElevenLabs Voice Reference](/reference/v0/voice/elevenlabs) をご参照ください。
  </TabItem>
  ...
  <TabItem value="Play.ai" label="PlayAI">
    ...
    PlayAI の音声プロバイダーの詳細は、[PlayAI Voice Reference](/reference/v0/voice/playai)をご覧ください。
  </TabItem>
  ...
  <TabItem value="Google" label="Google">
    ...
    Google 音声プロバイダーの詳細については、[Google Voice リファレンス](/reference/v0/voice/google)をご覧ください。
  </TabItem>
  ...
  <TabItem value="Deepgram" label="Deepgram">
    ...
    Deepgram の音声プロバイダーについて詳しくは、[Deepgram Voice リファレンス](/reference/v0/voice/deepgram)をご覧ください。
  </TabItem>
  ...
  <TabItem value="Speechify" label="Speechify">
    ...
    Speechify の音声プロバイダーについて詳しくは、[Speechify Voice Reference](/reference/v0/voice/speechify) をご覧ください。
  </TabItem>
  ...
  <TabItem value="sarvam" label="Sarvam">
    ...
    Sarvam のボイスプロバイダーについての詳細は、[Sarvam Voice Reference](/reference/v0/voice/sarvam) をご覧ください。
  </TabItem>
  ...
  <TabItem value="murf" label="Murf">
    ...
    Murf の音声プロバイダーの詳細は、[Murf Voice Reference](/reference/v0/voice/murf) をご覧ください。
  </TabItem>
  ...
  <TabItem value="openai-realtime" label="OpenAI リアルタイム">
    ...
    OpenAI Realtime の音声プロバイダーについて詳しくは、[OpenAI Realtime Voice Reference](/reference/v0/voice/openai-realtime)をご参照ください。
  </TabItem>
  ...
  <TabItem value="google-gemini-live" label="Google Gemini Live">
    ...
    Google Gemini Live の音声プロバイダーの詳細は、[Google Gemini Live リファレンス](/reference/v0/voice/google-gemini-live)をご覧ください。
  </TabItem>
</Tabs>
...
CompositeVoice の詳細は、[CompositeVoice リファレンス](/reference/v0/voice/composite-voice)をご参照ください。
...
- [CompositeVoice](/reference/v0/voice/composite-voice)
- [MastraVoice](/reference/v0/voice/mastra-voice)
- [OpenAI Voice](/reference/v0/voice/openai)
- [OpenAI Realtime Voice](/reference/v0/voice/openai-realtime)
- [Azure Voice](/reference/v0/voice/azure)
- [Google Voice](/reference/v0/voice/google)
- [Google Gemini Live Voice](/reference/v0/voice/google-gemini-live)
- [Deepgram Voice](/reference/v0/voice/deepgram)
- [PlayAI Voice](/reference/v0/voice/playai)
- [音声のサンプル](/examples/v0/voice/text-to-speech)