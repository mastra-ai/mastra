...
<div id="speech-to-speech-capabilities-in-mastra">
  # Mastra の音声対話機能
</div>
...
エージェントに音声対音声（Speech-to-Speech）機能を統合する方法については、[Adding Voice to Agents](/docs/v0/agents/adding-voice) のドキュメントを参照してください。


<div id="google-gemini-live-realtime">
