---
title: "Alibaba（中国） | モデル | Mastra"
description: "Mastra で Alibaba（中国）のモデルを利用できます。全61モデル。"
---
...
Mastraのモデルルーター経由で、Alibaba (China) の61種類のモデルにアクセスできます。認証は環境変数 `DASHSCOPE_API_KEY` により自動的に行われます。
