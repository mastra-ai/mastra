...
For information on contributing your own templates to the Mastra ecosystem, see the [Contributing Templates](/community/contributing-templates) guide in the community section.
