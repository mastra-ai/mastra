...
### Documentation
- [AI Tracing Overview](/observability/ai-tracing/overview/overview) - Complete guide to AI tracing
- [Creating Child Spans](/observability/ai-tracing/overview/overview#creating-child-spans) - Working with span hierarchies
- [Adding Custom Metadata](/observability/ai-tracing/overview/overview#adding-custom-metadata) - Enriching traces
