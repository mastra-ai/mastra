...
The [Playground](/server-db/studio) lets you rapidly build and prototype agents without needing to build a UI. Once you're ready, you can integrate your Mastra agent into your application using the guides below.


### Next steps

- Read more about [Mastra's features](/docs#why-mastra).
- Integrate Mastra with your frontend framework: [Next.js](/frameworks/web-frameworks/next-js), [React](/frameworks/web-frameworks/vite-react), or [Astro](/frameworks/web-frameworks/astro).
...
You can now launch the [Playground](/server-db/studio) and test your agent.
