...
If you have not yet set up your Mastra server, follow the [getting started guide](/getting-started/installation) to set up a new Mastra project.
...
- [Next.js Integration with Mastra](/frameworks/web-frameworks/next-js) - Full-stack Next.js setup guide
