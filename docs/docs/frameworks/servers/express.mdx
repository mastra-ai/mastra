...
Each LLM provider uses a different env var. See [Model Capabilities](/getting-started/model-capability) for more information.
...
In production it's not necessary to run Mastra alongside your Express server. But for development Mastra offers a [Local Development Environment](/server-db/studio) which you can use to improve and debug your agent.
