...
This page explains how to navigate the Mastra Cloud dashboard, where you can configure your project, view deployment details, and interact with agents and workflows using the built-in [Playground](/mastra-cloud/dashboard#playground).
...
- [Understanding Tracing and Logs](/mastra-cloud/observability)
