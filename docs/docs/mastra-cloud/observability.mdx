...
You can view detailed logs for debugging and monitoring your application's behavior on the [Logs](/mastra-cloud/dashboard#logs) page of the Dashboard.
...
More detailed traces are available for both agents and workflows by using a [logger](/observability/logging) or enabling [telemetry](/observability/tracing) using one of our [supported providers](/reference/observability/providers).

### Agents

With a [logger](/observability/logging) enabled, you can view detailed outputs from your agents in the **Traces** section of the Agents Playground.
...
With a [logger](/observability/logging) enabled, you can view detailed outputs from your workflows in the **Traces** section of the Workflows Playground.
