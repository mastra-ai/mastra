...
You can add built-in scorers to your agents to automatically evaluate their outputs. See the [full list of built-in scorers](/scorers/off-the-shelf-scorers) for all available options.
...
For more details, see the [Local Dev Playground](/server-db/studio) docs.

## Next steps

- Learn how to create your own scorers in the [Creating Custom Scorers](/scorers/custom-scorers) guide
- Explore built-in scorers in the [Off-the-shelf Scorers](/scorers/off-the-shelf-scorers) section
- Test scorers with the [Local Dev Playground](/server-db/studio)
