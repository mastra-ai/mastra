...
:::info Scorers
This documentation refers to the legacy evals API. For the latest scorer features, see [Scorers](/scorers/overview).
:::
...
See [Textual Evals](/evals/textual-evals) for more info on what evals can do.

For more info on how to create your own evals, see the [Custom Evals](/evals/custom-eval) guide.

For running evals in your CI pipeline, see the [Running in CI](/evals/running-in-ci) guide.
