...
The Mastra Client SDK provides a simple and type-safe interface for interacting with your [Mastra Server](/deployment/server-deployment.mdx) from your client environment.
