...
sidebar_position: 11
sidebar_label: "Mastra Client SDK"
description: Learn how to interact with Mastra using the client-js SDK.
---

# Mastra Client SDK

The Mastra Client SDK provides a simple and type-safe interface for interacting with your [Mastra Server](/deployment/server-deployment) from your client environment.
