---
title: "Example: Data Mapping with Workflow Variables (Legacy) | Workflows (Legacy) | Mastra Docs"
sidebar_position: 9
...
For more information on workflow variables, see the [Workflow Variables documentation](/workflows-legacy/variables).
