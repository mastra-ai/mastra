...
sidebar_position: 1
sidebar_label: "Basic AI Tracing"
...
- **[DefaultExporter](/observability/ai-tracing/overview/exporters/default)** - Persists traces to your storage
- **[CloudExporter](/observability/ai-tracing/overview/exporters/cloud)** - Sends to Mastra Cloud (if token is set)
- **[SensitiveDataFilter](/observability/ai-tracing/overview/processors/sensitive-data-filter)** - Redacts sensitive fields
- **[100% sampling](/observability/ai-tracing/overview/overview#always-sample)** - All traces are collected
...
### Documentation
- [AI Tracing Overview](/observability/ai-tracing/overview/overview) - Complete guide to tracing
- [Sensitive Data Filter](/observability/ai-tracing/overview/processors/sensitive-data-filter) - Redact sensitive information
- [Configuration Patterns](/observability/ai-tracing/overview/overview#common-configuration-patterns--troubleshooting) - Best practices
