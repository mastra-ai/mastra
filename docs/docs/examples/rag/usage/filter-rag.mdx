...
sidebar_position: 3
sidebar_label: "Metadata Filtering"
...
> Note: Different vector stores have specific prompts available. See [Vector Store Prompts](/rag/retrieval#vector-store-prompts) for details.
