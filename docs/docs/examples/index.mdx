...
<CardItems
  titles={["Agent", "Workflow", "Processors", "legacyWorkflow", "Memory", "RAG", "Evals", "Scorers (Experimental)", "Voice", "Observability"]}
  items={{
    Agent: [
      ...
      { title: "Runtime Context", href: "/docs/examples/agents/runtime-context" },
      { title: "Deploying an MCP Server", href: "/docs/examples/agents/deploying-mcp-server" },
    ...
    Processors: [
      { title: "Message Length Limiter", href: "/docs/examples/processors/message-length-limiter" },
      { title: "Response Length Limiter", href: "/docs/examples/processors/response-length-limiter" },
      { title: "Response Validator", href: "/docs/examples/processors/response-validator" }
    ],
    legacyWorkflow: [
    ...
    Memory: [
      ...
      { title: "Memory with MongoDB", href: "/docs/examples/memory/memory-with-mongodb" }
    ],
    RAG: [
    ...
    Observability: [
      { title: "Basic AI Tracing", href: "/docs/examples/observability/basic-ai-tracing" }
    ]
  }}
/>
