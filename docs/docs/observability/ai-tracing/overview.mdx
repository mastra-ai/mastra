...
- **[Default](/observability/ai-tracing/overview/exporters/default)** - Persists traces to local storage for viewing in the Playground
- **[Cloud](/observability/ai-tracing/overview/exporters/cloud)** - Sends traces to Mastra Cloud for production monitoring and collaboration
...
- **[Arize](/observability/ai-tracing/overview/exporters/arize)** - Exports traces to Arize Phoenix or Arize AX using OpenInference semantic conventions
- **[Braintrust](/observability/ai-tracing/overview/exporters/braintrust)** - Exports traces to Braintrust's eval and observability platform
- **[Langfuse](/observability/ai-tracing/overview/exporters/langfuse)** - Sends traces to the Langfuse open-source LLM engineering platform
- **[LangSmith](/observability/ai-tracing/overview/exporters/langsmith)** - Pushes traces into LangSmith's observability and evaluation toolkit
- **[OpenTelemetry](/observability/ai-tracing/overview/exporters/otel)** - Deliver traces to any OpenTelemetry-compatible observability system
...
* [Sensitive Data Filter](/observability/ai-tracing/overview/processors/sensitive-data-filter) redacts sensitive information. It is enabled in the default observability config.
...
### Processors
- [Sensitive Data Filter](/observability/ai-tracing/overview/processors/sensitive-data-filter) - Data redaction
