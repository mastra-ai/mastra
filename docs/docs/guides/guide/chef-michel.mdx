...
sidebar_position: 5
sidebar_label: "Building an AI Chef Assistant"
...
- An existing Mastra project (Follow the [installation guide](/getting-started/installation) to set up a new project)
...
Instead of showing the agent's response to a human you might want to pass it along to another part of your code. For these instances your agent should return [structured output](/agents/overview#4-structured-output).
...
This will start a server exposing endpoints to interact with your registered agents. Within the [playground](/server-db/studio) you can test your agent through a UI.
