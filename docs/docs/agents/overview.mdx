...
Mastra supports more than 600 models. Choose from the [full list](/models/index).
...
Use the Mastra [Playground](/server-db/local-dev-playground) to test agents with different messages, inspect tool calls and responses, and debug agent behavior.
