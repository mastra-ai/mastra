...
- [Amazon EC2](/deployment/cloud-providers/amazon-ec2)
- [AWS Lambda](/deployment/cloud-providers/aws-lambda)
- [Digital Ocean](/deployment/cloud-providers/digital-ocean)
- [Azure App Services](/deployment/cloud-providers/azure-app-services)

For self-hosted Node.js server deployment, see the [Creating A Mastra Server](/deployment/server) guide.

## Prerequisites

Before deploying to a cloud provider, ensure you have:

- A [Mastra application](/getting-started/installation)
