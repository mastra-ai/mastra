...
- [Netlify](/deployment/serverless-platforms/netlify-deployer)
- [Vercel](/deployment/serverless-platforms/vercel-deployer)

Deployers **aren't** required when integrating Mastra with a framework. See [Web Framework Integration](/deployment/web-framework) for more information.
