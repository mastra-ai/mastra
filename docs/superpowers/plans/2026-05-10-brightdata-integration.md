...
describe('createBrightDataSearchTool', () => {
  ...
  it('should call client.search.google with mapped parameters', async () => {
    ...
    const result = await tool.execute!({ query: 'pizza restaurants', country: 'us', cursor: 'abc' }, {} as any)
...
const agent = new Agent({
  ...
  instructions: 'You are a realtime information agent. Use web-search to find pages, and web-fetch to read them.',
