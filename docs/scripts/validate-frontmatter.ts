...
const DEFAULT_CONFIG: ValidationConfig = {
  ...
  // Allow for @mastra/* packages + mastra + create-mastra + create-agentbuilder + mastracode
  packagePattern: /^(@mastra\/[\w-]+|mastra|create-mastra|create-agentbuilder|mastracode)$/,
  concurrency: 50,
}
