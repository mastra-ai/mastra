...
The metric provides:
- A score between 0 and 1 for normal cases
- A special score of -1 when no instructions are applicable
- Detailed breakdown of followed, missed, and N/A instructions
- Clear reasoning for the score calculation
