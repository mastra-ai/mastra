...
const memory = new Memory({
  ...
  options: {
    lastMessages: 1, // working memory means we can have a shorter context window but maintain coherence
    workingMemory: {
      enabled: true,
    },
  },
