...
# Adding Voice Capabilities to Agents
...
1. Agent1 converts text to speech using PlayAI and saves it to a file
...
<GithubLink path="examples/basics/agents/voice-capabilities/index.ts" />
