...
For a practical example, see how we evaluate [Chef Michel's](/docs/guides/01-chef-michel) recipe completeness in our [Recipe Completeness example](/examples/evals/custom-eval).
