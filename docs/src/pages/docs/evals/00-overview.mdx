...
Eval scores provide quantifiable feedback for improving agent performance:
...
1. Find patterns - Which types of inputs cause lower scores?
2. Experiment with prompts - Try different ways of asking
3. Add guardrails - Include specific rules for tricky cases
4. Test more scenarios - Add examples that cover edge cases

### High Scores (> 0.8)
Your agent is doing well. Next steps:
1. Watch for changes - Do scores stay high over time?
2. Raise the bar - Try increasing your quality targets
3. Save what works - Keep notes on successful approaches
4. Fine-tune - Look for small ways to improve speed or efficiency

## Next Steps

1. See [Textual Evals](/docs/evals/textual-evals) for more examples of what evals can do
2. See [Custom Evals](/docs/evals/02-custom-eval) for more info on how to create your own evals
