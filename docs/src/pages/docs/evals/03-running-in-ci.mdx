...
Think about evals like including performance testing in your CI pipeline. There's going to be some randomness in each result, but on the whole and over time there should be a correlation between application quality and test results.
