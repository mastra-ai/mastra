---
title: "Creating Mastra Projects"
description: "Create new projects or add Mastra to existing ones"
---
...
You can create a new project using either:

```bash
# Option 1: Using npm create
npm create mastra

# Option 2: Using the Mastra CLI
