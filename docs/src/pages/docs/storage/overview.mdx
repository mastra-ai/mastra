...
<SchemaTable
  columns={[
    ...
    },
    {
      name: "name",
      type: "text",
      description: "Operation name (e.g. function name, HTTP route)",
      constraints: [{ type: "nullable", value: false }]
    },
    {
      name: "traceId",
    ...
    },
    {
      name: "scope",
      type: "text",
      description: "Package/module/service name that created the span",
      constraints: [{ type: "nullable", value: false }]
    },
    {
      name: "kind",
    ...
    },
    {
      name: "attributes",
      type: "jsonb",
      description: "User defined key-value pairs with span metadata",
    },
    {
      name: "status",
      type: "jsonb",
...
- For caching, check out [Upstash Storage](../reference/storage/upstash.mdx)