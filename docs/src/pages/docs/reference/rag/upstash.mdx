---
title: "Reference: UpstashStore | Vector Databases | RAG | Mastra Docs"
description: Documentation for the UpstashStore class in Mastra, which provides vector search using Upstash Vector.
---

# Upstash

The UpstashStore class provides vector search using [Upstash Vector](https://upstash.com/vector), a serverless vector database service that provides vector similarity search with metadata filtering capabilities.
