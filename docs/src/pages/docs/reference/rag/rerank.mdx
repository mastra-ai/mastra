...
<PropertiesTable
  content={[
    ...
    },
    {
      name: "config",
      type: "object",
      description: "Model configuration for llm reranking",
      isOptional: false,
      properties: [
        {
          type: "object",
          ...
          parameters: [
            {
              name: "provider",
              description: "Provider to use for reranking",
              isOptional: false,
              type: "string",
            },
            {
    ...
    },
    {
      name: "config (cohere)",
      type: "object",
      description: "Model configuration for cohere reranking",
      isOptional: false,
      properties: [
        {
          type: "object",
          ...
          parameters: [
            {
              name: "apiKey",
              description: "API key for the reranking model",
              isOptional: false,
              type: "string",
            },
            {
