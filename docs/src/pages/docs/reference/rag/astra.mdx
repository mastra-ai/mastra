---
title: "Reference: AstraStore | Vector Databases | RAG | Mastra Docs"
description: Documentation for the AstraStore class in Mastra, which provides vector search using DataStax Astra DB.
---

# Astra

The AstraStore class provides vector search using [DataStax Astra DB](https://www.datastax.com/products/datastax-astra), a cloud-native, serverless database built on Apache Cassandra.
