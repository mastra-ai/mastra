...
The metric evaluates recall by comparing the LLM's response against the provided context through:
- Relevant information identification
- Response-context comparison
- Information recall tracking
...
2. Calculates recall score:
   ...
   - Divides by total relevant items in context

Final score: `correctly_recalled_items / total_relevant_items`
