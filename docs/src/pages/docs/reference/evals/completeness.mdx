...
The metric evaluates completeness through linguistic analysis based on:
- Key terms and concepts from input
- Nouns and entities
- Action verbs
...
1. Extracts elements from input and output text:
...
Final score: `covered_elements / total_input_elements`
