...
The metric evaluates textual similarity based on:
- Character-level matching
- Word boundary alignment
- Text normalization options
- Sequential pattern matching
- Overall string composition

### Scoring Process

1. Normalizes input and output text:
   - Converts to lowercase if ignoreCase is true
   - Normalizes whitespace if ignoreWhitespace is true
...
Final score: Normalized similarity value between input and output strings
