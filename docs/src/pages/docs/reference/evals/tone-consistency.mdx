...
1. **Tone Consistency** (both input and output provided):
...
1. Analyzes tone patterns:
   ...
   - Calculates consistency/stability

2. Generates final metrics:
   - Determines overall tone score
   - Computes sentiment variance
   - Assesses confidence level

Final score: Mode-specific sentiment analysis
