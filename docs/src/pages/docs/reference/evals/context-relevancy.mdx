...
The metric evaluates context relevancy through:
- Individual statement extraction
- Query-statement relevance assessment
- Binary relevance classification
- Statement-level scoring
- Overall context evaluation
...
Final score: `relevant_statements / total_statements`
