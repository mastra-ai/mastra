...
The metric evaluates hallucination by identifying contradictions between the output and context:

1. Statement Analysis:
   - Extracts key factual statements from context
   - Evaluates output against each statement
   - Identifies direct conflicts and contradictions

2. Numerical Precision:
   - Scale of numbers involved
...
1. Evaluates context statements:
   - Extracts factual claims from context
   - Identifies key numerical values
   - Maps relationships between statements
...
Final score: `contradicted_statements / total_statements`
