...
1. Evaluates instruction compliance:
   - Assesses each instruction independently
   - Assigns binary scores (1: compliant, 0: non-compliant)
   - Documents reasons for non-compliance

2. Calculates overall alignment:
   - Sums compliant instructions
   - Computes compliance percentage
   - Scales to configured range

Final score: `compliant_instructions / total_instructions`
...
- 0.0: No instructions followed correctly
