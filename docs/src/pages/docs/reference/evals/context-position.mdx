...
1. Evaluates each context piece:
   - Determines relevance (yes/no verdict)
   - Considers position in sequence

2. Calculates position-weighted score:
   - Weight = 1/(position + 1)
   - Relevant pieces contribute their weight
