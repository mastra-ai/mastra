  ...
  content={[
    {
      ...
      description: "Record of Agent instances to register",
      isOptional: true,
      defaultValue: "{}",
    },
    {
      name: "networks",
      type: "Record<string, AgentNetwork>",
      description: "Record of AgentNetwork instances to register"
      isOptional: true,
      defaultValue: "{}",
    },
    {
    ...
    },
    {
      ...
      description: "MastraTTS to register. Structured as a key-value pair, with keys being the tts name and values being the tts instance.",
      isOptional: true,
      defaultValue: "{}",
    },
    {
