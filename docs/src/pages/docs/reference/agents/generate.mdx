...
- `output`: An object defining the expected structure of the output (JSON Schema or Zod schema)
- `experimental_output`: For structured output alongside text generation
- Additional options like `onStepFinish`, `maxSteps`, `threadId`, `resourceId`, `toolChoice`, etc.
      ...
      properties: [
        {
          ...
          parameters: [
            ...
            },
            {
              ...
              type: "MemoryConfig",
              isOptional: true,
              description: "Configuration options for memory management.",
            },
            {
              name: "toolChoice",
