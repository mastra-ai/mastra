      ...
      properties: [
        {
          ...
          parameters: [
            {
              name: "cohere",
              description: "Cohere reranking configuration",
              type: "{ method: 'cohere', config: { apiKey: string, model?: string } }",
            },
            {
              name: "llm",
              description: "LLM-based reranking configuration",
              type: "{ method: 'llm', config: { provider: string, name: string } }",
            }
          ]
        }
      ]
