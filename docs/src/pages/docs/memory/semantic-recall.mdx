...
Semantic recall is useful when users need to reference information from earlier in the conversation that would no longer be in the recent message history. This feature helps agents maintain context across longer interactions.
