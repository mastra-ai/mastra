...
<Tabs items={['Pg Vector', 'Pinecone', 'Qdrant', 'Chroma', 'Astra', 'LibSQL', 'Upstash', 'Cloudflare', 'OpenSearch']}>
  <Tabs.Tab>
...
- [Insert Embedding in OpenSearch](../../examples/rag/insert-embedding-in-opensearch.mdx)
