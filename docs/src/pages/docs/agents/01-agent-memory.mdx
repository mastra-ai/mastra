...
// 3. When user asks this question, the agent will see:
//    - The last 10 messages from the conversation
//    - Any relevant messages about search features from earlier
...
const memory = new Memory({
  options: {
    historySearch: {
      ...
      messageRange: {
        // Messages before and after each result
        before: 2,
        after: 2,
      },
    },
