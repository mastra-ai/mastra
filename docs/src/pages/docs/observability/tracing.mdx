...
Next.js applications can use either Vercel's OpenTelemetry setup or a custom instrumentation file. Both approaches require installing the OpenTelemetry API package and configuring an instrumentation file. 
