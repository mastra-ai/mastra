...
If you have an Anthropic Claude Max or OpenAI ChatGPT Plus subscription, run `/connect` and select **Sign in with an account**. The `/login` command opens the same flow.
