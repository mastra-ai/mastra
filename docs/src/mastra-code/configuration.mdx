...
If you have a supported provider subscription, run `/connect` and select **Sign in with an account**. The `/login` command opens the same flow.
...
| **Cursor** | Cursor subscription | Access to Cursor models through your account |
