...
Rotation walks accounts in the order they were added and wraps around; each account is tried at most once per request. When every account in the pool has been tried, the error surfaces normally.
