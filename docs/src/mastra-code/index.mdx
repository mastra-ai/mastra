...
Mastra Code is a terminal-based AI coding agent that never compacts. Built on Mastra's [AgentController](https://mastra.ai/reference/agent-controller/agent-controller-class), [Agent](https://mastra.ai/guides/agents/overview), and [Memory](https://mastra.ai/guides/memory/overview) primitives. It runs in your terminal, connects to thousands of AI models, and provides tools for reading, searching, editing, and executing code.
...
- **Long-running projects**: Mastra Code's persistent threads and [Observational Memory](https://mastra.ai/guides/memory/observational-memory) make it ideal for ongoing projects where context builds up over time.
