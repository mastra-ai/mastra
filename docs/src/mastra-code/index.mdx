...
<Steps>
  ...
  <StepItem>
    ...
    Observational Memory models default to **Auto** and follow the active main model's provider. Onboarding doesn't ask you to choose them. Use `/om` later to pin or reset the Observer and Reflector independently.
