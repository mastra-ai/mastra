...
`OMModel` accepts `"auto"` or a concrete model ID.
...
| `observerModelId` | `string` | — | Legacy concrete model for the observational memory observer |
| `reflectorModelId` | `string` | — | Legacy concrete model for the observational memory reflector |
| `observerModelSelection` | `OMModel` | `"auto"` | Automatic or explicit observer model selection |
| `reflectorModelSelection` | `OMModel` | `"auto"` | Automatic or explicit reflector model selection |
