...
export const Footer = () => {
  ...
  return (
    <footer
      ...
      className="flex z-30 bg-[#fafafa] dark:bg-[#0a0a0a] dark:border-t-[#222222] relative w-full border-t-[0.5px] flex-col px-0 items-center pt-8 lg:pt-[5rem] pb-24 md:pb-32 footer data-[state=false]:mt-8 "
    >
