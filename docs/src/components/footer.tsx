...
export const Footer = () => {
  ...
  return (
    <footer
      ...
      className="flex z-30 max-w-[1184px] mx-auto px-1 bg-[#050505] border-t-[#222222] relative w-full border-t-[0.5px] flex-col items-center pt-8 lg:pt-[5rem] pb-24 md:pb-32 footer data-[state=false]:mt-8 "
    >
