...
- [Skills (Build with AI)](/docs/getting-started/build-with-ai#mastra-skills)
- [Skills (Workspace)](/ecosystem/workspace/skills)
- [MCP Docs Server](/docs/getting-started/build-with-ai#mcp-docs-server)
- [Build with AI (Getting Started)](/docs/getting-started/build-with-ai)
