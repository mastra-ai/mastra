This lesson maps the scaffolded project to the code you'll actually edit. The Weather agent, tool, and workflow that come with `create-mastra` aren't just demo code. They're the clearest reference for how agents, tools, and workflows are structured in Mastra.
