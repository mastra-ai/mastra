---
title: "Google | 模型 | Mastra"
description: "在 Mastra 中使用 Google 模型。共 26 个模型。"
---
...
通过 Mastra 的模型路由器访问 26 个 Google 模型。身份验证使用 `GOOGLE_GENERATIVE_AI_API_KEY` 环境变量自动处理。

在 [Google 文档](https://ai.google.dev/gemini-api/docs/cn/docs/pricing) 中了解更多信息。
