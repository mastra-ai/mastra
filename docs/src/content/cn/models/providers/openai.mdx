---
title: "OpenAI | 模型 | Mastra"
description: "在 Mastra 中使用 OpenAI 模型。共 41 个模型。"
---
...
通过 Mastra 的模型路由器访问 41 个 OpenAI 模型。身份验证使用 `OPENAI_API_KEY` 环境变量自动处理。

在 [OpenAI 文档](https://platform.openai.com/docs/cn/docs/models) 中了解更多信息。
...
<PropertiesTable
  content={[
    ...
    },
    {
        "name": "store",
        "type": "boolean | null | undefined",
        "description": "Controls whether OpenAI stores your API requests for model training. Required to be \"false\" if your organization has zero data retention enabled. See: https://platform.openai.com/docs/cn/docs/guides/your-data#zero-data-retention",
        "isOptional": true
    },
    {
