---
title: "Poe | 模型 | Mastra"
description: "在 Mastra 中使用 Poe 模型。共 113 个模型。"
---
...
通过 Mastra 的模型路由器访问 113 个 Poe 模型。身份验证使用 `POE_API_KEY` 环境变量自动处理。

在 [Poe 文档](https://creator.poe.com/docs/cn/docs/external-applications/openai-compatible-api) 中了解更多信息。
...
Mastra 使用 OpenAI 兼容的 `/chat/completions` 端点。某些提供商特定功能可能不可用。查看 [Poe 文档](https://creator.poe.com/docs/cn/docs/external-applications/openai-compatible-api) 了解详情。
...
<ProviderModelsTable
  ...
  {
    "model": "poe/cerebras/llama-3.3-70b-cs",
    "imageInput": false,
    "audioInput": false,
    "videoInput": false,
    "toolUsage": false,
  ...
  {
    "model": "poe/cerebras/qwen3-235b-2507-cs",
    "imageInput": false,
    "audioInput": false,
    "videoInput": false,
    "toolUsage": true,
  ...
  {
    "model": "poe/cerebras/qwen3-32b-cs",
    "imageInput": false,
    "audioInput": false,
    "videoInput": false,
    "toolUsage": true,
