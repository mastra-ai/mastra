---
title: "Cloudflare AI Gateway | 模型 | Mastra"
description: "在 Mastra 中使用 Cloudflare AI Gateway 模型。共 65 个模型。"
---
...
通过 Mastra 的模型路由器访问 65 个 Cloudflare AI Gateway 模型。身份验证使用 `CLOUDFLARE_API_TOKEN` 环境变量自动处理。

在 [Cloudflare AI Gateway 文档](https://developers.cloudflare.com/ai-gateway/) 中了解更多信息。
...
Mastra 使用 OpenAI 兼容的 `/chat/completions` 端点。某些提供商特定功能可能不可用。查看 [Cloudflare AI Gateway 文档](https://developers.cloudflare.com/ai-gateway/) 了解详情。
