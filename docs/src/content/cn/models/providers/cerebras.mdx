---
title: "Cerebras | 模型 | Mastra"
description: "在 Mastra 中使用 Cerebras 模型。共 3 个模型。"
---
...
通过 Mastra 的模型路由器访问 3 个 Cerebras 模型。身份验证使用 `CEREBRAS_API_KEY` 环境变量自动处理。

在 [Cerebras 文档](https://inference-docs.cerebras.ai/models/overview) 中了解更多信息。
