---
title: "Groq | 模型 | Mastra"
description: "在 Mastra 中使用 Groq 模型。共 9 个模型。"
---
...
通过 Mastra 的模型路由器访问 9 个 Groq 模型。身份验证使用 `GROQ_API_KEY` 环境变量自动处理。

在 [Groq 文档](https://console.groq.com/docs/cn/docs/models) 中了解更多信息。
