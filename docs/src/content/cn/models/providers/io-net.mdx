---
title: "IO.NET | 模型 | Mastra"
description: "在 Mastra 中使用 IO.NET 模型。共 17 个模型。"
---
...
通过 Mastra 的模型路由器访问 17 个 IO.NET 模型。身份验证使用 `IOINTELLIGENCE_API_KEY` 环境变量自动处理。

在 [IO.NET 文档](https://io.net/docs/cn/docs/guides/intelligence/io-intelligence) 中了解更多信息。
...
Mastra 使用 OpenAI 兼容的 `/chat/completions` 端点。某些提供商特定功能可能不可用。查看 [IO.NET 文档](https://io.net/docs/cn/docs/guides/intelligence/io-intelligence) 了解详情。
