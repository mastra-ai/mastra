---
title: "Anthropic | 模型 | Mastra"
description: "在 Mastra 中使用 Anthropic 模型。共 22 个模型。"
---
...
通过 Mastra 的模型路由器访问 22 个 Anthropic 模型。身份验证使用 `ANTHROPIC_API_KEY` 环境变量自动处理。

在 [Anthropic 文档](https://docs.anthropic.com/en/docs/cn/docs/about-claude/models) 中了解更多信息。
