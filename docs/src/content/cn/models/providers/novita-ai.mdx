---
title: "NovitaAI | 模型 | Mastra"
description: "在 Mastra 中使用 NovitaAI 模型。共 81 个模型。"
---
...
通过 Mastra 的模型路由器访问 81 个 NovitaAI 模型。身份验证使用 `NOVITA_API_KEY` 环境变量自动处理。

在 [NovitaAI 文档](https://novita.ai/docs/cn/docs/guides/introduction) 中了解更多信息。
...
Mastra 使用 OpenAI 兼容的 `/chat/completions` 端点。某些提供商特定功能可能不可用。查看 [NovitaAI 文档](https://novita.ai/docs/cn/docs/guides/introduction) 了解详情。
