---
title: "Vertex"
description: "通过 AI SDK 使用 Vertex 模型。"
---
...
Vertex 可通过 AI SDK 使用。安装提供商包以在 Mastra 中使用其模型。

有关详细的提供商特定文档，请参阅 [AI SDK Vertex 提供商文档](https://ai-sdk.dev/providers/ai-sdk-providers/google-vertex)。
