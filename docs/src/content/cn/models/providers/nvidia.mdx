---
title: "Nvidia | 模型 | Mastra"
description: "在 Mastra 中使用 Nvidia 模型。共 70 个模型。"
---
...
通过 Mastra 的模型路由器访问 70 个 Nvidia 模型。身份验证使用 `NVIDIA_API_KEY` 环境变量自动处理。

在 [Nvidia 文档](https://docs.api.nvidia.com/nim/) 中了解更多信息。
...
Mastra 使用 OpenAI 兼容的 `/chat/completions` 端点。某些提供商特定功能可能不可用。查看 [Nvidia 文档](https://docs.api.nvidia.com/nim/) 了解详情。
