---
title: "Mistral | 模型 | Mastra"
description: "在 Mastra 中使用 Mistral 模型。共 26 个模型。"
---
...
通过 Mastra 的模型路由器访问 26 个 Mistral 模型。身份验证使用 `MISTRAL_API_KEY` 环境变量自动处理。

在 [Mistral 文档](https://docs.mistral.ai/getting-started/models/) 中了解更多信息。
