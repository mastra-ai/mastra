---
title: "参考文档: Koa 适配器 | 服务器"
description: "@mastra/koa 服务器适配器的 API 参考。"
packages:
  - "@mastra/koa"
---
...
`@mastra/koa` 包提供了使用 [Koa](https://koajs.com) 运行 Mastra 的服务器适配器。
...
- [Koa 适配器](https://github.com/mastra-ai/mastra/tree/main/examples/server-koa-adapter) - 基本 Koa 服务器设置
