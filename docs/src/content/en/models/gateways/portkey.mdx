...
Portkey is an AI gateway that adds production-grade features to your Mastra agents including observability, reliability, caching, guardrails, and access to 1600+ LLMs through a unified interface.

Access models from OpenAI, Anthropic, Google, AWS Bedrock, Azure, Mistral, and 200+ other providers while gaining complete visibility and control over your AI infrastructure.

Learn more in the [Portkey documentation for Mastra](https://portkey.ai/docs/integrations/agents/mastra).
...
Check the [Portkey documentation for Mastra](https://portkey.ai/docs/integrations/agents/mastra) for complete setup instructions.
...
Built-in fallbacks, automatic retries, load balancing, and timeouts keep your agents running reliably. Route requests across multiple providers and API keys to avoid rate limits and outages.
...
- [Portkey documentation for Mastra](https://portkey.ai/docs/integrations/agents/mastra) - Complete setup and implementation guide
