...
The Azure gateway works without Management API credentials—you just need to know your deployment names.
...
const agent = new Agent({
  ...
  model: "azure/my-gpt4-deployment"  // Use your Azure deployment name (autocompleted in dev mode)
});
