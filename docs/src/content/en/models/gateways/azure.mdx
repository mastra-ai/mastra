...
When you configure optional Management API credentials (see below), IDE autocomplete will show your actual deployment names.
:::
...
For IDE autocomplete with your deployment names, add Management API credentials and run dev mode:
...
const agent = new Agent({
  ...
  model: "azure/my-gpt4-deployment"  // Your deployment name (autocompleted if credentials provided and running in dev mode)
});
