...
<Callout type="info">
Mastra uses the OpenAI-compatible `/chat/completions` endpoint. Some provider-specific features may not be available. Check the [Google documentation](https://ai.google.dev/gemini-api/docs/pricing) for details.
</Callout>
