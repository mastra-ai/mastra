...
description: "Use Synthetic models with Mastra. 20 models available."
---
...
Access 20 Synthetic models through Mastra's model router. Authentication is handled automatically using the `SYNTHETIC_API_KEY` environment variable.
