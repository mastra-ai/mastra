...
description: "Use OpenAI models with Mastra. 25 models available."
---
...
Access 25 OpenAI models through Mastra's model router. Authentication is handled automatically using the `OPENAI_API_KEY` environment variable.
