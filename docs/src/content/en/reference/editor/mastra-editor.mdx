...
See the [Editor overview](/guides/editor/overview) for an introduction to what the editor does.
...
The `builder` field enables the [Agent Builder](/guides/agent-builder/overview), a browser-based UI for creating and editing stored agents. See:

- [Agent Builder overview](/guides/agent-builder/overview): Concepts and getting started.
...
See the [Agent Builder overview](/guides/agent-builder/overview#prerequisites) for the full setup checklist.
