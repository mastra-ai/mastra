    ...
    properties: [
      {
        ...
        parameters: [
          {
            name: 'create',
            type: '(input: StorageCreateMCPServerInput) => Promise<MCPServerRegistryEntry>',
            description: 'Create a new stored MCP server configuration and return a hydrated server instance.',
          },
          {
            name: 'getById',
            type: '(id: string, options?: GetByIdOptions) => Promise<MCPServerRegistryEntry | null>',
            description: 'Return a hydrated MCP server for a given id.',
          },
          {
            name: 'update',
            type: '(input: StorageUpdateMCPServerInput) => Promise<MCPServerRegistryEntry>',
