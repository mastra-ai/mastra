...
Restoring a historical prompt version creates a new draft. It doesn't replace the active version until that draft is published. See [Editor versioning](/docs/editor/overview#versioning) for the shared lifecycle.
