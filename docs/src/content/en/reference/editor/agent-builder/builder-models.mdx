...
See [Model policy](/guides/agent-builder/model-policy) for concepts and worked examples.
...
- [Model policy](/guides/agent-builder/model-policy): Concept and worked examples.
