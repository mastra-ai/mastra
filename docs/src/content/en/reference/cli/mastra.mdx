...
```bash
mastra api factory work-item transition 11111111-1111-4111-8111-111111111111 22222222-2222-4222-8222-222222222222 '{"board":"work","stage":"planning","requestId":"00000000-0000-4000-8000-000000000000","cause":"manual","expectedRevision":1}'
```
