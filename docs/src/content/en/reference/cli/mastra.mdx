...
See [Import traces into Mastra Platform](/docs/observability/tracing/import-traces) for the complete workflow, data mapping, local-file lifecycle, and limits.
