...
Organization, project, and environment are resolved in this order:

1. Environment variable (`MASTRA_ORG_ID`, `MASTRA_PROJECT_ID`)
1. CLI flag (`--org`, `--project`, `--env`)
1. `.mastra-project.json` config file
1. Current organization from stored credentials
