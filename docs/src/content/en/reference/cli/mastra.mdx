...
If you're deploying to a [serverless platform](/ecosystem/deployment-patterns/cloud-providers) you need to install the correct deployer to receive the correct output in `.mastra`.
...
See [Workers](/ecosystem/deployment-patterns/workers) for deployment topologies and configuration.
