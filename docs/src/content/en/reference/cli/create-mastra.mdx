...
```bash copy
npx create-mastra@^0 my-mastra-project -- --template coding-agent
```
...
```bash copy
yarn dlx create-mastra@^0 --template coding-agent
```
...
```bash copy
pnpm create mastra@^0 --template coding-agent
```
...
```bash copy
bun create mastra@^0 --template coding-agent
```
...
```bash
npx create-mastra@^0 my-mastra-project -- --template mastra-ai/template-coding-agent
```
...
```bash copy
MASTRA_TELEMETRY_DISABLED=1 npx create-mastra@^0
```
