...
Register classifiers on the `Mastra` instance to share them across your application. Registration wires the classifier to Mastra's logger and observability, and makes it retrievable by key or ID.
