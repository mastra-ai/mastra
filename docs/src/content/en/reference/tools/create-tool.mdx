...
<PropertiesTable
  ...
  },
  {
    ...
    description:
      "A schema defining the expected input parameters for the tool's `execute` function. You can pass a Zod schema or a plain JSON Schema object.",
    isOptional: true,
  },
  {
    name: 'outputSchema',
    type: 'Zod schema | JSON Schema',
    description:
      "A schema defining the expected output structure of the tool's `execute` function. You can pass a Zod schema or a plain JSON Schema object.",
    isOptional: true,
  },
  {
    name: 'toModelOutput',
  ...
  },
  {
    ...
    type: 'Zod schema | JSON Schema',
    description:
      'A schema for validating request context values. When provided, the context is validated before execute() runs, returning an error object if validation fails.',
    isOptional: true,
  },
  {
    name: 'execute',
