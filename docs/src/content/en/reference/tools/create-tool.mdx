...
<PropertiesTable
  ...
  },
  {
    ...
    type: 'string',
    description:
      'A human-readable display name for the tool. It is not sent to the model. Chat UIs use it to label tool calls, and MCP clients receive it as the tool `title`.',
    isOptional: true,
  },
  {
    name: 'description',
