...
When used inside an [AgentController](/docs/agent-controller/overview), plan approval triggers an automatic mode switch from the planning mode to the default execution mode. See [Modes](/docs/agent-controller/overview#switch-modes-and-models) for details.
