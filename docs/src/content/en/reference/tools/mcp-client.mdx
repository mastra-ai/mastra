...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      isOptional: true,
      description: "For HTTP servers: OAuth authentication provider for automatic token refresh and OAuth flow management. Use MastraOAuthClientProvider for a ready-to-use implementation.",
    },
    {
...
For connecting to MCP servers that require OAuth authentication per the [MCP Auth Specification](https://modelcontextprotocol.io/specification/2025-06-18/basic/authorization), use the `MastraOAuthClientProvider`:
