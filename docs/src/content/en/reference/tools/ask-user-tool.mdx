        ...
        parameters: [
          {
            ...
            type: 'string',
            description:
              'Short display text for this option (1-5 words). This value is returned to the model when selected.',
          },
          {
            name: 'description',
            type: 'string',
...
All types, the tool, and `formatQuestionAnswer` are exported from `@mastra/core/tools`:

```typescript
import { askUserTool, formatQuestionAnswer } from '@mastra/core/tools'
