...
See the [Workspace documentation](/ecosystem/workspace/overview) for implementation details.
...
Visit the [Authentication documentation](/ecosystem/auth-providers) to learn more.
