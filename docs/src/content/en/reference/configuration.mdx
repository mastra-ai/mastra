...
|----------|------|---------|-------------|
| `swaggerUI` | `boolean` | `false` | Enable Swagger UI at `/swagger-ui` for interactive API exploration |
...
Port the Mastra development server binds to.
