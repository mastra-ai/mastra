...
A listed provider with no connection in the project yet is skipped with a one-time warning and is included automatically once a connection is attached. Without `integrations`, every connected provider is included.
