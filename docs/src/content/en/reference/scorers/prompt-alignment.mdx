---
title: "Reference: Prompt Alignment Scorer | Scorers"
...
- [Answer Relevancy Scorer](/reference/v0/scorers/answer-relevancy) - Evaluates query-response relevance
- [Faithfulness Scorer](/reference/v0/scorers/faithfulness) - Measures context groundedness
- [Tool Call Accuracy Scorer](/reference/v0/scorers/tool-call-accuracy) - Evaluates tool selection
