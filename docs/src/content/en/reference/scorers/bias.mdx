---
title: "Reference: Bias Scorer | Scorers"
...
For more details on `runExperiment`, see the [runExperiment reference](/reference/v0/scorers/run-experiment).

To add this scorer to an agent, see the [Scorers overview](/docs/v0/scorers/overview#adding-scorers-to-agents) guide.
