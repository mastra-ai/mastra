---
title: "Reference: Context Precision Scorer | Scorers"
...
- [Answer Relevancy Scorer](/reference/v0/scorers/answer-relevancy) - Evaluates if answers address the question
