...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      required: true,
      description: "An array of records. This should contain user messages or the reference text to compare against.",
    },
    {
      name: "output",
      type: "Record<string, any>",
      required: true,
      description: "A record. This should contain the text to evaluate for similarity.",
    },
    {
