---
title: "Reference: runExperiment | Scorers"
...
- [createScorer()](/reference/v0/scorers/create-scorer) - Create custom scorers for experiments
- [MastraScorer](/reference/v0/scorers/mastra-scorer) - Learn about scorer structure and methods
- [Custom Scorers](/docs/v0/scorers/custom-scorers) - Guide to building evaluation logic
- [Scorers Overview](/docs/v0/scorers/overview) - Understanding scorer concepts
