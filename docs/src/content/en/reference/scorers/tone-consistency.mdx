...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      required: true,
      description: "An array of records. This should contain user messages or the text to analyze for tone.",
    },
    {
      name: "output",
      type: "Record<string, any>",
      required: true,
      description: "A record. This should contain the reference text for tone comparison (empty string for stability analysis).",
    },
    {
