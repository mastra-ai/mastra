...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      required: true,
      description: "An array of records. This should contain user messages or the original text to be covered.",
    },
    {
      name: "output",
      type: "Record<string, any>",
      required: true,
      description: "A record. This should contain the LLM's response to evaluate for completeness.",
    },
    {
