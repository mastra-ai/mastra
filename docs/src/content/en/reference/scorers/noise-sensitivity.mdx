---
title: "Reference: Noise Sensitivity Scorer (CI/Testing Only) | Scorers"
...
- [Running in CI](/docs/v0/scorers/overview) - Setting up scorers in CI/CD pipelines
- [Hallucination Scorer](/reference/v0/scorers/hallucination) - Evaluates fabricated content
- [Answer Relevancy Scorer](/reference/v0/scorers/answer-relevancy) - Measures response focus
- [Custom Scorers](/docs/v0/scorers/custom-scorers) - Creating your own evaluation metrics
