---
title: "Reference: Context Relevance Scorer | Scorers"
...
- [Context Precision Scorer](/reference/v0/scorers/context-precision) - Evaluates context ranking using MAP
- [Faithfulness Scorer](/reference/v0/scorers/faithfulness) - Measures answer groundedness in context
