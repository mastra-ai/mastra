...
description: "Use WebhookSignalProvider for push-based signals that route incoming webhook payloads to subscribed agent threads and pending signal handlers."
packages:
  - "@mastra/core"
---
