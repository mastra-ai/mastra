...
<PropertiesTable
  ...
  },
  {
    ...
    isOptional: true,
    description:
      'The span ID of the root agent run span. When using the Braintrust exporter, this corresponds to the Braintrust root span ID which can be used for efficient queries against the Braintrust API.',
  },
]}
/>
