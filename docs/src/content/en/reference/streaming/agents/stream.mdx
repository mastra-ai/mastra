      ...
      properties: [
        ...
        },
        {
          parameters: [
            {
              name: "contextFilter",
              type: "(context: ContextFilterContext) => MastraDBMessage[] | Promise<MastraDBMessage[]>",
              isOptional: true,
              description: "Callback function for filtering messages before passing them to sub-agents. Receives the full message list and context, returns filtered messages to share with the sub-agent.",
            },
          ],
        },
      ],
