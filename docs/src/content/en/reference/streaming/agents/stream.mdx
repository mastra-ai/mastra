    ...
    properties: [
      {
        ...
        parameters: [
          ...
          },
          {
            ...
            isOptional: true,
            description:
              "Signal object that allows you to abort the agent's execution. When the signal is aborted, all ongoing operations are terminated, including in-flight subagent runs. Transcript content available when the aborted run is saved remains in configured memory.",
          },
          {
            name: 'activeTools',
