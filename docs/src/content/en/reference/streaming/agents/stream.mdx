...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      defaultValue: "false",
      description:
        "Include raw chunks of type 'raw' from the provider (default: false). This allows access to cutting-edge provider features not yet wrapped by the Mastra and AI SDK.",
    },
    {
