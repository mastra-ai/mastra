    ...
    properties: [
      {
        ...
        parameters: [
          ...
          },
          {
            ...
            isOptional: true,
            description:
              "Signal object that allows you to abort the agent's execution. When the signal is aborted, all ongoing operations are terminated, including in-flight subagent runs. Transcript content submitted or produced before termination remains in configured memory, while output produced by a provider after cancellation is excluded.",
          },
          {
            name: 'activeTools',
