    ...
    properties: [
      {
        ...
        parameters: [
          ...
          },
          {
            ...
            isOptional: true,
            description:
              "Signal object that allows you to abort the agent's execution. When the signal is aborted, all ongoing operations will be terminated, including in-flight work inside delegated subagents when using a supervisor pattern.",
          },
          {
            name: 'activeTools',
