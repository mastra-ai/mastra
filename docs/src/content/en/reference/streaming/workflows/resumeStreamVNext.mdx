...
<PropertiesTable
  content={[
    ...
    {
<<<<<<<< HEAD:docs/src/content/en/reference/streaming/workflows/resumeStreamVNext.mdx
      name: "step",
...
>>>>>>>> 41743cd05b61:docs/src/content/en/reference/streaming/workflows/streamVNext.mdx
      isOptional: true,
    },
  ]}
/>
