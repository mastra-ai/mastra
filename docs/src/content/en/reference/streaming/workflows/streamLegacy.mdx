---
title: "Reference: Run.streamLegacy() | Workflows | Mastra Docs"
description: Documentation for the `Run.streamLegacy()` method in workflows, which allows you to monitor the execution of a workflow run as a stream.
---

# Run.streamLegacy()

The `.streamLegacy()` method allows you to monitor the execution of a workflow run, providing real-time updates on the status of steps.
