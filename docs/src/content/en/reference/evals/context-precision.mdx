...
For more details on `runEvals`, see the [runEvals reference](./run-evals).
...
- [Answer Relevancy Scorer](./answer-relevancy) - Evaluates if answers address the question
- [Faithfulness Scorer](./faithfulness) - Measures answer groundedness in context
