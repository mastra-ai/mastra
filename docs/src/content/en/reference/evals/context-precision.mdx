...
To add this scorer to an agent, see the [Scorers overview](/guides/evals/overview#adding-scorers-to-agents) guide.
...
- [Custom Scorers](/guides/evals/custom-scorers): Creating your own evaluation metrics
