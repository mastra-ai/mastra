...
<PropertiesTable
  ...
  },
  {
    ...
    description:
      'Present when a step returned notScorable(). Carries the step name and optional reason. Remaining steps are skipped and no score is produced. See the notScorable() reference (optional).',
  },
  {
    name: 'reason',
    type: 'string',
