...
- [Answer Relevancy Scorer](./answer-relevancy) - Evaluates query-response relevance
- [Faithfulness Scorer](./faithfulness) - Measures context groundedness
- [Tool Call Accuracy Scorer](./tool-call-accuracy) - Evaluates tool selection
