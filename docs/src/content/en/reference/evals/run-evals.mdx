...
<PropertiesTable
  ...
  },
  {
    ...
    type: 'number',
    description:
      'Score at or above this value passes. Must be between 0 and 1. If the average score across data items is below this threshold, the verdict includes it as a miss.',
  },
]}
/>
