...
<PropertiesTable
  ...
  },
  {
    ...
    type: 'Trajectory',
    description:
      'Expected trajectory for trajectory scoring. Passed to trajectory scorers as `run.expectedTrajectory`. Overrides the static `expectedTrajectory` in scorer constructors.',
    isOptional: true,
  },
  {
    name: 'requestContext',
...
<PropertiesTable
  ...
  },
  {
    ...
    type: 'MastraScorer[]',
    description:
      'Scorers that receive a pre-extracted Trajectory object. The pipeline automatically converts agent messages to a Trajectory before passing to these scorers.',
    isOptional: true,
  },
]}
/>
...
<PropertiesTable
  ...
  },
  {
    ...
    type: 'MastraScorer[]',
    description:
      'Scorers that receive a pre-extracted Trajectory from the workflow step results and execution path. The pipeline automatically converts step results to a Trajectory before passing to these scorers.',
    isOptional: true,
  },
]}
/>
