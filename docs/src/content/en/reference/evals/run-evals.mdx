...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      description: "Model settings applied to all LLM judge calls (e.g., temperature, maxTokens, topP).",
      isOptional: true,
    },
    {
      name: "temperatures",
      type: "number[]",
      description: "Run the scorer multiple times with different temperature values. Useful for getting varied opinions from the LLM judge. Each temperature run creates a separate score entry.",
      isOptional: true,
    },
  ]}
/>
