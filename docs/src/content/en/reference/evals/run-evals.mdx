...
- [Multi-turn evals](/guides/evals/multi-turn): Conceptual guide to multi-turn evaluation
- [Gates and Verdicts](/guides/evals/gates-and-verdicts): Conceptual guide to severity semantics
...
- [Custom Scorers](/guides/evals/custom-scorers): Guide to building evaluation logic
- [Scorers Overview](/guides/evals/overview): Understanding scorer concepts
