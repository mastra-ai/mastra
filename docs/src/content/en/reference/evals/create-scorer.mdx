    ...
    properties: [
      {
        ...
        parameters: [
          ...
          },
          {
            ...
            isOptional: true,
            description:
              'Maximum number of times error processors can retry one judge generation. The runtime defaults to 3 when errorProcessors are configured without this value. Set it explicitly to bound the retry budget.',
          },
        ],
      },
    ],
