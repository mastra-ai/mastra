...
description: "Use tool-call accuracy scorers to evaluate whether an LLM selected the expected tools, either from recorded calls or against available tool definitions."
packages:
  - "@mastra/evals"
---
