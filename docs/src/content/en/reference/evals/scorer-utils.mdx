...
```typescript
import { extractTrajectory, extractWorkflowTrajectory } from '@mastra/core/evals'
```
...
const result = compareTrajectories(actualTrajectory, expectedTrajectory, {
  strictOrder: false,
  compareStepData: false,
