    ...
    properties: [
      {
        ...
        parameters: [
          ...
          },
          {
            ...
            isOptional: true,
            description:
              'Per-invocation selectors for the root agent and delegated sub-agents. Dependency selectors merge on top of Mastra instance defaults and propagate through delegation. The root `self` selector is consumed by the current execution and does not propagate. Requires the editor package. See [Editor versioning](/reference/editor/versioning#sub-agent-versioning).',
            properties: [
              {
                type: 'VersionOverrides',
                parameters: [
                  {
                    ...
                    isOptional: true,
                    description:
                      'Select the root agent for this execution. Pass exactly one `versionId`, `label`, or `status`.',
                  },
                  {
                    name: 'agents',
                    ...
                    properties: [
                      {
                        ...
                        parameters: [
                          ...
                          },
                          {
                            ...
                            type: 'string',
                            isOptional: true,
                            description: 'Resolve a computed or custom version label.',
                          },
                          {
                            name: 'status',
                  ...
                  },
                  {
                    ...
                    type: "'draft' | 'published'",
                    isOptional: true,
                    description: 'Fallback publication status for delegated agents without an explicit selector.',
                  },
                ],
              },
            ],
