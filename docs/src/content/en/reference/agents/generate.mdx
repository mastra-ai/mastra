    ...
    properties: [
      {
        ...
        parameters: [
          ...
          },
          {
            ...
            isOptional: true,
            description:
              'Callback fired when a thread title is generated and persisted to storage. Only fires when `generateTitle` is enabled in memory options and the thread has no existing title.',
          },
          {
            name: 'telemetry',
