                ...
                parameters: [
                  {
                    ...
                    isOptional: true,
                    description:
                      'Custom instructions for producing the structured output. Used as the structuring agent instructions when `model` is set, and injected in place of the generated schema instruction when `jsonPromptInjection` is enabled.',
                  },
                ],
              },
              {
