...
description: "Use Agent.getMemory() to retrieve the memory system configured for an agent, including request-context resolution when memory is supplied dynamically."
packages:
  - "@mastra/core"
---
