...
- **Current APIs**: The current APIs support a `format` option that allows you to choose between Mastra's native format, AI SDK v5, and other frontends like `copilotkit` and `assistant-ui`:
