...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      isOptional: true,
      description: "Experimental structured output schema for generation alongside tool calls.",
    },
    {
      name: "instructions",
      type: "string",
    ...
    },
    {
      ...
      type: "MemoryConfig",
      isOptional: true,
      description: "Deprecated. Use memory.options instead. Memory configuration for conversation persistence and retrieval.",
    },
    {
      name: "onFinish",
