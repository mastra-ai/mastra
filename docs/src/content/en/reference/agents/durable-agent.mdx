...
Wraps an `Agent` with fire-and-forget durable execution on the built-in workflow engine. Use this when you want to start a run and stream its events without holding the call open.
