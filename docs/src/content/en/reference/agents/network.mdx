...
The `.network()` method enables multi-agent collaboration and routing. This method accepts messages and optional streaming options.
...
<PropertiesTable
  content={[
    {
      name: "stream",
      type: "ReadableStream<NetworkChunkType>",
      description: "A stream that returns network chunks",
    },
  ]}
/>