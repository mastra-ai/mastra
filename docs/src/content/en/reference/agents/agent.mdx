...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      isOptional: true,
      description:
        "Input processors that run before messages are sent to the language model. These middleware components can intercept, modify, validate, or filter messages. Can be a static array or a function that returns processors based on runtime context.",
    },
    {
