            ...
            properties: [
              {
                ...
                parameters: [
                  ...
                  {
                    name: 'streamOptions',
                    type: 'AgentExecutionOptions | (() => Promise<AgentExecutionOptions>)',
                    isOptional: true,
                    description:
                      'Options for a new stream, or request context for persistence. An async factory defers setup until Mastra starts the stream or persists the input; active delivery and discard do not evaluate it. Mastra uses the top-level `resourceId` and `threadId` for memory context.',
                  },
                  {
                    name: 'attributes',
                    type: 'Record<string, string | number | boolean>',
                ...
                parameters: [
                  {
                    ...
                    isOptional: true,
                    description:
                      'Options for the stream that starts when an immediate notification wakes an idle thread. An async factory defers setup until the stream starts, without running during active delivery.',
                  },
                ],
              },
            ],
