...
**Deprecated**: This method is deprecated and only works with V1 models. For V2 models, use the new [`.generate()`](./generate) method instead. See the [migration guide](/guides/v0/migrations/vnext-to-standard-apis) for details on upgrading.
...
The new `.generate()` method offers enhanced capabilities including AI SDK v5 compatibility, better structured output handling, and improved streaming support. See the [migration guide](/guides/v0/migrations/vnext-to-standard-apis) for detailed migration instructions.
...
- [Migration Guide](/guides/v0/migrations/vnext-to-standard-apis)
