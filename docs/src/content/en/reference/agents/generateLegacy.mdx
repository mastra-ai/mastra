...
The new `.generate()` method offers enhanced capabilities including AI SDK v5+ compatibility, better structured output handling, and improved streaming support. See the [migration guide](/reference/migrations/vnext-to-standard-apis) for detailed migration instructions.
