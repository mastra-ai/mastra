---
title: "Reference: .skill() | Agents"
description: "API reference for the Agent .skill() method, which retrieves a specific skill by name."
packages:
  - "@mastra/core"
---
...
When both agent-level skills and workspace skills are configured, `.skill()` searches the merged set. Agent-level skills take precedence on name conflicts.
