...
name: "sessionToken",
type: "string",
description: "AWS session token for temporary credentials. Required when using SSO, AssumeRole, container credentials, or any other temporary credential provider.",
isOptional: true,
},
{
name: "endpoint",
