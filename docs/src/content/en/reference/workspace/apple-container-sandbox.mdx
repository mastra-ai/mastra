...
Requires a host that can run Apple's `container` CLI. Start the container system before using the provider:
...
<PropertiesTable
  ...
  },
  {
    name: 'tmpfs',
    type: 'string[]',
    description: 'tmpfs mount specs passed as `--tmpfs`.',
    isOptional: true,
  },
  {
    name: 'dns',
  ...
  },
  {
    ...
    type: 'boolean',
    description: 'Delete the Apple container when the sandbox is destroyed. When false, destroy stops the container instead.',
    isOptional: true,
    defaultValue: 'true',
  },
  {
