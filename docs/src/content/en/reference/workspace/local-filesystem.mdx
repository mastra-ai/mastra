...
Returns a description of how paths work in this filesystem. Used in tool descriptions. When `instructions` is a function, the auto-generated text and optional `requestContext` are passed to it.
