...
<PropertiesTable
  ...
  },
  {
    ...
    type: 'boolean',
    description:
      'When true, all file operations are restricted to stay within basePath. Prevents path traversal attacks and symlink escapes. See [containment](/ecosystem/workspace/filesystem#containment).',
    isOptional: true,
    defaultValue: 'true',
  },
  {
