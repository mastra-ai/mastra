...
<PropertiesTable
  content={[
    ...
    {
      name: "instructions",
      type: "string | ((opts: { auto: string; requestContext?: RequestContext }) => string)",
      description: "Custom instructions that override or extend the auto-generated instructions returned by `getInstructions()`. Pass a string to fully replace the auto-generated instructions (pass an empty string to suppress instructions entirely). Pass a function to receive the auto-generated instructions and return a modified version, with optional access to the current request context.",
      isOptional: true,
    },
  ]}
/>
...
Returns a description of how this sandbox works. Used in tool descriptions. When `instructions` is a function, the auto-generated text and optional `requestContext` are passed to it.
  ...
  content={[
    {
      ...
      type: "RequestContext",
      description: "Optional request context, passed through to function-form instructions",
      isOptional: true,
    },
  ]}
/>
