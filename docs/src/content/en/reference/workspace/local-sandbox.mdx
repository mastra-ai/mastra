...
<PropertiesTable
  content={[
    ...
    },
    {
      name: "instructions",
      type: "string",
      description: "Custom instructions string that overrides the auto-generated instructions returned by `getInstructions()`. Pass an empty string to suppress instructions entirely.",
      isOptional: true,
    },
  ]}
/>
