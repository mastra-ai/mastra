...
<PropertiesTable
  ...
  },
  {
    name: 'instance',
    type: 'Sandbox',
    description: 'Deprecated alias for daytona. Throws SandboxNotReadyError if the sandbox has not been started.',
  },
  {
    name: 'processes',
...
The `daytona` getter throws `SandboxNotReadyError` if the sandbox hasn't been started yet. The `instance` getter is a deprecated alias.
