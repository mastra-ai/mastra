...
Returns combined instructions from static or dynamic filesystem and sandbox providers. Use this when the workspace uses resolver-backed providers.
...
<PropertiesTable
  content={[
  {
    ...
    type: 'RequestContext',
    description:
      'Passed to dynamic filesystem or sandbox resolvers, and forwarded to provider `instructions` functions.',
    isOptional: true,
  },
]}
/>
