...
Use `PlatformSandbox` when your agent runs on a Mastra Platform deployment and you want the sandbox to be provisioned and managed by the platform. For self-hosted Railway sandboxes, see [`RailwaySandbox`](/ecosystem/workspace-integrations/railway-sandbox). For a local sandbox during development, see [`LocalSandbox`](/reference/workspace/local-sandbox).
...
- [RailwaySandbox reference](/ecosystem/workspace-integrations/railway-sandbox)
