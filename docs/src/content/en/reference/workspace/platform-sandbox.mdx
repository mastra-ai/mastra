...
<PropertiesTable
  ...
  {
    name: 'template',
    type: 'SerializedSandboxTemplate | (() => SerializedSandboxTemplate | undefined | Promise<SerializedSandboxTemplate | undefined>)',
    description:
      'Providerless definition or lazy resolver built before a fresh sandbox provision. Resolution and build failures fall back to the provider default. Cannot be combined with templateId or templateDefinition.',
    isOptional: true,
  },
  {
    name: 'templateId',
