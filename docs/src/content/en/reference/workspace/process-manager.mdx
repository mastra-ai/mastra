...
[`BlaxelSandbox`](/ecosystem/workspace-vendors/blaxel-sandbox), [`DaytonaSandbox`](/ecosystem/workspace-vendors/daytona-sandbox), [`E2BSandbox`](/ecosystem/workspace-vendors/e2b-sandbox), [`ModalSandbox`](/ecosystem/workspace-vendors/modal-sandbox), and [`LocalSandbox`](/reference/workspace/local-sandbox) all include built-in process managers. You don't need to instantiate this class directly unless you're building a custom sandbox provider.
...
- [E2BSandbox reference](/ecosystem/workspace-vendors/e2b-sandbox)
- [DaytonaSandbox reference](/ecosystem/workspace-vendors/daytona-sandbox)
