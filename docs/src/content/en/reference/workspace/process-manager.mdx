...
[`BlaxelSandbox`](/ecosystem/workspace-integrations/blaxel-sandbox), [`DaytonaSandbox`](/ecosystem/workspace-integrations/daytona-sandbox), [`E2BSandbox`](/ecosystem/workspace-integrations/e2b-sandbox), [`ModalSandbox`](/ecosystem/workspace-integrations/modal-sandbox), and [`LocalSandbox`](/reference/workspace/local-sandbox) all include built-in process managers. You don't need to instantiate this class directly unless you're building a custom sandbox provider.
...
- [Sandbox](/guides/workspace/sandbox)
