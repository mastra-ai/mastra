...
See [Advanced trace queries](/reference/observability/tracing/trace-query) for request fields, predicates, grouping, cursor pagination, response shapes, and errors.
