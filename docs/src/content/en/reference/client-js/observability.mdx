...
See [Advanced trace queries](/reference/observability/tracing/trace-query) for the complete limits, request fields, predicates, cursor pagination, response shape, and errors.
