...
Feedback methods create, list, and query human-in-the-loop signals such as ratings, thumbs, comments, and corrections. See the [feedback guide](/guides/observability/feedback) for examples and the [feedback reference](/reference/observability/feedback) for full schemas.
...
- [Feedback guide](/guides/observability/feedback): Learn how to create, list, and query feedback
