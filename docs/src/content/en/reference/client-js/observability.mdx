...
Each request accepts up to 1,000 trace IDs. The route doesn't accept tenant scope fields. Signals that aren't linked to a trace are preserved. Traces created by experiments are deleted like any other trace.
