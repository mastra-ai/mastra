...
Both `Agent` (code-defined) and `StoredAgent` instances have methods for managing configuration versions. See [Editor versioning](/reference/editor/versioning) for lifecycle and selection behavior.
