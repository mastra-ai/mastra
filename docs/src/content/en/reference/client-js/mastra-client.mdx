...
The Mastra Client SDK provides a type-safe interface for interacting with your [Mastra Server](/guides/deployment/mastra-server) from your client environment.
