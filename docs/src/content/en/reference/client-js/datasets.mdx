...
Permanently scrubs an item's content from every dataset version and linked experiment result while preserving version history, experiment counters, and review state.
