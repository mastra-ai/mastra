...
Initialize shared storage and propagate runtime services to agents. Configured workspaces initialize lazily when used. Repeated calls reuse the same initialization promise.
