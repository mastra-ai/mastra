    ...
    properties: [
      {
        ...
        parameters: [
          ...
          },
          {
            name: 'observerModel',
            type: "'auto' | string",
            description: "Default observer model. Use 'auto' to follow the active main model.",
            isOptional: true,
          },
          {
          ...
          },
          {
            name: 'reflectorModel',
            type: "'auto' | string",
            description: "Default reflector model. Use 'auto' to follow the active main model.",
            isOptional: true,
          },
          {
