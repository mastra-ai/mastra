...
<PropertiesTable
  ...
  },
  {
    ...
    description: 'Default observational memory model selections, automatic model resolver, and thresholds.',
    isOptional: true,
    properties: [
      {
        type: 'AgentControllerOMConfig',
        parameters: [
          {
            name: 'defaultObserverModelId',
            type: 'string',
            description: 'Concrete observer fallback used when automatic resolution returns no model or throws.',
            isOptional: true,
          },
          {
            name: 'defaultObserverModelSelection',
            type: 'OMModelSelection',
            description: 'Default observer intent: automatic selection or an explicit model ID.',
            isOptional: true,
          },
          {
            name: 'defaultReflectorModelId',
            type: 'string',
            description: 'Concrete reflector fallback used when automatic resolution returns no model or throws.',
            isOptional: true,
          },
          {
            name: 'defaultReflectorModelSelection',
            type: 'OMModelSelection',
            description: 'Default reflector intent: automatic selection or an explicit model ID.',
            isOptional: true,
          },
          {
            name: 'resolveAutoModelId',
            type: '(args: ResolveAutoOMModelArgs) => string | undefined',
            description:
              'Synchronously resolves an automatic role selection to a concrete model ID from the role, current main model, and read-only session state.',
            isOptional: true,
          },
          {
            name: 'defaultObservationThreshold',
            type: 'number',
            description: 'Default observation threshold in tokens.',
            isOptional: true,
          },
          {
            name: 'defaultReflectionThreshold',
            type: 'number',
            description: 'Default reflection threshold in tokens.',
            isOptional: true,
          },
        ],
      },
