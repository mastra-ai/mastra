...
The popup will say "New MCP server detected: mastra". You can choose to "Skip" or "Enable" it as an action.
...
1. Check the checkbox on the **Chat > MCP: Enabled (Preview)** option.
