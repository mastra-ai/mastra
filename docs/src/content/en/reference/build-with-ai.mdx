...
Examples for the [introduction page](/docs/getting-started/getting-started):

- [`/docs/getting-started/getting-started/llms.txt`](https://mastra.ai/docs/getting-started/getting-started/llms.txt)
- [`/docs/getting-started/getting-started.md`](https://mastra.ai/docs/getting-started/getting-started.md)

## MCP docs server

:::warning

The MCP docs server isn't recommended for everyday development. Use [Mastra skills](/docs/getting-started/develop#mastra-skills) instead because they're more up to date and perform better.
