...
description: "Configure MastraPlatformExporter to send traces to Mastra Platform with project credentials, batching, retries, and compatibility with CloudExporter."
packages:
