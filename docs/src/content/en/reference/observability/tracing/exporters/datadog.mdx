...
description: "Configure DatadogExporter to send Mastra traces into Datadog LLM Observability, supporting application monitoring and analysis of spans and AI performance."
packages:
  - "@mastra/core"
...
- `excludeSpanTypes?: SpanType[]` - Span types this exporter drops before export (only affects this exporter)
