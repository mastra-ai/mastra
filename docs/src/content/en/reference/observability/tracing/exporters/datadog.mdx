...
description: "Configure DatadogExporter to send Mastra traces to Datadog LLM Observability for application monitoring, span analysis, and AI performance insights."
packages:
  - "@mastra/core"
