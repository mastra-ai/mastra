...
Sends Tracing data to Arthur AI using OpenTelemetry and OpenInference semantic conventions.
...
<PropertiesTable
  ...
  },
  {
    name: 'endpoint',
    type: 'string',
    description: 'Arthur platform endpoint (e.g. https://app.arthur.ai). Falls back to ARTHUR_BASE_URL env var.',
    required: false,
  },
  {
    name: 'taskId',
    type: 'string',
    description: 'Arthur task ID to associate traces with. Falls back to ARTHUR_TASK_ID env var.',
    required: false,
  },
  {
    name: 'headers',
...
// Set ARTHUR_API_KEY, ARTHUR_BASE_URL, and ARTHUR_TASK_ID
