...
description: "Configure ArizeExporter to send Mastra traces to Arize Phoenix, Arize AX, or OpenTelemetry platforms that support OpenInference semantic conventions."
packages:
  - "@mastra/arize"
---
