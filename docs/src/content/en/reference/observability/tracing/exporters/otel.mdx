...
- [OtelExporter Guide](/ecosystem/observability-integrations/exporters/otel): Setup guide with provider configurations
- [OtelBridge](/ecosystem/observability-integrations/bridges/otel): For bidirectional OTEL context integration
- [Tracing Overview](/guides/observability/tracing/overview): General tracing concepts
