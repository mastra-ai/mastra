...
Numbered-page handoff cursors and delta cursors also bind the authorization state. Reload a numbered page when the authorization scope changes. A malformed cursor returns `400`.
