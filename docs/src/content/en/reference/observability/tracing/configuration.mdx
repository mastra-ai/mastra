...
- [Spans Reference](./spans) - Span lifecycle

### Exporters

- [DefaultExporter](./exporters/default-exporter) - Storage configuration
- [CloudExporter](./exporters/cloud-exporter) - Cloud setup
- [Braintrust](./exporters/braintrust) - Braintrust integration
- [Langfuse](./exporters/langfuse) - Langfuse integration
- [LangSmith](./exporters/langsmith) - LangSmith integration
