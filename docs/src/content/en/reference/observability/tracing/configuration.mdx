...
<PropertiesTable
  ...
  },
  {
    ...
    description:
      'Controls log forwarding to observability storage. See [Logging to observability storage](/guides/observability/logging#logging-to-observability-storage) for details.',
    required: false,
    properties: [
      {
        type: '{ enabled?: boolean; level?: LogLevel }',
...
- [Tracing Overview](/guides/observability/tracing/overview): Concepts and usage guide
- [Sampling Strategies](/guides/observability/tracing/overview#sampling-strategies): Sampling configuration details
- [Multi-Config Setup](/guides/observability/config#multi-config-setup): Using multiple configurations
