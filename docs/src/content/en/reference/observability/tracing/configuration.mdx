...
<PropertiesTable
  ...
  },
  {
    ...
    type: 'SpanType[]',
    description:
      'Span types to exclude from export. Useful for reducing noise and costs in per-span billing platforms. See [Span filtering](/docs/observability/tracing/span-filtering) for details.',
    required: false,
  },
  {
    name: 'spanFilter',
    ...
    description:
      'Filter function to control which spans are exported. Return true to keep, false to drop. Runs after excludeSpanTypes and spanOutputProcessors. See [Span filtering](/docs/observability/tracing/span-filtering) for details.',
    required: false,
  },
  {
...
- [Span Filtering](/docs/observability/tracing/span-filtering) - Selectively exclude spans
