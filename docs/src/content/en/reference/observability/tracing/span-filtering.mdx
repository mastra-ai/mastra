...
For a shorter overview of tracing configuration, see [Tracing](/guides/observability/tracing/overview).
...
- [Tracing overview](/guides/observability/tracing/overview) for setup and concepts
- [Configuration API](/reference/observability/tracing/configuration) for `ObservabilityInstanceConfig`
- [Sensitive data filter](/guides/observability/integrations/processors/sensitive-data-filter) for redacting span data
