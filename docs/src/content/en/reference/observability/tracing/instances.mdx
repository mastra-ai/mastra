...
- [Interfaces Reference](./interfaces) - Type definitions
- [Spans Reference](./spans) - Span lifecycle and methods

### Exporters

- [DefaultExporter](./exporters/default-exporter) - Storage persistence
- [CloudExporter](./exporters/cloud-exporter) - Mastra Cloud integration
- [ConsoleExporter](./exporters/console-exporter) - Debug output
