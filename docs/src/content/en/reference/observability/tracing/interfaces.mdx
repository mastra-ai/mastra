...
interface Span<TType extends SpanType> {
  ...
  /** Pointer to the Tracing instance */
  Tracing: Tracing;
...
interface TracingExporter {
  ...
  exportEvent(event: TracingEvent): Promise<void>;
...
Complete Tracing registry configuration.
...
interface ObservabilityRegistryConfig {
  ...
  configs?: Record<string, Omit<TracingConfig, "name"> | Tracing>;
...
type ConfigSelector = (
  ...
  availableConfigs: ReadonlyMap<string, Tracing>,
) => string | undefined;
```
...
- [Tracing Classes](/reference/observability/tracing/) - Core implementations
- [Span Reference](/reference/observability/tracing/span) - Span lifecycle methods

### Examples

- [Basic Tracing](/examples/observability/basic-tracing) - Implementation example
