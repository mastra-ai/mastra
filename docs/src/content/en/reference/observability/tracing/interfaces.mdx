...
- [Tracing Overview](/guides/observability/tracing/overview): Complete guide to Tracing
- [Creating Child Spans](/guides/observability/tracing/overview#creating-child-spans): Working with span hierarchies
- [Adding Custom Metadata](/guides/observability/tracing/overview#adding-custom-metadata): Enriching traces
