...
See the [OtelBridge Guide](/ecosystem/observability-integrations/bridges/otel#configuration) for complete setup instructions, including how to configure OTEL instrumentation and run your application.
...
- [OtelBridge Guide](/ecosystem/observability-integrations/bridges/otel): Setup guide with examples
