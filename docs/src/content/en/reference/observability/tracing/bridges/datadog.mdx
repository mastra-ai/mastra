...
See the [DatadogBridge Guide](/ecosystem/observability-integrations/bridges/datadog#configuration) for complete setup instructions, including dd-trace initialization, bundler externals, and agent configuration.
...
- [DatadogBridge Guide](/ecosystem/observability-integrations/bridges/datadog) - Setup guide with examples
