...
- [AI Tracing Overview](/docs/v0/observability/ai-tracing/overview) - Complete guide to AI tracing
- [Creating Child Spans](/docs/v0/observability/ai-tracing/overview#creating-child-spans) - Working with span hierarchies
- [Adding Custom Metadata](/docs/v0/observability/ai-tracing/overview#adding-custom-metadata) - Enriching traces

### Reference

- [Configuration](/reference/v0/observability/ai-tracing/configuration) - Registry and configuration
- [AITracing Classes](/reference/v0/observability/ai-tracing/) - Core implementations
- [Span Reference](/reference/v0/observability/ai-tracing/span) - Span lifecycle methods

### Examples

- [Basic AI Tracing](/examples/v0/observability/basic-ai-tracing) - Implementation example
