---
title: "Reference: AITracing | Observability"
...
- [Configuration Reference](/reference/v0/observability/ai-tracing/configuration) - Configuration options
- [Interfaces Reference](/reference/v0/observability/ai-tracing/interfaces) - Type definitions
- [Span Reference](/reference/v0/observability/ai-tracing/span) - Span lifecycle and methods

### Examples

- [Basic AI Tracing](/examples/v0/observability/basic-ai-tracing) - Getting started example

### Exporters

- [DefaultExporter](/reference/v0/observability/ai-tracing/exporters/default-exporter) - Storage persistence
- [CloudExporter](/reference/v0/observability/ai-tracing/exporters/cloud-exporter) - Mastra Cloud integration
- [ConsoleExporter](/reference/v0/observability/ai-tracing/exporters/console-exporter) - Debug output
