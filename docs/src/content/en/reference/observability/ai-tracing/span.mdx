---
title: "Reference: Span | Observability"
...
- [AI Tracing Overview](/docs/v0/observability/ai-tracing/overview) - Concepts and usage
- [Creating Child Spans](/docs/v0/observability/ai-tracing/overview#creating-child-spans) - Practical examples
- [Retrieving Trace IDs](/docs/v0/observability/ai-tracing/overview#retrieving-trace-ids) - Using trace IDs

### Reference

- [AITracing Classes](/reference/v0/observability/ai-tracing/) - Core tracing classes
- [Interfaces](/reference/v0/observability/ai-tracing/interfaces) - Complete type reference
- [Configuration](/reference/v0/observability/ai-tracing/configuration) - Configuration options

### Examples

- [Basic AI Tracing](/examples/v0/observability/basic-ai-tracing) - Working with spans
