...
- `src/mastra/agents/<name>`: You can define an agent by file convention instead of constructing it in code. Learn more in the [File-based Agents](/guides/getting-started/file-based-agents) docs.
