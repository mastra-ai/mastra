...
- [Signals](/guides/long-running-agents/signals): The runtime that uses leasing to coordinate thread execution across processes
- [Channels](/guides/capabilities/channels/overview): Uses leasing to coordinate agent runs in serverless and multi-instance deployments
