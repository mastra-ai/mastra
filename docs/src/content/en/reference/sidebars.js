  ...
  referenceSidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        { type: 'doc', id: 'agent-controller/session', label: 'Session Class' },
      ],
    },
    {
      type: 'category',
    ...
    },
    {
      ...
      items: [
        ...
        { type: 'doc', id: 'connect/create-anthropic-tools', label: 'createAnthropicTools()' },
        { type: 'doc', id: 'connect/create-cloudflare-tools', label: 'createCloudflareTools()' },
        { type: 'doc', id: 'connect/create-gitlab-tools', label: 'createGitlabTools()' },
        { type: 'doc', id: 'connect/create-jira-tools', label: 'createJiraTools()' },
        { type: 'doc', id: 'connect/create-linear-tools', label: 'createLinearTools()' },
        { type: 'doc', id: 'connect/create-neon-tools', label: 'createNeonTools()' },
        { type: 'doc', id: 'connect/create-notion-tools', label: 'createNotionTools()' },
        { type: 'doc', id: 'connect/create-resend-tools', label: 'createResendTools()' },
        { type: 'doc', id: 'connect/create-snowflake-tools', label: 'createSnowflakeTools()' },
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            { type: 'doc', id: 'datasets/createExperiment', label: '.createExperiment()' },
    ...
    },
    {
      ...
      collapsed: true,
      items: [
        { type: 'doc', id: 'migrations/agentnetwork', label: 'AgentNetwork to .network()' },
        { type: 'doc', id: 'migrations/ai-sdk-v4-to-v5', label: 'AI SDK v4 to v5' },
        { type: 'doc', id: 'migrations/mastra-cloud', label: 'Mastra Cloud to Mastra platform' },
        { type: 'doc', id: 'migrations/vnext-to-standard-apis', label: 'VNext to Standard APIs' },
        {
          type: 'doc',
        ...
        },
        {
          ...
          label: 'v1.0',
          items: [
            { type: 'doc', id: 'migrations/upgrade-to-v1/overview', label: 'Overview' },
            { type: 'doc', id: 'migrations/upgrade-to-v1/agent', label: 'Agents' },
            { type: 'doc', id: 'migrations/upgrade-to-v1/cli', label: 'CLI' },
            { type: 'doc', id: 'migrations/upgrade-to-v1/client', label: 'Client SDK' },
            { type: 'doc', id: 'migrations/upgrade-to-v1/deployment', label: 'Deployment' },
            { type: 'doc', id: 'migrations/upgrade-to-v1/evals', label: 'Evals' },
            { type: 'doc', id: 'migrations/upgrade-to-v1/mastra', label: 'Mastra' },
            { type: 'doc', id: 'migrations/upgrade-to-v1/mcp', label: 'MCP' },
            { type: 'doc', id: 'migrations/upgrade-to-v1/memory', label: 'Memory' },
            { type: 'doc', id: 'migrations/upgrade-to-v1/processors', label: 'Processors' },
            { type: 'doc', id: 'migrations/upgrade-to-v1/rag', label: 'RAG' },
            { type: 'doc', id: 'migrations/upgrade-to-v1/storage', label: 'Storage' },
            { type: 'doc', id: 'migrations/upgrade-to-v1/tools', label: 'Tools' },
            { type: 'doc', id: 'migrations/upgrade-to-v1/tracing', label: 'Tracing' },
            { type: 'doc', id: 'migrations/upgrade-to-v1/vectors', label: 'Vectors' },
            { type: 'doc', id: 'migrations/upgrade-to-v1/voice', label: 'Voice' },
            { type: 'doc', id: 'migrations/upgrade-to-v1/workflows', label: 'Workflows' },
          ],
        },
      ],
    },
      ...
      items: [
        ...
        },
        {
          ...
          items: [
            ...
            { type: 'doc', id: 'observability/metrics/queries', label: 'Metric queries' },
          ],
        },
        {
          type: 'category',
    ...
    },
    {
      ...
      items: [
        ...
        { type: 'doc', id: 'signals/task-signal-provider', label: 'TaskSignalProvider' },
