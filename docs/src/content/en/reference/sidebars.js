  ...
  referenceSidebar: [
    ...
    },
    {
      ...
      items: [
        ...
        {
          type: "doc",
          id: "core/listWorkflows",
          key: "core.listWorkflows",
          label: ".listWorkflows()",
        },
    ...
    },
    {
      ...
      items: [
        ...
        {
          type: "doc",
          id: "agents/listAgents",
          key: "agents.listAgents",
          label: ".listAgents()",
        },
        {
          type: "doc",
          id: "agents/listWorkflows",
          key: "agents.listWorkflows",
          label: ".listWorkflows()",
        },
        { type: "doc", id: "agents/listTools", label: ".listTools()" },
        {
          type: "doc",
          id: "agents/listScorers",
          key: "agents.listScorers",
          label: ".listScorers()",
        },
          ...
          items: [
            {
              ...
              key: "streaming.workflows.stream",
              label: ".stream()",
            },
            {
              type: "doc",
      ...
      items: [
        {
          ...
          items: [
            ...
            },
            {
              type: "category",
              label: "Processors",
              key: "observability.tracing.processors",
              items: [
                {
                  type: "doc",
