...
description: "Supervisor agents using Agent.stream() and Agent.generate() are the recommended approach for coordinating multiple agents, replacing the older .network() API."
packages:
  - "@mastra/core"
---
