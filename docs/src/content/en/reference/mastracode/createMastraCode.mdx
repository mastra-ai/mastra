...
`createMastraCode()` is the main factory function that bootstraps the Mastracode coding agent. It wires together project detection, storage, authentication, MCP servers, hooks, modes, subagents, and the [Harness](/reference/harness/harness-class) that drives the TUI or any other frontend.
