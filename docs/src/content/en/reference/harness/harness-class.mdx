    ...
    properties: [
      {
        ...
        parameters: [
          ...
          },
          {
            ...
            type: 'string[]',
            description:
              'Workspace tool keys the subagent is allowed to use. When set, workspace tools not in this list are hidden from the model. Non-workspace tools are never affected. When omitted, all workspace tools are visible.',
            isOptional: true,
          },
          {
            name: 'defaultModelId',
