...
See [Response caching](/guides/agents/processors#response-caching) for the conceptual overview, scoping rules, and recommended deployment patterns.
...
- [Response caching](/guides/agents/processors#response-caching)
