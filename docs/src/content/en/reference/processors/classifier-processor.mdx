    ...
    properties: [
      {
        ...
        parameters: [
          ...
          },
          {
            ...
            type: "'warn' | 'strict'",
            description:
              "How to handle evaluation model failures. 'warn' is fail-open: it logs the failure and lets the content through. 'strict' is fail-closed: it aborts the request, including during streaming. Classifier configuration errors always throw.",
            isOptional: true,
            default: "'warn'",
          },
          {
          ...
          },
          {
            ...
            type: 'number',
            description:
              'Number of trailing stream chunks to classify together, including the current text-delta chunk. A value of 0 classifies only the current chunk. Each text chunk triggers a classifier call, so larger windows increase cost.',
            isOptional: true,
            default: '0',
          },
          {
