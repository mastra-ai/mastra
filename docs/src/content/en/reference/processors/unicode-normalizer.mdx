...
description: "Use UnicodeNormalizer to normalize input text, standardize Unicode forms, and remove problematic characters before messages reach the language model."
packages:
  - "@mastra/core"
---
