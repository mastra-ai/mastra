...
<PropertiesTable
  content={[
  {
    ...
    description: "Change the model for this step. Can be a model instance or router ID like '__OPENAI_MODEL__'.",
    isOptional: true,
  },
  {
    name: 'toolChoice',
