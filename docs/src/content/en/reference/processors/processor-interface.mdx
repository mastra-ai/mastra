...
<PropertiesTable
  ...
  },
  {
    name: 'result',
    type: 'unknown',
    description: 'Raw value returned by `tool.execute()` (already serialized).',
    isOptional: false,
  },
  {
