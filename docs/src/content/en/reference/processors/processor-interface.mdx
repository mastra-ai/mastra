...
<PropertiesTable
  ...
  },
  {
    ...
    type: 'ChunkType[]',
    description:
      'All chunks accumulated during stream processing (from processOutputStream). Includes the finish chunk which contains usage data at `chunk.payload.output.usage`.',
    isOptional: false,
  },
  {
    name: 'abort',
