...
| [`onIterationComplete`](/reference/agents/generate) | Once after each completed loop iteration | Observes the iteration result and can influence whether execution continues. |
