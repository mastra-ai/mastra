...
| `processToolResult` | Per tool, after `tool.execute()` returns and before the result is added to the message list | Inspect tool output and enforce security policies |
