...
description: "Use dataset.purgeItem() to permanently scrub an item's stored content from every dataset version, deletion tombstone, and linked experiment result."
packages:
  - '@mastra/core'
---
...
- [dataset.deleteItem()](/reference/datasets/deleteItem)
- [Client SDK datasets API](/reference/client-js/datasets#purgedatasetitem)
- [Server routes](/reference/server/routes#purge-a-dataset-item)
