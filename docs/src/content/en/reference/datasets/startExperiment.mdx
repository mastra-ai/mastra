            ...
            properties: [
              {
                ...
                parameters: [
                  ...
                  },
                  {
                    ...
                    isOptional: true,
                    description:
                      'Tool replay divergence summary. Only present when `toolReplay` was active for the item. Contains `sourceTraceId`, `totalRecorded`, `replayedCount`, `misses`, `unconsumed`, and `argMismatches`.',
                  },
                  {
                    name: 'scores',
                    type: 'ScorerResult[]',
