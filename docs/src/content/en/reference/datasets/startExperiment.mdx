        ...
        parameters: [
          {
            ...
            type: 'string',
            isOptional: true,
            description: 'Prior experiment whose per-item results supply the source trace for each item ID.',
          },
          {
            name: 'onMiss',
