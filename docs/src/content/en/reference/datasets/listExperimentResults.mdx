            ...
            properties: [
              {
                ...
                parameters: [
                  ...
                  {
                    name: 'toolReplay',
                    type: 'ToolReplayReport | null',
                    description:
                      'Tool replay/mock report for items executed with toolReplay or toolMocks (misses, unconsumed events, arg mismatches, call flow, mock usage, expectation outcomes). Null for live runs.',
                  },
                  {
                    name: 'createdAt',
                    type: 'Date',
