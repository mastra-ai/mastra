...
- Using the `insert-only` [tracing strategy](/ecosystem/observability-integrations/exporters/mastra-storage#tracing-strategies) to reduce database write operations
