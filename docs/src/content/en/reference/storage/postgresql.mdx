...
- Using the `insert-only` [tracing strategy](/guides/observability/integrations/exporters/mastra-storage#tracing-strategies) to reduce database write operations
