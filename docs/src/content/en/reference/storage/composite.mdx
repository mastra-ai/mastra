...
Observability data can quickly overwhelm general-purpose databases in production. A single agent interaction generates multiple spans, and high-traffic applications can produce millions of traces per day.
