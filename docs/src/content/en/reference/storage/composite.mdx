...
This approach is also required when using storage providers that don't support observability (like Convex, DynamoDB, or Cloudflare). See the [MastraStorageExporter documentation](/ecosystem/observability-integrations/exporters/mastra-storage#storage-provider-support) for the full list of supported providers.
