...
[libSQL](https://docs.turso.tech/libsql) is an open-source, SQLite-compatible database that supports both local and remote deployments.

For vector storage with libSQL, see [libSQL Vector](/reference/v1/vectors/libsql) which covers semantic recall and embeddings.
