...
libSQL supports observability and is ideal for local development. Use the `realtime` [tracing strategy](/ecosystem/observability-integrations/exporters/mastra-storage#tracing-strategies) for immediate visibility while debugging.
