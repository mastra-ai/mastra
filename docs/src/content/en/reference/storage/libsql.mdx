...
For vectors like semantic recall or traditional RAG, use [libSQL Vector](../vectors/libsql) which covers embeddings and vector search.
...
When you pass storage to the Mastra class, `init()` is called automatically to create the [core schema](./overview#core-schema):
