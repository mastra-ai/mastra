...
For production environments with higher trace volumes, consider using [PostgreSQL](/reference/storage/postgresql) or [ClickHouse via composite storage](/reference/storage/composite#specialized-storage-for-observability-recommended-for-production).
