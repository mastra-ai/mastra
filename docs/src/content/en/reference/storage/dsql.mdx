...
Aurora DSQL storage uses Amazon Aurora DSQL with IAM authentication for thread, message, workflow, and observability storage.
...
The storage implementation creates the following tables during initialization:
