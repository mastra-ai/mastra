...
<PropertiesTable
  ...
  },
  {
    name: 'pool',
    type: 'oracledb.Pool',
    description: 'Existing Oracle connection pool. When provided, Mastra uses the pool but doesn\'t close it when `store.close()` is called.',
    isOptional: true,
  },
  {
    name: 'poolManager',
  ...
  },
  {
    name: 'disableInit',
    type: 'boolean',
    description: 'When true, automatic schema initialization is disabled. Use this when schema changes are applied separately before the app starts.',
    isOptional: true,
    defaultValue: 'false',
  },
  {
  ...
  },
  {
    ...
    type: 'string',
    description: 'OracleVector registry table used to discover semantic-recall vector tables when threads or messages are deleted. Set this to match `OracleVector`\'s `registryTableName` when that option is customized.',
    isOptional: true,
  },
]}
/>
