...
// Initialize with Vertex AI (uses service account authentication)
const voice = new GoogleVoice({
  vertexAI: true,
...
const voiceWithCredentials = new GoogleVoice({
  vertexAI: true,
  project: "your-gcp-project",
  speechModel: {
    credentials: {
...
When using Vertex AI, ensure your service account has:
