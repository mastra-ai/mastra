...
name: "apiKey",
type: "string",
description: "Google Cloud API key. Falls back to GOOGLE_API_KEY environment variable. Not used when vertexAI is true.",
isOptional: true,
},
{
name: "keyFilename",
type: "string",
description: "Path to service account JSON key file. Falls back to GOOGLE_APPLICATION_CREDENTIALS environment variable.",
isOptional: true,
},
{
name: "credentials",
...
name: "vertexAI",
type: "boolean",
description: "Enable Vertex AI mode for enterprise deployments. Uses project-based authentication instead of API keys. Requires 'project' to be set.",
isOptional: true,
defaultValue: "false",
},
{
name: "project",
type: "string",
description: "Google Cloud project ID (required when vertexAI is true). Falls back to GOOGLE_CLOUD_PROJECT environment variable.",
isOptional: true,
},
{
name: "location",
