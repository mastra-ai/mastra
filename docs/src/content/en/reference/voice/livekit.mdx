    ...
    properties: [
      {
        ...
        parameters: [
          ...
          },
          {
            ...
            description:
              'Named consent requirements for the call (starting with summaryStorage). Capture grants at runtime with createConsentTool; the requirements surface on onCallEnd for enforcement.',
            isOptional: true,
          },
          {
            name: 'endCall',
