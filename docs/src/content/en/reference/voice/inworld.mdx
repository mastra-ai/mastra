...
<PropertiesTable
  content={[
  {
    ...
    isOptional: true,
    defaultValue: "{ name: 'inworld-tts-1.5-max' }",
    properties: [
      {
        type: 'InworldVoiceConfig',
        parameters: [
          {
            name: 'name',
            type: "'inworld-tts-1.5-max' | 'inworld-tts-1.5-mini'",
  ...
  },
  {
    ...
    isOptional: true,
    defaultValue: "{ name: 'inworld/inworld-stt-1' }",
    properties: [
      {
        type: 'InworldListeningConfig',
        parameters: [
    ...
    properties: [
      {
        ...
        parameters: [
          ...
          },
          {
            name: 'temperature',
            type: 'number',
            description: 'Controls voice variability.',
            isOptional: true,
          },
        ],
      },
...
// [{ voiceId: 'Dennis', name: 'Dennis', language: 'en', gender: 'neutral' }, ...]
```
...
- An API key can be provided via the `speechModel` or `listeningModel` config, or the `INWORLD_API_KEY` environment variable.
