...
<PropertiesTable
  ...
  },
  {
    ...
    description:
      'Voice activity / turn detection. Defaults to `{ type: "semantic_vad", eagerness: "medium", create_response: true, interrupt_response: true }`. Supply your own object to override; set to `null` to disable turn detection entirely.',
    isOptional: true,
  },
  {
    name: 'tool_choice',
