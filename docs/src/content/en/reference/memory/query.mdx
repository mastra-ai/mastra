...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      type: "number | false",
      description:
        "Number of messages to retrieve per page. Set to false to fetch all messages without pagination. Note: threadConfig.lastMessages (default: 10) will override this if smaller.",
      isOptional: true,
    },
    {
      name: "page",
