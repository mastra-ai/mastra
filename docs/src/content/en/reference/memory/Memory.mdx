...
You can use various embedding models but to get started quickly you can use [FastEmbed](https://github.com/Anush008/fastembed-js) which is an on-device/local embedding model that requires no API keys or network requests.
