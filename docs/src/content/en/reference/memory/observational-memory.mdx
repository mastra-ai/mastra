...
Emitted once per agent loop step. Provides a snapshot of the current memory state, including token usage for both the message and observation windows, and the state of any async buffered content.
...
interface DataOmStatusPart {
  ...
  data: {
    windows: {
      ...
      buffered: {
        /** Observation chunks staged for activation */
        observations: {
          chunks: number;
        ...
        /** Reflection waiting to be activated */
        reflection: {
...
<PropertiesTable
  content={[
    ...
    { name: "tokensToObserve", type: "number", description: "Tokens being processed in this batch." },
...
<PropertiesTable
  content={[
    ...
    { name: "tokensObserved", type: "number", description: "Total input tokens that were processed." },
    { name: "observationTokens", type: "number", description: "Resulting observation tokens after compression." },
...
<PropertiesTable
  content={[
    ...
    { name: "tokensAttempted", type: "number", description: "Tokens that were attempted." },
...
<PropertiesTable
  content={[
    ...
    { name: "tokensToBuffer", type: "number", description: "Tokens being buffered in this cycle." },
    { name: "recordId", type: "string", description: "The OM record ID." },
    { name: "threadId", type: "string", description: "This thread's ID." },
...
<PropertiesTable
  content={[
    ...
    { name: "durationMs", type: "number", description: "Duration in milliseconds." },
    { name: "tokensBuffered", type: "number", description: "Total input tokens that were buffered." },
    { name: "bufferedTokens", type: "number", description: "Resulting tokens after compression." },
...
<PropertiesTable
  content={[
    ...
    { name: "failedAt", type: "string", description: "ISO timestamp when the failure occurred." },
    { name: "durationMs", type: "number", description: "Duration until failure in milliseconds." },
    { name: "tokensAttempted", type: "number", description: "Tokens that were attempted to buffer." },
    { name: "error", type: "string", description: "Error message." },
...
<PropertiesTable
  content={[
    ...
    { name: "tokensActivated", type: "number", description: "Total message tokens from activated chunks." },
