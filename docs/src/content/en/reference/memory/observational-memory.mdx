    ...
    properties: [
      {
        ...
        parameters: [
          ...
          },
          {
            ...
            type: 'number',
            description:
              'Token count of unobserved messages that triggers observation. When unobserved message tokens exceed this threshold, the Observer agent is called. Image parts are included with model-aware estimates when possible, with deterministic fallbacks when image metadata is incomplete.',
            isOptional: true,
            defaultValue: '30000',
          },
          {
