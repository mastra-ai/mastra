...
Most users should use the `Memory` class above. Using `ObservationalMemory` directly is mainly useful for benchmarking, experimentation, or when you need to control processor ordering with other processors (like [guardrails](/guides/agents/guardrails)).
...
- [Observational Memory](/guides/memory/observational-memory)
- [Memory Overview](/guides/memory/overview)
- [Memory Class](/reference/memory/memory-class)
- [Memory Processors](/guides/memory/memory-processors)
- [Processors](/guides/agents/processors)
