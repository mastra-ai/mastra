...
- `recentMessages`: Formatted message parts from the observed conversation window. These parts have no additional 500-character cap. Tool results retain the existing `DEFAULT_OBSERVER_TOOL_RESULT_MAX_TOKENS` budget of 10,000 tokens.
