...
type: "number",
description:
"Ratio (0-1) controlling how much of the message window to retain after activation. For example, `0.8` means activate enough to keep only 20% of `messageTokens` remaining. Higher values remove more message history per activation.",
isOptional: true,
defaultValue: "0.8",
},
{
