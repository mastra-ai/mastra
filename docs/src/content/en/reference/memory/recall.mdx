...
<PropertiesTable
  ...
  },
  {
    ...
    type: 'boolean',
    description:
      'Deprecated. Use hideSignals: [] to include all signals, or hideSignals: ["reactive", "system-reminder"] to hide reminders. When hideSignals is omitted, true includes all signals; false or omitted preserves reminder-hidden history.',
    isOptional: true,
    defaultValue: 'false',
  },
  {
