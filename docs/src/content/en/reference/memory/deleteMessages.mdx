...
- [`saveMessages`](/reference/memory/saveMessages) - Save multiple messages
- [`updateMessages`](/reference/memory/updateMessages) - Update multiple messages
- [`query`](/reference/memory/query) - Query messages from memory