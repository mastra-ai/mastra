...
description: "A Logger instance is created using new PinoLogger() and provides methods to record events at severity levels."
packages:
  - "@mastra/core"
  - "@mastra/loggers"
---
...
<PropertiesTable
  ...
  },
  {
    ...
    isOptional: true,
    description:
      'Custom Pino serializers keyed by log field, merged over the defaults. By default, `Error` values logged under `err` or `error` are serialized with their type, message, and stack.',
  },
  {
    name: 'prettyPrint',
    type: 'boolean',
