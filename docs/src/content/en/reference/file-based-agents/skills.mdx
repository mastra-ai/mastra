...
Use this page for the file-based convention. For code-defined skills, see [Agent skills](/guides/agents/skills). For the `SKILL.md` package format, see [Workspace skills](/guides/workspace/skills).
