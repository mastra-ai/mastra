...
Use this page for the file-based convention. For code-defined skills, see [Agent skills](/docs/skills). For the `SKILL.md` package format, see [Workspace skills](/docs/workspace/skills).
