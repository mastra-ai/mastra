...
See the [`createTool()` reference](/reference/tools/create-tool) for all options and [tool approval](/guides/agent-controller/tool-approvals) for the approval flow.
