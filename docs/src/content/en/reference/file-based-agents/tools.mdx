...
See the [`createTool()` reference](/reference/tools/create-tool) for all options and [tool approval](/docs/agent-controller/overview#approve-tools-and-resume-suspensions) for the approval flow.
