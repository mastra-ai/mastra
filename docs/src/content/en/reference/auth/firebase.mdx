...
// Uses FIREBASE_SERVICE_ACCOUNT and FIRESTORE_DATABASE_ID environment variables
...
The following environment variables are used when constructor options are not provided:
