...
description: "Configure MastraAuthAuth0 to authenticate Mastra applications with Auth0, validate access tokens, and resolve authenticated users from request headers."
packages:
  - "@mastra/auth-auth0"
  - "@mastra/core"
---
