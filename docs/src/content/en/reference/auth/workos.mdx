...
description: "Configure MastraAuthWorkos to authenticate Mastra applications with WorkOS, validate access tokens, and resolve authenticated users from requests."
packages:
  - "@mastra/auth-workos"
  - "@mastra/core"
---
