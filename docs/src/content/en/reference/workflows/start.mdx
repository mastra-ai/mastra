---
title: "Reference: Workflow.start() | Workflows | Mastra Docs"
description: Documentation for the `Workflow.start()` method in workflows, which starts a workflow run with input data.
---
