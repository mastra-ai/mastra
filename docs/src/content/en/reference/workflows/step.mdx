...
description: "The suspend data that was originally passed to suspend() when the step was suspended. Only exists if the step is being resumed and was previously suspended with data.",
},
{
name: "mastra",
type: "Mastra",
...
name: "state",
type: "z.infer<TState>",
description: "The current workflow state. Contains shared values that persist across all steps and suspend/resume cycles. The structure is defined by the step's stateSchema.",
},
{
name: "setState",
...
name: "retryCount",
type: "number",
description: "The retry count for this specific step, it automatically increases each time the step is retried",
isOptional: true,
},
],
},
