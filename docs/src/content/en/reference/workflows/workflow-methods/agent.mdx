...
description: "Use Workflow.agent() to add a portable agent step with prompt input, text or structured output, runtime agent lookup, retries, scorers, and metadata."
packages:
  - "@mastra/core"
---
