...
description: "Use Workflow.parallel() to execute multiple workflow steps concurrently, wait for every branch, and pass their combined results to later steps."
packages:
  - "@mastra/core"
---
