---
title: "Reference: Workflow.resume() | Workflows | Mastra Docs"
description: Documentation for the `Workflow.resume()` method in workflows, which resumes a suspended workflow run with new data.
---
