...
The `initialState` object should match the structure defined in the workflow's `stateSchema`. See [Workflow State](/docs/v0/workflows/workflow-state) for more details.
...
- [Step Class](./step)
- [Workflow State](/docs/v0/workflows/workflow-state)
