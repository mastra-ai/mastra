---
title: "Reference: Workflow.stream() | Workflows | Mastra Docs"
description: Documentation for the `Workflow.stream()` method in workflows, which allows you to monitor the execution of a workflow run as a stream.
---
