---
title: "Reference: Workflow.streamVNext() | Workflows | Mastra Docs"
description: Documentation for the `Workflow.streamVNext()` method in workflows, which enables real-time streaming of responses.
---

# Workflow.streamVNext()
