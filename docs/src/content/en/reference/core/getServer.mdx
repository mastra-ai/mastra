  ...
  content={[
    {
      ...
      description:
        "The configured server configuration including port, host, path, timeout, API routes, middleware, CORS settings, and build options, or undefined if no server has been configured.",
    },
  ]}
/>
