---
title: "Reference: getScorerByName() | Core"
...
- [getScorer()](/reference/v0/core/getScorer) - Get a scorer by its registration key
- [listScorers()](/reference/v0/core/listScorers) - Get all registered scorers
- [createScorer()](/reference/v0/scorers/create-scorer) - Learn how to create scorers with names
