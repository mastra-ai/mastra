...
<PropertiesTable
  ...
  },
  {
    ...
    description:
      'Scorers for evaluating agent responses and workflow outputs. Registration also makes a scorer resolvable by ID, which is required to persist its scores. See [Score persistence](/reference/evals/run-evals#score-persistence)',
    isOptional: true,
    defaultValue: '{}',
  },
  {
