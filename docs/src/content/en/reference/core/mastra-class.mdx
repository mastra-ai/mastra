...
<PropertiesTable
  ...
  },
  {
    ...
    description:
      'Classifiers for typed fixed-option evaluation. Registered classifiers can be resolved by key or ID, for example by `ClassifierProcessor` when given a string. See [Classifier](/reference/classifier/classifier)',
    isOptional: true,
    defaultValue: '{}',
  },
  {
