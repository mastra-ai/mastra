...
description: "Documentation for the `Mastra.addStoredWorkflows()` method, which validates, persists, and live-registers a bundle of dynamic workflow definitions."
packages:
  - "@mastra/core"
---
...
The `.addStoredWorkflows()` method adds a bundle of dynamic workflow definitions that may reference each other. The typical case is a root workflow plus helper workflows it nests, where none of the definitions exist yet.
