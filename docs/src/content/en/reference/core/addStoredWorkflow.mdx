...
See [Stored workflows](/docs/workflows/stored-workflows) for the definition format.
...
- [Stored workflows](/docs/workflows/stored-workflows): Definition format and concepts
