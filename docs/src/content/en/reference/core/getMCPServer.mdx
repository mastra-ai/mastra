...
- [Mastra.getMCPServerById()](./getMCPServerById) - Retrieve an MCP server by its intrinsic `id` property
- [Mastra.listMCPServers()](./listMCPServers) - List all registered MCP servers
