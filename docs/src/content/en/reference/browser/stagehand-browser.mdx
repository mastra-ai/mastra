...
When `recording` is configured, `StagehandBrowser` also adds the alpha `browser_record` and `browser_record_caption` tools. See [Browser recording (alpha)](/guides/browser/recording).
...
- [Browser overview](/guides/browser/overview): Conceptual guide
- [Stagehand guide](/ecosystem/browser-integrations/stagehand): Usage guide
