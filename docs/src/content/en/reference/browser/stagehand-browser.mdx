...
| `stagehand_screenshot` | Capture a full-page screenshot as a PNG image |
...
Capture a full-page screenshot of the current page as a PNG image. The result includes multi-part content with the image and page metadata for vision-capable models. Use `stagehand_observe` or `stagehand_extract` when you only need text or structured data.
