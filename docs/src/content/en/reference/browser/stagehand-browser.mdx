...
<PropertiesTable
  ...
  },
  {
    ...
    description:
      "Model configuration for AI operations. Can be a string like 'openai/gpt-4o' or an object with modelName, apiKey, and baseURL.",
    isOptional: true,
  ...
  },
  {
    ...
    description: 'CDP WebSocket URL for connecting to an existing browser.',
    isOptional: true,
  },
  {
    name: 'scope',
...
interface StagehandAction {
  ...
  arguments?: string[];  // Action parameters
}
```
...
| **Flexibility** | Requires snapshot first | Direct instructions |
