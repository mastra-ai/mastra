...
When `recording` is configured, `AgentBrowser` also adds the alpha `browser_record` and `browser_record_caption` tools. See [Browser recording (alpha)](/ecosystem/browser/recording).
...
- [Browser overview](/ecosystem/browser/overview): Conceptual guide
- [agent-browser guide](/ecosystem/browser/agent-browser): Usage guide
