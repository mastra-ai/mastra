...
| `clickCount` | `number` | Number of clicks, 2 for double-click (optional) |
...
1. Use its ref with tools like `browser_click`, `browser_type`, etc.

```text
// 1. Get snapshot
// Returns: [textbox @e4] Search... [button @e5] Submit

// 2. Type in the search box
{ tool: "browser_type", input: { ref: "@e4", text: "mastra" } }

// 3. Click submit
{ tool: "browser_click", input: { ref: "@e5" } }
```
