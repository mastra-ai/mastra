...
### Match the browser window

Set `viewport` to `null` to disable viewport emulation. The page then uses the real browser window size and follows it as the window resizes. This is useful for headed sessions where you want the page to fill the visible window.
