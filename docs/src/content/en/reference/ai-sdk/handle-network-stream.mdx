...
Framework-agnostic handler for streaming network execution in AI SDK-compatible format. Use this function directly when you need to handle network streaming outside of Hono or Mastra's own [apiRoutes](/docs/v1/server-db/custom-api-routes) feature. 
