...
Framework-agnostic handler for streaming agent chat in AI SDK-compatible format. Use this function directly when you need to handle chat streaming outside of Hono or Mastra's own [apiRoutes](/docs/v1/server-db/custom-api-routes) feature. 
