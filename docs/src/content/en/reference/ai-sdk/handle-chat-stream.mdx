...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      description: "Memory configuration for the agent. When provided, only the latest user message is sent to the agent to avoid duplication, since memory recall provides the conversation history.",
      isOptional: true,
    },
    {
      name: "defaultOptions",
