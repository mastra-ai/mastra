...
export async function POST(req: Request) {
  ...
  const stream = await handleChatStream({
    ...
    params,
    // Optional: pass provider-specific options (e.g. OpenAI reasoningEffort)
...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      description: "Provider-specific options (e.g. openai.reasoningEffort) forwarded to the agent's stream/resumeStream call. Overrides params.providerOptions when both are set.",
      isOptional: true,
    },
    {
      name: "sendStart",
