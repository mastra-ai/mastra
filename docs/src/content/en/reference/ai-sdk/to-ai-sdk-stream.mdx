...
This is useful when building custom streaming endpoints outside of Mastra's built-in route handlers like [`chatRoute()`](/reference/v1/ai-sdk/chat-route) or [`workflowRoute()`](/reference/v1/ai-sdk/workflow-route).
...
The first parameter is the Mastra stream to convert. Can be one of:
