...
This is useful when building custom streaming endpoints outside Mastra's provided route helpers such as [`chatRoute()`](./chat-route) or [`workflowRoute()`](./workflow-route).
