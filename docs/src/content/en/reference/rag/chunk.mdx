...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      isOptional: true,
      defaultValue: "4000",
      description: "Maximum size of each chunk, applied universally across all strategies.",
    },
    {
      name: "overlap",
      type: "number",
...
const chunks = await doc.chunk({
  strategy: "sentence",
  maxSize: 450, // Sentence-specific option
...
<PropertiesTable
  content={[
    ...
    },
    {
      ...
      isOptional: true,
      defaultValue: "true",
      description: "Whether to preserve whitespace around sentence boundaries in the output.",
    },
    {
