...
description: "Use rerankWithScorer() with a RelevanceScoreProvider to reorder vector search results by semantic relevance, vector similarity, and original position."
packages:
  - "@mastra/rag"
---
