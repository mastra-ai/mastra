...
description: "Use rerankWithScorer() with a RelevanceScoreProvider to reorder vector search results by semantic relevance and vector similarity while accounting for position."
packages:
  - "@mastra/rag"
---
