...
| Status | Condition |
| - | - |
| `400` | Experiment isn't external (`EXPERIMENT_NOT_EXTERNAL`), or the dataset has no items at the pinned version (`EXPERIMENT_NO_ITEMS`) |
