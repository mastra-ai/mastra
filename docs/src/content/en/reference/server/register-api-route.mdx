...
**Note:** Paths cannot start with `/api/` as this prefix is reserved for built-in Mastra routes.
  ...
  openapi: {
    ...
    responses: {
      200: {
        ...
        content: {
          "application/json": {
            schema: ItemSchema, // Zod schemas are auto-converted
          },
        },
      },
      404: {
...
- [Custom API Routes Guide](/docs/v1/server/custom-api-routes) - Usage guide with examples
- [Server Middleware](/docs/v1/server/middleware) - Global middleware configuration
- [createRoute()](/reference/v1/server/create-route) - Type-safe route creation for server adapters
- [Server Routes](/reference/v1/server/routes) - Built-in Mastra server routes
