...
The `createRoute()` function creates type-safe routes with Zod validation and automatic OpenAPI spec generation.
...
- [Built-in Routes](/reference/server/routes) - Default Mastra routes
- [MastraServer](/reference/server/mastra-server) - Server adapter class
- [Server Adapters](/docs/server-db/server-adapters) - Using adapters
