...
description: "The @mastra/elysia package provides a server adapter for running Mastra with Elysia."
packages:
  - "@mastra/elysia"
---
...
<PropertiesTable
  ...
  },
  {
    ...
    description:
      'MCP transport options, such as `setRequestAuth` to control what tools see as `context.mcp.extra.authInfo`.',
    isOptional: true,
  },
]}
/>
