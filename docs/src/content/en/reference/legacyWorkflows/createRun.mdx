---
title: "Reference: Workflow.createRun() | Legacy Workflows"
...
- See the [Creating a Workflow](/examples/v0/workflows_legacy/creating-a-workflow) example for complete usage
