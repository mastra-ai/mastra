...
```bash copy
npx create-mastra@^0 --template template-name
```
...
For information on contributing your own templates to the Mastra ecosystem, see the [Contributing Templates](/docs/v0/community/contributing-templates) guide in the community section.
