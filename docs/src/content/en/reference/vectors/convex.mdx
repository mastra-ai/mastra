...
Before using `ConvexVector`, you need to set up the Convex schema and storage handler. See [Convex Storage Setup](/reference/storage/convex#convex-setup) for complete instructions.
...
- [Convex Storage](/reference/storage/convex)
- [Metadata Filters](/docs/rag/metadata-filters)
