...
description: "The DuckDB storage implementation provides an embedded high-performance vector search solution using DuckDB, an in-process analytical database."
packages:
  - "@mastra/duckdb"
---
