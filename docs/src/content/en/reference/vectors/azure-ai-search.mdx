...
<PropertiesTable
  ...
  },
  {
    ...
    isOptional: true,
    description:
      'Metadata keys that should also be created as explicit filterable Azure AI Search fields, in addition to the JSON-encoded metadata blob.',
  },
]}
/>
...
<PropertiesTable
  ...
  },
  {
    ...
    isOptional: true,
    description:
      'Metadata filter for the query. Accepts Mastra-style operators ($eq, $ne, $gt, $gte, $lt, $lte, $in, $nin, $exists, $and, $or, $not) or the legacy Azure-specific shape (eq, ne, gt, ge, lt, le, contains, startsWith, endsWith, any, all, $filter).',
  },
  {
    name: 'includeVector',
    type: 'boolean',
