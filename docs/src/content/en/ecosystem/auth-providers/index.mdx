...
- [Simple Auth](/ecosystem/auth-providers/simple-auth): Token-to-user mapping for development and API keys
- [JSON Web Token (JWT)](/ecosystem/auth-providers/jwt): HMAC-signed JWT verification

### Third-party integrations

- [Auth0](/ecosystem/auth-providers/auth0)
- [Better Auth](/ecosystem/auth-providers/better-auth)
- [Clerk](/ecosystem/auth-providers/clerk)
- [Firebase](/ecosystem/auth-providers/firebase)
- [Google](/ecosystem/auth-providers/google)
- [Okta](/ecosystem/auth-providers/okta)
- [Supabase](/ecosystem/auth-providers/supabase)
- [WorkOS](/ecosystem/auth-providers/workos)

### Advanced

- [Composite Auth](/ecosystem/auth-providers/composite-auth): Combine multiple auth providers
- [Custom Auth Provider](/ecosystem/auth-providers/custom-auth-provider): Build your own provider
