...
- [Auth overview](/ecosystem/auth-providers): Available auth providers and how they work
- [Token-based auth](/ecosystem/auth-providers/simple-auth): Token-to-user mapping authentication
- [Worker deployment](/ecosystem/deployment-targets/mastra-workers): Set up split worker processes
