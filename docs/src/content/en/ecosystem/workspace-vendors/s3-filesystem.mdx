...
See [E2BSandbox reference](/ecosystem/workspace-vendors/e2b-sandbox) for more details on mounting.

## Related

- [WorkspaceFilesystem interface](/reference/workspace/filesystem)
- [ArchilFilesystem reference](/ecosystem/workspace-vendors/archil-filesystem)
