...
- **`deleteFile`** on a directory delegates to `rmdir({ recursive: true })`, matching the [`S3Filesystem`](/ecosystem/workspace-vendors/s3-filesystem) and [`GCSFilesystem`](/ecosystem/workspace-vendors/gcs-filesystem) behavior.
...
- [S3Filesystem reference](/ecosystem/workspace-vendors/s3-filesystem)
- [GCSFilesystem reference](/ecosystem/workspace-vendors/gcs-filesystem)
- [AzureBlobFilesystem reference](/ecosystem/workspace-vendors/azure-blob-filesystem)
