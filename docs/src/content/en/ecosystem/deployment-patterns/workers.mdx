...
The [worker deployment guide](/ecosystem/deployment-targets/mastra-workers) walks through this setup with a Docker Compose example.
...
- [Worker deployment guide](/ecosystem/deployment-targets/mastra-workers): Docker Compose example and topology options
- [Worker authentication](/ecosystem/auth-providers/workers): Secure worker-to-API communication
