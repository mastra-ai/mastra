...
- The sandbox URL is public. Anyone with the URL can reach your Mastra server, including Studio. Enable [server auth](/ecosystem/auth-providers) for anything beyond throwaway previews.
