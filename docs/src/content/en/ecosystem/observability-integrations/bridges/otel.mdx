...
If you don't have existing OpenTelemetry instrumentation, the [OpenTelemetry Exporter](/ecosystem/observability-integrations/exporters/otel) may be simpler, it sends traces directly without requiring an OTEL SDK setup.
...
For details on span naming and attributes, see the [OpenTelemetry Exporter semantic conventions](/ecosystem/observability-integrations/exporters/otel#opentelemetry-semantic-conventions).
...
- [OpenTelemetry Exporter](/ecosystem/observability-integrations/exporters/otel): For sending traces to OTEL backends
