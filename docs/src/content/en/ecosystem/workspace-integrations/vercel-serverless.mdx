...
For a full Linux MicroVM with a persistent filesystem, `sudo` access, exposed ports, and background processes, use [`VercelSandbox`](/ecosystem/workspace-integrations/vercel-sandbox), which is backed by the [Vercel Sandbox](https://vercel.com/docs/vercel-sandbox) product.
...
- [E2BSandbox](/ecosystem/workspace-integrations/e2b-sandbox): Full-featured cloud sandbox with persistent filesystem and process management
