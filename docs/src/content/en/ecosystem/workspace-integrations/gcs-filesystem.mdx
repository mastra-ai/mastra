...
See [E2BSandbox reference](/ecosystem/workspace-integrations/e2b-sandbox) for more details on mounting.

## Related

- [WorkspaceFilesystem interface](/reference/workspace/filesystem)
- [ArchilFilesystem reference](/ecosystem/workspace-integrations/archil-filesystem)
- [S3Filesystem reference](/ecosystem/workspace-integrations/s3-filesystem)
- [AzureBlobFilesystem reference](/ecosystem/workspace-integrations/azure-blob-filesystem)
