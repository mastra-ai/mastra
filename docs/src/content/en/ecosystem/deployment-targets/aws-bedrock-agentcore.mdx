...
For a Lambda-based deployment of the full Mastra server, see the [AWS Lambda guide](/ecosystem/deployment-targets/aws-lambda). For a long-lived virtual machine, see the [Amazon EC2 guide](/ecosystem/deployment-targets/amazon-ec2).
