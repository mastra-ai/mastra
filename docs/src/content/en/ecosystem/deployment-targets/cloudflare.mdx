...
If you're using a [server adapter](/guides/server/server-adapters) or [web framework](/guides/deployment/web-framework), deploy the way you normally would for that framework.
