...
If you're using a [server adapter](/docs/server/server-adapters) or [web framework](/ecosystem/deployment-patterns/web-framework), deploy the way you normally would for that framework.
