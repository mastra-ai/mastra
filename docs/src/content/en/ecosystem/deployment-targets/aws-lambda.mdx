...
<Steps>
  ...
  <StepItem>
    ...
    :::warning
    For production deployments, set up [authentication](/guides/server/auth) before exposing your endpoints publicly, restrict CORS origins to your trusted domains, use AWS IAM roles for secure access to other AWS services, and store sensitive environment variables in AWS Secrets Manager or Parameter Store.
    :::
  </StepItem>
</Steps>
...
- [Mastra server](/guides/server/mastra-server)
