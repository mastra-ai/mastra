...
<CopyPrompt identifier="next-js-quickstart" description="Use this pre-built prompt to build your project">
  ...
  [https://mastra.ai/ecosystem/app-frameworks/next-js.md](https://mastra.ai/ecosystem/app-frameworks/next-js.md)
...
If you want to run [Studio](/guides/studio/overview) alongside your Next.js app and have both share the same database, update the storage URL in `src/mastra/index.ts` to use an absolute path:
...
- Deploy your agent to [Vercel](/ecosystem/deployment-targets/vercel)
