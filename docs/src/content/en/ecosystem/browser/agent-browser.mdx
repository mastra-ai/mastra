...
This adds `browser_record` and `browser_record_caption` to the agent's toolset. See [Browser recording (alpha)](/ecosystem/browser/recording) for details. See [AgentBrowser reference](/reference/browser/agent-browser) for all configuration options and tool details.

## Related

- [Browser overview](/ecosystem/browser/overview)
- [Stagehand](/ecosystem/browser/stagehand)
- [Firecrawl](/ecosystem/browser/firecrawl)
- [Browser recording (alpha)](/ecosystem/browser/recording)
