...
For SDK-based browser automation, use [AgentBrowser](/ecosystem/browser/agent-browser) or [Stagehand](/ecosystem/browser/stagehand) instead.
...
Install the corresponding [skill](/ecosystem/workspace/skills) so the agent knows how to use the CLI:
...
BrowserViewer supports three CLI providers. Each CLI must be installed separately in your workspace environment. Each CLI also publishes a [skill](/ecosystem/workspace/skills) that teaches the agent its commands and workflows.
...
- [Browser overview](/ecosystem/browser/overview)
- [AgentBrowser](/ecosystem/browser/agent-browser)
- [Stagehand](/ecosystem/browser/stagehand)
- [Workspace overview](/ecosystem/workspace/overview)
- [Workspace skills](/ecosystem/workspace/skills)
