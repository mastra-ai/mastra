...
description: "Run Mastra agents in E2B cloud desktops with screenshot, mouse, keyboard, command execution, live viewing, storage mounts, and computer-use tools."
packages:
  - "@mastra/e2b-desktop"
---
