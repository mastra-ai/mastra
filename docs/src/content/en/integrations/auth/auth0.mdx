---
title: "Auth0 | Auth"
description: "Authenticate Mastra servers with Auth0 JWTs, configure credentials and authorization, and connect client applications with authenticated requests."
packages:
  - "@mastra/auth-auth0"
  - "@mastra/client-js"
  - "@mastra/core"
