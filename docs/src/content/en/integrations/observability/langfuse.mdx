...
The Mastra CLI can import historical trace observations from Langfuse Cloud or a self-hosted Langfuse v4 or later instance. This is separate from configuring the exporter on this page. See [Import traces into Mastra Platform](/docs/observability/tracing/import-traces) for credentials, dry runs, resume, verification, and current limits.
