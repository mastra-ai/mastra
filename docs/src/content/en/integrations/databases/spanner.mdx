...
description: "Persist Mastra data in Google Cloud Spanner with strong consistency, GoogleSQL schemas, emulator support, initialization, and direct database access."
packages:
  - "@mastra/core"
  - "@mastra/spanner"
---
...
- `mastra_channel_installations` / `mastra_channel_config` / `mastra_channel_state`: multi-platform channel installations, per-platform configuration, and shared channel state (deduplication keys and interactive state)
