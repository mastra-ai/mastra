...
Mastra retains each deletion predicate for 45 days so an external scheduler can reapply requests and verify physical purging. Mastra OSS provides the storage primitives but doesn't run this scheduler.
