...
- **[DefaultExporter](/docs/observability/tracing/exporters/default)** - Persists traces to your storage
- **[CloudExporter](/docs/observability/tracing/exporters/cloud)** - Sends to Mastra Cloud (if token is set)
- **[SensitiveDataFilter](/docs/observability/tracing/processors/sensitive-data-filter)** - Redacts sensitive fields
- **[100% sampling](/docs/observability/tracing/overview#always-sample)** - All traces are collected
...
- [Sensitive Data Filter](/docs/observability/tracing/processors/sensitive-data-filter) - Redact sensitive information
- [Configuration Patterns](/docs/observability/tracing/overview#common-configuration-patterns--troubleshooting) - Best practices

### Reference

- [Configuration](/reference/observability/tracing/configuration) - ObservabilityConfig API
- [Exporters](/reference/observability/tracing/exporters/default-exporter) - DefaultExporter details
- [Span Types](/reference/observability/tracing/spans) - Span interfaces and methods
