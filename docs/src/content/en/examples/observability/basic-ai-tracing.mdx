---
title: "Example: Basic AI Tracing Example | Observability"
...
- **[DefaultExporter](/docs/v0/observability/ai-tracing/exporters/default)** - Persists traces to your storage
- **[CloudExporter](/docs/v0/observability/ai-tracing/exporters/cloud)** - Sends to Mastra Cloud (if token is set)
- **[SensitiveDataFilter](/docs/v0/observability/ai-tracing/processors/sensitive-data-filter)** - Redacts sensitive fields
- **[100% sampling](/docs/v0/observability/ai-tracing/overview#always-sample)** - All traces are collected
...
- [AI Tracing Overview](/docs/v0/observability/ai-tracing/overview) - Complete guide to tracing
- [Sensitive Data Filter](/docs/v0/observability/ai-tracing/processors/sensitive-data-filter) - Redact sensitive information
- [Configuration Patterns](/docs/v0/observability/ai-tracing/overview#common-configuration-patterns--troubleshooting) - Best practices

### Reference

- [Configuration](/reference/v0/observability/ai-tracing/configuration) - ObservabilityConfig API
- [Exporters](/reference/v0/observability/ai-tracing/exporters/default-exporter) - DefaultExporter details
- [Span Types](/reference/v0/observability/ai-tracing/span) - Span interfaces and methods
