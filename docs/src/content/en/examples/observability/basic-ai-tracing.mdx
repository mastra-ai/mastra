...
If you want to view traces in Mastra Cloude, create an `.env` file with your access token:
...
- **[SensitiveDataFilter](/docs/observability/processors/sensitive-data-filter)** - Redacts sensitive fields
...
In the Playground or in Mastra Cloud, goto the Observability page, and click on a Trace. You can also click on individual spans to get input, output, attributes & metadata.
...
- [Sensitive Data Filter](/docs/observability/processors/sensitive-data-filter) - Redact sensitive information
