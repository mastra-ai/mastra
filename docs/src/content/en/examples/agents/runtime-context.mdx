---
title: "Example: Runtime Context | Agents"
...
- [Runtime Context Documentation](/docs/v0/server-db/runtime-context)
- [Agent Reference](/reference/v0/agents/agent)
- [Input Processors](/docs/v0/agents/guardrails)
- [Output Processors](/docs/v0/agents/guardrails)
- [Scorers](/docs/v0/scorers/overview)
