---
title: Request Context Example | Agents | Mastra Docs
...
export const supportAgent = new Agent({
  ...
  instructions: async ({ requestContext }: { requestContext: RequestContext<SupportRequestContext> }) => {
  ...
  model: ({ requestContext }: { requestContext: RequestContext<SupportRequestContext> }) => {
    const userTier = requestContext.get("user-tier");
  ...
  tools: ({ requestContext }: { requestContext: RequestContext<SupportRequestContext> }) => {
    const userTier = requestContext.get("user-tier");
  ...
  memory: ({ requestContext }: { requestContext: RequestContext<SupportRequestContext> }) => {
    const userTier = requestContext.get("user-tier");
  ...
  inputProcessors: ({ requestContext }: { requestContext: RequestContext<SupportRequestContext> }) => {
    const userTier = requestContext.get("user-tier");
  ...
  outputProcessors: ({ requestContext }: { requestContext: RequestContext<SupportRequestContext> }) => {
    const userTier = requestContext.get("user-tier");
  ...
  scorers: ({ requestContext }: { requestContext: RequestContext<SupportRequestContext> }) => {
    const userTier = requestContext.get("user-tier");
...
- [Request Context Documentation](../../docs/server-db/runtime-context.mdx)
