...
```ts showLineNumbers copy filename="src/mastra/tools/index.ts"
...
```ts showLineNumbers copy filename="app/api/chat/route.ts"
...
```ts showLineNumbers copy filename="app/api/initial-chat/route.ts"
import { mastra } from "@/src/mastra";
