...
description: Example of creating an AI agent in Mastra that uses a dedicated workflow to provide weather information.
---
...
```typescript filename="src/mastra/tools/soccer-workflow.ts" showLineNumbers copy
...
```typescript filename="src/mastra/agents/soccer-agent.ts" showLineNumbers copy
