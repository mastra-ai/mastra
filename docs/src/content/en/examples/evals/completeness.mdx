---
title: "Example: Completeness Evaluation | Evals"
...
> See [CompletenessMetric](/reference/v0/evals/completeness) for a full list of configuration options.
...
<GithubLink
  outdated={true}
  marginTop="mt-16"
  href="https://github.com/mastra-ai/mastra/blob/main/examples/basics/evals/completeness"
/>
