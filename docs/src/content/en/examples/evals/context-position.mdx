---
title: "Example: Context Position Evaluation | Evals"
...
> See [ContextPositionMetric](/reference/v0/evals/context-position) for a full list of configuration options.
...
<GithubLink
  outdated={true}
  marginTop="mt-16"
  href="https://github.com/mastra-ai/mastra/blob/main/examples/basics/evals/context-position"
/>
