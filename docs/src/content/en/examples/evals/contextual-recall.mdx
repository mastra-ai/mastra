---
title: "Example: Contextual Recall Evaluation | Evals"
...
> See [ContextualRecallMetric](/reference/v0/evals/contextual-recall) for a full list of configuration options.
...
<GithubLink
  outdated={true}
  marginTop="mt-16"
  href="https://github.com/mastra-ai/mastra/blob/main/examples/basics/evals/contextual-recall"
/>
