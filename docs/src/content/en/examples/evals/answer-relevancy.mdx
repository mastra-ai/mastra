---
title: "Example: Answer Relevancy Evaluation | Evals"
...
> See [AnswerRelevancyMetric](/reference/v0/evals/answer-relevancy) for a full list of configuration options.
...
<GithubLink
  outdated={true}
  marginTop="mt-16"
  href="https://github.com/mastra-ai/mastra/blob/main/examples/basics/evals/answer-relevancy"
/>
