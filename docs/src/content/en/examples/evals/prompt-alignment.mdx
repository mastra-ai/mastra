---
title: "Example: Prompt Alignment Evaluation | Evals"
...
> See [PromptAlignmentMetric](/reference/v0/evals/prompt-alignment) for a full list of configuration options.
...
<GithubLink
  outdated={true}
  marginTop="mt-16"
  href="https://github.com/mastra-ai/mastra/blob/main/examples/basics/evals/prompt-alignment"
/>
