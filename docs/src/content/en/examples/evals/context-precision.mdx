---
title: "Example: Context Precision Evaluation | Evals"
...
> See [ContextPrecisionMetric](/reference/v0/evals/context-precision) for a full list of configuration options.
...
<GithubLink
  outdated={true}
  marginTop="mt-16"
  href="https://github.com/mastra-ai/mastra/blob/main/examples/basics/evals/context-precision"
/>
