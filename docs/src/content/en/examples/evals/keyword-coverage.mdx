---
title: "Example: Keyword Coverage Evaluation | Evals"
...
> See [KeywordCoverageMetric](/reference/v0/evals/keyword-coverage) for a full list of configuration options.
...
<GithubLink
  outdated={true}
  marginTop="mt-16"
  href="https://github.com/mastra-ai/mastra/blob/main/examples/basics/evals/keyword-coverage"
/>
