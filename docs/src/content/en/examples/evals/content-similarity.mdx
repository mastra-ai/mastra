---
title: "Example: Content Similarity Evaluation | Evals"
...
> See [ContentSimilarityMetric](/reference/v0/evals/content-similarity) for a full list of configuration options.
...
<GithubLink
  outdated={true}
  marginTop="mt-16"
  href="https://github.com/mastra-ai/mastra/blob/main/examples/basics/evals/content-similarity"
/>
