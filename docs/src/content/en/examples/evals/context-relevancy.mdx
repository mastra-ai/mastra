---
title: "Example: Context Relevancy Evaluation | Evals"
...
> See [ContextRelevancyMetric](/reference/v0/evals/context-relevancy) for a full list of configuration options.
...
<GithubLink
  outdated={true}
  marginTop="mt-16"
  href="https://github.com/mastra-ai/mastra/blob/main/examples/basics/evals/context-relevancy"
/>
