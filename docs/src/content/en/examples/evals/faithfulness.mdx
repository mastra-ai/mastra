---
title: "Example: Faithfulness Evaluation | Evals"
...
> See [FaithfulnessMetric](/reference/v0/evals/faithfulness) for a full list of configuration options.
...
<GithubLink
  outdated={true}
  marginTop="mt-16"
  href="https://github.com/mastra-ai/mastra/blob/main/examples/basics/evals/faithfulness"
/>
