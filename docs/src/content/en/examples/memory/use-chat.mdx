---
title: "Example: AI SDK useChat Hook | Memory | Mastra Docs"
description: Example for how to integrate Mastra memory with the Vercel AI SDK useChat hook when using a Mastra Server deployment.
---
