---
title: "Example: Streaming Structured Working Memory | Memory | Mastra Docs"
description: Example for how to use structured working memory with Zod schemas to maintain a todo list across conversations.
---
