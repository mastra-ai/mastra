...
Providing a `schema` helps define the structure of what should be remembered using Zod validation. In this example, the schema organizes tasks into active and completed items with proper typing.
