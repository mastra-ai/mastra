---
title: "Example: Streaming Working Memory (Advanced) | Memory | Mastra Docs"
description: Example for how to use working memory to maintain a todo list across conversations with UI feedback.
---
