---
title: "Example: Data Mapping with Workflow Variables (Legacy) | Workflows (Legacy)"
...
For more information on workflow variables, see the [Workflow Variables documentation](/docs/v0/workflows-legacy/variables).
