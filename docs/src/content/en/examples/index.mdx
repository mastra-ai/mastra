    ...
    Memory: [
      {
        ...
        href: "https://github.com/mastra-ai/mastra/tree/main/examples/memory-with-template",
      },
      {
        title: "Memory with Schema",
        href: "https://github.com/mastra-ai/mastra/tree/main/examples/memory-with-schema",
      },
    ],
    RAG: [
