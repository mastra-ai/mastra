...
The Mastra Client SDK provides a simple and type-safe interface for interacting with your [Mastra Server](/docs/v0/server-db/mastra-server) from your client environment.
...
<Tabs>
  <TabItem value="npm" label="npm">
    ...
    ```bash copy
    npm install @mastra/client-js@^0
    ```
...
- **[Agents](/reference/v0/client-js/agents)**: Generate responses and stream conversations.
- **[Memory](/reference/v0/client-js/memory)**: Manage conversation threads and message history.
- **[Tools](/reference/v0/client-js/tools)**: Executed and managed tools.
- **[Workflows](/reference/v0/client-js/workflows)**: Trigger workflows and track their execution.
- **[Vectors](/reference/v0/client-js/vectors)**: Use vector embeddings for semantic search.
- **[Logs](/reference/v0/client-js/logs)**: View logs and debug system behavior.
- **[Telemetry](/reference/v0/client-js/telemetry)**: Monitor app performance and trace activity.
...
> See [.generate()](/reference/v0/client-js/agents#generate-response) for more information.
...
> See [.stream()](/reference/v0/client-js/agents#stream-response) for more information.
...
> See [MastraClient](/reference/v0/client-js/mastra-client) for more configuration options.
...
1. **Error Handling**: Implement proper [error handling](/reference/v0/client-js/error-handling) for development scenarios.
2. **Environment Variables**: Use environment variables for configuration.
3. **Debugging**: Enable detailed [logging](/reference/v0/client-js/logs) when needed.
4. **Performance**: Monitor application performance, [telemetry](/reference/v0/client-js/telemetry) and traces.
