...
The `studioBase` option allows you to host Mastra Studio on a sub-path of your existing application. When configured, the studio will be available at `http://your-host:port/your-base` instead of the root.
