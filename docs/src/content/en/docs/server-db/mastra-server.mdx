...
When streaming agent responses, Mastra automatically redacts sensitive information (system prompts, tool definitions, API keys) from stream chunks before sending them to clients. This is enabled by default.
