...
For simple deployments without custom server requirements, use `mastra build` instead. See [Server Configuration](/docs/v1/server-db/mastra-server).

:::

## Available adapters

- **[@mastra/hono](/docs/v1/server-db/hono-adapter)** - Hono framework adapter
- **[@mastra/express](/docs/v1/server-db/express-adapter)** - Express framework adapter
...
See the [Hono Adapter](/docs/v1/server-db/hono-adapter) or [Express Adapter](/docs/v1/server-db/express-adapter) docs for framework-specific setup.
...
- [Hono: Adding custom routes](/docs/v1/server-db/hono-adapter#adding-custom-routes)
- [Express: Adding custom routes](/docs/v1/server-db/express-adapter#adding-custom-routes)
...
| Option | Description |
|--------|-------------|
| `auth` | Authentication config, used by `registerAuthMiddleware()`. See [Authentication](/docs/v1/auth/index). |
...
See [MCP](/docs/v1/mcp/overview) for configuration details.

## Related

- [Hono Adapter](/docs/v1/server-db/hono-adapter) - Hono-specific setup
- [Express Adapter](/docs/v1/server-db/express-adapter) - Express-specific setup
- [Server Configuration](/docs/v1/server-db/mastra-server) - Using `mastra build` instead
- [Authentication](/docs/v1/auth/index) - Configuring auth for your server
