...
- For local development, check out [LibSQL Storage](/reference/v0/storage/libsql)
- For production, check out [PostgreSQL Storage](/reference/v0/storage/postgresql)
- For serverless deployments, check out [Upstash Storage](/reference/v0/storage/upstash)
- For document-based storage, check out [MongoDB Storage](/reference/v0/storage/mongodb)
