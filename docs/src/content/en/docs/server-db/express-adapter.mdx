...
- [MCP Server Adapters](https://github.com/mastra-ai/mastra/tree/main/examples/mcp-server-adapters) - Hono and Express with MCP integration

## Related

- [Server Adapters](/docs/v1/server-db/server-adapters) - Shared adapter concepts
- [Hono Adapter](/docs/v1/server-db/hono-adapter) - Alternative adapter
