...
A filesystem gives an agent tools for reading, writing, listing, and [searching](/docs/sandbox/search) files. Use it as a knowledge base or to keep a sandbox's inputs and outputs after the sandbox stops.
