...
After a successful deployment you can test your agents and workflows [Studio](./dashboard#studio) in Mastra Cloud, or interact with them using our [Client SDK](../server/mastra-client).
