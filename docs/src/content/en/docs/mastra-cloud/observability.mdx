...
With observability enabled, you can view detailed outputs from your agents in the **Traces** section in [Studio](/docs/mastra-cloud/overview).
...
With observability enabled, you can view detailed outputs from your workflows in the **Traces** section in [Studio](/docs/mastra-cloud/overview).
