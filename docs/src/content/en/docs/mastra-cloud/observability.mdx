...
More detailed traces are available for both agents and workflows by using a [logger](/docs/logging) or enabling [observability](/docs/observability/tracing/overview) using one of our [supported providers](/docs/observability/tracing/overview#exporters).

### Agents

With a [logger](/docs/logging) enabled, you can view detailed outputs from your agents in the **Traces** section in Studio.
...
With a [logger](/docs/logging) enabled, you can view detailed outputs from your workflows in the **Traces** section in Studio.
