...
For details on configuring observability, see the [Cloud Exporter](../observability/tracing/exporters/cloud) docs.

## Traces

More detailed traces are available for both agents and workflows by enabling [observability](../observability/tracing/overview) using one of our [supported providers](../observability/tracing/overview#exporters).
...
You can view detailed logs for debugging and monitoring your application's behavior on the [Logs](./dashboard#logs) page of the Dashboard.
...
- [Tracing](../observability/tracing/overview)
