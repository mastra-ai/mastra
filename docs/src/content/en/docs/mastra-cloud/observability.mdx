...
More detailed traces are available for both agents and workflows by using a [logger](/docs/logging) or enabling [observability](/docs/observability/tracing/overview) using one of our [supported providers](/reference/observability/tracing/exporters/).
