...
The **Logs** page in the [project dashboard](/docs/mastra-cloud/deployment#project-dashboard) displays detailed information for debugging and monitoring your application's behavior.
