...
![Agent Interface with Chat Tab](/en/docs/mastra-cloud/agent.png)
...
![Agent Traces View](/en/docs/mastra-cloud/agent-traces.png)
...
![Workflow Interface](/en/docs/mastra-cloud/workflow.png)
...
![Workflow Run Details](/en/docs/mastra-cloud/workflow-run.png)

When examining a specific workflow execution, you can see the detailed steps and their outputs.

## Logs

![Logs Interface](/en/docs/mastra-cloud/logs.png)
