...
Import your Mastra project to [Mastra Cloud](https://cloud.mastra.ai) to use [Studio](/docs/studio/cloud) and optionally [deploy](/docs/mastra-cloud/deployment) your agent.
...
1. **Create from your server** - Connect a self-hosted Mastra instance to [Studio](/docs/studio/cloud)
...
Once your project is imported, [Studio](/docs/studio/cloud) automatically creates a sandbox where you can interact with your agents and share access with your team.
