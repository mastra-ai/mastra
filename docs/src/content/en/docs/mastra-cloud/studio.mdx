...
Mastra Cloud provides a hosted version of [Studio](/docs/studio/overview) that gives your team a shared environment for interacting with and testing your agents. Team members can chat with agents, review traces, give feedback, and tweak system prompts - without needing to run the project locally.

[Set up your project](/docs/mastra-cloud/setup) to access Studio in the cloud.

See the [Studio documentation](/docs/studio/overview) for details on features like the Agents playground, Workflows runner, Tools testing, and MCP Servers.
