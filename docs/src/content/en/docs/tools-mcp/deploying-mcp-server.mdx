---
title: "Deploying an MCP Server | Tools & MCP"
description: Guide to setting up, building, and deploying a Mastra MCP Server using the stdio transport and publishing it to NPM.
---
