...
description: Explore advanced features for Mastra tools, including abort signals and compatibility with the Vercel AI SDK tool format.
---
...
Mastra handles both tool formats seamlessly, allowing you to mix and match as needed.
