...
<Tabs items={["Ampersand","mcp.run", "Composio.dev", "Smithery.ai"]}>
  <Tabs.Tab>
    [withampersand.com](https://withampersand.com) offers a single multi-tenant [MCP Server](https://www.npmjs.com/package/@amp-labs/mcp-server) that allows you to connect your agent to 150+ B2B Integrations. 
    
    Sign up at https://withampersand.com to get your AMPERSAND_PROJECT_ID, AMPERSAND_INTEGRATION_ID & set the groupRef to the unique customerId inside your application. 
