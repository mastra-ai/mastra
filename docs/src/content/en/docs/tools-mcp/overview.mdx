...
Use [RequestContext](../server-db/runtime-context.mdx) to access request-specific values. This lets you conditionally adjust behavior based on the context of the request.
...
> See [Request Context](../server-db/runtime-context.mdx) for more information.
