...
> See [Request Context](../server/request-context) for more information.

## Testing with Studio

Use [Studio](../getting-started/studio) to test tools with different inputs, inspect execution results, and verify tool behavior.
