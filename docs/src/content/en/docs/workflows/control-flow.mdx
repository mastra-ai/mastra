...
3. The nested workflow's final output becomes one element in the result array
4. After all nested workflows complete, the next step in the parent receives the full array
