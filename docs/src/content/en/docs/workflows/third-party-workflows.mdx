...
[Inngest](https://www.inngest.com/docs) is a developer platform for building and running background workflows with hosted infrastructure.
...
- **Real-time Monitoring**: Observability through Inngest's dashboard with step-level tracking
...
Add these imports and the API route to your existing Mastra configuration. The `inngestServe` function registers your Mastra workflows as Inngest functions.
