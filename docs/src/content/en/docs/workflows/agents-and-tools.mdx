...
> See [Structured Output](../agents/structured-output) for more options like error handling strategies and streaming with structured output.
...
> See [Calling Tools](./agents-and-tools#calling-tools) for more examples.
