...
You can specify the target step using either a step reference or a string ID:
...
For steps inside nested workflows, use dot notation or an array of step references:
...
Test individual steps with specific inputs without running the entire workflow:
