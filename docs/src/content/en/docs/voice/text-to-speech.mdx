...
- [**OpenAI**](/reference/v0/voice/openai/) - High-quality voices with natural intonation and expression
- [**Azure**](/reference/v0/voice/azure/) - Microsoft's speech service with a wide range of voices and languages
- [**ElevenLabs**](/reference/v0/voice/elevenlabs/) - Ultra-realistic voices with emotion and fine-grained control
- [**PlayAI**](/reference/v0/voice/playai/) - Specialized in natural-sounding voices with various styles
- [**Google**](/reference/v0/voice/google/) - Google's speech synthesis with multilingual support
- [**Cloudflare**](/reference/v0/voice/cloudflare/) - Edge-optimized speech synthesis for low-latency applications
- [**Deepgram**](/reference/v0/voice/deepgram/) - AI-powered speech technology with high accuracy
- [**Speechify**](/reference/v0/voice/speechify/) - Text-to-speech optimized for readability and accessibility
- [**Sarvam**](/reference/v0/voice/sarvam/) - Specialized in Indic languages and accents
- [**Murf**](/reference/v0/voice/murf/) - Studio-quality voice overs with customizable parameters
...
Check out the [Adding Voice to Agents](/docs/v0/agents/adding-voice) documentation to learn how to use TTS in an agent.
