...
Visit the [Google Gemini Live Reference](/reference/v1/voice/google-gemini-live) for more information on the Google Gemini Live voice provider.
  ...
  <TabItem value="amazon" label="Amazon Nova Sonic">
...
Visit the [Amazon Nova Sonic Reference](/reference/v1/voice/amazon-nova-sonic) for more information on the Amazon Nova Sonic voice provider.
...
- [Amazon Nova Sonic Voice](/reference/v1/voice/amazon-nova-sonic)
