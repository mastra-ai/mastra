...
To learn how to integrate voice capabilities into your agents, check out the [Adding Voice to Agents](/docs/v0/agents/adding-voice) documentation. This section covers how to use both single and multiple voice providers, as well as real-time interactions.
...
Visit the [OpenAI Voice Reference](/reference/v0/voice/openai) for more information on the OpenAI voice provider.
...
Visit the [Azure Voice Reference](/reference/v0/voice/azure) for more information on the Azure voice provider.
...
Visit the [ElevenLabs Voice Reference](/reference/v0/voice/elevenlabs) for more information on the ElevenLabs voice provider.
...
Visit the [PlayAI Voice Reference](/reference/v0/voice/playai) for more information on the PlayAI voice provider.
...
Visit the [Google Voice Reference](/reference/v0/voice/google) for more information on the Google voice provider.
...
Visit the [Cloudflare Voice Reference](/reference/v0/voice/cloudflare) for more information on the Cloudflare voice provider.
...
Visit the [Deepgram Voice Reference](/reference/v0/voice/deepgram) for more information on the Deepgram voice provider.
...
Visit the [Speechify Voice Reference](/reference/v0/voice/speechify) for more information on the Speechify voice provider.
...
Visit the [Sarvam Voice Reference](/reference/v0/voice/sarvam) for more information on the Sarvam voice provider.
...
Visit the [Murf Voice Reference](/reference/v0/voice/murf) for more information on the Murf voice provider.
...
Visit the [OpenAI Voice Reference](/reference/v0/voice/openai-realtime) for more information on the OpenAI voice provider.
...
Visit the [Google Gemini Live Reference](/reference/v0/voice/google-gemini-live) for more information on the Google Gemini Live voice provider.
...
For more information on the OpenAI Realtime voice provider, refer to the [OpenAI Realtime Voice Reference](/reference/v0/voice/openai-realtime).
...
For more information on the CompositeVoice, refer to the [CompositeVoice Reference](/reference/v0/voice/composite-voice).
...
- [Voice Examples](/examples/v0/voice/text-to-speech)
