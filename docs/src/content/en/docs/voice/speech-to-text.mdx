...
- [**OpenAI**](/reference/v0/voice/openai/) - High-accuracy transcription with Whisper models
- [**Azure**](/reference/v0/voice/azure/) - Microsoft's speech recognition with enterprise-grade reliability
- [**ElevenLabs**](/reference/v0/voice/elevenlabs/) - Advanced speech recognition with support for multiple languages
- [**Google**](/reference/v0/voice/google/) - Google's speech recognition with extensive language support
- [**Cloudflare**](/reference/v0/voice/cloudflare/) - Edge-optimized speech recognition for low-latency applications
- [**Deepgram**](/reference/v0/voice/deepgram/) - AI-powered speech recognition with high accuracy for various accents
- [**Sarvam**](/reference/v0/voice/sarvam/) - Specialized in Indic languages and accents
...
Check out the [Adding Voice to Agents](/docs/v0/agents/adding-voice) documentation to learn how to use STT in an agent.
