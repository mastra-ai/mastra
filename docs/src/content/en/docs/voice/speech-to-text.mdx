...
- [**Smallest AI**](/reference/voice/smallest/): Multilingual and English-optimized transcription with the Pulse models
...
For a broader overview of voice providers on agents, see [Voice in Mastra](/docs/voice/overview).
