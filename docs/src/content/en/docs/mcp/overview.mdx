...
> See [MCPClient](/reference/v0/tools/mcp-client) for a full list of configuration options.
...
> See the [Agent Class](/reference/v0/agents/agent) for a full list of configuration options.
...
> See [MCPServer](/reference/v0/tools/mcp-server) for a full list of configuration options.
...
**Note:** Some MCP features require persistent connections and won't work in serverless mode, including elicitation, resource subscriptions, and update notifications. See the [serverless section](/reference/v0/tools/mcp-server#starthttp) in the API reference for full details and limitations.
...
> See [getTools()](/reference/v0/tools/mcp-client#gettools) for more information.
...
> See [getToolsets()](/reference/v0/tools/mcp-client#gettoolsets) for more information.
