...
<Tabs>
  ...
  <TabItem value="apify" label="Apify">
    [Apify](https://apify.com?utm_source=mastra-docs) is the largest marketplace of tools for AI, with thousands of ready-made [Actors](https://apify.com/store?utm_source=mastra-docs) to automate your business. Use the [Apify MCP Server](https://mcp.apify.com) to get real-time web data, track competitors, generate leads, analyze sentiment, and orchestrate your apps.
