...
Metrics requires DuckDB. PostgreSQL, LibSQL, and other relational databases don't support metrics collection. If you use in-memory storage, metrics reset on every server restart.
