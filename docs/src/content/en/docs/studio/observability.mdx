...
Tracing filters out low-level framework details so your traces stay focused and readable. Visit [Trace concepts](/docs/observability/tracing/overview) for more details.
...
- [Trace concepts](/docs/observability/tracing/overview)
