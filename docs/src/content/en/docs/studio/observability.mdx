...
To find a value inside a span, type in the search field at the top of any **Input**, **Output**, **Metadata**, or **Attributes** section. Every match highlights inline, and the current match stands out from the rest. Step through matches with the **Enter** and **Shift+Enter** keys, or with the next and previous controls next to the counter.
