---
title: "Editor"
description: "Use Mastra Studio Editor to let collaborators change agent instructions and tools, test drafts, and publish updates without modifying source code."
packages:
  - "@mastra/core"
  - "@mastra/editor"
  - "@mastra/client-js"
