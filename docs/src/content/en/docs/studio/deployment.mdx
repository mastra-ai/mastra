...
description: Learn how to deploy Studio on your own infrastructure or on Mastra Cloud
packages:
  - "@mastra/core"
---
...
- [Cloud](/docs/mastra-cloud/overview) hosts Studio for you and allows you to share access with your team via link
