...
- [`AgentCoreRuntimeSandbox`](/ecosystem/workspace-vendors/agentcore-runtime-sandbox): Executes commands in AWS Bedrock AgentCore Runtime sessions
- [`AppleContainerSandbox`](/ecosystem/workspace-vendors/apple-container-sandbox): Executes commands in local OCI Linux containers using Apple's `container` CLI
- [`BlaxelSandbox`](/ecosystem/workspace-vendors/blaxel-sandbox): Executes commands in isolated Blaxel cloud sandboxes
- [`DaytonaSandbox`](/ecosystem/workspace-vendors/daytona-sandbox): Executes commands in isolated Daytona cloud sandboxes
- [`DockerSandbox`](/ecosystem/workspace-vendors/docker-sandbox): Executes commands in long-lived Docker containers on the local machine
- [`E2BSandbox`](/ecosystem/workspace-vendors/e2b-sandbox): Executes commands in isolated E2B cloud sandboxes
- [`ModalSandbox`](/ecosystem/workspace-vendors/modal-sandbox): Executes commands in isolated Modal cloud sandboxes
...
- [`RailwaySandbox`](/ecosystem/workspace-vendors/railway-sandbox): Executes commands in ephemeral, isolated Railway cloud sandboxes
- [`VercelSandbox`](/ecosystem/workspace-vendors/vercel-sandbox): Executes commands in an ephemeral Vercel Sandbox Firecracker MicroVM
- [`VercelServerlessSandbox`](/ecosystem/workspace-vendors/vercel-serverless): Executes commands as stateless Vercel serverless functions
...
- [`AgentCoreRuntimeSandbox` reference](/ecosystem/workspace-vendors/agentcore-runtime-sandbox)
- [`AppleContainerSandbox` reference](/ecosystem/workspace-vendors/apple-container-sandbox)
...
- [`ModalSandbox` reference](/ecosystem/workspace-vendors/modal-sandbox)
- [`VercelSandbox` reference](/ecosystem/workspace-vendors/vercel-sandbox)
- [`VercelServerlessSandbox` reference](/ecosystem/workspace-vendors/vercel-serverless)
