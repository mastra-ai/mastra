...
- [`S3Filesystem`](/ecosystem/workspace-vendors/s3-filesystem): Stores files in Amazon S3 or S3-compatible storage (R2, MinIO, Tigris)
- [`GCSFilesystem`](/ecosystem/workspace-vendors/gcs-filesystem): Stores files in Google Cloud Storage
- [`PlatformFilesystem`](/reference/workspace/platform-filesystem): Stores files in a Mastra Platform workspace bucket
- [`GoogleDriveFilesystem`](/ecosystem/workspace-vendors/google-drive-filesystem): Stores files inside a Google Drive folder
- [`AzureBlobFilesystem`](/ecosystem/workspace-vendors/azure-blob-filesystem): Stores files in Azure Blob Storage
- [`FilesSDKFilesystem`](/ecosystem/workspace-vendors/files-sdk-filesystem): Stores files in any [FilesSDK](https://files-sdk.dev) adapter (S3, R2, GCS, Azure Blob, Vercel Blob, local filesystem, and more): useful when you want one provider that can target multiple backends
- [`AgentFSFilesystem`](/ecosystem/workspace-vendors/agentfs-filesystem): Stores files in a Turso/SQLite database via AgentFS
- [`MesaFilesystem`](/ecosystem/workspace-vendors/mesa-filesystem): Stores files in versioned Mesa repos
- [`ArchilFilesystem`](/ecosystem/workspace-vendors/archil-filesystem): Stores files on Archil elastic, serverless disks
...
- [GoogleDriveFilesystem reference](/ecosystem/workspace-vendors/google-drive-filesystem)
- [AzureBlobFilesystem reference](/ecosystem/workspace-vendors/azure-blob-filesystem)
- [FilesSDKFilesystem reference](/ecosystem/workspace-vendors/files-sdk-filesystem)
- [AgentFSFilesystem reference](/ecosystem/workspace-vendors/agentfs-filesystem)
- [MesaFilesystem reference](/ecosystem/workspace-vendors/mesa-filesystem)
