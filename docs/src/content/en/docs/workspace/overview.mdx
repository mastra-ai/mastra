...
When you assign a workspace to an agent, Mastra includes the corresponding workspace tools in the agent's toolset. The agent can then use these tools to interact with files and execute commands as part of its task.
