...
View the full example [here](/examples/evals/running-in-ci)
...
- Explore [off-the-shelf scorers](/docs/evals/off-the-shelf-scorers)
- Read the [runExperiment API reference](/reference/evals/run-experiment)
