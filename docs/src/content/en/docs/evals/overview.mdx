...
You can add built-in scorers to your agents to automatically evaluate their outputs. See the [full list of built-in scorers](./built-in-scorers) for all available options.
...
For more details, see [Studio](../getting-started/studio) docs.

## Next steps

- Learn how to create your own scorers in the [Creating Custom Scorers](./custom-scorers) guide
- Explore built-in scorers in the [Built-in Scorers](./built-in-scorers) section
- Test scorers with [Studio](../getting-started/studio)
