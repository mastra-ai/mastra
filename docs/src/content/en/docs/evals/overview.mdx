...
You can add built-in scorers to your agents to automatically evaluate their outputs. See the [full list of built-in scorers](/docs/evals/off-the-shelf-scorers) for all available options.
...
- Explore built-in scorers in the [Off-the-shelf Scorers](/docs/evals/off-the-shelf-scorers) section
