...
In Studio, open the global **Experiments** list and select the **Delete experiment** action on a row, or select **Delete Experiment** on the experiment's details page. The global list also lets you delete experiments orphaned by dataset deletion, which no longer have a dataset details page.
