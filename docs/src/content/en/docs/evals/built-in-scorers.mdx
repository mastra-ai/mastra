...
- [`checks.excludes`](/reference/evals/checks#checksexcludesunwanted-options): Scores 1 if output does not contain a substring (`0` or `1`)
...
- [`checks.didNotCall`](/reference/evals/checks#checksdidnotcalltoolname): Scores 1 if a tool was not called (`0` or `1`)
