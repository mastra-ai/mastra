...
:::note
For a complete polling-provider build with notification storage, agent registration, thread subscription, and testing, follow [Building a signal provider](/docs/guide/signal-provider).
:::
...
- [Guide: Building a signal provider](/docs/guide/signal-provider)
