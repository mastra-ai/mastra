...
| - | - | - |
| AgentBrowser | Accessibility tree refs | `browser_goto`, `browser_snapshot`, `browser_click`, `browser_type`, `browser_scroll`, `browser_select`, `browser_press`, `browser_hover`, `browser_back`, `browser_wait`, `browser_tabs`, `browser_drag`, `browser_dialog`, `browser_evaluate`, `browser_close` |
...
```bash
# For AgentBrowser (Playwright-based)
