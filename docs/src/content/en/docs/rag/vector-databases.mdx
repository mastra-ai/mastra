...
<Tabs>
  <TabItem value="mongodb" label="MongoDB">
    ...
    MongoDB supports hybrid search that fuses vector similarity with BM25 full-text search using server-side `$rankFusion` (requires MongoDB >= 8.1). This is useful when you want to combine semantic and keyword-based retrieval:
