...
We go deeper into chunking strategies in our [chunk documentation](/reference/v0/rag/chunk).
...
- [Chunk Reference](/reference/v0/rag/chunk)
- [Embeddings Reference](/reference/v0/rag/embeddings)

For more details on vector databases and embeddings, see:

- [Vector Databases](./vector-databases)
- [Embedding API Reference](/reference/v0/rag/embeddings)
