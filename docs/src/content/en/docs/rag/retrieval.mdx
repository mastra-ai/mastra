...
For an example of how to use the basic retrieval method, see the [Retrieve Results](/examples/v0/rag/query/retrieve-results) example.
...
For detailed information about available operators and syntax, see the [Metadata Filters Reference](/reference/v0/rag/metadata-filters).
...
For an example of how to use metadata filtering, see the [Hybrid Vector Search](/examples/v0/rag/query/hybrid-vector-search) example.
...
For detailed configuration options and advanced usage, see the [Vector Query Tool Reference](/reference/v0/tools/vector-query-tool).
...
For more details about re-ranking, see the [rerank()](/reference/v0/rag/rerankWithScorer) method.
...
For more details about graph-based retrieval, see the [GraphRAG](/reference/v0/rag/graph-rag) class and the [createGraphQueryTool()](/reference/v0/tools/graph-rag-tool) function.

For an example of how to use the graph-based retrieval method, see the [Graph-based Retrieval](/examples/v0/rag/usage/graph-rag) example.
