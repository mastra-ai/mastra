...
You can also use other relevance score providers like Cohere, ZeroEntropy, or Voyage AI:
...
```ts
import { voyageReranker } from '@mastra/voyageai'

const relevanceProvider = voyageReranker('__VOYAGE_RERANK_MODEL__')
```
