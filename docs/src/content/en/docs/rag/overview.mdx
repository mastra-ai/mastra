...
See the [OTEL Tracing](/docs/v0/observability/otel-tracing) documentation for more details.

## More resources

- [Chain of Thought RAG Example](/examples/v0/rag/usage/cot-rag)
- [All RAG Examples](/examples/v0) (including different chunking strategies, embedding models, and vector stores)
