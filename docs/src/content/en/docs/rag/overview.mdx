...
Mastra supports multiple vector stores for embedding persistence and similarity search, including pgvector, Milvus, Pinecone, and Qdrant. See the [vector database doc](./vector-databases.mdx).
