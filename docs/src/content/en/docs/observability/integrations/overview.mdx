...
- Hosted Mastra workflow: Add [Mastra platform](/docs/mastra-platform/observability).
...
- [Mastra platform](/docs/mastra-platform/observability): Send hosted observability data to Mastra platform.
...
- [Sensitive Data Filter](/reference/observability/tracing/processors/sensitive-data-filter): Redact sensitive fields before spans leave the runtime.
