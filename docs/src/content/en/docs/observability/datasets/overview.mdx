...
The Datasets page lists all your datasets with their current version and creation date.

![Datasets list page in Mastra Studio](/img/datasets/datasets-list.png)

## Creating a dataset

In the Studio, click **Create Dataset** to set a name, description, and optional schemas.

![Create dataset dialog](/img/datasets/datasets-create-dialog.png)
...
The Items tab shows all items in the dataset with search and version filtering.

![Dataset items tab](/img/datasets/datasets-item-tab.png)

Click **Add Item** to insert a new item with JSON editors for input and ground truth.

![Add item dialog](/img/datasets/datasets-add-item-dialog.png)
...
In the Studio, you can also import items in bulk from a CSV file. When importing, map each column to the corresponding dataset field.

![CSV column mapping dialog](/img/datasets/datasets-csv-column-mapping.png)
...
Open the versions panel to see the full history of changes to the dataset.

![Dataset versions panel](/img/datasets/datasets-versions-panel.png)
...
Select two versions to compare changes side by side, with status indicators for added, changed, and removed items.

![Compare dataset versions](/img/datasets/datasets-compare-versions.png)
