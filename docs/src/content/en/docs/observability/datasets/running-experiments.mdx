...
In the Studio, open a dataset and click **Run Experiment** to configure the target, scorers, and options.

![Run experiment dialog](/img/datasets/datasets-run-experiments-dialog.png)
...
The Experiments tab shows all runs for a dataset, with status and timestamps.

![Experiments tab](/img/datasets/datasets-experiments-tab.png)
...
Click an experiment to see per-item results, scores, and execution traces.

![Experiment detail page](/img/datasets/datasets-experiment-details.png)
...
Select two or more experiments to compare their scores and results side by side.

![Compare experiments page](/img/datasets/datasets-compare-experiments.png)
