...
Mastra's logging system captures logs from agents, workflows, and tools. Logs contain information about function execution, input data, and output responses in a structured format.
