---
title: "OpenTelemetry Exporter | AI Tracing | Observability"
...
- [AI Tracing Overview](/docs/v0/observability/ai-tracing/overview)
- [OpenTelemetry GenAI Conventions](https://opentelemetry.io/docs/specs/semconv/gen-ai/)
- [OTEL Exporter Reference](/reference/v0/observability/ai-tracing/exporters/otel)
