---
title: "AI Tracing | Observability"
...
- **[Default](/docs/v0/observability/ai-tracing/exporters/default)** - Persists traces to local storage for viewing in Studio
- **[Cloud](/docs/v0/observability/ai-tracing/exporters/cloud)** - Sends traces to Mastra Cloud for production monitoring and collaboration
...
- **[Arize](/docs/v0/observability/ai-tracing/exporters/arize)** - Exports traces to Arize Phoenix or Arize AX using OpenInference semantic conventions
- **[Braintrust](/docs/v0/observability/ai-tracing/exporters/braintrust)** - Exports traces to Braintrust's eval and observability platform
- **[Langfuse](/docs/v0/observability/ai-tracing/exporters/langfuse)** - Sends traces to the Langfuse open-source LLM engineering platform
- **[LangSmith](/docs/v0/observability/ai-tracing/exporters/langsmith)** - Pushes traces into LangSmith's observability and evaluation toolkit
- **[OpenTelemetry](/docs/v0/observability/ai-tracing/exporters/otel)** - Deliver traces to any OpenTelemetry-compatible observability system
...
- [Sensitive Data Filter](/docs/v0/observability/ai-tracing/processors/sensitive-data-filter) redacts sensitive information. It is enabled in the default observability config.
...
- [Basic AI Tracing Example](/examples/v0/observability/basic-ai-tracing) - Working implementation

### Reference Documentation

- [Configuration API](/reference/v0/observability/ai-tracing/configuration) - ObservabilityConfig details
- [AITracing Classes](/reference/v0/observability/ai-tracing/) - Core classes and methods
- [Span Interfaces](/reference/v0/observability/ai-tracing/span) - Span types and lifecycle
- [Type Definitions](/reference/v0/observability/ai-tracing/interfaces) - Complete interface reference
...
- [Arize](/reference/v0/observability/ai-tracing/exporters/arize) - Arize Phoenix and Arize AX integration
...
- [OpenTelemetry](/reference/v0/observability/ai-tracing/exporters/otel) - OTEL-compatible platforms

### Processors

- [Sensitive Data Filter](/docs/v0/observability/ai-tracing/processors/sensitive-data-filter) - Data redaction
