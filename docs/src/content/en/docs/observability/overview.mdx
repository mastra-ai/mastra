...
This enables tracing, log forwarding, and metrics. Mastra also supports external tracing providers like Langfuse, Datadog, and any OpenTelemetry-compatible platform. See [Configuration](/docs/observability/config), [Storage](/docs/observability/storage), and [Integrations overview](/docs/observability/integrations/overview) for setup details.
