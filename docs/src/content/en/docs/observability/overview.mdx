...
OTLP Tracing is deprecated and will be removed in a future release. For new projects, use AI Tracing which provides better support for AI-specific operations. See the [migration guide](/examples/observability/migration-from-otlp.mdx) for details.
</Callout>
...
export const mastra = new Mastra({
  ...
  telemetry: {
    enabled: true, // Enables OTLP Tracing (Deprecated)
  }
});
```
