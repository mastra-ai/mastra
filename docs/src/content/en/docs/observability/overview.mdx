...
We also support various external tracing providers like MLflow, Langfuse, Braintrust, and any OpenTelemetry-compatible platform (Datadog, New Relic, SigNoz, etc.). See more about this in the [Tracing](./tracing/overview) documentation.

## What's Next?

- **[Set up Tracing](./tracing/overview)**: Configure tracing for your application
- **[Configure Logging](./logging)**: Add structured logging
