...
export const mastra = new Mastra({
  ...
  observability: {
    default: { enabled: true }, // Enables Tracing
  },
...
We also support various external tracing providers like Langfuse, Braintrust, and any OpenTelemetry-compatible platform (Datadog, New Relic, SigNoz, etc.). See more about this in the [Tracing](/docs/observability/tracing/overview) documentation.

## What's Next?

- **[Set up Tracing](/docs/observability/tracing/overview)**: Configure tracing for your application
- **[Configure Logging](/docs/logging)**: Add structured logging
- **[View Examples](/examples/observability/basic-tracing)**: See observability in action
- **[API Reference](/reference/observability/tracing/)**: Detailed configuration options
