...
description: "Send traces, logs, metrics, scores, and feedback to Mastra Cloud"
packages:
...
The `CloudExporter` sends traces, logs, metrics, scores, and feedback to Mastra Cloud. Use it to route observability data from any Mastra app to a hosted project in Mastra Cloud.
