...
If you have existing OpenTelemetry instrumentation and want Mastra traces to inherit context from active OTEL spans, see the [OpenTelemetry Bridge](../bridges/otel) instead.
...
- [OpenTelemetry Bridge](../bridges/otel)
