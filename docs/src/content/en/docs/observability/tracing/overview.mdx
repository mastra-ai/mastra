...
- **Exporters**:
  ...
  - `CloudExporter` - Sends observability data to Mastra Cloud (requires `MASTRA_CLOUD_ACCESS_TOKEN`)
...
- **[Cloud](/docs/observability/tracing/exporters/cloud)** - Sends observability data to Mastra Cloud for production monitoring and collaboration
