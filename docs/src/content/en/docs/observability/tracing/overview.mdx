...
Tracing starts automatically after observability is configured and you run an agent or workflow.
...
- [Basic config](/docs/observability/config#basic-config): Configure the base observability instance, exporters, span processors, and logging behavior.
...
- [Bridges](/docs/observability/integrations/overview#bridges): Connect Mastra to third-party tracing systems.
