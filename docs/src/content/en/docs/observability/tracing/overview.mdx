...
Unlike the shared setup pages under observability, this page focuses on trace-specific concepts: span hierarchy, sampling, metadata, filtering, trace IDs, and external trace context.
...
- Connect Mastra traces to an existing distributed tracing system.

## Get started

Set up shared observability first:
...
Tracing starts automatically once observability is configured and agents or workflows begin running.

## Moved setup topics

<div id="configuration" />

Shared observability setup now lives on dedicated top-level pages:

<div id="basic-config" />

- [Basic config](/docs/observability/config#basic-config): Configure the base observability instance, exporters, processors, and logging behavior.

<div id="multi-config-setup" />

- [Multi-config setup](/docs/observability/config#multi-config-setup): Choose between multiple observability configs at runtime.

<div id="maintaining-studio-access" />

- [Maintaining Studio access](/docs/observability/config#maintaining-studio-access): Keep local Studio or Mastra platform visibility when adding external exporters.

<div id="exporters" />

- [Exporters](/docs/observability/integrations/overview#exporters): Send observability data to storage, Mastra platform, or external providers.

<div id="bridges" />

- [Bridges](/docs/observability/integrations/overview#bridges): Connect Mastra to an existing distributed tracing context.

<div id="flushing-traces-in-serverless-environments" />

- [Serverless runtimes](/docs/observability/config#flushing-traces-in-serverless-environments): Flush exporters before a serverless runtime pauses or exits.
...
- [MLflow](/docs/observability/integrations/exporters/otel#mlflow): MLflow OTLP endpoint setup
...
- [Sensitive Data Filter](/docs/observability/integrations/processors/sensitive-data-filter): Data redaction
