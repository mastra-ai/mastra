...
- **[Default](./exporters/default)** - Persists traces to local storage for viewing in Studio
- **[Cloud](./exporters/cloud)** - Sends traces to Mastra Cloud for production monitoring and collaboration
...
- **[Arize](./exporters/arize)** - Exports traces to Arize Phoenix or Arize AX using OpenInference semantic conventions
- **[Braintrust](./exporters/braintrust)** - Exports traces to Braintrust's eval and observability platform
- **[Langfuse](./exporters/langfuse)** - Sends traces to the Langfuse open-source LLM engineering platform
- **[LangSmith](./exporters/langsmith)** - Pushes traces into LangSmith's observability and evaluation toolkit
- **[OpenTelemetry](./exporters/otel)** - Deliver traces to any OpenTelemetry-compatible observability system
...
- **[OpenTelemetry Bridge](./bridges/otel)** - Integrate with existing OpenTelemetry infrastructure
...
- [Sensitive Data Filter](./processors/sensitive-data-filter) redacts sensitive information. It is enabled in the default observability config.
...
- [Sensitive Data Filter](./processors/sensitive-data-filter) - Data redaction
