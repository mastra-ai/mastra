...
Create a chat route for the Assistant UI frontend by using the `chatRoute()` helper from `@mastra/ai-sdk`. First, add it to your Mastra project:
...
```typescript copy title="src/mastra/index.ts" {2,27-33}
