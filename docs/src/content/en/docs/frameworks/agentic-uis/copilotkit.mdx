...
If you have not yet set up your Mastra server, follow the [getting started guide](/docs/v0/getting-started/installation) to set up a new Mastra project.
...
- [Next.js Integration with Mastra](/docs/v0/frameworks/web-frameworks/next-js) - Full-stack Next.js setup guide
