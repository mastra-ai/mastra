...
```bash copy
npm install mastra@^0 @mastra/core@^0 @mastra/libsql@^0 @mastra/client-js@^0
```
...
```bash copy
yarn add mastra@^0 @mastra/core@^0 @mastra/libsql@^0 @mastra/client-js@^0
```
...
```bash copy
pnpm add mastra@^0 @mastra/core@^0 @mastra/libsql@^0 @mastra/client-js@^0
```
...
```bash copy
bun add mastra@^0 @mastra/core@^0 @mastra/libsql@^0 @mastra/client-js@^0
```
...
```bash copy
npx mastra@^0 init --dir . --components agents,tools --example --llm openai
```

> See [mastra init](/reference/v0/cli/create-mastra) for more information.
...
> Once running, your agents are available locally. See [Local Development Environment](/docs/v0/getting-started/studio) for more information.
