...
```bash copy
npm install mastra@^0 @mastra/core@^0 @mastra/libsql@^0
```
...
```bash copy
yarn add mastra@^0 @mastra/core@^0 @mastra/libsql@^0
```
...
```bash copy
pnpm add mastra@^0 @mastra/core@^0 @mastra/libsql@^0
```
...
```bash copy
bun add mastra@^0 @mastra/core@^0 @mastra/libsql@^0
```
...
- [Deployment | With Astro on Vercel](/docs/v0/deployment/web-framework#with-astro-on-vercel)
