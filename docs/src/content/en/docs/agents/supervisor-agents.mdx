...
Supervisor agents are one approach to building multi-agent systems in Mastra. For other patterns, read the [conceptual overview](/docs/concepts/multi-agent-systems).
...
- [Guide: Research coordinator](/docs/guide/research-coordinator)
...
- [Concept: Multi-agent systems](/docs/concepts/multi-agent-systems)
