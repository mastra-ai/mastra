...
For approval flows that need extra buttons or programmatic approval from a workflow, combine three pieces:

- `toolDisplay: fn` posts whatever message you want (custom buttons, plain text, etc.).
