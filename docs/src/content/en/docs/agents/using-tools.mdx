...
- [Tools with structured output](/docs/agents/structured-output#combining-tools-and-structured-output): Model compatibility when combining tools and structured output
