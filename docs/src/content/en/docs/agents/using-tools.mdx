...
The [AgentController](/docs/agent-controller/overview) automatically includes all built-in tools in every mode, you don't need to add them manually. See [Tool approvals](/docs/agent-controller/overview#approve-tools-and-resume-suspensions) for AgentController-specific behavior.
