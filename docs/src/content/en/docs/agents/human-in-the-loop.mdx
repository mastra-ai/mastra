...
description: "Add human-in-the-loop controls to Mastra agents by requiring tool approval, suspending execution for input, and safely resuming or declining actions."
packages:
  - "@mastra/core"
  - "@mastra/libsql"
  - "@mastra/memory"
