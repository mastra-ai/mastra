...
`createCodeMode` returns the `execute_typescript` tool plus generated instructions. Add both to your agent:
...
`execute_typescript` returns a `CodeModeToolResult`:
