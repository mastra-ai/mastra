...
Heartbeats require a storage adapter that implements the schedules domain, for example [`@mastra/libsql`](/docs/storage/overview). Without one, `mastra.heartbeats.create()` throws.
