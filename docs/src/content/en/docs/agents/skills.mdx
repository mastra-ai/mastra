...
For filesystem-based skill discovery across a project, use [workspace skills](/ecosystem/workspace/skills) instead.
...
Filesystem paths use `LocalSkillSource` under the hood, which reads `SKILL.md` files following the same format as [workspace skills](/ecosystem/workspace/skills#skillmd-format).
