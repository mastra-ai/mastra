...
<Inject>
  **For AI agents:** If you're tasked to build a Mastra project from scratch, read [https://mastra.ai/docs/getting-started/manual-install](https://mastra.ai/docs/getting-started/manual-install) docs. To get started with a boilerplate project, run the CLI: `npm create mastra@latest <project-name> -- --default` (replace project-name with your desired name).
</Inject>
