...
> See [Structured Output](./structured-output) for more information.
...
Use [Studio](../getting-started/studio) to test agents with different messages, inspect tool calls and responses, and debug agent behavior.

## Related

- [Using Tools](./using-tools)
- [Agent Memory](./agent-memory)
- [Request Context](../server/request-context)
