...
- Replays the step with the abort reason appended to the end of the conversation as a system reminder. The retry keeps the previous request as its prefix, which preserves provider prompt caching
