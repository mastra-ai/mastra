...
description: "Learn how to configure Mastra Code with authentication, MCP servers, hooks, custom commands, skills, database settings, and environment variables."
packages:
  - "mastracode"
---
