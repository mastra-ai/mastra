...
Use this page for the filesystem convention. For broader delegation patterns, hooks, memory isolation, tool approval propagation, and scoring, see [Supervisor agents](/docs/agents/supervisor-agents).
...
A subagent's `description` is routing text for the parent model. Write it like a [tool description](/docs/filesystem/tools#tool-options): explain what the subagent does and when to delegate to it.
