...
![Diagram showing cursor prompt to enable Mastra docs MCP server](/img/enable-mastra-docs-cursor.png)
...
1. Open your Antigravity MCP configuration file:
    ...
    ![Antigravity interface showing configured Mastra MCP server](/img/antigravity_mcp_server.png)
...
1. To add a custom MCP server, select **Manage MCP Servers** at the top of the MCP Store and click **View raw config** in the main tab.
    ...
    ![Antigravity interface showing configured Mastra MCP server](/img/antigravity_managed_mcp.png)
...
1. Save the configuration and restart Antigravity
    ...
    ![Antigravity interface showing configured Mastra MCP server](/img/antigravity_final_interface_mcp.png)
...
3. Click "enable" on the Chat > MCP option.
    ...
    ![Settings page of VSCode to enable MCP](/img/vscode-mcp-setting.png)
...
![Settings page of VSCode to enable MCP](/img/vscode-start-mcp.png)
