...
If you did the automatic installation, you'll see a popup when you open cursor in the bottom right corner to prompt you to enable the Mastra Docs MCP Server
<img
