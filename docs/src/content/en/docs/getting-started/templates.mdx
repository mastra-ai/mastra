...
<Tabs>
  ...
  <TabItem value="yarn" label="yarn">
    ```bash copy
    yarn dlx create-mastra@^0 --template template-name
    ```
  </TabItem>
  <TabItem value="pnpm" label="pnpm">
    ```bash copy
    pnpm create mastra@^0 --template template-name
    ```
  </TabItem>
  <TabItem value="bun" label="bun">
    ```bash copy
    bun create mastra@^0 --template template-name
    ```
  </TabItem>
</Tabs>
...
```bash copy
npx create-mastra@^0 --template text-to-sql
```
...
For detailed information on creating templates, see the [Templates Reference](/reference/v0/templates/overview).
