...
Playground helps you get started with building agents. It provides an interactive UI for testing your agents, workflows, and tools, along with a REST API that exposes your Mastra application as a local service. This allows you to start building without having to worry about integrating Mastra into your project right away.

As your project evolves, Playground includes the features you need to support your next steps. You can inspect traces, run scorers, and iterate quickly as you extend your agent's capabilities.
...
- Visit  http://localhost:4111/swagger-ui to discover and interact with the REST API.
...
To explore the API interactively, visit the Swagger UI at `http://localhost:4111/swagger-ui`, where you can test endpoints directly from your browser.
...
- Learn more about Mastra's [Project Structure](/docs/getting-started/project-structure)
