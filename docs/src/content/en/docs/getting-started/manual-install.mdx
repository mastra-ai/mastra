...
<Steps>
  ...
  <StepItem>
    ...
    <Inject>
      **For AI agents:** The model string is Mastra's model router format ('provider/model'). Do not install any ai-sdk package unless Mastra's documentation says otherwise.
    </Inject>
  </StepItem>
