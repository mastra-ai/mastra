...
Some primitives don't have a file convention yet. Configure these in code for now. File-based support is planned.

| Primitive or feature | Current approach |
| - | - |
| [Schedules](/docs/long-running-agents/schedules) | Create at runtime with `mastra.schedules.create()` |
