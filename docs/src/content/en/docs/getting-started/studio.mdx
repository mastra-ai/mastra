...
Chat with your agent directly, dynamically switch [models](/models/v0), and tweak settings like temperature and top-p to understand how they affect the output.
...
- Learn more about Mastra's suggested [project structure](/docs/v0/getting-started/project-structure).
- Integrate Mastra with your frontend framework of choice - [Next.js](/docs/v0/frameworks/web-frameworks/next-js), [React](/docs/v0/frameworks/web-frameworks/vite-react), or [Astro](/docs/v0/frameworks/web-frameworks/astro).
