...
You can host the Mastra Studio on a sub-path of your existing application using the `base` configuration:
...
export const mastra = new Mastra({
  server: {
    port: 3000,
    base: "my-mastra-studio", // Studio will be available at /my-mastra-studio
  },
});
```
