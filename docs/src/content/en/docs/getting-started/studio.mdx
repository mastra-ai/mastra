...
You can host the Mastra Studio and REST APIs on a sub-path of your existing application using the `base` configuration:
...
- With `base`: `http://localhost:4111/my-mastra-studio/` (studio at sub-path)
