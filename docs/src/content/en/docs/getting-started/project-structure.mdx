...
- `src/mastra/agents/<name>`: You can define an agent by file convention instead of constructing it in code. Learn more in the [Filesystem](/docs/filesystem/overview) docs.
