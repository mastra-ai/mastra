...
Mastra is an open-source TypeScript framework for building AI applications and autonomous agents. It gives you the pieces of an agent harness out of the box, including tools, memory, workflows, observability, and evals.

Use Mastra in an existing app or run it as a standalone server. Start below with a working agent you can open in Studio and extend.
