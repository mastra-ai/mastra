...
For more control over setup, or to add Mastra to an existing project, see the [manual installation guide](/guides/v1/quickstarts/manual-install). You can also use [`mastra init`](/reference/v1/cli/mastra#mastra-init) for existing projects.
