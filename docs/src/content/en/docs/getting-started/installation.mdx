...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  <Tabs.Tab>```bash copy npm install dotenv ```</Tabs.Tab>
  <Tabs.Tab>```bash copy pnpm add dotenv ```</Tabs.Tab>
  <Tabs.Tab>```bash copy yarn add dotenv ```</Tabs.Tab>
  <Tabs.Tab>```bash copy bun add dotenv ```</Tabs.Tab>
</Tabs>
