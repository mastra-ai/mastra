...
<Callout type="info">
We've shortened and simplified the `weatherTool` example here. You can see a the complete weather tool under [Giving an Agent a Tool](/examples/agents/using-a-tool).
</Callout>
