...
Upgrading from `@mastra/mcp` v1 changes the default protocol behavior. Follow the [v2 migration guide](/docs/connections/mcp-v2-migration) before removing explicit legacy configuration.
