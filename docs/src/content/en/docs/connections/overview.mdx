---
title: "Connections"
description: "Connect Mastra to remote agents, coding agents, SDK runtimes, MCP servers, and external tools by choosing the protocol that fits your application."
packages:
  - "@mastra/core"
  - "@mastra/acp"
  - "@mastra/claude"
...
- [**SDK agents**](/docs/connections/sdk-agents): Register Claude, Cursor, OpenAI, or OpenCode SDK-backed agents while the provider SDK retains control of the runtime, tools, permissions, and agent loop.
