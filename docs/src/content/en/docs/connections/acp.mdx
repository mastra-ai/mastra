...
description: "Connect ACP-compatible coding agents to Mastra as tools or subagents, configure models and sessions, and stream Agent Client Protocol interactions."
packages:
  - "@mastra/acp"
  - "@mastra/core"
---
