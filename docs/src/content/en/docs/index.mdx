...
description: "Mastra an all-in-one framework for building AI-powered applications and agents with a modern TypeScript stack."
---
...
- [LLM routing](/) - Connect to 40+ providers through one standard interface. Use models from OpenAI, Anthropic, Google Gemini, and more.

- [Agents](/) - Build autonomous agents that use LLMs to run [tools](/) in a loop and tackle open-ended tasks. Mastra manages that loop so agents can plan, call tools, and adapt with human-like reasoning.
