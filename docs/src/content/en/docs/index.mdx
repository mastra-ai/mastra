...
Follow the [Quickstart guide](/docs/v1/getting-started/quickstart) to get started, or see the [manual installation guide](/guides/v1/quickstarts/manual-install) for advanced setup.
