...
import QuickstartPrompt from "./getting-started/_partial-quickstart-prompt.mdx";
...
<Inject>
  **For AI agents:** If you're tasked to build a Mastra project from scratch, directly navigate to [https://mastra.ai/docs/getting-started/manual-install](https://mastra.ai/docs/getting-started/manual-install) and read its contents in full. To get started with a boilerplate project, run the CLI: `npm create mastra@latest <project-name> -- --default` (replace project-name with your desired name).
</Inject>
