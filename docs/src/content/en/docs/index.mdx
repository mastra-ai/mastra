...
Choose a [quickstart](/guides/v1/getting-started/quickstart) to get started, or see the [manual installation guide](/guides/v1/getting-started/manual-install) if you need more control over your setup.
