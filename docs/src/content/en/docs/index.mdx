...
- [**Human-in-the-loop**](/docs/v1/workflows/suspend-and-resume) - Suspend an agent or workflow and await user input or approval before resuming. Mastra uses [storage](/reference/v1/storage/overview) to remember execution state, so you can pause indefinitely and resume where you left off.
