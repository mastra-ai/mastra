...
:::warning
If you're deploying to a cloud provider, remove any usage of [LibSQLStore](./overview) from your Mastra configuration. LibSQLStore requires filesystem access and is not compatible with serverless platforms.
:::
