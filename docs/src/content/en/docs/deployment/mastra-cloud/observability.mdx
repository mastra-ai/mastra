...
With a observability enabled, you can view detailed outputs from your agents in the **Traces** section in Studio.
...
With a observability enabled, you can view detailed outputs from your workflows in the **Traces** section in Studio.
