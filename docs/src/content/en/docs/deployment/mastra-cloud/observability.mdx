...
More detailed traces are available for both agents and workflows by using a [logger](/docs/v1/observability/logging) or enabling [observability](/docs/v1/observability/tracing/overview) using one of our [supported providers](/docs/v1/observability/tracing/overview#exporters).

### Agents

With a [logger](/docs/v1/observability/logging) enabled, you can view detailed outputs from your agents in the **Traces** section in Studio.
...
With a [logger](/docs/v1/observability/logging) enabled, you can view detailed outputs from your workflows in the **Traces** section in Studio.
