...
For details on configuring observability, see the [Cloud Exporter](/docs/v0/observability/ai-tracing/exporters/cloud) docs.

<MastraCloudCallout />

## Traces

More detailed traces are available for both agents and workflows by enabling [observability](/docs/v0/observability/ai-tracing/overview) using one of our [supported providers](/docs/v0/observability/ai-tracing/overview#exporters).
...
You can view detailed logs for debugging and monitoring your application's behavior on the [Logs](/docs/v0/deployment/mastra-cloud/dashboard#logs) page of the Dashboard.
...
- [Logging](/docs/v0/observability/logging)
- [Tracing](/docs/v0/observability/ai-tracing/overview)
