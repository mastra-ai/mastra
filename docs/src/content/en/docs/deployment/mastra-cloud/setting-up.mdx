...
> See our [Getting started](/docs/v0/getting-started/installation) guide to scaffold out a new Mastra project with sensible defaults.
...
- **Build and Store settings**:
  ...
  - **Store settings**: Use Mastra Cloud's built-in [LibSQLStore](/docs/v0/server-db/storage) storage
...
After a successful deployment you can test your agents and workflows [Studio](/docs/v0/deployment/mastra-cloud/dashboard#studio) in Mastra Cloud, or interact with them using our [Client SDK](/docs/v0/server-db/mastra-client).

## Next steps

- [Navigating the Dashboard](/docs/v0/deployment/mastra-cloud/dashboard)
