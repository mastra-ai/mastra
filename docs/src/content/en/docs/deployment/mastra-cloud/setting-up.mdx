...
After a successful deployment you can test your agents and workflows [Studio](/docs/deployment/mastra-cloud/dashboard#studio) in Mastra Cloud, or interact with them using our [Client SDK](/docs/server-db/mastra-client).

## Next steps

- [Navigating the Dashboard](/docs/deployment/mastra-cloud/dashboard)
