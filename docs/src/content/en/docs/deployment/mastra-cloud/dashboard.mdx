...
This page explains how to navigate the Mastra Cloud dashboard, where you can configure your project, view deployment details, and interact with agents and workflows using the built-in [Studio](/docs/v0/deployment/mastra-cloud/dashboard#studio).
...
- [Understanding Tracing and Logs](/docs/v0/deployment/mastra-cloud/observability)
