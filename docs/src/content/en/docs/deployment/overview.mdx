...
Use this option for instant previews, PR/CI smoke deploys, verifying agent-built apps, or running untrusted per-user instances. Read the [sandbox deployment guide](/docs/deployment/sandbox).
