...
For production workloads, you can split background processing — workflow orchestration, cron scheduling, and background tool execution — into separate processes or containers. Each worker type scales independently from the API.
