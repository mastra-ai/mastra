...
> To learn how to create a Cloudflare API token, see [Create API token](https://vercel.com/guides/how-do-i-use-a-vercel-api-access-token) in the Cloudflare docs.
