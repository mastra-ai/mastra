...
Deploying Mastra in a monorepo follows the same approach as deploying a standalone application. While some [Cloud](/guides/deployment) or [Serverless Platform](/guides/deployment) providers may introduce extra requirements, the core setup is the same.
