...
Any [supported storage backend](/reference/workers/overview#supported-storage-backends) works for orchestration and background tasks. If you use the scheduler worker, the backend must also support the `schedules` domain. See the [storage compatibility table](/reference/workers/overview#supported-storage-backends) for details.
...
- [Workers reference](/reference/workers/overview): Configuration details and supported backends
