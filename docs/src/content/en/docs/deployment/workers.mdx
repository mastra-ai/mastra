...
- **Workers connect outbound only.** They pull events from the distributed PubSub backend and read/write to PostgreSQL. They do not accept inbound traffic from clients.
