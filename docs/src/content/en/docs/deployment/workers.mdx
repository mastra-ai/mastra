...
The [worker deployment guide](/docs/deployment/mastra-workers) walks through this setup with a Docker Compose example.
...
- [Worker deployment guide](/docs/deployment/mastra-workers): Docker Compose example and topology options
