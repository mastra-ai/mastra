...
description: "Run Mastra workflow orchestration, schedules, and long-running background tasks in dedicated workers to keep API processes responsive and scalable."
packages:
  - "@mastra/core"
