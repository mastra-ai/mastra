...
description: "Deploy a complete Mastra server and Studio to an ephemeral CreateOS, E2B, Daytona, or Vercel sandbox and receive a public URL for testing and previews."
packages:
...
- [CreateOS](/integrations/sandboxes/createos) (`@mastra/createos`)
