...
The `VercelDeployer` class handles deployment of standalone Mastra applications to Vercel. It manages configuration, deployment, and extends the base [Deployer](/reference/v0/deployer/) class with Vercel specific functionality.

## Installation

```bash copy
npm install @mastra/deployer-vercel@^0
```
...
> See the [VercelDeployer](/reference/v0/deployer/vercel) API reference for all available configuration options.
