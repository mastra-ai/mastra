...
`npx create-mastra@^0` command.
For more information on how to create a new Mastra application,
refer to our [getting started guide](/docs/v0/getting-started/installation)
:::
...
For more memory configuration options, see the [Memory documentation](/docs/v0/memory/overview).
...
For more information about available API endpoints, see the [Server documentation](/docs/v0/deployment/building-mastra).
