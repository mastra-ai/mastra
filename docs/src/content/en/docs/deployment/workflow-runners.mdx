...
The `@mastra/workflow-sdk` package is experimental and not ready for production use. Visit the [package README](https://github.com/mastra-ai/mastra/tree/main/workflows/workflow-sdk) for setup instructions and the [Workflow SDK example](https://github.com/mastra-ai/mastra/tree/main/examples/workflow-sdk) for a complete implementation.
