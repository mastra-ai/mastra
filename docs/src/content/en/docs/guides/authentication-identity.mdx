...
description: "Design secure identity flows for Mastra by protecting endpoints, carrying trusted user context through agents and tools, and enforcing data boundaries."
packages:
  - "@mastra/core"
  - "@mastra/auth"
---
