...
[Observational Memory](/docs/memory/observational-memory) handles this continuously. An Observer turns older messages and tool interactions into dense observations. By default, periodic reflection reorganizes and compresses those observations. You can instead enable rolling archives, which keep a bounded live tail and retrieve retired observations on demand without invoking the Reflector.
