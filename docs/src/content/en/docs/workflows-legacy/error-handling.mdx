---
title: "Error Handling in Workflows (Legacy) | Workflows (Legacy)"
sidebar_position: 8
...
For more details about step retries, see the [Step Retries](/reference/v0/legacyWorkflows/step-retries) reference.
...
- [Step Retries Reference](/reference/v0/legacyWorkflows/step-retries)
- [Watch Method Reference](/reference/v0/legacyWorkflows/watch)
- [Step Conditions](/reference/v0/legacyWorkflows/step-condition)
