---
title: "Control Flow in Legacy Workflows: Branching, Merging, and Conditions | Workflows (Legacy)"
sidebar_position: 7
...
See the [Parallel Steps](/examples/v0/workflows_legacy/parallel-steps) example for more details.
...
See the [Sequential Steps](/examples/v0/workflows_legacy/sequential-steps) example for more details.
...
See the [Branching Paths](/examples/v0/workflows_legacy/branching-paths) example for more details.
