---
title: "Handling Complex LLM Operations with Workflows (Legacy) | Workflows (Legacy)"
sidebar_position: 1
...
- [Steps](/docs/v0/workflows-legacy/steps)
- [Control Flow](/docs/v0/workflows-legacy/control-flow)
- [Variables](/docs/v0/workflows-legacy/variables)
- [Suspend & Resume](/docs/v0/workflows-legacy/suspend-and-resume)
- [Dynamic Workflows](/docs/v0/workflows-legacy/dynamic-workflows)
- [Error Handling](/docs/v0/workflows-legacy/error-handling)
- [Nested Workflows](/docs/v0/workflows-legacy/nested-workflows)
- [Runtime/Dynamic Variables](/docs/v0/workflows-legacy/runtime-variables)
...
Mastra workflows automatically [log the input and output of each step within a workflow run](/docs/v0/observability/otel-tracing), allowing you to send this data to your preferred logging, telemetry, or observability tools.
...
- [Sequential Steps workflow example](/examples/v0/workflows_legacy/sequential-steps)
- [Parallel Steps workflow example](/examples/v0/workflows_legacy/parallel-steps)
- [Branching Paths workflow example](/examples/v0/workflows_legacy/branching-paths)
- [Workflow Variables example](/examples/v0/workflows_legacy/workflow-variables)
- [Cyclical Dependencies workflow example](/examples/v0/workflows_legacy/cyclical-dependencies)
- [Suspend and Resume workflow example](/examples/v0/workflows_legacy/suspend-and-resume)
