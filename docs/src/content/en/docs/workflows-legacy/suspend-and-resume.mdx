...
- [Understanding Snapshots in Mastra Workflows](/reference/v0/legacyWorkflows/snapshots) - Learn about the snapshot mechanism that powers suspend and resume functionality
...
- [Event-Driven Workflows](/reference/v0/legacyWorkflows/events) - Detailed reference for event-based workflows

## Related Resources

- See the [Suspend and Resume Example](/examples/v0/workflows_legacy/suspend-and-resume) for a complete working example
- Check the [Step Class Reference](/reference/v0/legacyWorkflows/step-class) for suspend/resume API details
- Review [Workflow Observability](/docs/v0/observability/otel-tracing) for monitoring suspended workflows
