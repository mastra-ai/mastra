...
- [Templates Reference](/reference/v0/templates/overview) - Technical requirements and conventions
- [Project Structure](/docs/v0/getting-started/project-structure) - Standard Mastra project organization
...
Ensure your template meets all requirements outlined in the [Templates Reference](/reference/v0/templates/overview):
