...
description: "Configure Mastra Fine-Grained Authorization to enforce resource-level permissions, map routes and actions, and scope stored resources for enterprise users."
packages:
  - "@mastra/auth-workos"
  - "@mastra/core"
  - "@mastra/mcp"
