...
description: "Create a custom Mastra authentication provider by extending MastraAuthProvider to validate tokens, authorize users, and protect selected server routes."
packages:
  - "@mastra/core"
  - "@mastra/auth"
---
