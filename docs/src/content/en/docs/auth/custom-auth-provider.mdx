...
description: "Create a custom Mastra authentication provider by extending MastraAuthProvider, with token validation and user authorization protecting selected server routes."
packages:
  - "@mastra/core"
  - "@mastra/auth"
---
