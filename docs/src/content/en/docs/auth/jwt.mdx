...
description: "Secure Mastra APIs with MastraJwtAuth by creating JSON Web Tokens, configuring a shared secret, and sending authenticated requests with MastraClient."
packages:
  - "@mastra/auth"
  - "@mastra/client-js"
  - "@mastra/core"
