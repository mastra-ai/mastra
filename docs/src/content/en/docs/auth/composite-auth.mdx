...
description: "Combine multiple Mastra authentication providers with CompositeAuth, control provider order, and support fallback across JWT, OAuth, and custom identity systems."
packages:
  - "@mastra/core"
---
