...
Semantic recall relies on a [storage and vector db](/reference/v0/memory/memory-class) to store messages and their embeddings.
...
Semantic recall relies on an [embedding model](/reference/v0/memory/memory-class) to convert messages into embeddings. Mastra supports embedding models through the model router using `provider/model` strings, or you can use any [embedding model](https://sdk.vercel.ai/docs/ai-sdk-core/embeddings) compatible with the AI SDK.
...
For detailed information about index configuration options and performance tuning, see the [PgVector configuration guide](/reference/v0/vectors/pg#index-configuration-guide).
