...
The main parameters that control semantic recall behavior are:
...
4. **filter**: Optional metadata filtering to restrict search results to specific criteria (e.g., projectId, category, etc.)
