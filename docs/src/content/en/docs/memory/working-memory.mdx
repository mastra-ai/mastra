...
Here's an example of a custom template. In this example the agent will store the user's name, location, timezone, etc as soon as the user sends a message containing any of the info:
