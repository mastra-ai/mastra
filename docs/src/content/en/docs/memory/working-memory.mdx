...
While [conversation history](/docs/v0/memory/conversation-history) and [semantic recall](./semantic-recall) help agents remember conversations, working memory allows them to maintain persistent information about users across interactions.
...
- [Working memory with template](/examples/v0/memory/working-memory-template)
- [Working memory with schema](/examples/v0/memory/working-memory-schema)
