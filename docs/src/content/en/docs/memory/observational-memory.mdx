...
Pass `toolNames` to drop results from a different set of tools. Because a hook is just a function over the messages, it composes with your own filtering by chaining the outputs:
