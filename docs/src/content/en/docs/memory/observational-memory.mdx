...
The generic `@mastra/memory` configuration above keeps its concrete default model. Mastra Code and Factory add a separate **Auto** selection for each Observational Memory role.
