...
Memory processors are [processors](/docs/v1/agents/guardrails) that operate specifically on memory-related messages and state.
...
- [Guardrails](/docs/v1/agents/guardrails) - General processor concepts and custom processor creation
