...
- Add [Message History](./message-history) to control recent message recall
- Add [Working Memory](./working-memory) to store persistent user details
- Add [Semantic Recall](./semantic-recall) for RAG-based memory retrieval
