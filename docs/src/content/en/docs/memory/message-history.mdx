...
:::info
Each message belongs to a thread (the conversation) and a resource (the user or entity it's associated with). See [Threads and resources](/docs/storage/overview#threads-and-resources) for more detail.
:::
