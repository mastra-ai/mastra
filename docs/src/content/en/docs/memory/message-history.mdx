...
Use the `toAISdkV5Messages` utility to convert messages before returning them to the client, for example from an [Next.js API route](/guides/getting-started/next-js):
