...
description: "Run long-lived Mastra tool calls and subagents as background tasks while keeping streams open, selecting LLM behavior, and handling completion events."
packages:
  - "@mastra/core"
  - "@mastra/memory"
---
