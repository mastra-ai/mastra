...
If you host your Mastra application on your own infrastructure, you can still send observability data to Mastra platform using the [MastraPlatformExporter](/ecosystem/observability-integrations/exporters/mastra-platform).
