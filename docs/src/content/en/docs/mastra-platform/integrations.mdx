...
Mastra platform integrations connect your project to third-party providers such as Linear, Notion, and Snowflake. You complete a provider's authorization flow once and the platform stores the connection. Your application then consumes it through the `@mastra/connect` package.
