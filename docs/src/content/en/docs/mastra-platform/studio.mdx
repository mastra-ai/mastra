...
description: "Deploy Mastra Studio as a hosted team workspace for testing agents, running workflows, and inspecting traces without managing the UI infrastructure."
---
