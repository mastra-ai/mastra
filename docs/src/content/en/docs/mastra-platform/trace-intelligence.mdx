...
- Select a theme in a distribution card to open its unfiltered details and generated example summaries.
- Select **Noise** in a distribution card to inspect its unfiltered distribution and generated example summaries.
