...
- Switch to **Compare** to see which themes grew, shrank, appeared, or disappeared between two points in time, or **Lifelines** to follow each theme's share across the whole selected range.
