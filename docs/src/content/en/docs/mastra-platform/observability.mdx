...
Use the Mastra CLI to move a resumable 30-day snapshot of completed traces from Langfuse into the same Platform trace views. See [Import traces from Langfuse](/docs/mastra-platform/import-langfuse-traces) for credentials, dry-run, resume, retention, and mapping behavior.
...
- [Import traces from Langfuse](/docs/mastra-platform/import-langfuse-traces)
