...
You can add built-in scorers to your agents to automatically evaluate their outputs. See the [full list of built-in scorers](/docs/v0/scorers/built-in-scorers) for all available options.
...
For more details, see [Studio](/docs/v0/getting-started/studio) docs.

## Next steps

- Learn how to create your own scorers in the [Creating Custom Scorers](/docs/v0/scorers/custom-scorers) guide
- Explore built-in scorers in the [Off-the-shelf Scorers](/docs/v0/scorers/built-in-scorers) section
- Test scorers with [Studio](/docs/v0/getting-started/studio)
