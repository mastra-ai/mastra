...
### Benefits of live evaluations

**Continuous monitoring**: Track quality metrics in real-time without manual intervention

**Performance optimization**: Use sampling to balance evaluation coverage with system performance

**Early detection**: Catch quality issues as they happen rather than discovering them later

**Production insights**: Understand how your AI systems perform with real user interactions

**A/B testing**: Compare scorer results across different agent configurations or prompts

### Best practices for live evaluations

**Choose appropriate sampling rates**: Use higher rates (0.8-1.0) for critical scorers like safety checks, and lower rates (0.1-0.3) for expensive or less critical evaluations.

**Monitor multiple dimensions**: Combine different types of scorers (accuracy, safety, bias) to get comprehensive quality coverage.

**Use lighter models for high-frequency scoring**: Consider using faster models like `gpt-4o-mini` for scorers that run frequently.

**Start with low sampling in production**: Begin with conservative sampling rates and increase based on performance impact and monitoring needs.

## Integration with Mastra

Beyond live evaluations, scorers integrate with other parts of the Mastra ecosystem for comprehensive evaluation workflows.

## Benefits of using scorers

1. **Objective measurement**: Replace subjective "feels good" assessments with quantifiable metrics
2. **Continuous monitoring**: Track performance over time and catch regressions early
3. **A/B testing**: Compare different prompts, models, or configurations systematically
4. **Quality assurance**: Ensure outputs meet your standards before reaching users
5. **Debugging**: Identify specific failure modes and improvement opportunities
