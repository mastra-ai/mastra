...
- [`context-precision`](/reference/scorers/context-precision): Evaluates relevance and positioning of retrieved context using Mean Average Precision (`0-1`, higher is better)
