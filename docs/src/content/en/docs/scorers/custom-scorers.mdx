...
**Prompt Objects:** See the [`createScorer`](/reference/v0/scorers/create-scorer) API reference for details on using prompt objects with generateScore, including required `calculateScore` function.
...
> See [createScorer](/reference/v0/scorers/create-scorer) for the full API and configuration options.
...
- [createScorer API Reference](/reference/v0/scorers/create-scorer) - Complete technical documentation
