...
See [Textual Evals](/docs/v0/scorers/evals-legacy/textual-evals) for more info on what evals can do.

For more info on how to create your own evals, see the [Custom Evals](/docs/v0/scorers/evals-legacy/custom-eval) guide.

For running evals in your CI pipeline, see the [Running in CI](/docs/v0/scorers/evals-legacy/running-in-ci) guide.
