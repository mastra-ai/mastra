...
Use this URL anywhere the WhatsApp adapter docs ask for the callback URL or webhook URL. The adapter handles webhook verification and incoming events through the generated Mastra webhook route.
