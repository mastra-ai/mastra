...
Visit [.generate()](/reference/client-js/agents#generate-response) for more information.
...
Visit [.stream()](/reference/client-js/agents#stream-response) for more information.
