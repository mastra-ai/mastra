...
Authentication alone doesn't enable user isolation. If you don't configure a mapper, you're responsible for setting a trusted resource ID in middleware or otherwise enforcing authorization.
