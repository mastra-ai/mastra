...
description: "Create a custom server adapter for frameworks beyond the built-in Express, Hono, Fastify, Koa, and LoopBack adapters."
packages:
  - "@mastra/core"
  - "@mastra/express"
  - "@mastra/hono"
...
Create a custom adapter when the prebuilt server adapters (Hono, Express, Fastify, Koa, LoopBack) don't support your framework or you have specific request or response handling requirements.
...
- [@mastra/loopback](/reference/server/loopback-adapter)
