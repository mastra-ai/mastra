...
description: "Create a custom server adapter for frameworks beyond the built-in adapters."
packages:
  - "@mastra/core"
  - "@mastra/express"
  - "@mastra/hono"
...
Create a custom adapter when the prebuilt server adapters don't support your framework or you have specific request or response handling requirements.
