...
- **Background tasks**: A task manager dispatches work to a worker group and fans task lifecycle updates out to subscribers, which is how background task streams stay live. See [Background task streaming](/docs/agents/background-tasks#subscribe-to-all-task-events).
...
- [Background task streaming](/docs/agents/background-tasks#subscribe-to-all-task-events)
