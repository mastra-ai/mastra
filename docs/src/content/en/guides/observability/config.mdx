...
Use external storage in serverless environments instead of local file storage. For storage selection and routing, see [Storage](/guides/observability/storage).
...
For trace sampling, see [Tracing](/guides/observability/tracing/overview).
