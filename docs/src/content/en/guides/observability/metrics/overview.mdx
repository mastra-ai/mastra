...
The Studio metrics dashboard visualizes all automatic metrics with KPI cards, detailed breakdowns, token usage timelines, and configurable time ranges. See [Studio observability](/guides/studio/observability) for a full walkthrough.
...
- [MastraStorageExporter reference](/guides/observability/integrations/exporters/mastra-storage)
