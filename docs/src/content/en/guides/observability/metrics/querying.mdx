...
For setup of the observability store itself, see the [Metrics overview](/guides/observability/metrics/overview). For the list of metric names you can query, see the [Automatic metrics reference](/reference/observability/metrics/automatic-metrics).

:::note
Metric queries are served by the observability domain, which requires an OLAP-capable store (DuckDB locally, ClickHouse in production). See [Metrics overview](/guides/observability/metrics/overview) for setup. If the observability store isn't configured, `getStore('observability')` returns `null`.
:::
...
- [Metrics overview](/guides/observability/metrics/overview)
...
- [Studio observability](/guides/studio/observability)
