...
For backend compatibility details and exporter batching behavior, see [Mastra Storage exporter](/guides/observability/integrations/exporters/mastra-storage).
...
- [Mastra Storage exporter](/guides/observability/integrations/exporters/mastra-storage)
