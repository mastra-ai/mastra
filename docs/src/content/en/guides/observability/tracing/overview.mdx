...
- [Configuration](/guides/observability/config): Base observability config and multiple configs, plus serverless flushing
- [Storage](/guides/observability/storage): Storage routing for traces, logs, and metrics
- [Integrations overview](/ecosystem/observability-integrations/overview): Exporters, bridges, and processors
...
For more fine-grained control over sensitive data, consider using the [Sensitive Data Filter](/guides/observability/integrations/processors/sensitive-data-filter) processor, which can redact specific fields (like passwords, tokens, and keys) while preserving the rest of the input/output.
...
- [Sensitive Data Filter](/guides/observability/integrations/processors/sensitive-data-filter) redacts sensitive information. It's enabled in the default observability config.
...
For the broader exporter, bridge, and processor model, see [Integrations overview](/ecosystem/observability-integrations/overview).
