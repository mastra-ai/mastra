...
- [`AgentCoreRuntimeSandbox`](/ecosystem/workspace-integrations/agentcore-runtime-sandbox): Executes commands in AWS Bedrock AgentCore Runtime sessions
- [`AppleContainerSandbox`](/ecosystem/workspace-integrations/apple-container-sandbox): Executes commands in local OCI Linux containers using Apple's `container` CLI
- [`BlaxelSandbox`](/ecosystem/workspace-integrations/blaxel-sandbox): Executes commands in isolated Blaxel cloud sandboxes
- [`DaytonaSandbox`](/ecosystem/workspace-integrations/daytona-sandbox): Executes commands in isolated Daytona cloud sandboxes
- [`DockerSandbox`](/ecosystem/workspace-integrations/docker-sandbox): Executes commands in long-lived Docker containers on the local machine
- [`E2BSandbox`](/ecosystem/workspace-integrations/e2b-sandbox): Executes commands in isolated E2B cloud sandboxes
- [`ModalSandbox`](/ecosystem/workspace-integrations/modal-sandbox): Executes commands in isolated Modal cloud sandboxes
...
- [`RailwaySandbox`](/ecosystem/workspace-integrations/railway-sandbox): Executes commands in ephemeral, isolated Railway cloud sandboxes
- [`VercelSandbox`](/ecosystem/workspace-integrations/vercel-sandbox): Executes commands in an ephemeral Vercel Sandbox Firecracker MicroVM
- [`VercelServerlessSandbox`](/ecosystem/workspace-integrations/vercel-serverless): Executes commands as stateless Vercel serverless functions
...
- [`AgentCoreRuntimeSandbox` reference](/ecosystem/workspace-integrations/agentcore-runtime-sandbox)
- [`AppleContainerSandbox` reference](/ecosystem/workspace-integrations/apple-container-sandbox)
- [`DaytonaSandbox` reference](/ecosystem/workspace-integrations/daytona-sandbox)
- [`E2BSandbox` reference](/ecosystem/workspace-integrations/e2b-sandbox)
- [`LocalSandbox` reference](/reference/workspace/local-sandbox)
- [`ModalSandbox` reference](/ecosystem/workspace-integrations/modal-sandbox)
- [`VercelSandbox` reference](/ecosystem/workspace-integrations/vercel-sandbox)
- [`VercelServerlessSandbox` reference](/ecosystem/workspace-integrations/vercel-serverless)
- [Workspace overview](/guides/workspace/overview)
- [Filesystem](/guides/workspace/filesystem)
