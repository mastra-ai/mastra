...
You can add built-in scorers to your agents to automatically evaluate their outputs. See the [full list of built-in scorers](/guides/evals/built-in-scorers) for all available options.
...
- Use [Quick Checks](/guides/evals/quick-checks) for fast, deterministic assertions on text and tool usage
- Add [gates and verdicts](/guides/evals/gates-and-verdicts) to enforce hard requirements and quality thresholds
- Test [multi-turn conversations](/guides/evals/multi-turn) where behavior emerges across sequential turns
- Learn how to create your own scorers in the [Creating Custom Scorers](/guides/evals/custom-scorers) guide
- Explore built-in scorers in the [Built-in Scorers](/guides/evals/built-in-scorers) section
- Test scorers with [Studio](/guides/studio/overview)
