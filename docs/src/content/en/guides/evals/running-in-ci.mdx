...
- Learn about [creating custom scorers](/guides/evals/custom-scorers)
- Explore [built-in scorers](/guides/evals/built-in-scorers)
- Run scorers against [memory-enabled agents](/guides/evals/evals-with-memory)
