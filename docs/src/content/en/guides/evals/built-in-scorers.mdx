...
To create your own scorers, see the [Custom Scorers](/guides/evals/custom-scorers) guide.
...
Zero-LLM micro-scorers for fast, deterministic assertions. See the [Quick Checks](/guides/evals/quick-checks) guide for usage details.
