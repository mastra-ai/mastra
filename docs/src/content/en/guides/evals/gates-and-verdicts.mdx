...
- [Quick Checks](/guides/evals/quick-checks): Zero-LLM micro-scorers that work well as gates
- [runEvals() reference](/reference/evals/run-evals): Full API documentation
- [Built-in scorers](/guides/evals/built-in-scorers): LLM-based and code-based scorers
- [Running evals in CI](/guides/evals/running-in-ci): CI integration patterns
