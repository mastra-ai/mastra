...
Sandboxes have provider-enforced runtime caps and expire. For production hosting, see the [deployment overview](/guides/deployment/overview).
...
- The sandbox URL is public. Anyone with the URL can reach your Mastra server, including Studio. Enable [server auth](/guides/server/auth) for anything beyond throwaway previews.
