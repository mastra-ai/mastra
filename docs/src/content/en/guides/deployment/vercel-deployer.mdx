    ...
    configs: {
      default: {
        ...
        exporters: [
          ...
          // new LangfuseExporter(), // Langfuse
          // new ArizeExporter(),    // Arize Phoenix / AX
          // new BraintrustExporter(), // Braintrust
        ],
      },
    },
  }),
...
| `LANGFUSE_SECRET_KEY`, `LANGFUSE_PUBLIC_KEY` | Required if using LangfuseExporter |
