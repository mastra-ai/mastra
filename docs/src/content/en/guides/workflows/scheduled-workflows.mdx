...
- [Workflow overview](/guides/workflows/overview)
- [Suspend and resume](/guides/workflows/suspend-and-resume)
- [Agent schedules](/guides/long-running-agents/schedules): Run an agent rather than a workflow on a cron schedule, and manage both schedule types at runtime through `mastra.schedules`.
