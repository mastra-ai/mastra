...
Studio is a React-based Single Page Application (SPA) that runs in the browser and connects to a running [Mastra server](/guides/deployment/mastra-server).
...
Visit the [Authentication](/guides/studio/auth) docs to learn more.

:::

### Alongside your API

Alternatively, you can serve Studio alongside your [Mastra server](/guides/deployment/mastra-server). This way you only have one service to deploy and manage.
...
Some of the [Cloud providers](/guides/deployment/cloud-providers) offer an option to deploy Studio alongside your serverless function. Currently, the supported providers are:
