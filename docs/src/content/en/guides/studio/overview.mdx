...
Studio provides an interactive UI for building, testing, and managing your agents, workflows, and tools. Run it locally during development, add [authentication](/guides/studio/auth), or [deploy it](/guides/studio/deployment) to production so your team can manage agents and monitor performance, plus gain insights through built-in observability.
...
While Studio is running, you can edit your [agents](/guides/agents/overview), [workflows](/guides/workflows/overview), and other parts of your Mastra application in real time.

## Deploy Studio

When you're ready to share Studio with your team, you can deploy it to production using [Studio on Mastra platform](/docs/mastra-platform/studio) or your own infrastructure. Visit the [deployment docs](/guides/studio/deployment) to learn how.
...
Use [Editor](/guides/editor/overview) to let non-technical team members iterate on agents and version every change, plus run experiments without redeploying.
...
See [processors](/guides/agents/processors) and [guardrails](/guides/agents/guardrails) for configuration details.
...
See [workspaces](/guides/workspace/overview) for configuration details.
...
See [request context](/guides/server/request-context) for configuration details.
...
Create and manage collections of test cases to evaluate your agents and workflows. Import items from CSV or JSON and define input and ground-truth schemas, plus pin to specific versions so you can reproduce experiments exactly. Run experiments with [scorers](/guides/evals/overview) to compare quality across prompts, models, or code changes.

See [datasets overview](/guides/evals/datasets/overview) for the full API and versioning details.
...
See [datasets overview](/guides/evals/datasets/overview) for setup details.

## Observability

Visit the [Studio observability](/guides/studio/observability) docs to learn more.
...
- Learn how to [deploy Studio](/guides/studio/deployment) for production use.
- Add [authentication](/guides/studio/auth) to control access to your deployed Studio.
- Explore [Studio observability](/guides/studio/observability) to monitor agent performance through metrics, traces, and logs.
