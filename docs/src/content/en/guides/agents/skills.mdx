...
For filesystem-based skill discovery across a project, use [workspace skills](/guides/workspace/skills) instead.
...
Filesystem paths use `LocalSkillSource` under the hood, which reads `SKILL.md` files following the same format as [workspace skills](/guides/workspace/skills#skillmd-format).
...
See [Request Context](/guides/server/request-context) for more on using request context with agents and workflows.
...
- [Workspace skills](/guides/workspace/skills)
