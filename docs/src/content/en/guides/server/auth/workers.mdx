...
- [Auth overview](/guides/server/auth): Available auth providers and how they work
- [Token-based auth](/guides/server/auth/simple-auth): Token-to-user mapping authentication
