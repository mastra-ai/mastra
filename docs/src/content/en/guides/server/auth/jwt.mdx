...
Inside [Studio](/guides/studio/overview), go to **Settings** and under **Headers** select the **"Add Header"** button. Enter `Authorization` as the header name and `Bearer <your-jwt>` as the value.
...
Visit [Mastra Client SDK](/guides/server/mastra-client) for more configuration options.
