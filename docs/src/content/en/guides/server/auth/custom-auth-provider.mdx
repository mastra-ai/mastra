...
- [Auth Overview](/guides/server/auth): Authentication concepts and configuration
- [Custom API Routes](/guides/server/custom-api-routes): Controlling authentication on custom endpoints
