...
The Mastra Client SDK provides a concise and type-safe interface for interacting with your [Mastra Server](/guides/server/mastra-server) from your client environment.
...
- **[A2A](/guides/agents/a2a)**: Discover agents through agent cards and work with task-based A2A streams.
