...
For more information about authentication providers, see the [Auth documentation](/guides/server/auth).
...
- [Server Middleware](/guides/server/middleware): Global middleware configuration
- [Mastra Server](/guides/server/mastra-server): Server configuration options
