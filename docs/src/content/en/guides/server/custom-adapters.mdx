...
See [Server Adapters](/guides/server/server-adapters) for full documentation on each option.
...
If you want to use [Studio](/guides/studio/overview) with your server adapter, use [`mastra studio`](/reference/cli/mastra#mastra-studio) to only launch the Studio UI.

:::

## Related

- [Server Adapters](/guides/server/server-adapters): Overview and shared concepts
