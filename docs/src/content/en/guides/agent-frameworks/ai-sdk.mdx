...
If you want to use Mastra together with AI SDK UI (e.g. `useChat()`), visit the [AI SDK UI guide](../build-your-ui/ai-sdk-ui).
...
- [AI SDK UI](../build-your-ui/ai-sdk-ui) - Using AI SDK UI hooks with Mastra agents, workflows, and networks
