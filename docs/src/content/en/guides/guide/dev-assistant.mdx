...
- [Filesystem](/guides/workspace/filesystem) for file management
- [Sandbox](/guides/workspace/sandbox) for code execution
- [Skills](/guides/workspace/skills) for coding standards
- [Search](/guides/workspace/search) for finding examples
...
Start [Studio](/guides/studio/overview) and interact with the agent to see it in action.
