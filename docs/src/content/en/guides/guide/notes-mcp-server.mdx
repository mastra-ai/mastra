...
After following the default [installation guide](/guides/v1/frameworks/servers/express) your project will include files that are not relevant for this guide. You can safely remove them:
