...
<Steps>
  ...
  <StepItem>
    Instead of showing the agent's response to a human you might want to pass it along to another part of your code. For these instances your agent should return [structured output](/guides/agents/structured-output).
...
<Steps>
  <StepItem>
    ...
    This will start a server exposing endpoints to interact with your registered agents. Within [Studio](/guides/studio/overview) you can test your agent through a UI.
  </StepItem>
