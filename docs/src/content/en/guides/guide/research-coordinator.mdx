...
The supervisor pattern requires memory to track conversation history and enable effective coordination. Configure memory storage in your Mastra instance.
...
The supervisor coordinates research and writing tasks. Its instructions define the delegation strategy - when to use each sub-agent and how to synthesize results.
