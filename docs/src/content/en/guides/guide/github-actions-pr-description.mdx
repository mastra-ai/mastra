...
Before deploying the workflow, you can test the agent in [Studio](/guides/studio/overview) to verify it generates descriptions correctly.
...
- Read the [agents](/guides/agents/overview) documentation
- Give your agent [tools](/guides/agents/using-tools) to fetch additional context
