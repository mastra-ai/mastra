...
Memory processors are [processors](/guides/agents/processors) that operate specifically on memory-related messages and state.
...
- [Processors](/guides/agents/processors): General processor concepts and custom processor creation
- [Guardrails](/guides/agents/guardrails): Security and validation processors
- [Memory Overview](/guides/memory/overview): Memory types and configuration
