...
The `@mastra/ai-sdk` route handlers will seamlessly integrate with AI SDK UI's hooks. AI SDK UI provides three main hooks: [`useChat()`](https://ai-sdk.dev/docs/ai-sdk-ui/chatbot), [`useCompletion()`](https://ai-sdk.dev/docs/ai-sdk-ui/completion), and [`useObject`](https://ai-sdk.dev/docs/ai-sdk-ui/object-generation).
...
To manually transform Mastra's streams to AI SDK-compatible format, use the [`toAISdkStream()`](/reference/v1/ai-sdk/to-ai-sdk-stream) utility. Take a look at the [examples](/reference/v1/ai-sdk/to-ai-sdk-stream#examples) to learn more.
