...
Define a tool with an output schema.

```typescript title="src/mastra/tools/weather-tool.ts" copy
...
Render the tool output as a custom component.

```typescript title="src/components/chat.tsx" copy
import { useChat } from "@ai-sdk/react";
import { DefaultChatTransport } from "ai";
...
```typescript title="src/components/workflow-chat.tsx" copy
import { useChat } from "@ai-sdk/react";
import { DefaultChatTransport } from "ai";
...
Render network execution steps.

```typescript title="src/components/network-chat.tsx" copy
import { useChat } from "@ai-sdk/react";
import { DefaultChatTransport } from "ai";
...
```typescript title="src/mastra/tools/task-tool.ts" copy
import { createTool } from "@mastra/core/tools";
import { z } from "zod";
...
Render custom progress events.

```typescript title="src/components/task-chat.tsx" copy
import { useChat } from "@ai-sdk/react";
import { DefaultChatTransport } from "ai";
