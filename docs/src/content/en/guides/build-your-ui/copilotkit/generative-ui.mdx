...
- **Human-in-the-loop**: pause a run and wait for user approval or edits. Backend side, see Mastra's [Human-in-the-loop](/docs/agents/human-in-the-loop); frontend side, see CopilotKit's [`useHumanInTheLoop`](https://docs.copilotkit.ai/reference/hooks/useHumanInTheLoop).
