...
In this quickstart, you’ll build a tool-calling AI agent with Mastra and run it in [Studio](/docs/v1/getting-started/studio), Mastra’s interactive development environment.

You’ll use the `create mastra` CLI to scaffold a new project with example agents, workflows, and tools you can learn from or adapt.

In a couple of minutes, you’ll have a standalone Mastra server running - ready to extend with your own tools and logic, and to integrate into your app when you’re ready.
...
<figcaption class="text-sm text-center">What you'll build: an agent that can call a weather tool and stream back a weather summary. You’ll interact with it in Mastra Studio, an interactive UI for building and testing your agents.</figcaption>
</figure>
## Before you begin
...
2. Try asking about the weather. If your API key is set up correctly, you'll get a response
