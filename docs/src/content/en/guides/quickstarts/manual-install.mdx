---
title: "Manual Install | Quickstarts"
...
:::info
Use this guide if you want full, step-by-step control over setting up Mastra manually. For new projects, `mastra create` with a [quickstart](/guides/v1/quickstarts/standalone-server) is usually faster. For existing projects, [`mastra init`](/reference/v1/cli/mastra#mastra-init) is often the simplest option.
:::
