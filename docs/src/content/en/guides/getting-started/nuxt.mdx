...
```bash
npx nuxi@latest init mastra-nuxt
```
...
```bash
pnpm dlx nuxi@latest init mastra-nuxt
```
...
```bash
yarn dlx nuxi@latest init mastra-nuxt
```
...
```bash
bunx nuxi@latest init mastra-nuxt
```
  ...
  <div class="chat-container">
    ...
    <form class="input-form" @submit.prevent="handleSubmit">
      <input
        ...
        class="chat-input"
      />
      <button type="submit" class="submit-button" :disabled="status !== 'ready'">
        Send
      </button>
    </form>
  </div>
