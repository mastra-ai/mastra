...
This guide is for building a custom Electron app. If you want an installable local Studio shell with a bundled Mastra runtime and LM Studio preset, see [Studio desktop app](/docs/studio/desktop).
