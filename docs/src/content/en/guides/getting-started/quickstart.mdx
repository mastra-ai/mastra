...
- Integrate Mastra with your frontend framework: [Next.js](/guides/v1/frameworks/web-frameworks/next-js), [React](/guides/v1/frameworks/web-frameworks/vite-react), or [Astro](/guides/v1/frameworks/web-frameworks/astro)
