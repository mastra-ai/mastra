...
import QuickstartPrompt from "@site/src/content/en/guides/getting-started/_partial-quickstart-prompt.mdx";
...
[Studio](/guides/studio/overview) lets you build and test agents without creating a separate UI.

## Next steps

- Integrate Mastra with [Next.js](/ecosystem/app-frameworks/next-js), [React](/ecosystem/app-frameworks/vite-react), or [Astro](/ecosystem/app-frameworks/astro)
- Learn how to [build Mastra with AI](/guides/getting-started/build-with-ai)
- Build an agent from scratch with a [guide](/docs)
