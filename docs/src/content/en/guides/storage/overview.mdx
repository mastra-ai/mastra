...
- [Memory](/guides/memory/overview): Message history, threads, resources, and working memory.
- [Workflows](/guides/workflows/overview): Durable snapshots for suspended and resumed workflow runs.
- [Observability](/guides/observability/overview): Traces, spans, metrics, logs, and feedback.
- [Evals](/guides/evals/overview): Scores, datasets, experiments, and evaluation results.
- [Long-running agents](/guides/long-running-agents/durable-agents): Background tasks, schedules, goals, and thread state.
...
You can also route `observability` to a dedicated analytics backend. See [observability storage](/guides/observability/storage) for an observability-specific example.
...
- [Observability storage](/guides/observability/storage)
