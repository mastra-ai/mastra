...
**Important:** Run this SQL through your normal migration process (e.g., Prisma Migrate, Drizzle Kit, or your DBA review process). Your migration tool will ensure it only runs once. Do not run it directly on production databases without proper review.
