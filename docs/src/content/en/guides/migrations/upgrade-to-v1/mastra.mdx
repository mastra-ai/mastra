...
### Changed: getAgents -> listAgents
### Changed: getWorkflows -> listWorkflows
### Changed: getScorers -> listScorers
### Changed: getTools -> listTools
### Changed: getLogs -> listLogs
### Changed: getLogsByRunId -> listLogsByRunId
### Changed: getLogTransports -> listLogTransports
### Changed: `experimental_auth` -> `auth`
### Removed: `memory` from Mastra class
