...
### Changed: Required configuration parameters
...
### Changed: Default settings for semantic recall and last messages
...
### Changed: Default memory scope from `thread` to `resource`
...
### Changed: Thread title generation location
...
### Changed: Semantic recall default settings optimization
...
### Changed: `Memory.query()` return format
...
### Changed: `Memory.query()` parameter format
...
### Changed: `MastraMessageV2` type renamed to `MastraDBMessage`
...
### Changed: `rememberMessages` return format
...
### Removed: Working memory `text-stream` mode
...
### Removed: `format` parameter from memory methods
...
### Removed: `processors` config from Memory constructor
