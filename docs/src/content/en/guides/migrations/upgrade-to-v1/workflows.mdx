...
Workflow step execution signatures have been updated to match tool signatures, and legacy workflow features have been removed.

## Changed

### Workflow step `execute` signature to `(inputData, context)` format
