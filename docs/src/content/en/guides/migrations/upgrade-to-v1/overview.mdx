...
- **[Tools](/guides/migrations/upgrade-to-v1/tools)** - Execute signature changed to separate input and context.
- **[Workflows](/guides/migrations/upgrade-to-v1/workflows)** - Step execution signature updated and legacy features removed.
...
- Update tool signatures to `(inputData, context)` format - [Tools](/guides/migrations/upgrade-to-v1/tools)
- Update workflow step signatures to `(inputData, context)` format - [Workflows](/guides/migrations/upgrade-to-v1/workflows)
- Restructure `@mastra/core` imports to use subpath imports - [Mastra Class](/guides/migrations/upgrade-to-v1/mastra)
- Add required `storage`, `vector`, and `embedder` to Memory configuration - [Memory](/guides/migrations/upgrade-to-v1/memory)
