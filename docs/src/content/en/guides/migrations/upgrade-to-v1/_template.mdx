...
Each change (be it "changed" or "removed") should be a h3 heading. Prefix the heading with "Changed: " or "Removed: " respectively. You must follow that format exactly.
...
### Changed: `oldFunction` to `newFunction`
```
