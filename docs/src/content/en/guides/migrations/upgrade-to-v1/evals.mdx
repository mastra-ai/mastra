...
### Changed: `runExperiment` to `runEvals`
...
### Changed: `getScorerByName` to `getScorerById`
...
### Changed: Scorer configuration from `name` to `id`
...
### Changed: Storage score APIs to `listScoresBy*` pattern
...
### Changed: Processor interface requirements
...
### Removed: Agent `TMetrics` generic parameter
...
### Removed: Deprecated input processor exports
...
### Removed: Evals-related type exports
