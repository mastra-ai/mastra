...
- [Agent.generateLegacy()](/reference/v0/agents/generateLegacy)
- [Agent.streamLegacy()](/reference/v0/streaming/agents/streamLegacy)
...
- [Agent.generate()](/reference/v0/agents/generate)
- [Agent.stream()](/reference/v0/streaming/agents/stream)
