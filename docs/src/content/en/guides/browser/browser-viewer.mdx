...
For SDK-based browser automation, use [AgentBrowser](/guides/browser/agent-browser) or [Stagehand](/ecosystem/browser-integrations/stagehand) instead.
...
Install the corresponding [skill](/guides/workspace/skills) so the agent knows how to use the CLI:
...
BrowserViewer supports three CLI providers. Each CLI must be installed separately in your workspace environment. Each CLI also publishes a [skill](/guides/workspace/skills) that teaches the agent its commands and workflows.
