...
- [Deploying](/guides/agent-builder/deploying): Set a public `baseUrl` for production deployments.
- [Configuration](/guides/agent-builder/configuration): Wire channel toggles into the Builder UI.
