...
- [Model policy](/guides/agent-builder/model-policy): Pin the allowed models and default model.
- [Memory](/guides/agent-builder/memory): Set the default memory shape for new agents.
