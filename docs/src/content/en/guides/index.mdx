...
## [PayFinder Agent](/guides/guide/payfinder)
Build an AI agent that analyzes financial documents using Retrieval Augmented Generation (RAG) to extract and answer questions about executive compensation and salary information from corporate filings.
