	...
	referenceSidebar: [
		...
		},
		{
			...
			items: [
				...
				{ type: 'doc', id: 'signals/signal-provider', label: 'SignalProvider', customProps: { badge: ['beta'] } },
				{
					type: 'doc',
		...
		},
		{
			...
			items: [
				...
				{ type: 'doc', id: 'tools/create-code-mode', label: 'createCodeMode()', customProps: { badge: ['beta'] } },
