---
title: "Subagents | AgentController"
...
For the full list of subagent configuration options, see [`AgentController` reference](/reference/agent-controller/agent-controller-class).
