---
title: "Reference: Run.streamLegacy() (Legacy) | Workflows | Mastra Docs"
description: Documentation for the legacy `Run.streamLegacy()` method in workflows. This method is deprecated and will be removed in a future version.
---

import { Callout } from 'nextra/components';

# Run.streamLegacy() (Legacy)

<Callout type="warning">
  **Deprecated**: This method is deprecated and only works with V1 models. For V2 models, use the new [`.stream()`](./stream.mdx) method instead.
</Callout>

The `.streamLegacy()` method is the legacy version for monitoring the execution of a workflow run, providing real-time updates on the status of steps.
