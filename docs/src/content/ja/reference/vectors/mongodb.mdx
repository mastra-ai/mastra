---
title: "リファレンス：MongoDB Vector Store | ベクターデータベース | Mastra ドキュメント"
description: Mastra の MongoDBVector クラスのドキュメント。MongoDB Atlas と Atlas Vector Search を用いたベクトル検索を提供します。
---
