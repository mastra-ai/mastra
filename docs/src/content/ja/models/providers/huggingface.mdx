...
description: "Mastra で Hugging Face のモデルを利用できます。利用可能なモデルは 13 件です。"
---
...
Mastraのモデルルーター経由で、Hugging Faceの13のモデルにアクセスできます。認証は `HF_TOKEN` 環境変数により自動的に処理されます。

詳しくは [Hugging Faceのドキュメント](https://huggingface.co) をご覧ください。
