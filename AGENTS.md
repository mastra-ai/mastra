...
Use [code-best-practices](.claude/skills/code-best-practices/SKILL.md) for all code changes and reviews, including backend, scripts, and tests.
...
Read applicable `@.claude/skills/`: `playground-msw-tests` (primary for playground/UI), `e2e-tests-studio` (secondary), `mastra-docs`, `tailwind-v4`, `mastra-frontend`, `mastra-smoke-test`, `smoke-test`.
