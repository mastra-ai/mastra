  ...
  beforeEach(async () => {
    ...
    const getWeatherTool = createTool({
      ...
      execute: async ({ context }) => {
        console.log('🌤️  Weather tool called with args:', context);
        receivedToolCalls.push({ name: 'getWeather', args: context });
    ...
    const calculatorTool = createTool({
      ...
      execute: async ({ context }) => {
        console.log('🧮 Calculator tool called with args:', context);
        receivedToolCalls.push({ name: 'calculate', args: context });
