...
5. Dynamically fetch and generate provider configurations from models.dev API
...
- [ ] Add caching layer for gateway API calls
- [ ] Support for custom provider registries
- [ ] Auto-detection of provider capabilities
- [ ] Advanced retry strategies per provider
