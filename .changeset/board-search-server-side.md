...
```text
GET /web/github/projects/<repository-id>/issues?q=21068
GET /web/github/projects/<repository-id>/prs?q=21068
GET /web/linear/projects/<factory-project-id>/issues?q=ENG-123
```
