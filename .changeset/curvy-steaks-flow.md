...
The default input now shares the capsule transitions, selected-value preview, completion shimmer, and animated removal. Search and keyboard selection stay inline. Opt into the button with the same children:
