...
Added `@mastra/brightdata` integration with `web-search` and `web-fetch` tools backed by Bright Data's SERP API and Web Unlocker. The tools bypass bot detection and CAPTCHAs out of the box.
