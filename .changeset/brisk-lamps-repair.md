...
The proposal tag also had a dead `hover:text-positive2` in two byte-identical copies of the component. There is one copy now, in `shared/components`, re-exported from the review barrel the way `BulkTagPicker` already was.
