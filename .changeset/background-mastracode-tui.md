...
Fixed rapid thread switches so delayed transcript, goal, observational-memory, Git-branch, and model-pack loads cannot overwrite the active thread's UI state or clear its background-tool tracking.
