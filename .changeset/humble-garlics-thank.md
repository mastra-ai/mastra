...
Metrics tables now render through DataList so sticky row headers share the same header colors and hover treatment as the rest of the list system.

The legacy `Table` export was removed. Use DataList for DS-owned tabular layouts.
