...
Metrics tables now render directly through DataList so sticky row headers share the same header colors and hover treatment as the rest of the list system.
