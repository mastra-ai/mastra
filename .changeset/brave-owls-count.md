...
- Commands that exit with a nonzero code now show as failed. Previously they showed a checkmark unless their output happened to contain an error-like word.
...
- Run times now survive reloading a thread instead of resetting to `0ms`, and times over a minute read as `2m 4s`.
