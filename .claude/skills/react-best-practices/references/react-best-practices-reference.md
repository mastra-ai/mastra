...
| `structure-component-naming`             | JSX-Returning Helpers Must Be Components              | MEDIUM      | Name reusable JSX-returning helpers as PascalCase components and call them with JSX; pick a dynamic tag with a ternary over literal tags rather than building the tag name.                                                                                                | `references/rules/structure-component-naming.md`             |
