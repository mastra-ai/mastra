...
| `structure-complex-derived-logic`        | Extract Complex Derived Logic                         | MEDIUM      | Move oversized conditions, nested ternaries, fallback chains, and mutating derived composition into named predicates or pure helpers. | `references/rules/structure-complex-derived-logic.md`        |
