...
- Use PascalCase components for JSX-returning helpers; keep lowercase helpers for non-JSX values, and pick a dynamic tag with a ternary over literal tags instead of building the name (`structure-component-naming`)
