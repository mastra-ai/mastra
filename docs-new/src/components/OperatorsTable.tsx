        ...
        {operators.map((operator, index) => {
          return (
            ...
            >
              ...
              <div style={{ fontSize: '0.875rem', lineHeight: '1.5rem', color: 'var(--ifm-color-emphasis-800)' }}>
              ...
              <div style={{ fontSize: '0.8125rem', color: 'var(--ifm-color-emphasis-600)', fontStyle: 'italic' }}>
