...
const showcaseItems: ShowcaseCardProps[] = [
  {
    title: 'Olive',
    description: msg('Generate powerful tools and dashboards connected to your data sources in minutes'),
    image: 'from-olive.png',
    link: 'https://fromolive.com/',
  },
  {
    title: 'Artifact',
    description: msg('Design tool that lets you design at any level of fidelity - from concept to connector'),
  ...
  },
  {
    ...
    description: msg('AI-powered assistant that creates podcasts from the sources you upload'),
  ...
  },
  {
    ...
    description: msg('A tool that converts whiteboard images into editable Excalidraw diagrams'),
    ...
    <div className={styles.showcaseContainer}>
      ...
      <div className={styles.showcaseGrid}>
        {showcaseItems.map(item => (
          <ShowcaseCard key={item.title} description={m(item.description)} {...item} />
        ))}
      </div>
    </div>
  );
