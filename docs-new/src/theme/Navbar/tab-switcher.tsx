...
export const TabSwitcher = ({ className }: { className?: string }) => {
  ...
  return (
    <div
      className={cn(
        ' border-b-[0.5px] dark:border-b-[--border] bg-[--light-color-surface-15] dark:bg-[--primary-bg] border-b-(--border-subtle)',
        className,
      )}
    >
      <div className="w-full">
        <div className="flex overflow-x-auto gap-6 px-5 py-2 -ml-3 tab" aria-label="Documentation tabs">
          {docsTabs.map(tab => {
