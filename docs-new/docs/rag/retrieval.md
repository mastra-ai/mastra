...
For an example of how to use the basic retrieval method, see the [Retrieve Results](/docs/examples/rag/query/retrieve-results) example.
...
For an example of how to use metadata filtering, see the [Hybrid Vector Search](/docs/examples/rag/query/hybrid-vector-search) example.
...
For more details about re-ranking, see the [rerank()](/docs/reference/rag/rerankWithScorer) method.

For an example of how to use the re-ranking method, see the [Re-ranking Results](/docs/examples/rag/rerank) example.
...
For an example of how to use the graph-based retrieval method, see the [Graph-based Retrieval](/docs/examples/rag/usage/graph-rag) example.
