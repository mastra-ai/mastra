...
1. Sets up a Mastra agent with gpt-5.1 that can handle both querying and cleaning documents
...
**Full example:** [cleanup-rag](https://github.com/mastra-ai/mastra/blob/main/examples/basics/rag/cleanup-rag)
