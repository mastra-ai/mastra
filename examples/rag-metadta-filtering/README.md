...
> **Note:** Different vector stores have specific prompts available. See the Mastra documentation on vector store prompts for details.
...
**Full example:** [filter-rag](https://github.com/mastra-ai/mastra/blob/main/examples/basics/rag/filter-rag)
