...
export function OpenAISDKResponsesExample() {
  ...
  async function submit(nextMode: 'json' | 'stream') {
    ...
    const request = {
      ...
      input: prompt,
      instructions: 'You are a memory-backed Mastra agent being called through the OpenAI SDK compatibility surface.',
      store: true,
        ...
        <div className="demo-topbar__leading">
          <div className="demo-brand">
            ...
            <div className="demo-brand__copy">
              ...
              <span className="demo-brand__label">Mastra via OpenAI SDK</span>
            </div>
          </div>

          <p className="demo-brand__subtitle">
            Uses the official OpenAI SDK in the browser, with `baseURL` pointed at the Mastra server.
          </p>
        </div>
        ...
        <div className="demo-messages">
          {turns.length === 0 ? (
            <div className="demo-empty-state">
              <p>The request goes through `openai.responses.create(...)`, but the base URL targets Mastra.</p>
              <div className="demo-chip-list">
                {[
                  'Draft a release note for a new AI orchestration feature.',
