        ...
        <div className="demo-topbar__leading">
          <div className="demo-brand">
            ...
            <div className="demo-brand__copy">
              ...
              <span className="demo-brand__label">Mastra Agent + Tool Responses</span>
            </div>
          </div>

          <p className="demo-brand__subtitle">
            Uses a Mastra agent with memory and tools so tool calls and tool outputs come back in `output`.
          </p>
        </div>
