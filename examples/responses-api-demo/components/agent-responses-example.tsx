...
export function AgentResponsesExample() {
        ...
        <div className="demo-topbar__leading">
          <div className="demo-brand">
            ...
            <div className="demo-brand__copy">
              ...
              <span className="demo-brand__label">Mastra Agent Responses</span>
            </div>
          </div>

          <p className="demo-brand__subtitle">
            Uses a Mastra agent with memory, `store: true`, and `previous_response_id` for follow-up turns.
          </p>
        </div>

        <span className="demo-response-badge" title={currentAnchor ?? 'awaiting-agent'}>
        ...
        <div className="demo-messages">
          {turns.length === 0 ? (
            <div className="demo-empty-state">
              <p>Each reply returns a stored response ID, and the next turn sends it as `previous_response_id`.</p>
