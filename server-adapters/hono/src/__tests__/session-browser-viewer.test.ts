...
import { AgentBrowser } from '../../../../browser/agent-browser/src/agent-browser';
import { MastraClient } from '../../../../client-sdks/client-js/src/client';
import { MastraServer } from '../index';

it('connects the authenticated SDK to the exact Session browser over native SSE and commands', async () => {
