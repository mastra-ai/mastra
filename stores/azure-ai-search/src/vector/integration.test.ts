...
describeIntegration('AzureAISearchVector Conformance Suite Integration Tests', () => {
  // Only construct when credentials are present. Under describe.skip the body
  // still executes at collection time to register skipped tests, and the
  // AzureAISearchVector constructor throws on a null endpoint — so guard it.
