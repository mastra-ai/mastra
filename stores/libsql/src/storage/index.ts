...
import { InboxLibSQL } from './domains/inbox';
...
export { AgentsLibSQL, InboxLibSQL, MemoryLibSQL, ObservabilityLibSQL, ScoresLibSQL, WorkflowsLibSQL };
...
export class LibSQLStore extends MastraStorage {
  ...
  constructor(config: LibSQLConfig) {
    ...
    const inbox = new InboxLibSQL(domainConfig);
