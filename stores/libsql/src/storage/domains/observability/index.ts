  ...
  async listTraces(args: ListTracesArgs): Promise<ListTracesResponse> {
    ...
    try {
      ...
      if (sortField === 'durationMs') {
        orderByClause = `CASE WHEN endedAt IS NULL THEN 1 ELSE 0 END, MAX(0, (julianday(endedAt) - julianday(startedAt)) * 86400000) ${sortDirection}, traceId ${sortDirection}, spanId ${sortDirection}`;
