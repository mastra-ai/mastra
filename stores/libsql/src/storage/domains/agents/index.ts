...
export class AgentsLibSQL extends AgentsStorage {
    ...
    for (const row of oldAgents) {
      ...
      await this.#db.insert({
        ...
        record: {
          ...
          toolIntegrations: row.toolIntegrations ?? null,
    ...
    try {
      ...
      await this.#db.insert({
        ...
        record: {
          ...
          toolIntegrations: input.toolIntegrations ?? null,
  ...
  private parseVersionRow(row: any): AgentVersion {
    return {
      ...
      toolIntegrations: this.parseJson(row.toolIntegrations, 'toolIntegrations'),
