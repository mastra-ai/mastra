...
export async function batchCreateMetrics(db: DuckDB, args: BatchCreateMetricsArgs): Promise<void> {
...
export async function getMetricNames(db: DuckDB, args: GetMetricNamesArgs): Promise<GetMetricNamesResponse> {
