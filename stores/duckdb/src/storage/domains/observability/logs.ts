...
export async function batchCreateLogs(db: DuckDB, args: BatchCreateLogsArgs): Promise<void> {
...
export async function listLogs(db: DuckDB, args: ListLogsArgs): Promise<ListLogsResponse> {
