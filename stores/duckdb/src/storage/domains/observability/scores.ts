...
export async function createScore(db: DuckDB, args: CreateScoreArgs): Promise<void> {
  const s = args.score;
  await db.execute(
...
export async function batchCreateScores(db: DuckDB, args: BatchCreateScoresArgs): Promise<void> {
...
export async function listScores(db: DuckDB, args: ListScoresArgs): Promise<ListScoresResponse> {
