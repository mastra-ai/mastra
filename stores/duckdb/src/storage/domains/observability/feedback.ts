...
export async function createFeedback(db: DuckDB, args: CreateFeedbackArgs): Promise<void> {
...
export async function batchCreateFeedback(db: DuckDB, args: BatchCreateFeedbackArgs): Promise<void> {
...
export async function listFeedback(db: DuckDB, args: ListFeedbackArgs): Promise<ListFeedbackResponse> {
