...
import { QV_CouchbaseFilterTranslator } from './queryVectorFilter';

/**
 * Test suite for CouchbaseFilterTranslator
 *
 * These tests are structured to validate filter translation from Mastra format to Couchbase SQL++ format.
  ...
  describe('translates equality operations ($eq)', () => {
    const cases: TestCase[] = [
      ...
      },
      {
        ...
        expected: "(meta.years = '2011-10-05T14:48:00.000Z')",
      },
      {
      ...
      },
      {
        ...
        expected: '(nickname IS NULL)',
      },
      {
        name: 'multiple field operations',
        input: { field1: { $eq: 'value1', $ne: 'value2' } },
        expected: "(field1 = 'value1') AND (field1 != 'value2')",
      },
    ];
    ...
    const cases: TestCase[] = [
      {
        ...
        expected: "(meta.years != '2011')",
      },
      {
        name: 'number inequality',
        input: { 'meta.years': { $ne: 1 } },
        expected: '(meta.years != 1)',
      },
      {
  ...
  describe('translates comparison operations ($gt, $gte, $lt, $lte)', () => {
    const cases: TestCase[] = [
      ...
      },
      {
        ...
        expected: '(field2 > 10) AND (field2 >= 10) AND (field2 < 10) AND (field2 <= 10)',
      },
    ];
  ...
  describe('translates logical operations', () => {
    const cases: TestCase[] = [
      ...
      },
      {
        ...
        expected:
          "((meta.years = 2019) AND (meta.date1 = '2011-10-05T14:48:00.000Z') AND ((meta.text = '1') OR (meta.date2 >= '2011-10-05T14:48:00.000Z') OR (NOT (meta.date3 = '2011-10-05T14:48:00.000Z'))))",
      },
    ];
  ...
  describe('translates edge cases', () => {
    const cases: TestCase[] = [
      ...
      },
      {
        ...
        expected: "(name = 'Bob') AND (age > 18) AND (active != false)",
      },
    ];
