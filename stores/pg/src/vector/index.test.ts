...
describe('Validation', () => {
  ...
  describe('tableMap support (PgVector)', () => {
    const logicalName = 'mastra_messages';
    const physicalName = 'mastra_messages_tbl';
    const connectionString = process.env.DB_URL || 'postgresql://postgres:postgres@localhost:5434/mastra';
    ...
    beforeAll(async () => {
      ...
      db = new PgVector({ id: 'test-pg-vector', connectionString, tableMap: { [logicalName]: physicalName } });
