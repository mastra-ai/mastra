import { MastraStorage, TABLE_SPANS, TraceStatus } from '@mastra/core/storage';
  ...
  describe('Observability Storage', () => {
    ...
    describe('batchCreateSpans', () => {
      ...
      it('should create spans across multiple traces', async () => {
        ...
        const trace3 = await storage.getTrace('trace-3');
    ...
    describe('getTrace', () => {
      ...
      it('should return trace with all associated spans', async () => {
        ...
        await storage.batchCreateSpans({ records: [rootSpan, child1, child2] });
    ...
    describe('batchDeleteTraces', () => {
      ...
      it('should handle deleting non-existent traces gracefully', async () => {
        await expect(storage.batchDeleteTraces({ traceIds: ['non-existent'] })).resolves.not.toThrow();
      });
    });
    ...
    describe('listTraces', () => {
      ...
      describe('basic pagination', () => {
        ...
        it('should handle page navigation', async () => {
          ...
          const page1 = await storage.listTraces({
            pagination: { page: 0, perPage: 2 },
          });

          const page2 = await storage.listTraces({
