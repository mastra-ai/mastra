...
- facdb94: fix(@mastra/arize): Auto-detect arize endpoint when endpoint field is not provided
...
- Updated dependencies [173c535]
  ...
  - @mastra/otel-exporter@0.0.0-kitchen-sink-e2e-test-20251120010328
