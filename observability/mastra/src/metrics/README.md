...
- `rollup.jsonl`
  - minified model-pricing rollup
  - one JSON object per line
  - intended to be the shipped runtime artifact

## Source of Truth

`rollup.jsonl` is generated by the costing pipeline under:

- `observability/costing/`

The upstream rollup process:
...
This file is optimized for shipping size, not readability. If a human-readable rollup or provenance-oriented lineage file is needed, use the upstream costing pipeline outputs instead of editing or expanding the embedded snapshot here.
