...
- Full `/settings` command restart flow after saving storage changes, including selected-backend reload; restart notice and raw connection-string persistence are covered by `storage-settings`.
