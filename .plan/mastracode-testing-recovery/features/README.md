...
| Chat | Agent signals and streaming follow-ups | #16231, #16338 | core Agent signal conversion + Harness follow-up queue + React thread subscription + TUI/Playground pending signal projection | Partial | High | [page](./chat/agent-signals.md) |
...
| Integrations | Core Harness API and reference docs | #13353, #13457, #13519, #13525, #13716, #14433, #15036, #16250, #13891, #16340, #16231 | Core Harness runtime + docs + model request headers + browser propagation + createMastraCode memory override + Agent signal/follow-up APIs + plan approval resolver/abort ordering | Partial | High | [page](./integrations/harness-api.md) |
