...
| TUI | Interactive chat | #13218, #13350, #13413, #13427, #13456, #13460, #13442, #13487, #13609, #13696, #13712, #13723, #13999, #14423, #15082, #15088, #15942 | TUI + Harness display state + prompt/editor animation + optimistic user-message projection + count-based rendered component pruning | Partial | High | [page](./tui/interactive-chat.md) |
