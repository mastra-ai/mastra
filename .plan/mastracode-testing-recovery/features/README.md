...
| Goals | Persistent `/goal` mode | #16065, #16322, #16340, #16654 | thread goal metadata + GoalManager + judge agent/defaults + waiting/retry/resume judge decisions + TUI judge/input-lock/status-line state + approved-plan goal start ordering | Partial | High | [page](./goals/persistent-goals.md) |
