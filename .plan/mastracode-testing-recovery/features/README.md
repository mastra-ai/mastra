...
| TUI | Interactive chat | #13218, #13350 | TUI + harness session | Partial | High | [page](./tui/interactive-chat.md) |
| Chat | Prompt context and project instructions | #13234, #13346 | Harness request context + instruction files | Partial | High | [page](./chat/prompt-context.md) |
...
| Tools | Coding tools and approval permissions | #13218, #13344, #13347, #13348, #13355 | Harness state + permission policy | Partial | High | [page](./tools/coding-tools-permissions.md) |
