...
| Tools | Workspace-backed coding tools | #13437, #13526, #13687, #13693, #13695, #13700, #13724, #13753, #13940, #14565, #14961, #15151 | core/custom Workspace + LocalFilesystem/LocalSandbox + tool-name overrides + allowed paths + Agent Skills directories + request_access guidance + schema compat + subagent inheritance + LSP inspect | Partial | High | [page](./tools/workspace-tools.md) |
...
| Integrations | Skills command and workspace resolution | #13457, #13700, #15151 | Core Harness workspace cache + Workspace skills provider + Agent Skills directories | Partial | High | [page](./integrations/skills-command.md) |
