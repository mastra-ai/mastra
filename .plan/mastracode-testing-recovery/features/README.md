...
| Headless | Prompt mode | #13648, #14962 | CLI args + Harness events + auto-resolution + thread/resource controls | Partial | High | [page](./headless/prompt-mode.md) |
| TUI | Startup banner | #13422 | TUI options + terminal width | Partial | Medium | [page](./tui/startup-banner.md) |
| TUI | Help and shortcuts | #13426, #13712, #13723, #13787, #14250, #15036 | TUI command metadata + settings + queueing shortcut labels + browser command listing | Partial | Medium | [page](./tui/help-and-shortcuts.md) |
...
| Settings | Onboarding and global settings | #13421, #13431, #13487, #13494, #13500, #13505, #13508, #13512, #13566, #13603, #13611, #13748, #13953, #13573, #14604, #14605, #14788, #14952, #14936, #15036 | settings.json + thread settings + provider registry + AuthStorage/stored API keys + built-in pack defaults + browser settings + OM threshold defaults + Memory Gateway settings + masked sensitive prompts | Partial | High | [page](./settings/onboarding-and-global-settings.md) |
...
| Chat | Prompt context and project instructions | #13234, #13346, #13376, #13456, #14587, #14688, #14637, #14790, #14961 | Harness request context + static/dynamic capped instruction files + git metadata + model-specific prompt sections + request_access guidance + late tone/style guidance | Partial | High | [page](./chat/prompt-context.md) |
...
| Models | Model auth, selection, modes | #13218, #13307, #13490, #13512, #13566, #13600, #13611, #13695, #13716, #13573, #14433, #14469, #14604, #14605, #14867, #14952, #14936 | Settings + harness session + thread pack metadata + provider registry/cache generation + AuthStorage/stored API keys + Memory Gateway settings/proxy + harness headers + built-in defaults + masked key input | Partial | High | [page](./models/model-auth-and-modes.md) |
...
| Integrations | Browser automation | #15036 | settings.json browser config + Harness browser propagation + core Agent browser context | Partial | High | [page](./integrations/browser-automation.md) |
