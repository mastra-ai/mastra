...
| Chat | Agent signals and streaming follow-ups | #16231, #16338, #16521 | core Agent signal conversion + Harness follow-up queue + structured plan-approval reminders + React thread subscription + TUI/Playground pending signal projection | Partial | High | [page](./chat/agent-signals.md) |
