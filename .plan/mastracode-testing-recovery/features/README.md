...
| Chat | Agent signals and streaming follow-ups | #16231, #16338, #16521, #16622 | core Agent signal conversion + narrowed multimodal signal contents + legacy signal rehydration + Harness follow-up queue + structured plan-approval reminders + React thread subscription + TUI/Playground pending signal projection | Partial | High | [page](./chat/agent-signals.md) |
...
| Integrations | Core Harness API and reference docs | #13353, #13457, #13519, #13525, #13716, #14433, #15036, #16250, #13891, #16340, #16231, #16521 | Core Harness runtime + docs + model request headers + browser propagation + createMastraCode memory override + Agent signal/follow-up APIs + structured plan approval resolver/signal ordering | Partial | High | [page](./integrations/harness-api.md) |
...
| Integrations | Observability and eval feedback | #15642, #16223 | settings/AuthStorage observability config + DuckDB/storage/platform exporters + deprecated Cloud/Default exporter compatibility + eval context builder + outcome/efficiency scorers + `/feedback` trace correlation | Partial | High | [page](./integrations/observability-and-evals.md) |
...
| Memory | Observational memory | #13231, #13305, #13330, #13349, #13354, #13476, #13568, #13563, #13569, #13815, #13953, #13996, #14436, #14437, #14567, #14788, #14790, #14952, #15359, #15365, #16663, #15420, #15462, #15566, #15605, #15703, #16275 | Memory storage/vector index + gateway memory proxy + harness/settings OM state + persisted thresholds/caveman mode + thread OM toggle restore/seed + temporal-gap markers + actor-context idle/provider-change activation + TUI idle counter + reflection overshoot guards + bounded thread-tag stripping + scope config + retrieval/recall provenance + cross-thread access guards + observer-context budgeting + attachment filtering/token estimates + OM custom model picker + dynamic-reminder exclusion + clone remapping + generated thread titles | Partial | High | [page](./memory/observational-memory.md) |
