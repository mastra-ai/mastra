...
| Headless | Prompt mode | #13648, #14962, #14909 | CLI args + Harness events + auto-resolution + model/mode preflight + thread/resource controls | Partial | High | [page](./headless/prompt-mode.md) |
| TUI | Startup banner | #13422 | TUI options + terminal width | Partial | Medium | [page](./tui/startup-banner.md) |
| TUI | Help and shortcuts | #13426, #13712, #13723, #13787, #14250, #15036, #15014 | TUI command metadata + settings + queueing shortcut labels + browser/API-key command listing | Partial | Medium | [page](./tui/help-and-shortcuts.md) |
| TUI | Interactive prompts and access requests | #13696, #13753, #14479, #14845, #14936 | TUI active prompt + pending prompt queue + answered-prompt wrapping/custom response mode + masked sensitive input + sandbox allowed paths | Partial | High | [page](./tui/interactive-prompts.md) |
...
| Settings | Onboarding and global settings | #13421, #13431, #13487, #13494, #13500, #13505, #13508, #13512, #13566, #13603, #13611, #13748, #13953, #13573, #14604, #14605, #14788, #14952, #14936, #15036, #15014, #15194, #15359 | settings.json + thread settings + provider registry + AuthStorage/stored API keys + built-in pack defaults + browser profile/executable settings + OM threshold/caveman defaults + Memory Gateway settings + masked sensitive prompts | Partial | High | [page](./settings/onboarding-and-global-settings.md) |
...
| TUI | Interactive chat | #13218, #13350, #13413, #13427, #13456, #13460, #13442, #13487, #13609, #13696, #13712, #13723, #13999, #14423, #15082, #15088 | TUI + Harness display state + prompt/editor animation + count-based rendered component pruning | Partial | High | [page](./tui/interactive-chat.md) |
| TUI | Shell passthrough streaming | #13999, #15092 | TUI input router + shell subprocess + live collapsible output component | Partial | Medium | [page](./tui/shell-passthrough.md) |
| TUI | Debug logging | #13691, #13701 | env vars + app-data/debug trace files | Partial | Medium | [page](./tui/debug-logging.md) |
| Chat | Prompt context and project instructions | #13234, #13346, #13376, #13456, #14587, #14688, #14637, #14790, #14961, #14435, #15352, #15359 | Harness request context + static/dynamic capped instruction files + API-error retry reminders + git metadata + model-specific prompt sections + request_access/autonomy guidance + memory-style caveat + late tone/style guidance | Partial | High | [page](./chat/prompt-context.md) |
...
| Threads | Persistent conversations / switching | #13218, #13334, #13343, #14428, #14436, #14690, #14691, #14567 | Harness session + thread metadata + all-resource selector + cache-only preview/title display + `/thread` provenance + OM title updates | Partial | High | [page](./threads/persistent-conversations.md) |
...
| Models | Model auth, selection, modes | #13218, #13307, #13490, #13512, #13566, #13600, #13611, #13695, #13716, #13573, #14433, #14469, #14604, #14605, #14867, #14952, #14936, #15014, #15370, #14909, #15458, #15483 | Settings + harness session + thread pack metadata + provider registry/cache generation + AuthStorage/stored API keys + `/api-keys` management + Memory Gateway settings/proxy + harness headers + model-pack share/import payloads + headless model preflight + built-in defaults + provider key fallback chain + masked key input | Partial | High | [page](./models/model-auth-and-modes.md) |
...
| Tools | Coding tools and approval permissions | #13218, #13344, #13347, #13348, #13355, #13385, #13384, #13428, #13442, #13519, #13526, #13564, #13609, #13611, #13687, #13696, #13713, #13724, #13753, #13870, #13999, #14157, #14168, #14565, #14535 | Harness state + permission policy + workspace filesystem + extraTools + schemas + local shell passthrough + validation errors + safe tool-result serialization + LSP inspect category | Partial | High | [page](./tools/coding-tools-permissions.md) |
...
| Tools | Workspace-backed coding tools | #13437, #13526, #13687, #13693, #13695, #13700, #13724, #13753, #13940, #14565, #14961, #15151, #15228 | core/custom Workspace + LocalFilesystem/LocalSandbox + tool-name overrides + allowed paths + Agent Skills directories + canonical symlink skill aliases + request_access guidance + schema compat + subagent inheritance + LSP inspect | Partial | High | [page](./tools/workspace-tools.md) |
| Tools | Streaming tool arguments | #13328, #13335, #14472, #14535 | Harness display state + TUI pending tools + argument/result highlight/safe serialization | Partial | High | [page](./tools/streaming-tool-arguments.md) |
| Tools | Task tracking tools and TUI progress | #13344, #15192 | Harness task state + TUI progress + thread-boundary reset | Partial | High | [page](./tools/task-tracking.md) |
...
| Integrations | Core Harness API and reference docs | #13353, #13457, #13519, #13525, #13716, #14433, #15036 | Core Harness runtime + docs + model request headers + browser propagation | Partial | High | [page](./integrations/harness-api.md) |
...
| Integrations | Skills command and workspace resolution | #13457, #13700, #15151, #15228 | Core Harness workspace cache + Workspace skills provider + Agent Skills directories + canonical symlink alias de-duping | Partial | High | [page](./integrations/skills-command.md) |
...
| Subagents | Delegation to Explore / Plan / Execute | #13227, #13339, #13700, #13940, #14804, #15088 | Harness config + parent Workspace + configured subagent picker + subagent model defaults + subagent request context/session state | Partial | High | [page](./subagents/delegation.md) |
| Subagents | Audit-tests subagent | #13331 | Harness subagent config | Missing | High | [page](./subagents/audit-tests.md) |
| Memory | Observational memory | #13231, #13305, #13330, #13349, #13354, #13476, #13568, #13563, #13569, #13815, #13953, #13996, #14436, #14437, #14567, #14788, #14790, #14952, #15359, #15365, #15420, #15462 | Memory storage/vector index + gateway memory proxy + harness/settings OM state + persisted thresholds/caveman mode + idle/provider-change activation + reflection overshoot guards + scope config + retrieval/recall provenance + cross-thread access guards + observer-context budgeting + attachment filtering/token estimates + OM model picker + dynamic-reminder exclusion + clone remapping + generated thread titles | Partial | High | [page](./memory/observational-memory.md) |
