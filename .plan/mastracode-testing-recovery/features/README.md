...
| TUI | Interactive chat | #13218, #13350, #13413, #13427, #13456, #13460, #13442, #13487, #13609, #13696, #13712, #13723, #13999, #14423, #15082, #15088, #15942, #15993, #16006, #16231 | TUI + Harness display state + prompt/editor animation + optimistic/piped user-message projection + active-run signal interjections + full-width border sizing + count-based rendered component pruning | Partial | High | [page](./tui/interactive-chat.md) |
...
| Chat | Queued follow-ups and slash commands | #13345, #13493, #14250, #14727, #15678, #16231 | TUI transient queue state + active-thread custom commands + custom command loader/processor + active-run signal/queue routing | Partial | High | [page](./chat/queued-followups.md) |
| Chat | Agent signals and streaming follow-ups | #16231, #16338, #16521, #16622, #16665, #16669 | core Agent signal conversion + narrowed multimodal signal contents + legacy signal rehydration + PubSub/Unix-socket-routed thread subscriptions + Harness follow-up queue + structured plan-approval reminders + React thread subscription + TUI/Playground pending signal projection | Partial | High | [page](./chat/agent-signals.md) |
...
| Models | Model auth, selection, modes | #13218, #13307, #13490, #13512, #13566, #13600, #13611, #13695, #13716, #13573, #14433, #14469, #14604, #14605, #14867, #14952, #14936, #15014, #15370, #14909, #15458, #15483, #15631, #15703, #15759, #16294, #16332, #16129, #16548 | Settings + harness session + thread pack metadata + provider registry/cache generation/corrupt-cache fallback + AuthStorage/stored API keys + GitHub Copilot OAuth/live catalog + OpenAI Codex browser/device login + `/api-keys` management + Memory Gateway settings/proxy + harness headers + model-pack share/import payloads + headless model preflight + GPT-5.5 built-in defaults + provider key fallback chain + masked key input + normalized TUI model labels + custom OM model role overrides + Codex OAuth callback port fallback/account headers | Partial | High | [page](./models/model-auth-and-modes.md) |
...
| Integrations | Core Harness API and reference docs | #13353, #13457, #13519, #13525, #13716, #14433, #15036, #16250, #13891, #16340, #16231, #16521, #16665, #16669 | Core Harness runtime + docs + model request headers + browser propagation + createMastraCode memory/PubSub overrides + Agent signal/follow-up APIs + structured plan approval resolver/signal ordering + cross-runtime/thread Unix socket subscriptions | Partial | High | [page](./integrations/harness-api.md) |
