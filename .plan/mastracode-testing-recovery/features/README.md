...
| Tools | Workspace-backed coding tools | #13437, #13526, #13687, #13693, #13695, #13700, #13724, #13753, #13940, #14565 | core/custom Workspace + LocalFilesystem/LocalSandbox + tool-name overrides + allowed paths + schema compat + subagent inheritance + LSP inspect | Partial | High | [page](./tools/workspace-tools.md) |
