...
| Headless | Prompt mode | #13648, #14962, #14909, #15423 | CLI args + Harness events + auto-resolution + model/mode preflight + thread/resource controls + automation output formats | Partial | High | [page](./headless/prompt-mode.md) |
...
| Models | Model auth, selection, modes | #13218, #13307, #13490, #13512, #13566, #13600, #13611, #13695, #13716, #13573, #14433, #14469, #14604, #14605, #14867, #14952, #14936, #15014, #15370, #14909, #15458, #15483, #15631 | Settings + harness session + thread pack metadata + provider registry/cache generation + AuthStorage/stored API keys + `/api-keys` management + Memory Gateway settings/proxy + harness headers + model-pack share/import payloads + headless model preflight + built-in defaults + provider key fallback chain + masked key input + normalized TUI model labels | Partial | High | [page](./models/model-auth-and-modes.md) |
...
| Tools | Coding tools and approval permissions | #13218, #13344, #13347, #13348, #13355, #13385, #13384, #13428, #13442, #13519, #13526, #13564, #13609, #13611, #13687, #13696, #13713, #13724, #13753, #13870, #13999, #14157, #14168, #14565, #14535, #15566 | Harness state + permission policy + workspace filesystem + extraTools + schemas + local shell passthrough + validation errors + safe tool-result serialization + bounded parser/rendering helpers + LSP inspect category | Partial | High | [page](./tools/coding-tools-permissions.md) |
| Tools | Web search tool rendering | #13609, #13870, #15448 | provider/Tavily result shape + @mastra/tavily package + Mastra Code wrapper formatting + TUI renderer | Partial | Medium | [page](./tools/web-search-rendering.md) |
| Tools | Workspace-backed coding tools | #13437, #13526, #13687, #13693, #13695, #13700, #13724, #13753, #13940, #14565, #14961, #15151, #15228, #15566 | core/custom Workspace + LocalFilesystem/LocalSandbox + tool-name overrides + allowed paths + Agent Skills directories + canonical symlink skill aliases + procedural path parsing + request_access guidance + schema compat + subagent inheritance + LSP inspect | Partial | High | [page](./tools/workspace-tools.md) |
...
| Integrations | Skills command and workspace resolution | #13457, #13700, #15151, #15228, #15566 | Core Harness workspace cache + Workspace skills provider + Agent Skills directories + canonical symlink alias de-duping + procedural versioned path normalization | Partial | High | [page](./integrations/skills-command.md) |
