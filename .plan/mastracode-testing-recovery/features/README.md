...
| Goals | Plan approval and build handoff | #13416, #13557, #13598, #16065 | Core Harness plan resolver + TUI plan card + plan files + goal handoff | Partial | High | [page](./goals/plan-approval.md) |
| Goals | Persistent `/goal` mode | #16065, #16322 | thread goal metadata + GoalManager + judge agent/defaults + TUI judge/input-lock state | Partial | High | [page](./goals/persistent-goals.md) |
