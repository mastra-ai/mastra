...
| Settings | Onboarding and global settings | #13421, #13431, #13487, #13494, #13500, #13505, #13508, #13512, #13566, #13603, #13611, #13748, #13953, #13573, #14604, #14605, #14788, #14952, #14936, #15036, #15014, #15194, #15359, #16274, #16682 | settings.json + thread settings + provider registry + AuthStorage/stored API keys + built-in pack defaults + browser profile/executable settings + OM threshold/caveman/attachment defaults + Memory Gateway settings + masked sensitive prompts + modal setup/config flows | Partial | High | [page](./settings/onboarding-and-global-settings.md) |
...
| Chat | Agent signals and streaming follow-ups | #16231, #16338, #16521, #16622, #16665 | core Agent signal conversion + narrowed multimodal signal contents + legacy signal rehydration + PubSub-routed thread subscriptions + Harness follow-up queue + structured plan-approval reminders + React thread subscription + TUI/Playground pending signal projection | Partial | High | [page](./chat/agent-signals.md) |
...
| Integrations | Core Harness API and reference docs | #13353, #13457, #13519, #13525, #13716, #14433, #15036, #16250, #13891, #16340, #16231, #16521, #16665 | Core Harness runtime + docs + model request headers + browser propagation + createMastraCode memory/PubSub overrides + Agent signal/follow-up APIs + structured plan approval resolver/signal ordering + cross-runtime thread subscriptions | Partial | High | [page](./integrations/harness-api.md) |
