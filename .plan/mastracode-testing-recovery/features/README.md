...
| Chat | Prompt context and project instructions | #13234, #13346, #13376, #13456, #14587, #14688, #14637, #14790, #14961, #14435, #15352, #15359, #15759 | Harness request context + static/dynamic capped instruction files + API-error retry reminders + git metadata + exact-ID model-specific prompt sections + request_access/autonomy guidance + memory-style caveat + late tone/style guidance | Partial | High | [page](./chat/prompt-context.md) |
...
| Models | Model auth, selection, modes | #13218, #13307, #13490, #13512, #13566, #13600, #13611, #13695, #13716, #13573, #14433, #14469, #14604, #14605, #14867, #14952, #14936, #15014, #15370, #14909, #15458, #15483, #15631, #15703, #15759 | Settings + harness session + thread pack metadata + provider registry/cache generation + AuthStorage/stored API keys + `/api-keys` management + Memory Gateway settings/proxy + harness headers + model-pack share/import payloads + headless model preflight + GPT-5.5 built-in defaults + provider key fallback chain + masked key input + normalized TUI model labels + custom OM model role overrides | Partial | High | [page](./models/model-auth-and-modes.md) |
