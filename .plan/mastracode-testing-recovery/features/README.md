...
| Models | Model auth, selection, modes | #13218, #13307, #13490, #13512, #13566, #13600, #13611, #13695, #13716, #13573, #14433, #14469, #14604, #14605, #14867, #14952, #14936, #15014, #15370, #14909, #15458, #15483, #15631, #15703 | Settings + harness session + thread pack metadata + provider registry/cache generation + AuthStorage/stored API keys + `/api-keys` management + Memory Gateway settings/proxy + harness headers + model-pack share/import payloads + headless model preflight + built-in defaults + provider key fallback chain + masked key input + normalized TUI model labels + custom OM model role overrides | Partial | High | [page](./models/model-auth-and-modes.md) |
...
| Models | Provider history compatibility | #15730 | core prompt/error processor rules + provider-scoped history rewrites + Mastra Code agent wiring | Partial | High | [page](./models/provider-history-compat.md) |
...
| Tools | Task tracking tools and TUI progress | #13344, #15192, #15749 | Harness task state + TUI progress + thread-boundary reset for tasks/plan/access/task UI | Partial | High | [page](./tools/task-tracking.md) |
