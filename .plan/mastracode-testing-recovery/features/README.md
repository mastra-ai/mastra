...
| Setup | Startup performance | #16513 | non-blocking gateway sync + local LibSQL PRAGMAs + cached/coalesced init + message indexes + column cache | Partial | High | [page](./setup/startup-performance.md) |
...
| TUI | Interactive chat | #13218, #13350, #13413, #13427, #13456, #13460, #13442, #13487, #13609, #13696, #13712, #13723, #13999, #14423, #15082, #15088, #15942, #15993, #16006, #16231, #16790 | TUI + Harness display state + prompt/editor animation + optimistic/piped user-message projection + active-run signal interjections/slash commands + full-width border sizing + count-based rendered component pruning | Partial | High | [page](./tui/interactive-chat.md) |
...
| Memory | Observational memory | #13231, #13305, #13330, #13349, #13354, #13476, #13568, #13563, #13569, #13815, #13953, #13996, #14436, #14437, #14567, #14788, #14790, #14952, #15359, #15365, #16663, #15420, #15462, #15566, #15605, #15703, #16275, #16682, #16922 | Memory storage/vector index + gateway memory proxy + harness/settings OM state + persisted thresholds/caveman/attachment mode + thread OM toggle restore/seed + temporal-gap markers + actor-context idle/provider-change activation + TUI idle counter + reflection overshoot guards + bounded thread-tag stripping + scope config + retrieval/recall provenance + cross-thread access guards + observer-context budgeting + model-capability attachment filtering/token estimates + OM custom model picker + dynamic-reminder exclusion + clone remapping + generated thread titles | Partial | High | [page](./memory/observational-memory.md) |
