...
| TUI | Quiet mode | #13556, #16771 | settings preference + TUI render state + rollout prompt + compact tool grouping/previews + quiet task summaries | Partial | High | [page](./tui/quiet-mode.md) |
