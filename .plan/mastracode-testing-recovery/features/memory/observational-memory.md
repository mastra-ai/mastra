...
- Automatic triggers: memory factory attaches observational memory to agent runs; startup resolves global OM settings; OM events render progress/output; retrieval mode wraps observations in source-message ranges and indexes observation groups for later recall/search.
