...
- `mastracode/src/__tests__/index.test.ts` — verifies default dynamic memory is passed into Harness, cross-process PubSub validation/thread-lock behavior, and adjacent `createMastraCode()` runtime wiring.
