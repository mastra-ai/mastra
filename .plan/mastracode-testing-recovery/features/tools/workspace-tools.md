...
- `packages/core/src/workspace/skills/*` and `packages/core/src/workspace/filesystem/local-filesystem.ts` — skill source canonical path resolution and symlink-aware allowed-root containment.
...
- `packages/core/src/workspace/skills/workspace-skills.test.ts`, `workspace.test.ts`, `tools.test.ts`, and `packages/core/src/workspace/filesystem/local-filesystem.test.ts` — symlink/canonical skill alias resolution and allowed-root containment.
