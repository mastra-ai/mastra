...
- `mastracode/src/agents/workspace.ts` — dynamic workspace construction, skill/default-temp/sandbox allowed path assembly, plan-mode write-tool disabling, LSP config, sandbox env.
