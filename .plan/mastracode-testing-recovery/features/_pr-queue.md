...
| Order | Date | PR | Commit | Initial flag | Subject | Mastra Code files touched |
| ---: | --- | ---: | --- | --- | --- | ---: |
| 1 | 2026-02-18 | #13218 | `0e64154f1b` | review | MastraCode initial port (#13218) | 112 |
| 2 | 2026-02-18 | #13227 | `5013f35869` | review | MC follow up 1 (#13227) | 13 |
| 3 | 2026-02-18 | #13231 | `6515d301d4` | review | More cleanup (#13231) | 10 |
| 4 | 2026-02-18 | #13234 | `4e28562012` | review | MC fixes (#13234) | 67 |
| 5 | 2026-02-18 | #13239 | `9bbf08e3c2` | review | fix(core): use structural typing for ZodLikeSchema to prevent tsc OOM (#13239) | 112 |
| 6 | 2026-02-18 | #13245 | `6fdd3d451a` | review | Harness primitive (#13245) | 24 |
| 7 | 2026-02-18 | #13037 | `a0b5df263a` | likely skip | chore: version packages (alpha) (#13037) | 2 |
| 8 | 2026-02-18 | #13250 | `4f2e364945` | review | fix(mastracode): ESM module resolution error on startup (#13250) | 1 |
| 9 | 2026-02-18 | #13251 | `a20fbeff59` | likely skip | chore: version packages (alpha) (#13251) | 2 |
| 10 | 2026-02-18 | #13253 | `1415bcd894` | review | fix(schema-compat): fix zodToJsonSchema routing for v3/v4 schemas (#13253) | 11 |
| 11 | 2026-02-18 | #13252 | `f090302af0` | likely skip | chore: version packages (alpha) (#13252) | 2 |
| 12 | 2026-02-19 | #13255 | `d715911c91` | review | feat(mastracode): add separate export path for MastraTUI (#13255) | 2 |
| 13 | 2026-02-19 | #13257 | `834b03e500` | likely skip | chore: version packages (alpha) (#13257) | 2 |
| 14 | 2026-02-19 | #13305 | `b2601234bd` | review | fix(memory): improve OM activation chunk selection and safeguards (#13305) | 1 |
...
| 30 | 2026-02-20 | #13349 | `5f1f0fa8a3` | review | fix: raise memory buffer activation threshold to prevent aggressive window shrinking (#13349) | 1 |
| 31 | 2026-02-20 | #13350 | `e65ec08031` | review | refactor: extract TUI state into dedicated TUIState interface and factory (#13350) | 3 |
| 32 | 2026-02-20 | #13355 | `89b1a4aead` | review | fix(mastracode): allow view_range for directory listings (#13355) | 2 |
...
| 38 | 2026-02-23 | #13385 | `18553c3541` | review | fix(mastracode): use correct LSP language identifier for TS/JS files (#13385) | 1 |
...
| 46 | 2026-02-23 | #13427 | `d4701f7e24` | review | feat(core): add HarnessDisplayState for UI-agnostic display state (#13427) | 28 |
...
| 87 | 2026-03-02 | #13701 | `33f289c616` | review | use separate tui debug env var (#13701) | 1 |
...
| 99 | 2026-03-04 | #13760 | `fa9692afe2` | review | fix(mastracode): inline version at build time instead of requiring package.json (#13760) | 2 |
...
| 105 | 2026-03-04 | #13753 | `633370bdf4` | review | fix: rename request_sandbox_access to request_access, fix tilde expansion and mid-turn setAllowedPaths (#13753) | 7 |
...
| 111 | 2026-03-06 | #13648 | `4df211619d` | review | feat(mastracode): add headless non-interactive mode via --prompt flag (#13648) | 5 |
...
| 117 | 2026-03-10 | #13883 | `868dcde021` | likely skip | chore: version packages (alpha) (#13883) | 2 |
...
| 223 | 2026-04-22 | #15631 | `c7b5417617` | review | feat(mastracode): normalize Fireworks and generic model IDs in TUI status line (#15631) | 2 |
