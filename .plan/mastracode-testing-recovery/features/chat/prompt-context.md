...
| Project metadata, branch, and common binaries | Project detection + live git branch refresh + cached `which`/`where` common binary detection | Environment section |
