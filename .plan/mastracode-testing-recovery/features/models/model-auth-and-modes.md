...
- Built-in provider defaults drift; #14604/current source assert OpenAI `gpt-5.5` build/plan and `gpt-5.4-mini` fast/OM, while #15458/current source assert Anthropic OAuth `claude-opus-4-7` and API-key `claude-sonnet-4-6`.
