...
- Later changes: [#13231](https://github.com/mastra-ai/mastra/pull/13231) — runtime model selection from request context and gateway heartbeat sync.
...
- Commands / shortcuts / flags: `/login`, `/models`, `/mode`, Shift+Tab, `--model`, `--mode`, `--thinking-level`.
- Automatic triggers: startup provider access checks, mode defaults, thread/session metadata sync.
