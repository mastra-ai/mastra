...
- Pack identity can be global, thread-scoped, inferred from per-mode IDs, removed during custom pack cleanup, or imported from a serialized `mastra-pack:` string; stale IDs and unavailable imported model IDs are reload/import risks.
