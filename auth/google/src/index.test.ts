...
describe('MastraRBACGoogle', () => {
  ...
  it('throws without Directory API authentication', () => {
    expect(() => new MastraRBACGoogle({ roleMapping: { Admin: ['*'] } })).toThrow(
      'Google Workspace Directory authentication is required',
    );
  });
