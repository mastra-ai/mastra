...
must_haves:
  truths:
    ...
    - "LibSQL uses timestamp-based versioning (version column stores ISO timestamp)"
...
5. addItem/updateItem/deleteItem update version to current timestamp
</verification>
...
- [ ] Timestamp versioning: `UPDATE ... SET version = ?` with ISO timestamp
