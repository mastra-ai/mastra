...
Also consider:
6. `should return tripwire status when streaming agent in workflow` (line 20439)
...
Check for new streaming tests and their pass/fail status.
  ...
  <done>
5-6 streaming tests ported. Document writer support status.
  </done>
</task>
...
- Skipped tests have documented reasons
  ...
  <done>
10-11 tests ported. Counts documented. Changes committed.
  </done>
</task>
