...
async function runScorerSafe(scorer: MastraScorer, input: unknown, output: unknown, expectedOutput?: unknown) {
  try {
...
export async function runDataset(mastra: Mastra, config: RunConfig): Promise<RunResult> {
