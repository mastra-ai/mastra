...
:::warning
  ...
  **Deprecated**: This method is deprecated and only works with V1 models. For V2 models, use the new [`.stream()`](./stream.md) method instead. See the [migration guide](../../agents/migration-guide.md) for details on upgrading.
...
:::info
  ...
  The new `.stream()` method offers enhanced capabilities including AI SDK v5 compatibility, better structured output handling, and improved callback system. See the [migration guide](../../agents/migration-guide.md) for detailed migration instructions.
...
- [Migration Guide](../../agents/migration-guide.md)
- [New .stream() method](./stream.md)
