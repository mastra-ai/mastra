...
describe('TextualDifferenceMetric', () => {
  ...
  it('should handle small differences', async () => {
    const inputMessages = [createMastraMessageV2({ content: 'The quick brown fox', role: 'user', id: 'test-input' })];
    const output = [createMastraMessageV2({ content: 'The quick brown cat', role: 'assistant', id: 'test-output' })];
  ...
  it('should handle word additions', async () => {
    const inputMessages = [createMastraMessageV2({ content: 'The quick brown fox', role: 'user', id: 'test-input' })];
    const output = [
      createMastraMessageV2({ content: 'The very quick brown fox', role: 'assistant', id: 'test-output' }),
    ];
  ...
  it('should handle word deletions', async () => {
    const inputMessages = [
      createMastraMessageV2({ content: 'The quick brown fox jumps', role: 'user', id: 'test-input' }),
    ];
    const output = [createMastraMessageV2({ content: 'The quick fox jumps', role: 'assistant', id: 'test-output' })];
  ...
  it('should handle whitespace sensitivity', async () => {
    const inputMessages = [
      createMastraMessageV2({ content: 'The   quick\nbrown    fox', role: 'user', id: 'test-input' }),
    ];
    const output = [createMastraMessageV2({ content: 'The quick brown fox', role: 'assistant', id: 'test-output' })];
