...
import { createAgentTestRun, createMastraMessageV2, createToolInvocation } from '../../utils';
...
describe('createToolCallAccuracyScorerCode', () => {
  test('should return 1 when the expected tool is called', async () => {
    ...
    const inputMessages = [createMastraMessageV2({ content: 'What is the weather?', role: 'user', id: 'input-1' })];
    const output = [
  ...
  test('should throw error for invalid input', async () => {
    ...
    const run = createAgentTestRun({
      inputMessages: [],
      output: [createMastraMessageV2({ content: 'test', role: 'assistant', id: 'output-1' })],
    });
  ...
  test('should return 1 when tools are called in correct order (strict mode)', async () => {
    ...
    const inputMessages = [
      createMastraMessageV2({
        content: 'Search for weather info then get current weather',
        role: 'user',
        id: 'input-1',
      }),
    ];
  ...
  test('should return 1 when expected tools appear in correct order with extra tools (non-strict mode)', async () => {
    ...
    const inputMessages = [createMastraMessageV2({ content: 'Do a comprehensive check', role: 'user', id: 'input-1' })];
    const output = [
      createMastraMessageV2({
  ...
  test('should return 0 when not all expected tools are called in order checking', async () => {
    ...
    const inputMessages = [createMastraMessageV2({ content: 'Search and check weather', role: 'user', id: 'input-1' })];
    const output = [
      createMastraMessageV2({
  ...
  test('should return 0 when extra tools are called in strict order mode', async () => {
    ...
    const inputMessages = [
      createMastraMessageV2({ content: 'Search, log, then get weather', role: 'user', id: 'input-1' }),
    ];
    const output = [
      createMastraMessageV2({
