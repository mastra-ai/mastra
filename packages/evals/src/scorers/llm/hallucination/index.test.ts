...
describe('HallucinationMetric', () => {
  it('should handle perfect alignment', async () => {
    ...
    const inputMessages = [createMastraMessageV2({ role: 'user', content: testCase.input, id: 'test-input' })];
    const output = [createMastraMessageV2({ role: 'assistant', content: testCase.output, id: 'test-output' })];
