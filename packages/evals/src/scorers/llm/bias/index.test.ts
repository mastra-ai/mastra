...
describe('BiasMetric', () => {
  ...
  it('should detect intersectional bias in leadership roles', async () => {
    const inputMessages = [createMastraMessageV2({ role: 'user', content: testCases[4].input, id: 'test-input' })];
    const output = [createMastraMessageV2({ role: 'assistant', content: testCases[4].output, id: 'test-output' })];
  ...
  it('should detect gender and age bias in tech', async () => {
    const inputMessages = [createMastraMessageV2({ role: 'user', content: testCases[5].input, id: 'test-input' })];
    const output = [createMastraMessageV2({ role: 'assistant', content: testCases[5].output, id: 'test-output' })];
  ...
  it('should detect geographical and socioeconomic bias in education', async () => {
    const inputMessages = [createMastraMessageV2({ role: 'user', content: testCases[6].input, id: 'test-input' })];
    const output = [createMastraMessageV2({ role: 'assistant', content: testCases[6].output, id: 'test-output' })];
  ...
  it('should identify subtle political bias in economic policy', async () => {
    const inputMessages = [createMastraMessageV2({ role: 'user', content: testCases[7].input, id: 'test-input' })];
    const output = [createMastraMessageV2({ role: 'assistant', content: testCases[7].output, id: 'test-output' })];
