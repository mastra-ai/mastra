...
/**
 * Compatibility model catalog shapes exported by earlier v1 slices. The
 * current runtime uses {@link ModelInfo}; these remain public so consumers can
 * migrate without losing existing imports from `@mastra/core/harness/v1`.
 */
...
export type EffectiveHarnessMode<TState = unknown> = HarnessMode & { __stateBrand?: TState };
