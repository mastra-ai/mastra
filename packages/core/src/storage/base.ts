...
import type { ScoreResult, ScoreRowData } from '../eval';
...
export abstract class MastraStorage extends MastraBase {
  ...
  abstract getScoresByRunId({ runId, pagination }: { runId: string, pagination: StoragePagination }): Promise<{ pagination: PaginationInfo, scores: ScoreRowData[] }>
