...
export const EXPERIMENTS_SCHEMA: Record<string, StorageColumn> = {
  ...
  executionStatusCounts: { type: 'jsonb', nullable: true },
  scorerStatusCounts: { type: 'jsonb', nullable: true },
  thresholds: { type: 'jsonb', nullable: true },
...
export const EXPERIMENT_RESULTS_SCHEMA: Record<string, StorageColumn> = {
  ...
  groundTruth: { type: 'jsonb', nullable: true },
  error: { type: 'jsonb', nullable: true },
  executionStatus: { type: 'text', nullable: true },
