...
When \`github_subscribe_pr\` and \`github_unsubscribe_pr\` are available, use them to manage pull-request activity for the current thread. A successful \`gh pr create\` is subscribed automatically in supported environments.
