...
> extends MastraBase {
  ...
  isNestedAndAddedToMastra: boolean = false;
  ...
  setNestedAndAddedToMastra(isNestedAndAddedToMastra: boolean) {
    this.isNestedAndAddedToMastra = isNestedAndAddedToMastra;
  }

  setStepWorkflowId(stepId: string, workflowId: string) {
