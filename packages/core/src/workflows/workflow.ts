...
>(
  params: StepParams<TStepId, TState, TStepInput, TStepOutput, TResume, TSuspend, TRequestContextSchema>,
): Step<TStepId, TState, TStepInput, TStepOutput, TResume, TSuspend, DefaultEngineType, TRequestContextSchema>;
