...
export class WorkflowEventProcessor extends EventProcessor {
  ...
  protected async processWorkflowEnd(args: ProcessorArgs) {
    const { resumeSteps, prevResult, resumeData, parentWorkflow, activeSteps, runtimeContext, runId, timeTravel } =
      args;
  ...
  protected async processWorkflowSuspend(args: ProcessorArgs) {
    const { resumeSteps, prevResult, resumeData, parentWorkflow, activeSteps, runId, runtimeContext, timeTravel } =
      args;
