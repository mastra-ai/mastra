...
describe('Workflow', () => {
  ...
  describe('Run count', () => {
    ...
    describe('Branching Step Status Bug Test', () => {
      it('should maintain correct step status after resuming in branching workflows', async () => {
        // This test addresses GitHub issue #6419
        // Bug: Step status remains "suspended" after successful resume in branching workflows
        ...
        // BUG FIX: Final result should be 'success', not 'suspended'
        expect(finalResult.status).toBe('success');
