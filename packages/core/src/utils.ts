...
/**
 * Normalizes a route path (e.g., API prefix, studio base path).
 *
 * - If path is '/' or empty, returns empty string
 * - Validates against path traversal, query params, and special chars
