...
export abstract class MastraMemory extends MastraBase {
   ...
   */
  public async getSystemMessage(_input: { threadId: string; resourceId?: string; memoryConfig?: MemoryConfig }): Promise<string | null> {
    return null;
  }
   ...
   * Implementations can override this to inject custom system messages.
   */
  public async getUserContextMessage(_input: { threadId: string; resourceId?: string; memoryConfig?: MemoryConfig }): Promise<string | null> {
    return null;
  }
