 ...
 */
export type InferToolInput<T> = T extends Tool<infer I, any, any, any, any, any, any> ? I : never;

/**
 * Infer the output type of a Mastra tool
 */
export type InferToolOutput<T> = T extends Tool<any, infer O, any, any, any, any, any> ? O : never;
