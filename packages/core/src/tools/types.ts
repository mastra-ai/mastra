...
import type { SchemaWithValidation, ZodLikeSchema, InferZodLikeSchema } from '../stream/base/schema';
...
export interface ToolAction<
  ...
  TSuspend = unknown,
  TResume = unknown,
  TContext extends ToolExecutionContext<TSuspend, TResume, any> = ToolExecutionContext<TSuspend, TResume, undefined>,
