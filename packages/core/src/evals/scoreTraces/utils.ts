 ...
 */
function extractInputMessages(agentSpan: SpanRecord): TransformedUIMessage[] {
 ...
 */
function extractRememberedMessages(llmSpan: SpanRecord, currentInputContent: string): TransformedUIMessage[] {
