...
describe('MessageList', () => {
  ...
  describe('providerOptions preservation', () => {
    ...
    describe('Mixed conversation scenarios', () => {
      ...
      it('should preserve message-level providerOptions on the final user message after a tool-call assistant turn (regression for #15474)', async () => {
        const messageList = new MessageList();
      ...
      it('should preserve message-level providerOptions on assistant tool-call turns without attaching them to tool results', async () => {
        const messageList = new MessageList();
