...
/**
 * Output schema for the prepare memory step
 */
const storageThreadSchema = z.object({
  id: z.string(),
...
/**
 * Creates the prepare memory step that handles memory fetching and message list construction.
 * This step runs in parallel with prepareToolsStep.
 *
