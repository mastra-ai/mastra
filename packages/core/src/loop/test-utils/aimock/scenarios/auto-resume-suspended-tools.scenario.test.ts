 ...
 */
describe('AIMock loop scenario: autoResumeSuspendedTools', () => {
    ...
    await runLoopScenario({
      ...
      fixtures: llm => {
        llm.onMessage(/yes|approve/i, {
          content: 'I understand you want to delete the config file. Please use the approveToolCall API to approve it.',
        });
      },
    });
