...
describe('feature usage telemetry', () => {
  ...
  it('tracks a project surface snapshot without names or identifiers', () => {
    ...
    const mastra = makeMastra({
      listAgents: () => ({ weatherAgent: {}, supportAgent: {} }),
    ...
    expect(event).toMatchObject({
      ...
      properties: {
        ...
        processor_configurations_enabled: true,
        memory_count: 1,
        memory_enabled: true,
        vector_count: 2,
        scorer_count: 1,
        ...
        prompt_blocks_enabled: true,
        editor_enabled: true,
        studio_enabled: true,
        server_enabled: true,
        mastra_server_enabled: true,
        server_middleware_enabled: true,
        server_cache_enabled: true,
        deployer_enabled: true,
        version_overrides_enabled: true,
        tool_payload_transform_enabled: true,
  ...
  it('uses safe defaults for missing registries', () => {
    ...
    expect(capture.mock.calls[0]![0].properties).toMatchObject({
      ...
      processor_configurations_enabled: false,
      memory_count: 0,
      ...
      prompt_blocks_enabled: false,
      editor_enabled: false,
      studio_enabled: false,
      server_enabled: false,
      mastra_server_enabled: false,
      server_middleware_enabled: false,
      server_cache_enabled: false,
      deployer_enabled: false,
      version_overrides_enabled: false,
      tool_payload_transform_enabled: false,
