...
- 13b557d: Adds MCP prompts to the docs server to help users migrate from v0.x to v1.0.
...
- eef57b7: Clean up mcp docs server migration tool to have a better prompt.
...
- Updated dependencies [85436ef]
  - @mastra/core@0.0.0-kitchen-sink-e2e-test-20251120010328
  - @mastra/mcp@0.0.0-kitchen-sink-e2e-test-20251120010328
