...
- **Business Hooks**: Data-fetching and state management (`src/domain`)
  - Examples: `useAgents()`, `useWorkflows()`
- **Business Components**: Domain-specific components (`src/domain`)
...
- **REQUIRED**: Use design tokens from `src/ds/index.ts`
...
```tsx
// ✅ Good
import { useMastraClient } from './client';
