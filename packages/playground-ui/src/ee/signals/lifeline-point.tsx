  ...
  return (
    <>
      ...
      {tooltipPosition
        ? createPortal(
            <div
              className="border-border1 bg-surface5 text-ui-sm text-neutral6 shadow-elevated pointer-events-none fixed z-50 -translate-x-1/2 -translate-y-full rounded-md border px-2 py-1 font-mono whitespace-nowrap tabular-nums"
              id={tooltipId}
              role="tooltip"
