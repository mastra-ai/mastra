...
export function LifelineRow({
  ...
  return (
    ...
    >
      <span
        className="text-ui-sm text-neutral4 group-hover:text-neutral6 w-52 shrink-0 truncate text-right"
        title={row.label}
      >
        {row.label}
      </span>
      ...
      <span className="text-ui-sm text-neutral3 w-9 shrink-0 font-mono tabular-nums">
