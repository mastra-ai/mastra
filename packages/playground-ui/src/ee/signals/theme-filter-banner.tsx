      ...
      {selections.map((selection, index) => {
        ...
        return (
          <button
            ...
            className="border-border1 bg-surface2 text-neutral6 hover:bg-surface4 flex items-center gap-1.5 rounded-full border py-1 pr-2 pl-2.5 text-ui-sm font-medium transition-colors"
