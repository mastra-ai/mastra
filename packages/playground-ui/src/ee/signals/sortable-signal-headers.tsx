                        ...
                        >
                          <div
                            className={`relative inline-flex items-center justify-center rounded-md border border-transparent px-1 py-0.5 motion-safe:transition-[background-color,border-color,box-shadow,scale] motion-safe:duration-150 ${contentOffsetClass(anchor)} ${
                              dragSnapshot.isDragging ? 'scale-1.03 border-gray-alpha-5 bg-gray-2 shadow-lg' : ''
                            }`}
                          ...
                          >
                            ...
                            <div
                              ...
                              className="text-gray-9 hover:text-gray-10 absolute top-1/2 ml-0.5 -translate-y-1/2 cursor-grab rounded-sm p-1 active:cursor-grabbing aria-disabled:cursor-wait aria-disabled:opacity-50"
                              style={{ left: '100%' }}
