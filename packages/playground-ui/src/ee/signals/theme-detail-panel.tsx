    ...
    >
      <DrawerContent>
        ...
        <DrawerBody className="grid content-start gap-6 overflow-y-auto p-6">
          ...
          {insightTraceId === undefined && (
            <>
              {detailQuery.isPending && <p className="text-ui-md text-neutral3">Loading theme details…</p>}
              ...
              {detailQuery.data && !detailQuery.data.theme && (
                <section>
                  <h2 className="text-ui-md text-neutral6 font-semibold">Not present in this snapshot</h2>
                  <p className="text-ui-md text-neutral3 mt-2">This theme has no data in the selected snapshot.</p>
                </section>
              )}
              {detailQuery.data?.theme && (
                <>
                  <section aria-labelledby="theme-summary-heading">
                    ...
                    <p className="text-ui-md text-neutral5 mt-3 font-mono tabular-nums">
                      {shareSentence(
                    ...
                    {examplesQuery.data && (
                      <>
                        {examplesQuery.data.examples.length === 0 ? (
                          <p className="text-ui-md text-neutral3 mt-3">No examples in this snapshot.</p>
                        ) : (
                  ...
                  {snapshotTotal > 1 && (
                    <section aria-labelledby="theme-trend-heading">
                      ...
                      {historyQuery.isPending && <p className="text-ui-md text-neutral3 mt-3">Loading trend…</p>}
