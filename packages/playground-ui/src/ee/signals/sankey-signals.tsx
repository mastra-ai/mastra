  ...
  return (
    <TraceIntelligenceContext.Provider value={traceIntelligenceContext}>
      <main className="min-w-0 space-y-5 p-4 lg:p-6">
        ...
        <p className="text-ui-sm text-neutral3">{viewDescription}</p>
        ...
        {viewMode === 'compare' ? (
          ...
          <>
            ...
            {isDrilledEmpty ? (
              <section className="border-border1 bg-surface2 text-ui-md text-neutral3 rounded-lg border p-6">
            ...
            {perspectiveMutation.isPending ? (
              <p className="text-ui-sm text-neutral3 font-mono" role="status">
