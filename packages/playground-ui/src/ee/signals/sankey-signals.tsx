      ...
      <div className="min-w-0 space-y-5 p-4 lg:p-6">
        ...
        {viewMode === 'compare' ? (
          ...
          <>
            ...
            {isDrilledEmpty ? (
              <section className="border-border bg-background text-body text-muted-foreground rounded-lg border p-6">
            ...
            {perspectiveMutation.isPending ? (
              <p className="text-caption text-muted-foreground font-mono" role="status">
