...
export function FlowCard({
  ...
  return (
    ...
    >
      <span
        aria-hidden="true"
        className="bg-surface2 text-ui-xs text-neutral3 absolute top-0 left-5 -translate-y-1/2 px-2 font-mono tracking-[0.18em]"
      >
        SIGNALS
      </span>
      <CardContent className="px-0 pt-4 pb-2 sm:pt-5 sm:pb-3">
        ...
        <div
          aria-label="Themes"
          className="text-ui-xs text-neutral3 flex items-center gap-2 py-1 font-mono tracking-[0.18em]"
          role="separator"
        >
