  ...
  <div className="grid grid-cols-6 gap-4">
    {icons.map(({ name, component: IconComponent }) => (
      ...
      >
        ...
        <span className="text-ui-sm text-neutral3 text-center">{name.replace('Icon', '')}</span>
      </div>
    ))}
  </div>
);
  ...
  render: () => (
    <div className="flex items-end gap-8">
      <div className="flex flex-col items-center gap-2">
        ...
        <span className="text-ui-sm text-neutral3">Small</span>
      </div>
      <div className="flex flex-col items-center gap-2">
        <Icon size="default" className="text-neutral5">
          <AgentIcon />
        </Icon>
        <span className="text-ui-sm text-neutral3">Default</span>
      </div>
      <div className="flex flex-col items-center gap-2">
        <Icon size="lg" className="text-neutral5">
          <AgentIcon />
        </Icon>
        <span className="text-ui-sm text-neutral3">Large</span>
      </div>
    </div>
  ),
};
  ...
  render: () => (
    <div className="flex gap-4">
      <div className="bg-surface3 flex flex-col items-center gap-2 rounded-lg p-3">
        ...
        <span className="text-ui-sm text-neutral3">Agent</span>
      </div>
      <div className="bg-surface3 flex flex-col items-center gap-2 rounded-lg p-3">
        <Icon size="lg" className="text-neutral5">
          <AgentCoinIcon />
        </Icon>
        <span className="text-ui-sm text-neutral3">AgentCoin</span>
      </div>
      <div className="bg-surface3 flex flex-col items-center gap-2 rounded-lg p-3">
        <Icon size="lg" className="text-neutral5">
          <AgentNetworkCoinIcon />
        </Icon>
        <span className="text-ui-sm text-neutral3">AgentNetworkCoin</span>
      </div>
    </div>
  ),
};
  ...
  render: () => (
    <div className="flex gap-4">
      <div className="bg-surface3 flex flex-col items-center gap-2 rounded-lg p-3">
        ...
        <span className="text-ui-sm text-neutral3">Workflow</span>
      </div>
      <div className="bg-surface3 flex flex-col items-center gap-2 rounded-lg p-3">
        <Icon size="lg" className="text-neutral5">
          <WorkflowCoinIcon />
        </Icon>
        <span className="text-ui-sm text-neutral3">WorkflowCoin</span>
      </div>
    </div>
  ),
};
  ...
  render: () => (
    <div className="flex gap-4">
      <div className="bg-surface3 flex flex-col items-center gap-2 rounded-lg p-3">
        ...
        <span className="text-ui-sm text-neutral3">Tools</span>
      </div>
      <div className="bg-surface3 flex flex-col items-center gap-2 rounded-lg p-3">
        <Icon size="lg" className="text-neutral5">
          <ToolCoinIcon />
        </Icon>
        <span className="text-ui-sm text-neutral3">ToolCoin</span>
      </div>
    </div>
  ),
};
  ...
  render: () => (
    <div className="flex gap-4">
      <div className="bg-surface3 flex flex-col items-center gap-2 rounded-lg p-3">
        ...
        <span className="text-ui-sm text-neutral3">Github</span>
      </div>
      <div className="bg-surface3 flex flex-col items-center gap-2 rounded-lg p-3">
        <Icon size="lg" className="text-neutral5">
          <GithubCoinIcon />
        </Icon>
        <span className="text-ui-sm text-neutral3">GithubCoin</span>
      </div>
      <div className="bg-surface3 flex flex-col items-center gap-2 rounded-lg p-3">
        <Icon size="lg" className="text-neutral5">
          <GoogleIcon />
        </Icon>
        <span className="text-ui-sm text-neutral3">Google</span>
      </div>
      <div className="bg-surface3 flex flex-col items-center gap-2 rounded-lg p-3">
        <Icon size="lg" className="text-neutral5">
          <OpenAIIcon />
        </Icon>
        <span className="text-ui-sm text-neutral3">OpenAI</span>
      </div>
    </div>
  ),
};
