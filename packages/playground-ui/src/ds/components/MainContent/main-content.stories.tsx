...
export const Default: Story = {
  render: () => (
    <MainContentLayout className="bg-background-1 h-100">
      <PageHeader>
      ...
      <MainContentContent>
        <div className="p-4">
          <p className="text-gray-10">Main content area</p>
        </div>
      </MainContentContent>
    </MainContentLayout>
  ),
    ...
    <MainContentLayout className="bg-background-1 h-100">
      ...
      <MainContentContent isCentered>
        <div className="text-center">
          <p className="text-gray-10 text-lg">No items found</p>
          <p className="text-gray-9 text-sm">Create your first item to get started</p>
        </div>
      </MainContentContent>
    </MainContentLayout>
  ),
  ...
  render: () => (
    <MainContentLayout className="bg-background-1 h-100">
      ...
      <MainContentContent isDivided>
        <div className="border-gray-alpha-3 border-r p-4">
          <p className="text-gray-10">Left column content</p>
        </div>
        <div className="p-4">
          <p className="text-gray-10">Right column content</p>
        </div>
      </MainContentContent>
    </MainContentLayout>
  ),
  ...
  render: () => (
    <MainContentLayout className="bg-background-1 h-100">
      ...
      <MainContentContent hasLeftServiceColumn>
        <div className="border-gray-alpha-3 bg-background-2 border-r p-2">
          <p className="text-gray-9 text-sm">Nav</p>
        </div>
        <div className="p-4">
          <p className="text-gray-10">Main content</p>
        </div>
      </MainContentContent>
    </MainContentLayout>
  ),
  ...
  render: () => (
    <MainContentLayout className="bg-background-1 h-100">
      ...
      <MainContentContent isDivided hasLeftServiceColumn>
        ...
        <div className="border-gray-alpha-3 border-r p-4">
          <p className="text-gray-10">Center column</p>
        </div>
        <div className="p-4">
          <p className="text-gray-10">Right column</p>
        </div>
      </MainContentContent>
    </MainContentLayout>
  ),
