...
export const Default: Story = {
  render: () => (
    <MainContentLayout className="h-100 bg-sidebar">
      <PageHeader>
    ...
    <MainContentLayout className="h-100 bg-sidebar">
      ...
      <MainContentContent isCentered>
        <div className="text-center">
          <p className="text-heading text-foreground">No items found</p>
          <p className="text-body text-muted-foreground">Create your first item to get started</p>
        </div>
      </MainContentContent>
    </MainContentLayout>
  ),
  ...
  render: () => (
    <MainContentLayout className="h-100 bg-sidebar">
      ...
      <MainContentContent hasLeftServiceColumn>
        <div className="border-r border-border bg-background p-2">
          <p className="text-body text-muted-foreground">Nav</p>
        </div>
        <div className="p-4">
