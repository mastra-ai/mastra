      ...
      <Tree>
        <Tree.Folder defaultOpen>
          <Tree.FolderTrigger>
            ...
            <span className="text-ui-xs text-neutral3 ml-auto">12 items</span>
          </Tree.FolderTrigger>
          <Tree.FolderContent>
            <Tree.File>
              <Tree.Icon>
              ...
              <span className="text-ui-xs text-neutral3 ml-auto">v2.1.0</span>
            </Tree.File>
            <Tree.File>
              <Tree.Icon>
                <FileCode className="text-neutral3" />
              ...
              <span className="text-ui-xs text-neutral3 ml-auto">v1.0.3</span>
            </Tree.File>
          </Tree.FolderContent>
        </Tree.Folder>
      </Tree>
