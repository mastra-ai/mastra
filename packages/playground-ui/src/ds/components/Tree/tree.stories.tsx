      ...
      <Tree>
        <Tree.Folder defaultOpen>
          <Tree.FolderTrigger>
            ...
            <span className="text-neutral3 ml-auto text-ui-xs">12 items</span>
          </Tree.FolderTrigger>
          <Tree.FolderContent>
            <Tree.File>
              <Tree.Icon>
              ...
              <span className="text-neutral3 ml-auto text-ui-xs">v2.1.0</span>
            </Tree.File>
            <Tree.File>
              <Tree.Icon>
                <FileCode className="text-neutral3" />
              ...
              <span className="text-neutral3 ml-auto text-ui-xs">v1.0.3</span>
            </Tree.File>
          </Tree.FolderContent>
        </Tree.Folder>
      </Tree>
