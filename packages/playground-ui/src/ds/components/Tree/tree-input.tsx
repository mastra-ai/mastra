    ...
    return (
      <li
        ...
        className={cn(
          ...
          transitions.colors,
          'focus-within:bg-surface4 focus-within:text-neutral6',
          className,
        )}
      ...
      >
        ...
        <input
          ...
          onBlur={handleBlur}
          onFocus={handleFocus}
          className="text-neutral5 placeholder:text-neutral3 text-ui-sm min-w-0 flex-1 border-none bg-transparent"
        />
      </li>
    );
  },
