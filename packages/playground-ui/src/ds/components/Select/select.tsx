...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={clsx(
      'flex h-9 w-full items-center justify-between rounded-md border border-border1 bg-transparent px-3 py-2 text-sm shadow-sm placeholder:text-neutral3 disabled:cursor-not-allowed disabled:opacity-50',
      className,
    )}
    {...props}
  >
