...
export const Default: Story = {
  args: {
    iconSlot: <Inbox className="text-gray-9 h-auto w-[126px]" />,
...
export const NoResults: Story = {
  args: {
    iconSlot: <Search className="text-gray-9 h-auto w-[126px]" />,
...
export const NoFiles: Story = {
  args: {
    iconSlot: <FileX className="text-gray-9 h-auto w-[126px]" />,
    titleSlot: 'No files',
...
export const NoTeamMembers: Story = {
  args: {
    iconSlot: <Users className="text-gray-9 h-auto w-[126px]" />,
