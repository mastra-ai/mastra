...
export const Default: Story = {
  args: {
    iconSlot: <Inbox className="h-auto w-[126px] text-(--text-secondary)" />,
...
export const NoResults: Story = {
  args: {
    iconSlot: <Search className="h-auto w-[126px] text-(--text-secondary)" />,
...
export const NoFiles: Story = {
  args: {
    iconSlot: <FileX className="h-auto w-[126px] text-(--text-secondary)" />,
    titleSlot: 'No files',
...
export const NoTeamMembers: Story = {
  args: {
    iconSlot: <Users className="h-auto w-[126px] text-(--text-secondary)" />,
