              ...
              {isForEach && foreachProgress && (
                <span className="text-meta flex flex-col gap-2 py-1">
                  ...
                  {foreachProgress.totalCount > 0 ? (
                    <progress
                      className="bg-muted accent-success-indicator [&::-moz-progress-bar]:bg-success-indicator [&::-webkit-progress-bar]:bg-muted [&::-webkit-progress-value]:bg-success-indicator h-1 w-full appearance-none border-0"
