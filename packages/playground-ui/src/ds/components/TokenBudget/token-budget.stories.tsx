...
export const Budgets: Story = {
  render: () => (
    <div className="border-gray-alpha-3 bg-background-2 flex items-center gap-5 rounded-xl border p-4">
...
export const Details: Story = {
  render: () => (
    <div className="border-gray-alpha-3 bg-background-2 grid w-112 gap-5 rounded-xl border p-5">
      <TokenBudgetDetail
