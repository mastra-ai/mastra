...
export const Default: Story = {
  render: () => (
    <DataPanel>
      ...
      <DataPanel.Content>
        <p className="text-ui-sm text-gray-9">Panel content goes here.</p>
      </DataPanel.Content>
    </DataPanel>
  ),
};
...
export const WithNavigation: Story = {
  render: () => (
    <DataPanel>
      ...
      <DataPanel.Content>
        <p className="text-ui-sm text-gray-9">Navigate between items with the arrows.</p>
      </DataPanel.Content>
    </DataPanel>
  ),
};
...
export const Collapsed: Story = {
  render: () => (
    <DataPanel collapsed>
      ...
      <DataPanel.Content>
        <p className="text-ui-sm text-gray-9">This panel uses h-auto instead of h-full.</p>
      </DataPanel.Content>
    </DataPanel>
  ),
};
...
export const DisabledNav: Story = {
  render: () => (
    <DataPanel>
      ...
      <DataPanel.Content>
        <p className="text-ui-sm text-gray-9">Previous button is disabled because onPrevious is undefined.</p>
      </DataPanel.Content>
    </DataPanel>
  ),
};
