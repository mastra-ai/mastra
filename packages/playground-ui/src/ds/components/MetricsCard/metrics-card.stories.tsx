  ...
  render: () => (
    <div style={{ width: '30rem' }}>
      <MetricsCard>
        ...
        <MetricsCard.Content>
          <p className="text-gray-9 text-sm">Chart or table content goes here</p>
        </MetricsCard.Content>
      </MetricsCard>
    </div>
  ),
  ...
  render: () => (
    <div style={{ width: '30rem' }}>
      <MetricsCard>
        ...
        <MetricsCard.Content>
          <p className="text-gray-9 text-sm">Bar chart content goes here</p>
        </MetricsCard.Content>
      </MetricsCard>
    </div>
  ),
  ...
  render: () => (
    <div style={{ width: '30rem' }}>
      <MetricsCard>
        ...
        <MetricsCard.Content>
          <p className="text-gray-9 text-sm">Content area</p>
        </MetricsCard.Content>
      </MetricsCard>
    </div>
  ),
