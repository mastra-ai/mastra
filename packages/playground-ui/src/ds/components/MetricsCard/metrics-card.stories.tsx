  ...
  render: () => (
    <div style={{ width: '30rem' }}>
      <MetricsCard>
        ...
        <MetricsCard.Content>
          <p className="text-ui-md text-neutral2">Chart or table content goes here</p>
        </MetricsCard.Content>
      </MetricsCard>
    </div>
  ),
  ...
  render: () => (
    <div style={{ width: '30rem' }}>
      <MetricsCard>
        ...
        <MetricsCard.Content>
          <p className="text-ui-md text-neutral2">Bar chart content goes here</p>
        </MetricsCard.Content>
      </MetricsCard>
    </div>
  ),
  ...
  render: () => (
    <div style={{ width: '30rem' }}>
      <MetricsCard>
        ...
        <MetricsCard.Content>
          <p className="text-ui-md text-neutral2">Content area</p>
        </MetricsCard.Content>
      </MetricsCard>
    </div>
  ),
