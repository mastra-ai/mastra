  ...
  const ScrollIndicator = ({
    ...
    return (
      <button
        ...
        className="bg-surface4 text-neutral3 border-surface5 hover:border-neutral3 fixed z-10 flex items-center justify-center rounded-lg border text-2xl hover:text-neutral6"
        style={{
          ...styles,
          left:
