...
export function ItemListHeader({ columns, isSelectionActive, children }: ItemListHeaderProps) {
  return (
    <div className={cn('sticky top-0 z-10 mb-4 rounded-lg bg-gray-1 px-4')}>
      <div
        className={cn('grid items-center gap-4 text-left text-ui-xs  tracking-widest text-gray-9 uppercase', {
