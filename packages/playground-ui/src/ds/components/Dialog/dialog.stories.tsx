  ...
  render: () => (
    <Dialog>
      ...
      <DialogContent>
        ...
        <div className="py-4">
          <p className="text-ui-md text-neutral5">Dialog body content goes here.</p>
        </div>
        <DialogFooter>
      ...
      <DialogContent>
        ...
        <DialogBody className="max-h-[80vh]">
          <div className="space-y-4 py-4">
            <p className="text-ui-md text-neutral5">
  ...
  render: () => (
    <Dialog>
      ...
      <DialogContent>
        ...
        <p className="text-ui-md text-neutral5">This is a simple informational dialog.</p>
      </DialogContent>
    </Dialog>
  ),
};
