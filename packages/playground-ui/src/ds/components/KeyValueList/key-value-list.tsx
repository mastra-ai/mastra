          ...
          <React.Fragment key={key ?? index}>
            ...
            <dd
              className={cn(
                ...
                'truncate [&>a]:flex [&>a]:min-h-7 [&>a]:w-auto [&>a]:max-w-full [&>a]:items-center [&>a]:gap-2 [&>a]:rounded-md [&>a]:bg-muted [&>a]:px-2 [&>a]:py-0.5 [&>a]:text-body [&>a]:text-foreground [&>a]:transition-colors',
