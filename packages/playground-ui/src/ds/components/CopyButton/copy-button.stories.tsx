...
export const InContext: Story = {
  render: () => (
    <div className="bg-gray-2 flex items-center gap-2 rounded-md p-3">
      <code className="text-gray-10 font-mono text-sm">npm install @mastra/core</code>
...
export const CodeBlock: Story = {
  render: () => (
    <div className="w-dropdown-max-height bg-gray-2 relative rounded-md p-4">
      <CopyButton content="const agent = new Agent()" className="absolute top-2 right-2" />
      <pre className="text-gray-10 font-mono text-sm">const agent = new Agent()</pre>
    </div>
  ),
};
