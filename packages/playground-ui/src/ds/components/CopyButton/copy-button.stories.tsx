...
export const InContext: Story = {
  render: () => (
    <div className="bg-surface4 flex items-center gap-2 rounded-md p-3">
      <code className="text-ui-md text-neutral5 font-mono">npm install @mastra/core</code>
...
export const CodeBlock: Story = {
  render: () => (
    <div className="w-dropdown-max-height bg-surface4 relative rounded-md p-4">
      ...
      <pre className="text-ui-md text-neutral5 font-mono">const agent = new Agent()</pre>
    </div>
  ),
};
