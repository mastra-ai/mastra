...
export const AllStates: Story = {
  ...
  render: () => (
    <div className="border-gray-alpha-3 bg-background-2 grid min-w-md gap-4 rounded-lg border p-4">
    ...
    <RadioGroup defaultValue="startup">
      <div className="flex items-start space-x-2">
        ...
        <div className="grid gap-1">
          ...
          <p className="text-gray-9 text-xs">Best for small teams just getting started</p>
        </div>
      </div>
      <div className="flex items-start space-x-2">
        ...
        <div className="grid gap-1">
          ...
          <p className="text-gray-9 text-xs">For growing companies with advanced needs</p>
        </div>
      </div>
      <div className="flex items-start space-x-2">
        ...
        <div className="grid gap-1">
          ...
          <p className="text-gray-9 text-xs">For large organizations requiring customization</p>
        </div>
      </div>
    </RadioGroup>
  ),
