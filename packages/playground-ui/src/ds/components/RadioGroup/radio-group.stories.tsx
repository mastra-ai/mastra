    ...
    <RadioGroup defaultValue="startup">
      <div className="flex items-start space-x-2">
        ...
        <div className="grid gap-1">
          ...
          <p className="text-ui-sm text-neutral3">Best for small teams just getting started</p>
        </div>
      </div>
      <div className="flex items-start space-x-2">
        ...
        <div className="grid gap-1">
          ...
          <p className="text-ui-sm text-neutral3">For growing companies with advanced needs</p>
        </div>
      </div>
      <div className="flex items-start space-x-2">
        ...
        <div className="grid gap-1">
          ...
          <p className="text-ui-sm text-neutral3">For large organizations requiring customization</p>
        </div>
      </div>
    </RadioGroup>
  ),
