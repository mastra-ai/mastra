...
export function MetricsKpiCardChange({
  ...
  return (
    <div className={cn('flex flex-wrap items-center gap-1 text-ui-sm text-muted-foreground', className)}>
      ...
      {prevValue && (
        <div>
          vs previous <b className="text-foreground font-semibold">{prevValue}</b>
        </div>
      )}
    </div>
  );
