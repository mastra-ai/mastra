...
describe('SettingsLayout', () => {
  it('renders the page title, action, and settings content', () => {
    ...
    expect(output).toContain(
      '<p class="text-ui-md text-neutral4 m-0 wrap-break-word">Manage your project configuration.</p>',
    );
  ...
  it('renders numeric header content', () => {
    ...
    expect(output).toContain('<p class="text-ui-md text-neutral4 m-0 wrap-break-word">0</p>');
  });
