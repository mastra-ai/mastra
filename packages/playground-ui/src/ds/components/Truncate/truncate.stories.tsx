  ...
  render: () => (
    <div className="flex flex-col gap-4">
      <div className="flex items-center gap-2">
        <span className="w-32 text-sm text-(--text-primary)">No truncation:</span>
        <Truncate>Short text</Truncate>
      </div>
      <div className="flex items-center gap-2">
        <span className="w-32 text-sm text-(--text-primary)">By char count:</span>
        <Truncate charCount={20}>This is a very long text that needs truncation</Truncate>
      </div>
      <div className="flex items-center gap-2">
        <span className="w-32 text-sm text-(--text-primary)">By delimiter:</span>
        <Truncate untilChar="-">workflow-run-12345</Truncate>
      </div>
      <div className="flex items-center gap-2">
        <span className="w-32 text-sm text-(--text-primary)">With copy:</span>
        <Truncate charCount={10} copy>
          Copy this long text
        </Truncate>
      </div>
      <div className="flex items-center gap-2">
        <span className="w-32 text-sm text-(--text-primary)">Mono font:</span>
        <Truncate charCount={8} font="mono" copy>
          550e8400-e29b-41d4
        </Truncate>
      </div>
      <div className="flex items-center gap-2">
        <span className="w-32 text-sm text-(--text-primary)">Header variant:</span>
