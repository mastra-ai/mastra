...
function ThreadRailPreviewContent({
  ...
  return (
    <div className={className} {...props}>
      <div className="text-ui-md text-neutral6 truncate font-medium">{turn.prompt}</div>
      {turn.reply && <p className="text-ui-sm text-neutral4 mt-1.5 line-clamp-3">{turn.reply}</p>}
