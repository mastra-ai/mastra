  ...
  return (
    <span className="grid min-w-0 text-caption">
      ...
      <span
        aria-hidden={!active}
        className={cn(
          'col-start-1 row-start-1 truncate bg-linear-to-r from-warning-indicator to-foreground to-30% bg-size-[200%_100%] bg-clip-text font-medium text-transparent transition-[opacity,translate,filter,background-position] dark:from-[color-mix(in_oklab,var(--accent6)_60%,var(--foreground))]',
          taskGraphMotion,
          active
