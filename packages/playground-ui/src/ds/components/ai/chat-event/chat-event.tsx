  ...
  return (
    <Collapsible defaultOpen={defaultOpen} className="max-w-full min-w-0" role="group" {...props}>
      ...
      <CollapsibleContent className="max-w-full min-w-0">
        <div className="relative ml-3.5 max-w-full min-w-0 py-1.5 pr-1 pl-4 before:absolute before:inset-y-0 before:left-0 before:w-px before:bg-border before:mask-b-from-[calc(100%-min(40%,80px))] before:content-['']">
          {children}
        </div>
      </CollapsibleContent>
    </Collapsible>
