...
const Code = ({ children }: { children: string }) => (
  <pre className="text-icon4 bg-surface1 text-caption m-0 max-h-60 overflow-auto rounded-md px-3 py-2 font-mono whitespace-pre-wrap">
    {children}
  </pre>
);
...
function ControlledExample() {
  ...
  return (
    <ToolCall open={open} onOpenChange={setOpen} aria-label="Tool: custom result">
      ...
      <ToolCallContent>
        <div className="border-border1 bg-surface1 text-body rounded-md border p-3">
