  ...
  ({ className, rightSlot, wrapperClassName, ...props }, ref) => (
    ...
    >
      ...
      <CommandPrimitive.Input
        ref={ref}
        className={cn(
          'flex h-8 min-w-0 flex-1 rounded-md bg-transparent py-2 text-ui-smd text-foreground',
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.Item
    ...
    className={cn(
      'relative flex cursor-pointer items-center gap-2.5 rounded-lg px-2 py-1.5 text-ui-smd text-muted-foreground select-none',
      'outline-none focus:outline-none focus-visible:outline-none',
      transitions.colors,
