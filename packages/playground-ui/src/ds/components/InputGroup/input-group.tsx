...
const inputGroupBaseClassName = cn(
  ...
  'border border-gray-alpha-3 text-gray-10',
  transitions.all,
  'has-[:disabled]:cursor-not-allowed has-[:disabled]:opacity-50',
  'has-[[aria-invalid=true]]:border-red-9',
...
const inputGroupFilledVariant = cn(
  'rounded-full bg-gray-alpha-1',
  'hover:bg-gray-alpha-2',
  inputHoverBorderWithin,
  'outline-hidden focus-within:bg-gray-alpha-2 focus-within:outline-hidden',
...
const inputGroupAddonVariants = cva(
  cn(
    'flex items-center justify-center gap-2 text-gray-9 select-none',
  ...
  ),
  {
    variants: {
      align: {
        ...
        'block-start': 'order-first w-full justify-start border-b border-gray-alpha-3 px-3 pt-2 pb-1',
        'block-end': 'order-last w-full justify-start border-t border-gray-alpha-3 px-3 pt-1 pb-2',
      },
    },
    defaultVariants: {
      align: 'inline-start',
    ...
    return (
      <input
        ...
        className={cn(
          ...
          'min-w-0 flex-1 bg-transparent px-3 text-gray-10 outline-hidden',
  ...
  ({ className, testId, error, ...props }, ref) => {
    return (
      <textarea
        ...
        aria-invalid={error}
        className={cn(
          'min-h-15 min-w-0 flex-1 resize-y bg-transparent px-3 py-2 text-gray-10 outline-hidden',
          inputGroupControlTextBySize,
          'placeholder:text-gray-9 placeholder:transition-opacity placeholder:duration-normal',
          'focus:placeholder:opacity-70',
          'disabled:cursor-not-allowed',
...
const InputGroupText = React.forwardRef<HTMLSpanElement, InputGroupTextProps>(({ className, ...props }, ref) => {
  return (
    <span
      ref={ref}
      className={cn(
        'flex items-center gap-2 text-ui-sm text-gray-9 [&_svg]:pointer-events-none',
