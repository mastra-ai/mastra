      ...
      <TooltipPrimitive.Portal>
        <TooltipPrimitive.Positioner className="isolate z-100" {...positionerProps}>
          <TooltipPrimitive.Popup
            ...
            role="tooltip"
            className={cn(
              'relative z-100 flex origin-(--transform-origin) flex-col rounded-lg border border-gray-alpha-3 bg-gray-1 px-2.5 py-1.5 text-ui-sm leading-ui-sm text-gray-10 shadow-dialog transition-[transform,scale,opacity] duration-150',
...
// center (popup_top + 0.5 with `border border-gray-alpha-3`), so the arrow outline
...
function TooltipArrowSvg() {
  return (
    <svg width="12" height="8" viewBox="0 0 12 8" fill="none" overflow="visible">
      <path d="M0 7L4 2Q6 0 8 2L12 7L12 8L0 8Z" className="fill-gray-1" />
      <path
        d="M0 7.5L4 2.5Q6 0.5 8 2.5L12 7.5"
        className="stroke-gray-alpha-3 fill-none"
        strokeWidth="1"
