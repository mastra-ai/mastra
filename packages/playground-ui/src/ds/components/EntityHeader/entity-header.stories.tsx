...
export const WithChildren: Story = {
  render: () => (
    <div className="bg-gray-1 w-100 rounded-lg">
      <EntityHeader icon={<Workflow />} title="Data Processing Pipeline">
        <p className="text-gray-9 text-sm">Processes incoming data and transforms it for analysis</p>
      </EntityHeader>
    </div>
  ),
};
...
export const LongTitle: Story = {
  render: () => (
    <div className="w-dropdown-max-height bg-gray-1 rounded-lg">
      <EntityHeader
        icon={<Settings />}
...
export const WithRichContent: Story = {
  render: () => (
    <div className="bg-gray-1 w-[450px] rounded-lg">
      <EntityHeader icon={<Bot />} title="AI Assistant">
        <div className="space-y-2">
          <p className="text-gray-9 text-sm">An intelligent assistant for customer support tasks</p>
          <div className="text-gray-9 flex items-center gap-4 text-xs">
