  ...
  render: () => (
    <div className="bg-surface3 w-100 rounded-lg">
      <EntityHeader icon={<Workflow />} title="Data Processing Pipeline">
        <p className="text-ui-md text-neutral3">Processes incoming data and transforms it for analysis</p>
      </EntityHeader>
    </div>
  ),
};
    ...
    <div className="bg-surface3 w-[450px] rounded-lg">
      <EntityHeader icon={<Bot />} title="AI Assistant">
        <div className="space-y-2">
          <p className="text-ui-md text-neutral3">An intelligent assistant for customer support tasks</p>
          <div className="text-ui-sm text-neutral3 flex items-center gap-4">
