      ...
      <PopoverContent>
        <div className="grid gap-4">
          <div className="space-y-2">
            ...
            <p className="text-gray-9 text-sm">Set the dimensions for the layer.</p>
          </div>
      ...
      <PopoverContent className="w-80">
        <div className="grid gap-4">
          <div className="space-y-2">
            ...
            <p className="text-gray-9 text-sm">Manage your preferences.</p>
          </div>
        </div>
      </PopoverContent>
    </Popover>
  ...
  render: () => (
    <Popover>
      ...
      <PopoverContent className="w-60">
        <p className="text-gray-10 text-sm">This is helpful information about the feature.</p>
      </PopoverContent>
    </Popover>
  ),
};
