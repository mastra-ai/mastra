  ...
  (
    ...
    return (
      <PopoverPrimitive.Portal container={resolvedContainer}>
        <PopoverPrimitive.Positioner className="z-50" {...positionerProps}>
          <PopoverPrimitive.Popup
            ref={ref}
            data-slot="popover-content"
            className={cn(
              'z-50 w-72 origin-[var(--transform-origin)] rounded-xl border border-border1 bg-surface3 text-neutral5 shadow-dialog',
