  ...
  return (
    ...
    >
      ...
      <input
        ...
        value={value}
        className={cn(
          'flex grow items-center cursor-pointer text-[0.875rem] text-[rgba(255,255,255,0.8)] border border-border1 leading-none rounded-lg bg-transparent min-h-[2.5rem] px-[0.75rem] py-[0.5rem] w-full',
