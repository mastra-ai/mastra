...
const badgeClassName = 'rounded-full border border-border1 px-2 py-0.5 text-meta text-muted-foreground';
      ...
      <div className="flex w-90 flex-col gap-3">
        ...
        <div className="flex flex-wrap gap-1.5">
          {selectedCapabilities.map(option => (
            <span
              key={option.value}
              className="border-border1 bg-surface3 text-meta text-muted-foreground rounded-full border px-2.5 py-1"
            >
              {option.label}
            </span>
          ))}
