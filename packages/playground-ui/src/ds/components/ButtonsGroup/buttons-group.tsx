  ...
  ({ className, orientation, ...props }, ref) => {
    ...
    return (
      <div
        ...
        className={cn('self-stretch bg-gray-alpha-3', resolved === 'vertical' ? 'w-px' : 'h-px', className)}
        {...props}
      />
    );
  },
...
const buttonsGroupTextVariants = cva(
  cn(
    'inline-flex items-center justify-center border border-gray-alpha-3 bg-gray-1 text-gray-10 select-none',
