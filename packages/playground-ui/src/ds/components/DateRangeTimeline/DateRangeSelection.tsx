...
export function DateRangeSelection({
  ...
  return (
    <div
      ...
      className={cn(
        'absolute inset-y-1 z-10 flex cursor-grab touch-none items-center justify-center overflow-hidden rounded-md bg-neutral6/10 text-neutral6 select-none active:cursor-grabbing',
        active
          ? 'transition-none'
