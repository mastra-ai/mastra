...
export function DateRangeHandle({
  ...
  return (
    ...
    >
      <span
        className={cn(
          'absolute top-1/2 left-1/2 h-7 w-1.5 -translate-1/2 rounded-xs bg-card ring-1 transition-[width,box-shadow] duration-150 group-hover:w-2 group-focus-visible:w-2 group-focus-visible:ring-2 group-focus-visible:ring-border-focus motion-reduce:transition-none',
