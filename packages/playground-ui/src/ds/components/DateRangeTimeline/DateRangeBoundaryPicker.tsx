    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger
        render={
          ...
          >
            <Txt as="span" variant="ui-sm" className="truncate text-(--text-primary) tabular-nums">
              {formattedDate}
            </Txt>
            <CalendarDaysIcon className="size-3.5 shrink-0 text-(--text-secondary)" aria-hidden="true" />
          </Button>
        }
      />
