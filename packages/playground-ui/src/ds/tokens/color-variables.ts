...
export const SemanticColors = {
  ...
  'text-on-contrast': 'var(--text-on-contrast)',
  'text-on-contrast-secondary': 'var(--text-on-contrast-secondary)',
  'text-on-accent': 'var(--text-on-accent)',
  'border-subtle': 'var(--border-subtle)',
  'border-default': 'var(--border-default)',
  'border-strong': 'var(--border-strong)',
  'border-on-contrast': 'var(--border-on-contrast)',
  'outline-image': 'var(--outline-image)',
  focus: 'var(--focus)',
