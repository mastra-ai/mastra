...
export const Colors = {
  ...
  'sidebar-item-hover': colorVar('sidebar-item-hover'),
  'sidebar-item-active': colorVar('sidebar-item-active'),
  'sidebar-item-selected': colorVar('sidebar-item-selected'),
  'table-selected-row': colorVar('table-selected-row'),
