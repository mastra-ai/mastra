      ...
      <PageHeader>
        ...
        {showMeta && (
          <PageHeader.Meta beside={metaBeside}>
            ...
            {!metaBeside && <span className="text-ui-xs text-muted-foreground font-mono">agent_8f3a91b2</span>}
          </PageHeader.Meta>
        )}
  ...
  render: () => (
    <StoryFrame>
      <PageHeader>
        ...
        <PageHeader.Meta>
          <span className="text-ui-xs text-muted-foreground font-mono">env_01j9</span>
        </PageHeader.Meta>
        <PageHeader.Action>
          <Button size="sm">Settings</Button>
        </PageHeader.Action>
