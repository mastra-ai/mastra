    ...
    <div className="w-150">
      ...
      {ruleGroup && (
        <div className="bg-surface3 mt-4 rounded-md p-3">
          <p className="text-ui-sm text-neutral3 mb-2">Current rule group:</p>
          <pre className="text-ui-sm text-neutral5 overflow-auto">{JSON.stringify(ruleGroup, null, 2)}</pre>
        </div>
      )}
    </div>
  );
