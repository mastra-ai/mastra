    ...
    <div className="w-150">
      ...
      {ruleGroup && (
        <div className="bg-surface3 mt-4 rounded-md p-3">
          <p className="text-neutral3 mb-2 text-ui-sm">Current rule group:</p>
          <pre className="text-neutral5 overflow-auto text-ui-sm">{JSON.stringify(ruleGroup, null, 2)}</pre>
        </div>
      )}
    </div>
  );
