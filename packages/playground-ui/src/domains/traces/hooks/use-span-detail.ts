...
export function useSpanDetail(traceId: string | null | undefined, spanId: string | null | undefined): UseQueryResult<{ span: LightSpanRecord & { output?: unknown; result?: unknown } } | null> {
