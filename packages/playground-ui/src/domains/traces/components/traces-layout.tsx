...
export function TracesLayout({
  ...
  // Templates are inline: a `minmax(0,…)` arbitrary class is not always emitted from this
  // package, and a silently missing rule reads as a broken layout.
  ...
  return (
    <div
      ...
      className="grid max-h-full min-h-0 items-start gap-4 transition-[grid-template-columns] duration-300 ease-in-out"
    >
      {listSlot}
