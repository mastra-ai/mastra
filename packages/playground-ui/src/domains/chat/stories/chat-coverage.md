...
`AI/Chat` is a design workbench, with controlled fixtures rather than either application runtime. The visible widgets below are the same playground-ui components imported by production. A story passing does not establish transport, persistence, or live voice behavior.
...
| Model selection                                                              | Shared ModelPicker menu / segmented combobox group             | Factory and Studio, including personal-chat packs    |
