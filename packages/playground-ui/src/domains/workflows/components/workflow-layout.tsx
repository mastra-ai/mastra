...
export function WorkflowPanelResizeHandle() {
  ...
  return (
    ...
    >
      <ResizeHandleIndicator className="group-hover/resize:opacity-100 group-focus-visible/resize:via-border-focus group-focus-visible/resize:opacity-100 group-active/resize:via-foreground/45 group-active/resize:opacity-100" />
    </div>
  );
}
