          ...
          return (
            <div key={d.name} className="group flex items-center gap-3">
              <div className="relative h-7 flex-1">
                ...
                />
                <span className="text-fixed-black absolute inset-y-0 left-2 flex items-center text-xs whitespace-nowrap">
                  {d.name}
                </span>
              </div>
          ...
          return (
            <div key={d.name} className="group flex items-center gap-3">
              <div className="relative h-7 flex-1">
                ...
                <span className="text-fixed-black pointer-events-none absolute inset-y-0 left-2 flex items-center text-xs whitespace-nowrap">
                  {d.name}
                </span>
              </div>
