...
export const EVALUATION_DATASET_TARGET_OPTIONS = [
  { value: 'all', label: 'All targets' },
  { value: 'agent', label: 'Agent' },
  { value: 'workflow', label: 'Workflow' },
] as const;

export const EVALUATION_DATASET_EXPERIMENT_OPTIONS = [
...
export function getEvaluationDatasetTagOptions(datasets: DatasetRecord[]) {
