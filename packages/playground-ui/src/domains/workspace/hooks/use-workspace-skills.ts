...
export const useWorkspaceSkills = (options?: { workspaceId?: string }) => {
  ...
  return useQuery({
    ...
    enabled: !!options?.workspaceId && hasMethod(client, 'getWorkspace'),
  });
};
...
export const useWorkspaceSkill = (skillName: string, options?: { enabled?: boolean; workspaceId?: string }) => {
  ...
  return useQuery({
    ...
    enabled: options?.enabled !== false && !!skillName && !!options?.workspaceId && hasMethod(client, 'getWorkspace'),
  });
};
