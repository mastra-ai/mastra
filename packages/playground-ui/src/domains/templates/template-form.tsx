  ...
  return (
    <Container>
      <div className="max-w-[40rem] my-[1rem] p-[1rem] lg:p-[2rem] mx-auto gap-[2rem] grid">
        <h2
          className={cn(
            'text-neutral4 text-header-sm font-semibold flex items-center gap-[0.5rem]',
          ...
          <>
            ...
            <div className="grid grid-cols-[1fr_1fr] gap-[1rem] items-start">
              {isLoadingEnvVars ? (
                <div
                  className={cn(
                    'flex items-center justify-center col-span-2 text-neutral3 text-ui-sm gap-[1rem]',
            ...
            <div className="border-t border-border1 pt-[3rem] mt-[0.875rem] relative">
              <div className="absolute w-[2rem] h-[2rem] rounded-full bg-surface2 top-0 left-[50%] translate-x-[-50%] translate-y-[-1rem] text-ui-sm text-neutral3 flex items-center justify-center">
                And
              </div>

              <h3 className="text-neutral4 text-ui-lg">Set AI Model for Template Installation</h3>
              <p className="text-neutral3 text-ui-md mt-[.5rem] mb-[2rem]">
        ...
        {selectedProvider && !isLoadingEnvVars && (
          <Button
            className={cn(
              'flex items-center gap-[0.5rem] mt-[1rem] justify-center text-ui-md w-full bg-surface5 min-h-[2.5rem] rounded-lg text-neutral5 hover:bg-surface6 transition-colors',
