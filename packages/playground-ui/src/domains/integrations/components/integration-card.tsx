      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1" onClick={e => e.stopPropagation()}>
              ...
              <AlertDialog.Content>
                <AlertDialog.Header>
                  ...
                  <AlertDialog.Description>
                    Are you sure you want to delete "{displayName}"? This will remove all {toolCount} tools. This action
                    cannot be undone.
                  </AlertDialog.Description>
                </AlertDialog.Header>
                <AlertDialog.Footer>
            ...
            {onEdit && <ChevronRight className="h-4 w-4 text-icon2 group-hover:text-icon4 transition-colors ml-1" />}
          </div>
        </div>
      </div>
    </div>
