...
import { MastraMemory, extractWorkingMemoryContent, getThreadOMMetadata, removeWorkingMemoryTags } from '@mastra/core/memory';
import type {
...
type MemoryOperationType = 'recall' | 'save' | 'delete' | 'update';
...
function filterSystemReminderMessages(messages: MastraDBMessage[], includeSystemReminders?: boolean): MastraDBMessage[] {
...
export class Memory extends MastraMemory {
  ...
  private createMemorySpan(
    ...
    return currentSpan.createChildSpan({
      type: 'memory_operation' as SpanType,
