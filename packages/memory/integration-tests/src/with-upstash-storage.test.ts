  ...
  describe('Memory Features', () => {
    ...
    describe('Message Types and Roles', () => {
      it('should handle different message types', async () => {
        const messages = [
          createTestMessage(thread.id, 'Regular message', 'user', 'text'),
          createTestMessage(thread.id, [{ type: 'text', text: 'Tool call' }], 'assistant', 'tool-call'),
          createTestMessage(thread.id, [{ type: 'text', text: 'Tool result' }], 'assistant', 'tool-result'),
        ];
      ...
      it('should handle complex message content', async () => {
        const complexMessage = [
          { type: 'text' as const, text: 'Main content' },
