...
describe('DepsService lockfile preparation', () => {
  ...
  it('rejects Yarn Classic lockfiles before running an install during preparation', async () => {
    ...
    await expect(deps.prepareLockfile({ dir: outputDir })).rejects.toMatchObject({
