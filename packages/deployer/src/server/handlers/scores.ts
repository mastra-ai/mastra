...
import { getScorersHandler as getOriginalScorersHandler, getScoresByRunIdHandler as getOriginalScoresByRunIdHandler, getScoresByEntityIdHandler as getOriginalScoresByEntityIdHandler, saveScoreHandler as getOriginalSaveScoreHandler } from '@mastra/server/handlers/scores';
...
export async function getScorersHandler(c: Context) {
    ...
    try {
        const scorers = await getOriginalScorersHandler({ mastra });
