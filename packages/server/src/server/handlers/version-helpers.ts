 ...
 */
export interface VersionedStoreInterface<TEntity = any> {
  ...
  update: (params: any) => Promise<TEntity>;
  listVersions: (params: any) => Promise<{
    versions: Array<{ id: string; versionNumber: number; [key: string]: any }>;
    total: number;
    page: number;
