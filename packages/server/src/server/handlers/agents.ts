...
export function generateHandler({
  ...
  const logger = mastra.getLogger();
  logger?.warn(
    "Deprecation NOTICE:\nGenerate method will switch to use generateVNext implementation September 9th. Please use generateLegacyHandler if you don't want to upgrade just yet.",
  );
...
export async function streamGenerateHandler({
  ...
  const logger = mastra.getLogger();
  logger?.warn(
    "Deprecation NOTICE:\Stream method will switch to use streamVNext implementation September 9th. Please use streamGenerateLegacyHandler if you don't want to upgrade just yet.",
  );
