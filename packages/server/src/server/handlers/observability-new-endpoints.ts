...
export const NEW_ROUTES = {
  ...
  LIST_LOGS: createNewRoute(NEW_ROUTE_DEFS.LIST_LOGS, {
  ...
  LIST_SCORES: createNewRoute(NEW_ROUTE_DEFS.LIST_SCORES, {
    queryParamSchema: wrapSchemaForQueryParams(
  ...
  CREATE_SCORE: createNewRoute(NEW_ROUTE_DEFS.CREATE_SCORE, {
  ...
  LIST_FEEDBACK: createNewRoute(NEW_ROUTE_DEFS.LIST_FEEDBACK, {
    queryParamSchema: wrapSchemaForQueryParams(
  ...
  CREATE_FEEDBACK: createNewRoute(NEW_ROUTE_DEFS.CREATE_FEEDBACK, {
  ...
  GET_METRIC_AGGREGATE: createNewRoute(NEW_ROUTE_DEFS.GET_METRIC_AGGREGATE, {
  ...
  GET_METRIC_BREAKDOWN: createNewRoute(NEW_ROUTE_DEFS.GET_METRIC_BREAKDOWN, {
  ...
  GET_METRIC_TIME_SERIES: createNewRoute(NEW_ROUTE_DEFS.GET_METRIC_TIME_SERIES, {
  ...
  GET_METRIC_PERCENTILES: createNewRoute(NEW_ROUTE_DEFS.GET_METRIC_PERCENTILES, {
  ...
  GET_METRIC_NAMES: createNewRoute(NEW_ROUTE_DEFS.GET_METRIC_NAMES, {
  ...
  GET_METRIC_LABEL_KEYS: createNewRoute(NEW_ROUTE_DEFS.GET_METRIC_LABEL_KEYS, {
  ...
  GET_METRIC_LABEL_VALUES: createNewRoute(NEW_ROUTE_DEFS.GET_METRIC_LABEL_VALUES, {
  ...
  GET_ENTITY_TYPES: createNewRoute(NEW_ROUTE_DEFS.GET_ENTITY_TYPES, {
  ...
  GET_ENTITY_NAMES: createNewRoute(NEW_ROUTE_DEFS.GET_ENTITY_NAMES, {
  ...
  GET_SERVICE_NAMES: createNewRoute(NEW_ROUTE_DEFS.GET_SERVICE_NAMES, {
  ...
  GET_ENVIRONMENTS: createNewRoute(NEW_ROUTE_DEFS.GET_ENVIRONMENTS, {
  ...
  GET_TAGS: createNewRoute(NEW_ROUTE_DEFS.GET_TAGS, {
