...
export async function listScoresByRunIdHandler({
  ...
  try {
    ...
    const scoreResults = (await storage?.listScoresByRunId?.({
      runId,
      pagination,
...
export async function listScoresByScorerIdHandler({
  ...
  try {
    ...
    const scoreResults = (await storage?.listScoresByScorerId?.({
      scorerId,
      pagination,
      entityId,
      entityType,
...
export async function listScoresByEntityIdHandler({
  ...
  try {
    ...
    const scoreResults = (await storage?.listScoresByEntityId?.({
