...
export const AGENT_BUILDER_ROUTES: ServerRoute[] = [
  ...
  createRoute({
    ...
    path: '/api/agent-builder/:actionId/runs/:runId/start',
    pathParamSchema: actionRunPathParams,
    bodySchema: startAsyncWorkflowBodySchema,
  ...
  createRoute({
    ...
    path: '/api/agent-builder/:actionId/runs/:runId/observe-stream',
    pathParamSchema: actionRunPathParams,
  ...
  createRoute({
    ...
    path: '/api/agent-builder/:actionId/runs/:runId/observe-stream-vnext',
    pathParamSchema: actionRunPathParams,
  ...
  createRoute({
    ...
    path: '/api/agent-builder/:actionId/runs/:runId/resume-async',
    pathParamSchema: actionRunPathParams,
  ...
  createRoute({
    ...
    path: '/api/agent-builder/:actionId/runs/:runId/resume',
    pathParamSchema: actionRunPathParams,
    bodySchema: resumeBodySchema,
    responseSchema: workflowControlResponseSchema,
