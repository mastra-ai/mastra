...
export const API_ROUTE_METADATA = {
  ...
  'POST /agents/:agentId/approve-tool-call-generate': {
    ...
    pathParams: ['agentId'],
    queryParams: [],
    bodyParams: ['format', 'requestContext', 'runId', 'toolCallId'],
    hasQuery: false,
    hasBody: true,
    responseShape: {
      kind: 'single',
  ...
  'GET /scores': {
    ...
    path: '/scores',
    pathParams: [],
    queryParams: ['entityId', 'entityType', 'page', 'perPage', 'runId', 'scorerId'],
    bodyParams: [],
    hasQuery: true,
    hasBody: false,
    responseShape: {
  ...
  'POST /observability/metrics/aggregate': {
    ...
    pathParams: [],
    queryParams: [],
    bodyParams: ['aggregation', 'comparePeriod', 'filters', 'name'],
    hasQuery: false,
    hasBody: true,
    responseShape: {
      kind: 'single',
  ...
  'POST /observability/metrics/breakdown': {
    ...
    pathParams: [],
    queryParams: [],
    bodyParams: ['aggregation', 'filters', 'groupBy', 'name'],
    hasQuery: false,
    hasBody: true,
    responseShape: {
      kind: 'object-property',
  ...
  'POST /observability/metrics/timeseries': {
    ...
    pathParams: [],
    queryParams: [],
    bodyParams: ['aggregation', 'filters', 'groupBy', 'interval', 'name'],
    hasQuery: false,
    hasBody: true,
    responseShape: {
      kind: 'object-property',
  ...
  'POST /a2a/:agentId': {
    ...
    pathParams: ['agentId'],
    queryParams: [],
    bodyParams: ['id', 'jsonrpc', 'method', 'params'],
    hasQuery: false,
    hasBody: true,
    responseShape: {
      kind: 'single',
  ...
  'POST /datasets/:datasetId/items': {
    ...
    pathParams: ['datasetId'],
    queryParams: [],
    bodyParams: ['expectedTrajectory', 'groundTruth', 'input', 'metadata', 'requestContext', 'source'],
    hasQuery: false,
    hasBody: true,
    responseShape: {
      kind: 'single',
