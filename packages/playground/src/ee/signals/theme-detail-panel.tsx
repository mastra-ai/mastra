...
export function ThemeDetailPanel({
  ...
  return (
    <SideDialog
      dialogTitle={title}
      dialogDescription={`Details for ${title}`}
      isOpen={selection !== undefined}
      onClose={onClose}
      className="w-full sm:w-3/4 lg:w-1/2 xl:w-2/5"
    >
      <SideDialog.Top>{title}</SideDialog.Top>
      <SideDialog.Content>
            ...
            <section aria-labelledby="theme-summary-heading">
              ...
              <dl className="mt-4 grid grid-cols-2 gap-3 text-sm">
                ...
                <div>
                  ...
                  <dd className="mt-1 font-mono text-neutral5">{Math.round(detailQuery.data.theme.coverage * 100)}%</dd>
                </div>
              </dl>
            </section>
