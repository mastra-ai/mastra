...
export default function AgentBuilderCreate() {
  // Warm the ['tools'], ['agents', requestContext], and ['workflows', requestContext]
  // tanstack-query caches while the user types their prompt, so the edit page can
  // dispatch the initial message with a tools-aware schema on its very first render
