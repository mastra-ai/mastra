    ...
    return (
      <span className="inline-flex items-center gap-0.5 rounded-md border border-border bg-card px-1">
        ...
        <button
          ...
          className="p-0.5 text-success-fg hover:text-success-fg"
        >
  ...
  return (
    <span className="group inline-flex items-center gap-0.5 rounded-md border border-border bg-card px-1.5 py-0.5 text-caption text-muted-foreground">
      ...
      <button
        type="button"
        onClick={onRemove}
        className="p-0.5 text-placeholder opacity-0 transition-opacity group-hover:opacity-100 hover:text-destructive-fg"
        title="Remove tag"
      >
        <X className="h-3 w-3" />
      </button>
