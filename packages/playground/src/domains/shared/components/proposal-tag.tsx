...
export function ProposalTag({
    ...
    return (
      <span className="bg-surface3 border-border1 inline-flex items-center gap-0.5 rounded-md border px-1">
        <input
          ...
          className="text-neutral4 w-20 bg-transparent py-0.5 text-ui-sm outline-hidden"
        />
        <button
          type="button"
          onMouseDown={e => {
  ...
  return (
    <span className="bg-surface3 border-border1 text-neutral4 group inline-flex items-center gap-0.5 rounded-md border px-1.5 py-0.5 text-ui-sm">
      {tag}
      <button
        type="button"
        onClick={() => {
