    ...
    return (
      <span className="bg-card border-border inline-flex items-center gap-0.5 rounded-md border px-1">
        ...
        <button
          ...
          className="text-success-fg hover:text-success-fg p-0.5"
        >
  ...
  return (
    <span className="bg-card border-border text-muted-foreground group text-caption inline-flex items-center gap-0.5 rounded-md border px-1.5 py-0.5">
      ...
      <button
        type="button"
        onClick={onRemove}
        className="text-placeholder hover:text-destructive-fg p-0.5 opacity-0 transition-opacity group-hover:opacity-100"
        title="Remove tag"
      >
        <X className="h-3 w-3" />
      </button>
