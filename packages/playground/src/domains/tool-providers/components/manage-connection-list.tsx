            ...
            >
              <EntityContent className="min-w-0">
                <button
                  ...
                  className="focus-visible:after:ring-border-focus flex w-full items-center justify-between gap-2 text-left outline-none after:absolute after:inset-0 after:rounded-lg focus-visible:after:ring-2"
                >
