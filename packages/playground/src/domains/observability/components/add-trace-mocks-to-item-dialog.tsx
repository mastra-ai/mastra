  ...
  return (
    ...
    >
      ...
      <SideDialog.Content>
        ...
        {isTrajectoryLoading ? (
          <div className="text-neutral4 px-2 py-4 text-ui-md">Loading tool calls from trace...</div>
        ) : (
    ...
    <form onSubmit={handleSubmit} className="grid gap-4">
      <div className="grid gap-2">
        ...
        <Select value={selectedDatasetId} onValueChange={handleDatasetChange} disabled={isDatasetsLoading}>
          ...
          <SelectContent>
            {datasets.length === 0 ? (
              <div className="text-neutral4 px-2 py-4 text-center text-ui-md">No datasets available</div>
            ) : (
      ...
      <div className="grid gap-2">
        ...
        >
          ...
          <SelectContent>
            {items.length === 0 ? (
              <div className="text-neutral4 px-2 py-4 text-center text-ui-md">No items available</div>
            ) : (
              items.map(item => (
