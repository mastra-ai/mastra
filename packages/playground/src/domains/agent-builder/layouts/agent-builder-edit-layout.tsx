...
export interface AgentBuilderEditLayoutProps {
  ...
  chat: ReactNode;
  /**
   * Optional profile pane. When provided, it renders side-by-side with the
...
export const AgentBuilderEditLayout = ({ topBar, chat, profile, browserOverlay }: AgentBuilderEditLayoutProps) => {
    ...
    <div className="flex flex-1 min-w-0 flex-col h-full min-h-0">
      ...
      <div
        className={cn(
          ...
          hasProfile && 'lg:grid lg:grid-rows-1 lg:grid-cols-2',
        )}
      >
