...
describe('AgentProfileTabs', () => {
  ...
  it('renders Model, Instructions, Tools, and Skills tabs when features are enabled and items are available', () => {
    ...
    expect(tabs).toEqual(['Model', 'Instructions', 'Tools', 'Skills']);
  });
