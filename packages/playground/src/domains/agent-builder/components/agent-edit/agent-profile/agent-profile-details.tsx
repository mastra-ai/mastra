  ...
  return (
    ...
    >
      <input
        ...
        className="text-ui-md text-neutral6 placeholder:text-neutral2 hover:bg-surface4 focus:bg-surface4 w-full max-w-sm rounded-lg px-3 py-1.5 font-semibold disabled:cursor-not-allowed"
      ...
      <textarea
        ...
        rows={2}
        className="text-ui-md text-neutral6 placeholder:text-neutral2 hover:bg-surface4 focus:bg-surface4 field-sizing-content w-full resize-none rounded-lg px-3 py-2 disabled:cursor-not-allowed"
