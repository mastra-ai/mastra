  ...
  return (
    ...
    >
      <input
        ...
        className="text-subheading text-foreground placeholder:text-placeholder hover:bg-surface4 focus:bg-surface4 w-full max-w-sm rounded-lg px-3 py-1.5 focus:outline-none disabled:cursor-not-allowed"
      ...
      <textarea
        ...
        rows={2}
        className="text-body text-foreground placeholder:text-placeholder hover:bg-surface4 focus:bg-surface4 field-sizing-content w-full resize-none rounded-lg px-3 py-2 focus:outline-none disabled:cursor-not-allowed"
