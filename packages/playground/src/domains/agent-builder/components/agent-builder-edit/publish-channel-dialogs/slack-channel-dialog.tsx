      ...
      <AlertDialog.Content>
        <AlertDialog.Header>
          ...
          <AlertDialog.Description>
            This will delete the Slack app from your workspace and remove the integration for this agent. Existing
            message history in Slack will remain, but the bot will stop responding. This cannot be undone.
          </AlertDialog.Description>
        </AlertDialog.Header>
        <AlertDialog.Footer>
          <AlertDialog.Action
