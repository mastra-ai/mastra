...
type TraceDataPanelProps = Omit<ComponentProps<typeof TraceDataPanelView>, 'activeTab' | 'onTabChange'>;
...
export function TraceDataPanel(props: TraceDataPanelProps) {
  ...
  return <TraceDataPanelView {...props} activeTab={activeTab} onTabChange={setActiveTab} />;
}
