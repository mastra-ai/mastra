...
import { modelProviderOptionsSchema } from '../context/provider-options';
...
export const AgentAdvancedSettingsBody = ({ canEdit = true, value, onChange }: AgentAdvancedSettingsBodyProps) => {
