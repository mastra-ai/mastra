    ...
    <div className={cn('group/add flex items-center gap-2 py-0.5', className)}>
      ...
      <DropdownMenu>
        <DropdownMenu.Trigger asChild>
          <button
            type="button"
            className="text-neutral3 hover:text-neutral6 hover:bg-surface4 flex h-6 w-6 items-center justify-center rounded-full opacity-0 transition-all duration-150 group-hover/add:opacity-100 focus-visible:opacity-100"
          >
            <Icon>
              <PlusIcon />
            </Icon>
