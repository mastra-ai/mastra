...
import type { AgentAdvancedSettingsBodyProps } from '../agent-advanced-settings';
...
describe('AgentAdvancedSettingsBody', () => {
  describe('when initial formatting finishes after the user types', () => {
    it('keeps the newer provider options draft', async () => {
      ...
      const onChange = vi.fn<AgentAdvancedSettingsBodyProps['onChange']>();
      render(<AgentAdvancedSettingsBody value={{}} onChange={onChange} />);
