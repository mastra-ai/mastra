import { Button, Input, JSONSchemaForm, jsonSchemaToFields, Label, ScrollArea, Spinner, Tabs, TabList, Tab, TabContent, Textarea, Icon, AgentIcon, ToolsIcon, VariablesIcon } from '@mastra/playground-ui';
