      ...
      <div className="flex flex-col gap-2">
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <Label htmlFor={`${scorerId}-none`} className="text-foreground text-ui-md cursor-pointer">
              None (evaluate all)
            </Label>
          </div>
          <div className="flex items-center gap-2">
            <RadioGroupItem value="ratio" id={`${scorerId}-ratio`} disabled={readOnly} />
            <Label htmlFor={`${scorerId}-ratio`} className="text-foreground text-ui-md cursor-pointer">
              Ratio (percentage)
            </Label>
          </div>
        </RadioGroup>
