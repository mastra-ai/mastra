...
export const ComposerModelWarning = () => {
  ...
  return (
    <div className="flex flex-col gap-1 px-3 pb-1.5">
      {(modelWarning || stale) && (
        <div
          className="text-warning-fg text-caption flex max-w-full min-w-0 items-start gap-1"
        ...
        >
          ...
          <span className="min-w-0 break-words">
            {modelWarning || (
              <>
                <code className="bg-warning-bg text-warning-fg rounded px-1 py-0.5 break-all">
      ...
      {showProviderWarning && (
        <div className="text-warning-fg text-caption flex max-w-full min-w-0 items-start gap-1">
          <TriangleAlert className="mt-0.5 h-3 w-3 shrink-0" />
          <span className="min-w-0 break-words">
            Set <code className="bg-warning-bg text-warning-fg rounded px-1 py-0.5 break-all">{envVar}</code> to use
            this provider
          </span>
        </div>
      )}
