            ...
            {showForm ? (
              <div className="border-border1 border-t pt-4">
                <button
                  ...
                  className="text-neutral3 hover:text-neutral5 mb-3 flex items-center gap-1.5 text-ui-sm transition-colors"
                >
                ...
                {isAdmin && (!hasFilesystem || !workspaceId) && (
                  <div className="mb-4 flex items-start gap-2 rounded-lg bg-yellow-500/10 p-3 text-ui-sm text-yellow-600">
                  ...
                  <>
                    ...
                    {isAdmin && (
                      <button
                        ...
                        className="text-neutral3 hover:text-neutral5 mt-3 flex items-center gap-1.5 text-ui-sm transition-colors"
                      >
              ...
              <div className="border-border1 border-t pt-3">
                <button
                  ...
                  className="text-neutral3 hover:text-neutral5 flex items-center gap-1.5 text-ui-sm transition-colors"
                >
                  <ChevronRight className="h-3 w-3" />
