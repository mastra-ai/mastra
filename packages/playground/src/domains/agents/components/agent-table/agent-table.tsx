import { Button, EmptyState, PermissionDenied, ScrollableContainer, Searchbar, SearchbarWrapper, Skeleton, Cell, Row, Table, Tbody, Th, Thead, useTableKeyboardNavigation, TooltipProvider, AgentCoinIcon, Icon, is403ForbiddenError } from '@mastra/playground-ui';
