...
export function renderStartupError(
  ...
  wrapper.style.cssText =
    'min-height:100vh;background:#0b0d10;color:#f4f4f5;font-family:Inter,-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,system-ui,sans-serif;padding:32px;box-sizing:border-box;';
