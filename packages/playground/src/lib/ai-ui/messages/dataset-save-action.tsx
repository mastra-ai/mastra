  ...
  return (
    <>
      <button
        ...
        onClick={handleClick}
        disabled={isFetching}
        className="text-muted-foreground hover:text-foreground text-ui-xs mx-auto flex cursor-pointer items-center gap-1.5 py-3 transition-colors disabled:opacity-50"
      >
