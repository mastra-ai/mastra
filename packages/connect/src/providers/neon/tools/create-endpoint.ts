    ...
    body: z.object({
      endpoint: z
        .object({
          ...
          settings: z
            .object({
              pg_settings: z
                .object({})
                .catchall(z.string())
                .describe('A raw representation of Postgres settings')
                .optional(),
              ...
              preload_libraries: z
                .object({
                  ...
                  enabled_libraries: z
                    .array(z.string())
                    .describe('Names of shared preload libraries to enable for the project.')
                    .optional(),
                })
          ...
          pooler_mode: z
            .enum(['transaction'])
            .describe('Deprecated. The connection pooler mode. Removal scheduled for June 20, 2026.\n')
            .optional(),
          disabled: z
            .boolean()
            .describe(
...
export const createEndpointOutputSchema = ProviderResponseSchema;

export function createEndpointTool(proxy: PlatformProxy) {
  return createTool({
    id: 'neon_create_endpoint',
    description:
    ...
    inputSchema: createEndpointInputSchema,
    outputSchema: createEndpointOutputSchema,
    execute: async (input, { requestContext }): Promise<z.infer<typeof createEndpointOutputSchema>> => {
