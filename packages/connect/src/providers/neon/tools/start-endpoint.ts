...
export const startEndpointInputSchema = z.object({
...
export const startEndpointOutputSchema = ProviderResponseSchema;

export function startEndpointTool(proxy: PlatformProxy) {
  return createTool({
    id: 'neon_start_endpoint',
    description:
    ...
    inputSchema: startEndpointInputSchema,
    outputSchema: startEndpointOutputSchema,
    execute: async (input, { requestContext }): Promise<z.infer<typeof startEndpointOutputSchema>> => {
