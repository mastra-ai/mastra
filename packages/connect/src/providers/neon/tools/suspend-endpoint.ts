...
export const suspendEndpointInputSchema = z.object({
...
export const suspendEndpointOutputSchema = ProviderResponseSchema;

export function suspendEndpointTool(proxy: PlatformProxy) {
  return createTool({
    id: 'neon_suspend_endpoint',
    description:
      'Suspend compute endpoint. Suspends the specified compute endpoint.\nAn `endpoint_id` has an `ep-` prefix.\nFor information about compute endpoints, see [Manage computes](https://neon.com/docs/manage/endpoints/).\n',
    inputSchema: suspendEndpointInputSchema,
    outputSchema: suspendEndpointOutputSchema,
    execute: async (input, { requestContext }): Promise<z.infer<typeof suspendEndpointOutputSchema>> => {
      const platformProxy = proxy.withRequestContext(requestContext);
      const config: PlatformProxyRequest = {
        // https://raw.githubusercontent.com/neondatabase/neon-pkgs/af5a839e5900dc98120af6261b5b29d02c74a8e1/packages/sdk/spec/neon-openapi.json,
        endpoint: `/v2/projects/${encodeURIComponent(input['project_id'])}/endpoints/${encodeURIComponent(input['endpoint_id'])}/suspend`,
        retries: 0,
      };
