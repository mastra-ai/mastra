...
export const getPullRequestOutputSchema = z.object({
...
export function getPullRequestTool(proxy: PlatformProxy) {
  return createTool({
    ...
    execute: async (input, { requestContext }): Promise<z.infer<typeof getPullRequestOutputSchema>> => {
