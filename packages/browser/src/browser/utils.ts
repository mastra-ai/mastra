...
export function isTextVisible(element: HTMLElement) {
...
export function isTopElement(elem: HTMLElement, rect: DOMRect) {
  const points = [
...
export function isActive(element: HTMLElement) {
  if (
