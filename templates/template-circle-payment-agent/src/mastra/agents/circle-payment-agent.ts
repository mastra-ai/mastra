...
// Defaults to the Mastra Gateway, which proxies OpenAI, Anthropic and others behind one key. Set
// LLM_MODEL to point somewhere else, including straight at a provider (`openai/gpt-5-mini` with
// OPENAI_API_KEY), which is the escape hatch when the Gateway account is out of inference credits.
const DEFAULT_MODEL = 'mastra/openai/gpt-5-mini';
