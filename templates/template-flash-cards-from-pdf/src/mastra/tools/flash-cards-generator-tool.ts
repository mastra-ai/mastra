...
const flashCardSchema = z.object({
  ...
  questionType: z.enum(['definition', 'concept', 'application', 'comparison', 'true-false', 'multiple-choice', 'short-answer']),
  ...
  "flashCards": [
    {
      ...
      console.log(`📊 Distribution: ${cardsByDifficulty.beginner} beginner, ${cardsByDifficulty.intermediate} intermediate, ${cardsByDifficulty.advanced} advanced`);
