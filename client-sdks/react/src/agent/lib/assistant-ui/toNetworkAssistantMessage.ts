...
import { toStreamAssistantUIMessage, toWorkflowAssistantUIMessage } from './toStreamAssistantUIMessage';
...
export const toNetworkAssistantUIMessage = ({
  ...
  if (chunk.type.startsWith('agent-execution-event-')) {
    ...
    return toStreamAssistantUIMessage({
      chunk: {
        ...chunk,
        type: 'tool-call',
        payload: {
    ...
    const next = toStreamAssistantUIMessage({
    ...
    return toWorkflowAssistantUIMessage({ workflowChunk, conversation, entityName: currentEntityId });
    ...
    return toStreamAssistantUIMessage({ chunk, conversation });
  }
};
