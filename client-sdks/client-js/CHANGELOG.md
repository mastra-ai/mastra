...
- f93d992: Remove deprecated methods from client-js
...
- 1ee3411: Add search memory in client-js
- dbd9db0: Fix clientTools execution in client js
- 6a86fe5: Include agentId parameter in listMessages API call
...
- ea0b8de: Move the enhance instruction fetch call to client-js
- 519d9e6: fix list memory
- dfe3f8c: Remove unused /model-providers API
- e8dcd71: Backward compat for list threads
- 63f2f18: add client-js function to fetch model providers
