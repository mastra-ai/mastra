...
type InputShared_Auxiliary_200 =
  | {
  ...
  | {
      op: 'and' | 'or';
      args: InputShared_Auxiliary_200[];
    }
  | {
      op: 'not';
      arg: InputShared_Auxiliary_200;
    }
  | {
      spans:
        | {
            some: InputShared_Auxiliary_218;
          }
        | {
            none: InputShared_Auxiliary_218;
          };
    }
  | {
      scores:
...
type InputShared_Auxiliary_218 =
  | {
      op: 'eq' | 'ne' | 'lt' | 'lte' | 'gt' | 'gte';
      left:
        | {
  ...
  | {
      op: 'and' | 'or';
      args: InputShared_Auxiliary_218[];
    }
  | {
      op: 'not';
      arg: InputShared_Auxiliary_218;
    };

type InputShared_Auxiliary_632 =
  | {
      op: 'eq' | 'ne' | 'lt' | 'lte' | 'gt' | 'gte';
      left:
        | {
  ...
  | {
      op: 'and' | 'or';
      args: InputShared_Auxiliary_632[];
    }
  | {
      op: 'not';
      arg: InputShared_Auxiliary_632;
    };

type InputShared_Auxiliary_706 = {
  id?: string | undefined;
  name: string;
  type: 'file' | 'folder';
  content?: string | undefined;
  children?: InputShared_Auxiliary_706[] | undefined;
};

type Shared_Auxiliary_720 = {
  id?: string | undefined;
  name: string;
  type: 'file' | 'folder';
  content?: string | undefined;
  children?: Shared_Auxiliary_720[] | undefined;
};
...
type InputShared_Type_86 = {
  ...
  metadata?:
    ...
    | undefined;
  steps: InputShared_Type_81[];
  predicates: InputShared_Auxiliary_632[];
};
...
type InputShared_Type_87 = {
  ...
  predicate: InputShared_Auxiliary_632;
};
...
type Shared_Type_78 = {
  ...
  files?: Shared_Auxiliary_720[] | undefined;
...
export type PostObservabilityTracesQuery_Body = {
  ...
  where?: InputShared_Auxiliary_200 | undefined;
  group?:
    | {
        by: ['threadId'];
      }
...
export type GetStoredAgentsAgentIdVersionsVersionId_Response = Shared_Type_64;
...
export type PostStoredSkills_Body = {
  ...
  assets?: string[] | undefined;
  /** Full file tree structure for the skill */
  files?: InputShared_Auxiliary_706[] | undefined;
  /** Additional metadata for the skill */
  metadata?:
    | {
        [key: string]: unknown;
...
export type PatchStoredSkillsStoredSkillId_Body = {
  ...
  /** Full file tree structure for the skill */
  files?: (InputShared_Auxiliary_706[] | undefined) | undefined;
  /** Additional metadata for the skill */
  metadata?:
    | (
        | {
