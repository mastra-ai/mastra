...
type Shared_Auxiliary_647 =
  | {
      op: 'and' | 'or';
      args: Shared_Auxiliary_647[];
    }
  | {
      op: 'not';
      arg: Shared_Auxiliary_647;
    }
  | {
      traces:
        | {
...
type Shared_Auxiliary_1180 =
  ...
  | {
      op: 'and' | 'or';
      args: Shared_Auxiliary_1180[];
    }
  | {
      op: 'not';
      arg: Shared_Auxiliary_1180;
    };

type Shared_Auxiliary_1320 = {
  id?: string | undefined;
  name: string;
  type: 'file' | 'folder';
  content?: string | undefined;
  children?: Shared_Auxiliary_1320[] | undefined;
};
...
type Shared_Type_111 = {
  ...
  metadata?:
    ...
    | undefined;
  steps: Shared_Type_106;
  predicates: Shared_Auxiliary_1180[];
};
...
type Shared_Type_112 = {
  ...
  predicate: Shared_Auxiliary_1180;
};
...
type Shared_Type_126 = {
  ...
  files?: Shared_Auxiliary_1320[] | undefined;
...
export type PostObservabilityThreadsQuery_Body = {
  ...
  where?: Shared_Auxiliary_647 | undefined;
  page: {
    limit: number;
    after?: (string | null) | undefined;
  };
...
export type PatchStoredSkillsStoredSkillId_Body = {
  ...
  /** Full file tree structure for the skill */
  files?: (Shared_Auxiliary_1320[] | undefined) | undefined;
  /** Additional metadata for the skill */
  metadata?:
    | (
        | {
