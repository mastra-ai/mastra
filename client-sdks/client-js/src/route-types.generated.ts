...
type Shared_Auxiliary_1075 =
  ...
  | {
      op: 'and' | 'or';
      args: Shared_Auxiliary_1075[];
    }
  | {
      op: 'not';
      arg: Shared_Auxiliary_1075;
    };

type Shared_Auxiliary_1216 = {
  id?: string | undefined;
  name: string;
  type: 'file' | 'folder';
  content?: string | undefined;
  children?: Shared_Auxiliary_1216[] | undefined;
};
...
type Shared_Type_106 =
  ...
  | {
      type: 'conditional';
      steps: Shared_Type_104[];
      predicates: Shared_Auxiliary_1075[];
    }
  | {
      type: 'loop';
      step: Shared_Type_104;
      loopType: 'dowhile' | 'dountil';
      predicate: Shared_Auxiliary_1075;
    };
...
type Shared_Type_119 = {
  ...
  files?: Shared_Auxiliary_1216[] | undefined;
...
export type PatchStoredSkillsStoredSkillId_Body = {
  ...
  /** Full file tree structure for the skill */
  files?: (Shared_Auxiliary_1216[] | undefined) | undefined;
  /** Additional metadata for the skill */
  metadata?:
    | (
        | {
