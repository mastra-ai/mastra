...
type Shared_Auxiliary_1094 =
  ...
  | {
      op: 'and' | 'or';
      args: Shared_Auxiliary_1094[];
    }
  | {
      op: 'not';
      arg: Shared_Auxiliary_1094;
    };

type Shared_Auxiliary_1234 = {
  id?: string | undefined;
  name: string;
  type: 'file' | 'folder';
  content?: string | undefined;
  children?: Shared_Auxiliary_1234[] | undefined;
};
...
type Shared_Type_113 = {
  ...
  metadata?:
    ...
    | undefined;
  steps: Shared_Type_108;
  predicates: Shared_Auxiliary_1094[];
};
...
type Shared_Type_114 = {
  ...
  predicate: Shared_Auxiliary_1094;
};
...
type Shared_Type_128 = {
  ...
  files?: Shared_Auxiliary_1234[] | undefined;
...
export type PatchStoredSkillsStoredSkillId_Body = {
  ...
  /** Full file tree structure for the skill */
  files?: (Shared_Auxiliary_1234[] | undefined) | undefined;
  /** Additional metadata for the skill */
  metadata?:
    | (
        | {
