...
type Shared_Auxiliary_592 =
  ...
  | {
      op: 'and' | 'or';
      args: Shared_Auxiliary_592[];
    }
  | {
      op: 'not';
      arg: Shared_Auxiliary_592;
    }
  | {
      spans:
        | {
            some: Shared_Auxiliary_610;
          }
        | {
            none: Shared_Auxiliary_610;
          };
    }
  | {
      scores:
...
type Shared_Auxiliary_610 =
  ...
  | {
      op: 'and' | 'or';
      args: Shared_Auxiliary_610[];
    }
  | {
      op: 'not';
      arg: Shared_Auxiliary_610;
    };
...
export type PostObservabilityTracesQuery_Body = {
  ...
  where?: Shared_Auxiliary_592 | undefined;
  group?:
    | {
        by: ['threadId'];
      }
