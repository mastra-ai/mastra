...
type Shared_Auxiliary_596 =
  ...
  | {
      op: 'and' | 'or';
      args: Shared_Auxiliary_596[];
    }
  | {
      op: 'not';
      arg: Shared_Auxiliary_596;
    }
  | {
      spans:
        | {
            some: Shared_Auxiliary_614;
          }
        | {
            none: Shared_Auxiliary_614;
          };
    }
  | {
      scores:
...
type Shared_Auxiliary_614 =
  ...
  | {
      op: 'and' | 'or';
      args: Shared_Auxiliary_614[];
    }
  | {
      op: 'not';
      arg: Shared_Auxiliary_614;
    };

type Shared_Auxiliary_1154 =
  | {
      op: 'eq' | 'ne' | 'lt' | 'lte' | 'gt' | 'gte';
      left:
        | {
  ...
  | {
      op: 'and' | 'or';
      args: Shared_Auxiliary_1154[];
    }
  | {
      op: 'not';
      arg: Shared_Auxiliary_1154;
    };

type Shared_Auxiliary_1294 = {
  id?: string | undefined;
  name: string;
  type: 'file' | 'folder';
  content?: string | undefined;
  children?: Shared_Auxiliary_1294[] | undefined;
};
...
type Shared_Type_111 = {
  ...
  metadata?:
    ...
    | undefined;
  steps: Shared_Type_106;
  predicates: Shared_Auxiliary_1154[];
};
...
type Shared_Type_112 = {
  ...
  predicate: Shared_Auxiliary_1154;
};
...
type Shared_Type_126 = {
  ...
  files?: Shared_Auxiliary_1294[] | undefined;
...
export type PostObservabilityTracesQuery_Body = {
  ...
  where?: Shared_Auxiliary_596 | undefined;
  group?:
    | {
        by: ['threadId'];
      }
...
export type PatchStoredSkillsStoredSkillId_Body = {
  ...
  /** Full file tree structure for the skill */
  files?: (Shared_Auxiliary_1294[] | undefined) | undefined;
  /** Additional metadata for the skill */
  metadata?:
    | (
        | {
