...
type Shared_Auxiliary_595 =
  ...
  | {
      op: 'and' | 'or';
      args: Shared_Auxiliary_595[];
    }
  | {
      op: 'not';
      arg: Shared_Auxiliary_595;
    }
  | {
      spans:
        | {
            some: Shared_Auxiliary_613;
          }
        | {
            none: Shared_Auxiliary_613;
          };
    }
  | {
      scores:
...
type Shared_Auxiliary_613 =
  ...
  | {
      op: 'and' | 'or';
      args: Shared_Auxiliary_613[];
    }
  | {
      op: 'not';
      arg: Shared_Auxiliary_613;
    };

type Shared_Auxiliary_648 =
  | {
      op: 'and' | 'or';
      args: Shared_Auxiliary_648[];
    }
  | {
      op: 'not';
      arg: Shared_Auxiliary_648;
    }
  | {
      traces:
        | {
            some: Shared_Auxiliary_595;
          }
        | {
            none: Shared_Auxiliary_595;
          };
    };

type Shared_Auxiliary_1170 =
  | {
      op: 'eq' | 'ne' | 'lt' | 'lte' | 'gt' | 'gte';
      left:
        | {
  ...
  | {
      op: 'and' | 'or';
      args: Shared_Auxiliary_1170[];
    }
  | {
      op: 'not';
      arg: Shared_Auxiliary_1170;
    };

type Shared_Auxiliary_1310 = {
  id?: string | undefined;
  name: string;
  type: 'file' | 'folder';
  content?: string | undefined;
  children?: Shared_Auxiliary_1310[] | undefined;
};
...
type Shared_Type_112 = {
  ...
  metadata?:
    ...
    | undefined;
  steps: Shared_Type_107;
  predicates: Shared_Auxiliary_1170[];
};
...
type Shared_Type_113 = {
  ...
  predicate: Shared_Auxiliary_1170;
};
...
type Shared_Type_127 = {
  ...
  files?: Shared_Auxiliary_1310[] | undefined;
...
type Shared_Type_131 = {
  ...
  toolMocks?: (Shared_Type_129[] | undefined) | null;
  ...
  source?: (Shared_Type_130 | undefined) | null;
  createdAt: Date;
  updatedAt: Date;
};
...
export type PostObservabilityTracesQuery_Body = {
  ...
  where?: Shared_Auxiliary_595 | undefined;
  group?:
    | {
        by: ['threadId'];
      }
...
export type PostObservabilityThreadsQuery_Body = {
  ...
  where?: Shared_Auxiliary_648 | undefined;
  page: {
    limit: number;
    after?: (string | null) | undefined;
  };
...
export type PatchStoredSkillsStoredSkillId_Body = {
  ...
  /** Full file tree structure for the skill */
  files?: (Shared_Auxiliary_1310[] | undefined) | undefined;
  /** Additional metadata for the skill */
  metadata?:
    | (
        | {
