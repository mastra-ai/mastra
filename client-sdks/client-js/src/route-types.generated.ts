...
type Shared_Auxiliary_1101 =
  ...
  | {
      op: 'and' | 'or';
      args: Shared_Auxiliary_1101[];
    }
  | {
      op: 'not';
      arg: Shared_Auxiliary_1101;
    };

type Shared_Auxiliary_1242 = {
  id?: string | undefined;
  name: string;
  type: 'file' | 'folder';
  content?: string | undefined;
  children?: Shared_Auxiliary_1242[] | undefined;
};
...
type Shared_Type_108 =
  ...
  | {
      type: 'conditional';
      steps: Shared_Type_106[];
      predicates: Shared_Auxiliary_1101[];
    }
  | {
      type: 'loop';
      step: Shared_Type_106;
      loopType: 'dowhile' | 'dountil';
      predicate: Shared_Auxiliary_1101;
    };
...
type Shared_Type_121 = {
  ...
  files?: Shared_Auxiliary_1242[] | undefined;
...
export type PatchStoredSkillsStoredSkillId_Body = {
  ...
  /** Full file tree structure for the skill */
  files?: (Shared_Auxiliary_1242[] | undefined) | undefined;
  /** Additional metadata for the skill */
  metadata?:
    | (
        | {
